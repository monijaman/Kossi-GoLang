...
func (s *SpecificationSeederMobileVivoY21d) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"8 MP": "৮ মেগাপিক্সেল",
		"Android 11, Funtouch 11.1": "অ্যান্ড্রয়েড ১১, Funথেকেuch ১১.১",
		"August 2021": "আগস্ট ২০২১",
		"Glass front, plastic back, plastic frame": "গ্লাস সামনে, প্লাস্টিক পেছনে, প্লাস্টিক ফ্রেম",
		"Helio P35": "হেলিও P৩৫",
		"Mediatek Helio P35 (12nm)": "মিডিয়াটেক হেলিও P৩৫ (১২nm)",
		"Midnight Blue, Diamond Glow": "মিডনাইট নীল, ডায়মন্ড Glow",
