...
// SpecificationSeederRefrigeratorMarcelMfcC6eGdehDdInverter seeds specifications/options for product 'marcel-mfc-c6e-gdeh-dd-inverter'
...
func NewSpecificationSeederRefrigeratorMarcelMfcC6eGdehDdInverter() *SpecificationSeederRefrigeratorMarcelMfcC6eGdehDdInverter {
	return &SpecificationSeederRefrigeratorMarcelMfcC6eGdehDdInverter{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfc-c6e-gdeh-dd-inverter"},
	}
}
...
func (s *SpecificationSeederRefrigeratorMarcelMfcC6eGdehDdInverter) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":         "মার্সেল",
				"marcel-mfc-c6e-gdeh-dd-inverter":         "মার্সেল-mfc-c6e-gdeh-dd-inverter",
		"MFC-C6E-GDEH-DD-INVERTER":   "MFC-C6E-GDEH-DD-INVERTER",
		// Add more translations as needed
	}
}

// Seed inserts specification records for the product identified by slug 'marcel-mfc-c6e-gdeh-dd-inverter'
func (s *SpecificationSeederRefrigeratorMarcelMfcC6eGdehDdInverter) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfc-c6e-gdeh-dd-inverter"
	...
	specs := map[string]string{
		"Brand":                       "Marcel",
		"Model Name":                  "MFC-C6E-GDEH-DD-INVERTER",
