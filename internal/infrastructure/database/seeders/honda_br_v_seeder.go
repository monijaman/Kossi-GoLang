...
// HondaBRVSeeder seeds specifications for Honda BR-V
type HondaBRVSeeder struct {
	BaseSeeder
}

// NewHondaBRVSeeder creates a new Honda BR-V seeder
func NewHondaBRVSeeder() *HondaBRVSeeder {
	return &HondaBRVSeeder{
		BaseSeeder: BaseSeeder{name: "Honda BR-V Specifications"},
	}
}

func (hbvs *HondaBRVSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"2018":                         "২০১৮",
		"MPV":                          "এমপিভি",
		"Alabaster Silver Metallic":    "অ্যালাবাস্টার সিলভার মেটালিক",
		"Inline":                       "ইনলাইন",
		"1497":                         "১৪৯৭ সিসি",
		"4 (Cylinder)":                 "৪ (সিলিন্ডার)",
		"120 hp":                       "১২০ হর্স পাওয়ার",
		"120 hp @ 6600 rpm":            "৬৬০০ আরপিএম এ ১২০ হর্স পাওয়ার",
		"145 Nm @ 4600 rpm":            "৪৬০০ আরপিএম এ ১৪৫ এনএম",
		"Petrol":                       "পেট্রোল",
...
// Seed inserts specification records for Honda BR-V
func (hbvs *HondaBRVSeeder) Seed(db *gorm.DB) error {
	productSlug := "honda-br-v"
	...
	banglaTranslations := hbvs.getBanglaTranslations()
