...
func (jws *JeepWranglerSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"2023":                          "২০২৩",
		"SUV":                           "এসইউভি",
		"Firecracker Red":               "ফায়ারক্র্যাকার রেড",
		"Inline":                        "ইনলাইন",
		"1995":                          "১৯৯৫ সিসি",
		"4":                             "৪ (সিলিন্ডার)",
		"268 hp":                        "২৬৮ হর্স পাওয়ার",
		"268 hp @ 5250 rpm":             "৫২৫০ আরপিএম এ ২৬৮ হর্স পাওয়ার",
		"400 Nm @ 3000 rpm":             "৩০০০ আরপিএম এ ৪০০ এনএম",
		"Petrol":                        "পেট্রোল",
		...
		"Removable Doors":               "রিমুভেবল ডোর",
		"Removable Roof":                "রিমুভেবল রুফ",
...
func (jws *JeepWranglerSeeder) Seed(db *gorm.DB) error {
	...
	if err := db.Where("name = ?", "Jeep Wrangler").First(&product).Error; err != nil {
