...
// SpecificationSeederRefrigeratorMarcelMfcC4hNexxXx seeds specifications/options for product 'marcel-mfc-c4h-nexx-xx'
...
func NewSpecificationSeederRefrigeratorMarcelMfcC4hNexxXx() *SpecificationSeederRefrigeratorMarcelMfcC4hNexxXx {
	return &SpecificationSeederRefrigeratorMarcelMfcC4hNexxXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfc-c4h-nexx-xx"},
	}
}
...
func (s *SpecificationSeederRefrigeratorMarcelMfcC4hNexxXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":         "মার্সেল",
		"marcel-mfc-c4h-nexx-xx":         "মার্সেল-এমএফসি-সি৪এইচ-এনইএক্সএক্স-এক্সএক্স",
		// Add more translations as needed
	}
}

// Seed inserts specification records for the product identified by slug 'marcel-mfc-c4h-nexx-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfcC4hNexxXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfc-c4h-nexx-xx"
