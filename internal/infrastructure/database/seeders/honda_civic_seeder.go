...
// HondaCivicSeeder seeds specifications for Honda Civic
type HondaCivicSeeder struct {
	BaseSeeder
}

// NewHondaCivicSeeder creates a new Honda Civic seeder
func NewHondaCivicSeeder() *HondaCivicSeeder {
	return &HondaCivicSeeder{
		BaseSeeder: BaseSeeder{name: "Honda Civic Specifications"},
	}
}

func (hcs *HondaCivicSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"182 hp @ 6000 rpm":                     "৬০০০ আরপিএম এ ১৮২ হর্স পাওয়ার",
		"240 Nm @ 1700 rpm":                     "১৭০০ আরপিএম এ ২৪০ এনএম",
		"140 hp":                                "১৪০ হর্স পাওয়ার",
		"140 hp @ 6500 rpm":                     "৬৫০০ আরপিএম এ ১৪০ হর্স পাওয়ার",
		"174 Nm @ 4200 rpm":                     "৪২০০ আরপিএম এ ১৭৪ এনএম",
		"Petrol":                                "পেট্রোল",
		...
		"519L":                                  "৫১৯ লিটার",
		"47L":                                   "৪৭ লিটার",
		"215/55 R16":                            "২১৫/৫৫ আর১৬",
		"235/40 R18":                            "২৩৫/৪০ আর১৮",
		...
		"SOHC":                                  "এসওএইচসি",
		"Open":                                  "ওপেন",
		"143 hp/ton":                            "১৪৩ হর্স পাওয়ার/টন",
		"3 Years":                               "৩ বছর",
		"5 Years":                               "৫ বছর",
...
// Seed inserts specification records for Honda Civic
func (hcs *HondaCivicSeeder) Seed(db *gorm.DB) error {
	productSlug := "honda-civic"
	...
	specs := map[string]string{
		...
		"Horsepower":                     "182 hp",
		"Max Power":                      "182 hp @ 6000 rpm",
		"Max Torque":                     "240 Nm @ 1700 rpm",
