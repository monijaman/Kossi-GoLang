...
// VolvoS60Seeder seeds specifications for Volvo S60
type VolvoS60Seeder struct {
	BaseSeeder
}

// NewVolvoS60Seeder creates a new Volvo S60 seeder
func NewVolvoS60Seeder() *VolvoS60Seeder {
	return &VolvoS60Seeder{
		BaseSeeder: BaseSeeder{name: "Volvo S60 Specifications"},
	}
}

func (vss *VolvoS60Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Volvo S60
func (vss *VolvoS60Seeder) Seed(db *gorm.DB) error {
	productSlug := "volvo-s60"
	...
	log.Printf("✅ Volvo S60 specifications seeded successfully")
	return nil
}
