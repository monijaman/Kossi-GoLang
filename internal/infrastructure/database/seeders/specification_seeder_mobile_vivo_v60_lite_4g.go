...
func (s *SpecificationSeederMobileVivoV60Lite4g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Helio G95 (12 nm)": "হেলিও G৯৫ (১২ ন্যানোমিটার)",
		"Li-Ion (non-removable)": "লি-আয়ন (অপসারণযোগ্য নয়)",
		"Mali-G76 MC4": "মালি-G৭৬ MC৪",
		"May 2021": "মে ২০২১",
		"MediaTek Helio G95": "মিডিয়াটেক হেলিও G৯৫",
...
func (s *SpecificationSeederMobileVivoV60Lite4g) Seed(db *gorm.DB) error {
	...
	// Override model-specific values for Vivo V60 Lite 4G
	specs["Display Size"] = "6.44 inches"
	specs["Processor"] = "MediaTek Helio G95"
	specs["Chipset"] = "Helio G95 (12 nm)"
	specs["Cpu Type"] = "Octa-core"
	specs["Gpu Type"] = "Mali-G76 MC4"
	specs["Ram"] = "6 / 8 GB"
	...
	specs["Announcement Date"] = "May 2021"
