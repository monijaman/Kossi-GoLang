...
// XiaomiMiNotebookProX14Seeder seeds specifications for Xiaomi Mi Notebook Pro X 14
type XiaomiMiNotebookProX14Seeder struct {
	BaseSeeder
}

// NewXiaomiMiNotebookProX14Seeder creates a new Xiaomi Mi Notebook Pro X 14 seeder
func NewXiaomiMiNotebookProX14Seeder() *XiaomiMiNotebookProX14Seeder {
	return &XiaomiMiNotebookProX14Seeder{
		BaseSeeder: BaseSeeder{name: "Xiaomi Mi Notebook Pro X 14 Specifications"},
	}
}

func (xmnpx14s *XiaomiMiNotebookProX14Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Xiaomi":                        "শাওমি",
		"Mi Notebook Pro X 14":          "এমআই নোটবুক প্রো এক্স ১৪",
		...
		"314.1 x 227.2 x 14.9 mm":              "৩১৪.১ x ২২৭.২ x ১৪.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"8":                                    "৮",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for Xiaomi Mi Notebook Pro X 14
func (xmnpx14s *XiaomiMiNotebookProX14Seeder) Seed(db *gorm.DB) error {
	productSlug := "xiaomi-mi-notebook-pro-x-14"
	...
	specs := map[string]string{
		"Brand":                "Xiaomi",
		"Model Name":           "Mi Notebook Pro X 14",
		...
		"Sensors":                 "No",
		"Dimensions":              "314.1 x 227.2 x 14.9 mm",
		"Body Type":               "Aluminum",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := xmnpx14s.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Xiaomi Mi Notebook Pro X 14 specifications seeded successfully")
	return nil
}
