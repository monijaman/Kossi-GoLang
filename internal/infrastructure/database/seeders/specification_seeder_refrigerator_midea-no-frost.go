...
// SpecificationSeederRefrigeratorMideaNoFrost seeds specifications/options for product 'midea-no-frost'
type SpecificationSeederRefrigeratorMideaNoFrost struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMideaNoFrost creates a new seeder instance
func NewSpecificationSeederRefrigeratorMideaNoFrost() *SpecificationSeederRefrigeratorMideaNoFrost {
	return &SpecificationSeederRefrigeratorMideaNoFrost{
		BaseSeeder: BaseSeeder{name: "Specifications for midea-no-frost"},
	}
}

func (s *SpecificationSeederRefrigeratorMideaNoFrost) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'midea-no-frost'
func (s *SpecificationSeederRefrigeratorMideaNoFrost) Seed(db *gorm.DB) error {
	productSlug := "midea-no-frost"
