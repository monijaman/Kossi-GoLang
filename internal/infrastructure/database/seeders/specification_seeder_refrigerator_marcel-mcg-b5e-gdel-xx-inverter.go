...
// SpecificationSeederRefrigeratorMarcelMcgB5eGdelXxInverter seeds specifications/options for product 'marcel-mcg-b5e-gdel-xx-inverter'
type SpecificationSeederRefrigeratorMarcelMcgB5eGdelXxInverter struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMcgB5eGdelXxInverter creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMcgB5eGdelXxInverter() *SpecificationSeederRefrigeratorMarcelMcgB5eGdelXxInverter {
	return &SpecificationSeederRefrigeratorMarcelMcgB5eGdelXxInverter{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mcg-b5e-gdel-xx-inverter"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMcgB5eGdelXxInverter) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":                          "মার্সেল",
		"marcel-mcg-b5e-gdel-xx-inverter": "মার্সেল-mcg-b5e-gdel-xx-inverter",
		"MCG-B5E-GDEL-XX-INVERTER":        "MCG-B5E-GDEL-XX-INVERTER",
...
// Seed inserts specification records for the product identified by slug 'marcel-mcg-b5e-gdel-xx-inverter'
func (s *SpecificationSeederRefrigeratorMarcelMcgB5eGdelXxInverter) Seed(db *gorm.DB) error {
	productSlug := "marcel-mcg-b5e-gdel-xx-inverter"
	...
	specs := map[string]string{
		"Brand":                       "Marcel",
		"Model Name":                  "MCG-B5E-GDEL-XX-INVERTER",
