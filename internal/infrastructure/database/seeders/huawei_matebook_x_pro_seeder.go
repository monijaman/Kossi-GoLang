...
// HuaweiMatebookXProSeeder seeds specifications for Huawei MateBook X Pro
type HuaweiMatebookXProSeeder struct {
	BaseSeeder
}

// NewHuaweiMatebookXProSeeder creates a new Huawei MateBook X Pro seeder
func NewHuaweiMatebookXProSeeder() *HuaweiMatebookXProSeeder {
	return &HuaweiMatebookXProSeeder{
		BaseSeeder: BaseSeeder{name: "Huawei MateBook X Pro Specifications"},
	}
}

func (hms *HuaweiMatebookXProSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Huawei":                        "হুয়াওয়ে",
		"MateBook X Pro":                "মেটবুক এক্স প্রো",
		...
		"3000 x 2000 pixels":            "৩০০০ x ২০০০ পিক্সেল",
		"13.9 inches":                   "১৩.৯ ইঞ্চি",
		"56 Wh":                         "৫৬ ডব্লিউএইচ",
		...
		"1.3 GHz base / 4.7 GHz boost":  "১.৩ গিগাহার্টজ বেস / ৪.৭ গিগাহার্টজ বুস্ট",
		"12 MB cache":                   "১২ এমবি ক্যাশ",
		"1080p HD":                      "১০৮০পি এইচডি",
		"Quad Speakers":                 "কোয়াড স্পিকার",
		"304 x 217 x 14.6 mm":           "৩০৪ x ২১৭ x ১৪.৬ মিমি",
		"Huawei Share":                  "হুয়াওয়ে শেয়ার",
		"4":                             "৪",
		"8":                             "৮",
		"LPDDR4X-4266":                  "এলপিডিডিআর৪এক্স-৪২৬৬",
		"No (soldered RAM)":             "না (সোল্ডার্ড র্যাম)",
		"NVMe PCIe Gen3":                "এনভিএমই পিসিআই জেন৩",
		"No (soldered)":                 "না (সোল্ডার্ড)",
		"Shared":                        "শেয়ার্ড",
		"English/Bangla":                "ইংরেজি/বাংলা",
		"Premium":                       "প্রিমিয়াম",
		"No HDMI":                       "এইচডিএমআই নেই",
		"2x USB-C 3.2 Gen 2":            "২x ইউএসবি-সি ৩.২ জেন ২"}
}

// Seed implements the Seeder interface for Huawei MateBook X Pro
func (hms *HuaweiMatebookXProSeeder) Seed(db *gorm.DB) error {
	productSlug := "huawei-matebook-x-pro"
	...
	specs := map[string]string{
		...
		"Processor Speed":         "1.3 GHz base / 4.7 GHz boost",
		...
		"Processor Cores":         "4",
		"Processor Threads":       "8",
		"RAM Speed":               "LPDDR4X-4266",
		"RAM Slots":               "No (soldered)",
		"RAM Expandable":          "No (soldered RAM)",
		"Storage Interface":       "NVMe PCIe Gen3",
		"Storage Expandable":      "No (soldered)",
	...
	log.Printf("✅ Huawei MateBook X Pro specifications seeded successfully")
	return nil
}
