...
func (s *SpecificationSeederMobilePocoX6Pro5g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Glass front (Gorilla Glass 5), plastic back or silicone polymer back, plastic frame": "গ্লাস সামনে (গরিলা গ্লাস ৫), প্লাস্টিক পেছনে বা সিলিকন পলিমার পেছনে, প্লাস্টিক ফ্রেম",
		"IP54": "IP৫৪",
