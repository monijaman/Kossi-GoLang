...
// SpecificationSeederRefrigeratorecobd249sgskyblue seeds specifications/options for product 'eco-bd-249sg-sky-blue'
type SpecificationSeederRefrigeratorecobd249sgskyblue struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecobd249sgskyblue creates a new seeder instance
func NewSpecificationSeederRefrigeratorecobd249sgskyblue() *SpecificationSeederRefrigeratorecobd249sgskyblue {
	return &SpecificationSeederRefrigeratorecobd249sgskyblue{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-bd-249sg-sky-blue"},
	}
}

func (s *SpecificationSeederRefrigeratorecobd249sgskyblue) getBanglaTranslations() map[string]string {
	return map[string]string{
		"ECO+":                   "ইকো+",
		"ECO+ BD-249SG Sky Blue": "ECO+ BD-249SG Sky Blue",
...
// Seed inserts specification records for the product identified by slug 'eco-bd-249sg-sky-blue'
func (s *SpecificationSeederRefrigeratorecobd249sgskyblue) Seed(db *gorm.DB) error {
	productSlug := "eco-bd-249sg-sky-blue"
	...
	specs := map[string]string{
		"Brand":                       "ECO+",
		"Model Name":                  "ECO+ BD-249SG Sky Blue",
