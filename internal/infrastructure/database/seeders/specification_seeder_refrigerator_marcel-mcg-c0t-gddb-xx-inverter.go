...
func (s *SpecificationSeederRefrigeratorMarcelMcgC0tGddbXxInverter) Seed(db *gorm.DB) error {
    ...
    specs := map[string]string{
		...
		"Compressor Input Power (Watt)": "V 23.01- 154 V 24.01- 235 V 25.01- 147 V 26.01- 147 V 27.01- 118",
		"Compressor Type": "V 23.01- RSCR V 24.01- CSIR V 25.01- RSCR V 26.01- RSCR V 27.01- RSCR",
		"Wide voltage range": "V 26.01, 150V-260V V 27.01, 145V-260V",
		"Cooling Efect": "Freezer Cabinet Less than -18℃",
		"Temperature Control (Electronic/ Mechanical)": "V 28.01 - Electronic",
		...
		"Sliding Glass": "Yes",
		"Lock": "No",
		"Refrigerant": "V 23.01- R134a V 24.01- R134a V 25.01- R600a V 26.01- R600a V 27.01- R600a",
		"Condenser": "Steel",
		"Thermostat": "RoHS Certified",
		"Capillary": "Copper",
		"Polyurethane foam blowing agent": "Cyclopentene [Eco-friendly (100% CFC & HCFC Free) Green Technology]",
		"Recommended voltage stabilizer capacity (2000VA or More)": "V 21.01 V 22.01 V 23.01 V 24.01 V 25.01",
