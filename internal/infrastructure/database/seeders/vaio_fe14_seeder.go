...
// VaioFe14Seeder seeds specifications for VAIO FE14
type VaioFe14Seeder struct {
	BaseSeeder
}

// NewVaioFe14Seeder creates a new VAIO FE14 seeder
func NewVaioFe14Seeder() *VaioFe14Seeder {
	return &VaioFe14Seeder{
		BaseSeeder: BaseSeeder{name: "VAIO FE14 Specifications"},
	}
}

func (vfs *VaioFe14Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"324 x 220 x 15.9 mm":                  "৩২৪ x ২২০ x ১৫.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"4":                                    "৪",
		"8":                                    "৮",
...
// Seed implements the Seeder interface for VAIO FE14
func (vfs *VaioFe14Seeder) Seed(db *gorm.DB) error {
	productSlug := "vaio-fe14"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "324 x 220 x 15.9 mm",
		"Body Type":               "Aluminum",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := vfs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ VAIO FE14 specifications seeded successfully")
	return nil
}
