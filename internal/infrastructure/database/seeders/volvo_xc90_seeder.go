...
// VolvoXc90Seeder seeds specifications for Volvo XC90
type VolvoXc90Seeder struct {
	BaseSeeder
}

// NewVolvoXc90Seeder creates a new Volvo XC90 seeder
func NewVolvoXc90Seeder() *VolvoXc90Seeder {
	return &VolvoXc90Seeder{
		BaseSeeder: BaseSeeder{name: "Volvo XC90 Specifications"},
	}
}

func (vxs *VolvoXc90Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Volvo XC90
func (vxs *VolvoXc90Seeder) Seed(db *gorm.DB) error {
	productSlug := "volvo-xc90"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "157 hp/ton",
	...
	log.Printf("✅ Volvo XC90 specifications seeded successfully")
	return nil
}
