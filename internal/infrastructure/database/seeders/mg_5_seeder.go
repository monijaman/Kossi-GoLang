...
// MG5Seeder seeds specifications for MG 5
type MG5Seeder struct {
	BaseSeeder
}

// NewMG5Seeder creates a new MG 5 seeder
func NewMG5Seeder() *MG5Seeder {
	return &MG5Seeder{
		BaseSeeder: BaseSeeder{name: "MG 5 Specifications"},
	}
}

func (mf *MG5Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"1.5L Turbo":                    "১.৫ লিটার টার্বো",
		"Compact Sedan":                 "কমপ্যাক্ট সেডান",
		"2020":                          "২০২০",
		"Sedan":                         "সেডান",
		"York White":                    "ইয়র্ক হোয়াইট",
		"Inline":                        "ইনলাইন",
		"1498":                          "১৪৯৮ সিসি",
		"4":                             "৪ (সিলিন্ডার)",
		"108 hp":                        "১০৮ হর্স পাওয়ার",
		"108 hp @ 5600 rpm":             "৫৬০০ আরপিএম এ ১০৮ হর্স পাওয়ার",
		...
		"1.5L Turbo":                    "১.৫লি টার্বো",
		"Displacement":                  "ডিসপ্লেসমেন্ট",
		"1498 cc":                       "১৪৯৮ সিসি",
		"Max Power":                     "ম্যাক্স পাওয়ার",
		"108 hp @ 5600 rpm":             "১০৮ হর্স পাওয়ার @ ৫৬০০ আরপিএম",
...
func (mf *MG5Seeder) Seed(db *gorm.DB) error {
	// First, find or create the product
	var product models.ProductModel
	if err := db.Where("name = ?", "MG 5").First(&product).Error; err != nil {
	...
	specifications := map[string]string{
		...
		"engine_max_power":            "108 hp @ 5600 rpm",
		...
		"dimensions_length":           "4601 mm",
		"dimensions_width":            "1818 mm",
		"dimensions_height":           "1489 mm",
		"dimensions_wheelbase":        "2650 mm",
		"dimensions_front_tread":      "1546 mm",
		"dimensions_rear_tread":       "1549 mm",
		"dimensions_ground_clearance": "150 mm",
		"dimensions_boot_space":       "523 L",
		"dimensions_fuel_tank":        "50 L",
		"dimensions_turning_radius":   "5.5 m",
		"weight_kerb_weight":          "1255 kg",
		"weight_gross_weight":         "1755 kg",
		...
		"brakes_front":                "Disc",
		"brakes_rear":                 "Drum",
		"tyres_size":                  "205/55 R16",
		"tyres_wheel_size":            "16 inches",
		"tyres_spare_size":            "205/55 R16",
		"exterior_colors":             "York White, Black, Gray, Silver, Blue, Red",
	...
	for key, value := range specifications {
		if specKeyID, exists := specKeyMap[key]; exists {
			...
			translation := models.SpecificationTranslationModel{
				...
				LanguageCode:    "bn",
				Value:           mf.getBanglaTranslations()[value],
				Status:          1,
			}
	...
	log.Printf("Seeded specifications for MG 5")
	return nil
}
