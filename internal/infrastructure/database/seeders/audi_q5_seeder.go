...
// AudiQ5Seeder seeds specifications for Audi Q5
type AudiQ5Seeder struct {
	BaseSeeder
}

// NewAudiQ5Seeder creates a new Audi Q5 seeder
func NewAudiQ5Seeder() *AudiQ5Seeder {
	return &AudiQ5Seeder{
		BaseSeeder: BaseSeeder{name: "Audi Q5 Specifications"},
	}
}

func (aqs *AudiQ5Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Audi Q5
func (aqs *AudiQ5Seeder) Seed(db *gorm.DB) error {
	productSlug := "audi-q5"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "187 hp/ton",
	...
	log.Printf("✅ Audi Q5 specifications seeded successfully")
	return nil
}
