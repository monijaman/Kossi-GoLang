...
// MercedesBenzGClassSeeder seeds specifications for Mercedes-Benz G-Class
type MercedesBenzGClassSeeder struct {
	BaseSeeder
}

// NewMercedesBenzGClassSeeder creates a new Mercedes-Benz G-Class seeder
func NewMercedesBenzGClassSeeder() *MercedesBenzGClassSeeder {
	return &MercedesBenzGClassSeeder{
		BaseSeeder: BaseSeeder{name: "Mercedes-Benz G-Class Specifications"},
	}
}

func (mbgcs *MercedesBenzGClassSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"G 500":                          "জি ৫০০",
		"5th Generation (W463)":          "৫ম প্রজন্ম (ডব্লিউ৪৬৩)",
...
// Seed implements the Seeder interface for Mercedes-Benz G-Class
func (mbgcs *MercedesBenzGClassSeeder) Seed(db *gorm.DB) error {
	productSlug := "mercedes-benz-g-class"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := mbgcs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Mercedes-Benz G-Class specifications seeded successfully")
	return nil
}
