...
func (s *SpecificationSeederMobileSamsungGalaxyS22Ultra) getBanglaTranslations() map[string]string {
	return map[string]string{
		"108 MP + 10 MP + 10 MP + 12 MP": "১০৮ মেগাপিক্সেল + ১০ মেগাপিক্সেল + ১০ মেগাপিক্সেল + ১২ মেগাপিক্সেল",
		"120Hz": "১২০Hz",
		...
		"IP68": "IP৬৮",
		"Phantom Black, White, Burgundy, Green": "ফ্যান্টম কালো, সাদা, Burgundy, সবুজ",
