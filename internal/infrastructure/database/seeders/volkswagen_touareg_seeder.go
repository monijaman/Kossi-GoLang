...
// VolkswagenTouaregSeeder seeds specifications for Volkswagen Touareg
type VolkswagenTouaregSeeder struct {
	BaseSeeder
}

// NewVolkswagenTouaregSeeder creates a new Volkswagen Touareg seeder
func NewVolkswagenTouaregSeeder() *VolkswagenTouaregSeeder {
	return &VolkswagenTouaregSeeder{
		BaseSeeder: BaseSeeder{name: "Volkswagen Touareg Specifications"},
	}
}

func (vts *VolkswagenTouaregSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"2995":                         "২৯৯৫ সিসি",
		"6":                            "৬ (সিলিন্ডার)",
		"286 hp":                       "২৮৬ হর্স পাওয়ার",
		"286 hp @ 4000 rpm":            "৪০০০ আরপিএম এ ২৮৬ হর্স পাওয়ার",
		"600 Nm @ 1250-4000 rpm":       "১২৫০-৪০০০ আরপিএম এ ৬০০ এনএম",
		"Diesel":                       "ডিজেল",
		...
		"9.2 inch (Screen)":            "৯.২ ইঞ্চি (স্ক্রিন)",
		"Yes (Apple CarPlay)":          "হ্যাঁ (অ্যাপল কারপ্লে)",
		"Yes (Android Auto)":           "হ্যাঁ (অ্যান্ড্রয়েড অটো)",
		"Dynaudio (Sound System)":      "ডায়নঅডিও (সাউন্ড সিস্টেম)",
...
// Seed implements the Seeder interface for Volkswagen Touareg
func (vts *VolkswagenTouaregSeeder) Seed(db *gorm.DB) error {
	productSlug := "volkswagen-touareg"
	...
	specs := map[string]string{
		...
		"Infotainment Screen (inch)":     "9.2 inch",
		"Apple CarPlay":                  "Yes",
		"Android Auto":                   "Yes",
		"Sound System Brand":             "Dynaudio",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := vts.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Volkswagen Touareg specifications seeded successfully")
	return nil
}
