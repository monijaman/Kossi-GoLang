...
func (s *SpecificationSeederMobileRealmeC61) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"60 Hz": "৬০ Hz",
		"Android 12, Realme UI Go Edition": "অ্যান্ড্রয়েড ১২, Realme UI Go Edition",
		"Black, Blue": "কালো, নীল",
		"Dual SIM (Nano-SIM)": "ডুয়াল সিম (ন্যানো-সিম)",
		"Fingerprint (rear), Accelerometer, Proximity": "ফিঙ্গারপ্রিন্ট (rear), অ্যাক্সিলেরোমিটার, প্রক্সিমিটি",
		"Li-Ion (non-removable)": "লি-আয়ন (অপসারণযোগ্য নয়)",
		"Mali-G57": "মালি-G৫৭",
		"Octa-core (2×1.8 GHz Cortex-A75 + 6×1.8 GHz Cortex-A55)": "অক্টা-কোর (২×১.৮ গিগাহার্টজ Cবাtex-A৭৫ + ৬×১.৮ গিগাহার্টজ Cবাtex-A৫৫)",
		"T612 (12 nm)": "T৬১২ (১২ ন্যানোমিটার)",
