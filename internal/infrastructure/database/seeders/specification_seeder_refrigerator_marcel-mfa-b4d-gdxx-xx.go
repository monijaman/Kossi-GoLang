...
func (s *SpecificationSeederRefrigeratorMarcelMfaB4dGdxxXx) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"Recommended voltage stabilizer capacity": "V 0701/V 0801 : No Need to use voltage stabilizerIf out of voltage range(145V-260V), then suggested
voltage stabilizer capacity is 1000VA.",
