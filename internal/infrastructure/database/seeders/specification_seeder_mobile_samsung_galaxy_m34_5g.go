...
func (s *SpecificationSeederMobileSamsungGalaxyM345g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Android 13, One UI 5 (আপগ্রেডযোগ্য)": "Android ১৩, One UI ৫ (আপগ্রেডযোগ্য)",
		...
		"হাইব্রিড Dual SIM (nano + microSD)": "হাইব্রিড ডুয়াল সিম (nano + microSD)",
		"July 2023": "July ২০২৩",
		"Li-Po (non-removable)": "লি-পো (অপসারণযোগ্য নয়)",
		"Mali-G68 MP4": "Mali-G৬৮ MP৪",
		"মিডনাইট Blue, Prism Silver, Waterfall Blue": "মিডনাইট নীল, Prism রূপালী, Waterfall নীল",
