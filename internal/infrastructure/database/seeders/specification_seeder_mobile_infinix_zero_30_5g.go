...
func (s *SpecificationSeederMobileInfinixZero305g) getBanglaTranslations() map[string]string {
	return map[string]string{
		"108 MP + 13 MP + 2 MP": "১০৮ মেগাপিক্সেল + ১৩ মেগাপিক্সেল + ২ মেগাপিক্সেল",
		...
		"AMOLED, 144Hz, Curved": "অ্যামোলেড, ১৪৪Hz, Curved",
		"Android 13, XOS 13": "অ্যান্ড্রয়েড ১৩, এক্সওএস ১৩",
		"Corning Gorilla Glass 5": "কর্নিং গরিলা গ্লাস ৫",
		"Dimensity 8020": "ডাইমেনসিটি ৮০২০",
		"Glass front, glass back, plastic frame": "গ্লাস সামনে, গ্লাস পেছনে, প্লাস্টিক ফ্রেম",
		"IP53": "IP৫৩",
		"Mali-G77 MC9": "মালি-G৭৭ MC৯",
		"Mediatek Dimensity 8020 (6 nm)": "মিডিয়াটেক ডাইমেনসিটি ৮০২০ (৬ ন্যানোমিটার)",
		"Rome Green, Golden Hour, Fantasy Purple": "Rome সবুজ, সোনালীen Hour, Fantasy বেগুনি",
