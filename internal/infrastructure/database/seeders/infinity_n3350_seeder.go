...
// InfinityN3350Seeder seeds specifications for Infinity N3350
type InfinityN3350Seeder struct {
	BaseSeeder
}

// NewInfinityN3350Seeder creates a new Infinity N3350 seeder
func NewInfinityN3350Seeder() *InfinityN3350Seeder {
	return &InfinityN3350Seeder{
		BaseSeeder: BaseSeeder{name: "Infinity N3350 Specifications"},
	}
}

func (in3 *InfinityN3350Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Infinity":                      "ইনফিনিটি",
		"N3350":                         "এন৩৩৫০",
		"Windows 10 Home":               "উইন্ডোজ ১০ হোম",
		"Intel":                         "ইন্টেল",
		"Celeron N3350":                 "সেলেরন এন৩৩৫০",
		"8th Gen":                       "৮ম প্রজন্ম",
		"Intel Platform Controller Hub": "ইন্টেল প্ল্যাটফর্ম কন্ট্রোলার হাব",
		"Intel HD Graphics 500":         "ইন্টেল এইচডি গ্রাফিক্স ৫০০",
		...
		"1.1 GHz base / 2.4 GHz boost":  "১.১ গিগাহার্টজ বেস / ২.৪ গিগাহার্টজ বুস্ট",
...
// Seed implements the Seeder interface for Infinity N3350
func (in3 *InfinityN3350Seeder) Seed(db *gorm.DB) error {
	productSlug := "infinity-n3350"
	...
	specs := map[string]string{
		...
		"Processor Speed":         "1.1 GHz base / 2.4 GHz boost",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := in3.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Infinity N3350 specifications seeded successfully")
	return nil
}
