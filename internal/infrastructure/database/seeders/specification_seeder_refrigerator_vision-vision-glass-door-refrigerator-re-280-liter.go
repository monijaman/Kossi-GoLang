...
func (s *SpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE280Liter) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Vision": "ভিশন",
		"VISION Glass Door Refrigerator RE-280 Liter": "VISION Glass Door Refrigerator RE-280 Liter",
		"Single Door": "Single Door",
		"280 Liters": "280 লিটার",
		"0 Liters": "০ লিটার",
		"5 Star": "৫ তারা",
		"5": "৫",
...
func (s *SpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE280Liter) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		"Brand": "Vision",
		"Model Name": "VISION Glass Door Refrigerator RE-280 Liter",
