...
// SpecificationSeederRefrigeratorAuxDoubleDoor seeds specifications/options for product 'aux-double-door'
type SpecificationSeederRefrigeratorAuxDoubleDoor struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorAuxDoubleDoor creates a new seeder instance
func NewSpecificationSeederRefrigeratorAuxDoubleDoor() *SpecificationSeederRefrigeratorAuxDoubleDoor {
	return &SpecificationSeederRefrigeratorAuxDoubleDoor{
		BaseSeeder: BaseSeeder{name: "Specifications for aux-double-door"},
	}
}

func (s *SpecificationSeederRefrigeratorAuxDoubleDoor) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'aux-double-door'
func (s *SpecificationSeederRefrigeratorAuxDoubleDoor) Seed(db *gorm.DB) error {
	productSlug := "aux-double-door"
