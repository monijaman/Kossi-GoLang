...
// Bmw5SeriesSeeder seeds specifications for BMW 5 Series
type Bmw5SeriesSeeder struct {
	BaseSeeder
}

// NewBmw5SeriesSeeder creates a new BMW 5 Series seeder
func NewBmw5SeriesSeeder() *Bmw5SeriesSeeder {
	return &Bmw5SeriesSeeder{
		BaseSeeder: BaseSeeder{name: "BMW 5 Series Specifications"},
	}
}

func (b5ss *Bmw5SeriesSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"1998":                            "১৯৯৮ সিসি",
		"4":                               "৪ (সিলিন্ডার)",
		"252 hp":                          "২৫২ হর্স পাওয়ার",
		"252 hp @ 5200 rpm":               "৫২০০ আরপিএম এ ২৫২ হর্স পাওয়ার",
		"350 Nm @ 1450-4800 rpm":          "১৪৫০-৪৮০০ আরপিএম এ ৩৫০ এনএম",
		"Petrol":                          "পেট্রোল",
...
// Seed implements the Seeder interface for BMW 5 Series
func (b5ss *Bmw5SeriesSeeder) Seed(db *gorm.DB) error {
	productSlug := "bmw-5-series"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "146 hp/ton",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := b5ss.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ BMW 5 Series specifications seeded successfully")
	return nil
}
