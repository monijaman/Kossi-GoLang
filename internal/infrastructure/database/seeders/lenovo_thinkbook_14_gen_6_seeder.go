...
// LenovoThinkbook14Gen6Seeder seeds specifications for Lenovo ThinkBook 14 Gen 6
type LenovoThinkbook14Gen6Seeder struct {
	BaseSeeder
}

// NewLenovoThinkbook14Gen6Seeder creates a new Lenovo ThinkBook 14 Gen 6 seeder
func NewLenovoThinkbook14Gen6Seeder() *LenovoThinkbook14Gen6Seeder {
	return &LenovoThinkbook14Gen6Seeder{
		BaseSeeder: BaseSeeder{name: "Lenovo ThinkBook 14 Gen 6 Specifications"},
	}
}

func (lts *LenovoThinkbook14Gen6Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Lenovo":                        "লেনোভো",
		"ThinkBook 14 Gen 6":            "থিঙ্কবুক ১৪ জেন ৬",
...
// Seed implements the Seeder interface for Lenovo ThinkBook 14 Gen 6
func (lts *LenovoThinkbook14Gen6Seeder) Seed(db *gorm.DB) error {
	productSlug := "lenovo-thinkbook-14-gen-6"
	...
	log.Printf("✅ Lenovo ThinkBook 14 Gen 6 specifications seeded successfully")
	return nil
}
