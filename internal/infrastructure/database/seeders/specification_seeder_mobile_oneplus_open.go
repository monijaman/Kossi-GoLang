...
func (s *SpecificationSeederMobileOneplusOpen) getBanglaTranslations() map[string]string {
	return map[string]string{
		"120Hz": "১২০Hz",
		"16 GB": "১৬ GB",
		"20 MP (Inner) + 32 MP (Cover)": "২০ মেগাপিক্সেল (Inner) + ৩২ মেগাপিক্সেল (Cover)",
		"2268 x 2440 pixels": "২২৬৮ x ২৪৪০ পিক্সেল",
		"239 g": "২৩৯ g",
		"4,805 mAh": "৪,৮০৫ এমএএইচ",
		"48 MP + 64 MP + 48 MP": "৪৮ মেগাপিক্সেল + ৬৪ মেগাপিক্সেল + ৪৮ মেগাপিক্সেল",
		"512 GB": "৫১২ GB",
		"5G": "৫G",
		"7.82 inches (Main) / 6.31 inches (Cover)": "৭.৮২ ইঞ্চি (Main) / ৬.৩১ ইঞ্চি (Cover)",
		"Adreno 740": "অ্যাড্রেনো ৭৪০",
		"Android 13, OxygenOS 13.2": "অ্যান্ড্রয়েড ১৩, OxygenOS ১৩.২",
		"Emerald Dusk, Voyager Black": "Emerald Dusk, Voyager কালো",
		"Foldable LTPO3 Flexi-fluid AMOLED, 120Hz, Dolby Vision, 2800 nits": "Foldable এলটিপিও৩ Flexi-fluid অ্যামোলেড, ১২০Hz, ডলবি ভিশন, ২৮০০ nits",
