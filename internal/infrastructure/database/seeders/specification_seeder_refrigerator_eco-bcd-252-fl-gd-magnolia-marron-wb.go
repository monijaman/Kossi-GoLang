...
// SpecificationSeederRefrigeratorecobcd252flgdmagnoliamarronwb seeds specifications/options for product 'eco-bcd-252-fl-gd-magnolia-marron-wb'
type SpecificationSeederRefrigeratorecobcd252flgdmagnoliamarronwb struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecobcd252flgdmagnoliamarronwb creates a new seeder instance
func NewSpecificationSeederRefrigeratorecobcd252flgdmagnoliamarronwb() *SpecificationSeederRefrigeratorecobcd252flgdmagnoliamarronwb {
	return &SpecificationSeederRefrigeratorecobcd252flgdmagnoliamarronwb{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-bcd-252-fl-gd-magnolia-marron-wb"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'eco-bcd-252-fl-gd-magnolia-marron-wb'
func (s *SpecificationSeederRefrigeratorecobcd252flgdmagnoliamarronwb) Seed(db *gorm.DB) error {
	productSlug := "eco-bcd-252-fl-gd-magnolia-marron-wb"
