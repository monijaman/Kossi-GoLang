...
// SpecificationSeederRefrigeratorMarcelMfcC6eGdneXx seeds specifications/options for product 'marcel-mfc-c6e-gdne-xx'
...
func NewSpecificationSeederRefrigeratorMarcelMfcC6eGdneXx() *SpecificationSeederRefrigeratorMarcelMfcC6eGdneXx {
	return &SpecificationSeederRefrigeratorMarcelMfcC6eGdneXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfc-c6e-gdne-xx"},
	}
}
...
func (s *SpecificationSeederRefrigeratorMarcelMfcC6eGdneXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":         "মার্সেল",
				"marcel-mfc-c6e-gdne-xx":         "মার্সেল-mfc-c6e-gdne-xx",
		"MFC-C6E-GDNE-XX":   "MFC-C6E-GDNE-XX",
		// Add more translations as needed
	}
}

// Seed inserts specification records for the product identified by slug 'marcel-mfc-c6e-gdne-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfcC6eGdneXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfc-c6e-gdne-xx"
