...
// SpecificationSeederRefrigeratorSingerSS300FBDS185BG seeds specifications/options for product 'singer-ss300-fbds185-bg'
type SpecificationSeederRefrigeratorSingerSS300FBDS185BG struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerSS300FBDS185BG creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerSS300FBDS185BG() *SpecificationSeederRefrigeratorSingerSS300FBDS185BG {
	return &SpecificationSeederRefrigeratorSingerSS300FBDS185BG{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ss300-fbds185-bg"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerSS300FBDS185BG) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                      "সিঙ্গার",
		"SS300-FBDS185-BG":            "SS300-FBDS185-BG",
		"SRREF-SS300-FBDS185-BG":      "SRREF-SS300-FBDS185-BG",
...
// Seed inserts specification records for the product identified by slug 'singer-ss300-fbds185-bg'
func (s *SpecificationSeederRefrigeratorSingerSS300FBDS185BG) Seed(db *gorm.DB) error {
	productSlug := "singer-ss300-fbds185-bg"
	...
	specs := map[string]string{
		"Brand":                       "Singer",
		"Model Name":                  "SRREF-SS300-FBDS185-BG",
