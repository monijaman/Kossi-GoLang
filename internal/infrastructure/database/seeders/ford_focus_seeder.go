...
// FordFocusSeeder seeds specifications for Ford Focus
type FordFocusSeeder struct {
	BaseSeeder
}

// NewFordFocusSeeder creates a new Ford Focus seeder
func NewFordFocusSeeder() *FordFocusSeeder {
	return &FordFocusSeeder{
		BaseSeeder: BaseSeeder{name: "Ford Focus Specifications"},
	}
}

func (ffs *FordFocusSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"120 hp @ 6500 rpm":                   "৬৫০০ আরপিএম এ ১২০ হর্স পাওয়ার",
...
// Seed implements the Seeder interface for Ford Focus
func (ffs *FordFocusSeeder) Seed(db *gorm.DB) error {
	productSlug := "ford-focus"
	...
	log.Printf("✅ Ford Focus specifications seeded successfully")
	return nil
}
