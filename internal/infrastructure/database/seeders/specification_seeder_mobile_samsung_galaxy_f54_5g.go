...
func (s *SpecificationSeederMobileSamsungGalaxyF545g) getBanglaTranslations() map[string]string {
	return map[string]string{
		"108 MP + 12 MP + 5 MP": "১০৮ মেগাপিক্সেল + ১২ মেগাপিক্সেল + ৫ মেগাপিক্সেল",
...
func (s *SpecificationSeederMobileSamsungGalaxyF545g) Seed(db *gorm.DB) error {
	...
	// Override model-specific values for Samsung Galaxy F54 5G
	...
	specs["Weight"] = "202 g"
	specs["Dimensions"] = "165 × 77 × 8.2 mm"
	...
	specs["Rear Camera"] = "108 MP + 12 MP + 5 MP"
