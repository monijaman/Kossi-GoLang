...
// WaltonPassionWp156u8sSeeder seeds specifications for Walton Passion WP156U8S
type WaltonPassionWp156u8sSeeder struct {
	BaseSeeder
}

// NewWaltonPassionWp156u8sSeeder creates a new Walton Passion WP156U8S seeder
func NewWaltonPassionWp156u8sSeeder() *WaltonPassionWp156u8sSeeder {
	return &WaltonPassionWp156u8sSeeder{
		BaseSeeder: BaseSeeder{name: "Walton Passion WP156U8S Specifications"},
	}
}

func (wps *WaltonPassionWp156u8sSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Walton":                        "ওয়ালটন",
		"Passion WP156U8S":              "প্যাশন ডব্লিউপি১৫৬ইউ৮এস",
...
// Seed implements the Seeder interface for Walton Passion WP156U8S
func (wps *WaltonPassionWp156u8sSeeder) Seed(db *gorm.DB) error {
	productSlug := "walton-passion-wp156u8s"
	...
	log.Printf("✅ Walton Passion WP156U8S specifications seeded successfully")
	return nil
}
