...
// AudiQ3Seeder seeds specifications for Audi Q3
type AudiQ3Seeder struct {
	BaseSeeder
}

// NewAudiQ3Seeder creates a new Audi Q3 seeder
func NewAudiQ3Seeder() *AudiQ3Seeder {
	return &AudiQ3Seeder{
		BaseSeeder: BaseSeeder{name: "Audi Q3 Specifications"},
	}
}

func (aqs *AudiQ3Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Audi Q3
func (aqs *AudiQ3Seeder) Seed(db *gorm.DB) error {
	productSlug := "audi-q3"
	...
	log.Printf("✅ Audi Q3 specifications seeded successfully")
	return nil
}
