...
// AppleMacbookPro16M3MaxSeeder seeds specifications for Apple MacBook Pro 16-inch M3 Max
type AppleMacbookPro16M3MaxSeeder struct {
	BaseSeeder
}

// NewAppleMacbookPro16M3MaxSeeder creates a new Apple MacBook Pro 16-inch M3 Max seeder
func NewAppleMacbookPro16M3MaxSeeder() *AppleMacbookPro16M3MaxSeeder {
	return &AppleMacbookPro16M3MaxSeeder{
		BaseSeeder: BaseSeeder{name: "Apple MacBook Pro 16-inch M3 Max Specifications"},
	}
}

func (amas *AppleMacbookPro16M3MaxSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Apple":                         "অ্যাপল",
		"MacBook Pro 16-inch M3 Max":    "ম্যাকবুক প্রো ১৬-ইঞ্চি এম৩ ম্যাক্স",
		"macOS Sonoma":                  "ম্যাকওএস সোনোমা",
		"M3 Max":                        "এম৩ ম্যাক্স",
		"Apple M3 Max GPU":              "অ্যাপল এম৩ ম্যাক্স জিপিইউ",
		...
		"Apple M3 Max":                  "অ্যাপল এম৩ ম্যাক্স",
		"Active":                        "অ্যাকটিভ",
		"120":                           "১২০",
		"1 Year":                        "১ বছর",
		...
		"14-core CPU, 30-core GPU":        "১৪-কোর সিপিইউ, ৩০-কোর জিপিইউ",
...
// Seed implements the Seeder interface for Apple MacBook Pro 16-inch M3 Max
func (amas *AppleMacbookPro16M3MaxSeeder) Seed(db *gorm.DB) error {
	productSlug := "apple-macbook-pro-16-inch-m3-max"
	...
	specs := map[string]string{
		"Brand":                "Apple",
		"Model Name":           "MacBook Pro 16-inch M3 Max",
		"Operating System":     "macOS Sonoma",
		"Processor Brand":      "Apple",
		"Processor Model":      "M3 Max",
		"Processor Generation": "M3 Max",
		...
		"Processor Speed":         "14-core CPU, 30-core GPU",
	...
	log.Printf("✅ Apple MacBook Pro 16-inch M3 Max specifications seeded successfully")
	return nil
}
