...
// KiaSportageSeeder seeds specifications for Kia Sportage
type KiaSportageSeeder struct {
	BaseSeeder
}

// NewKiaSportageSeeder creates a new Kia Sportage seeder
func NewKiaSportageSeeder() *KiaSportageSeeder {
	return &KiaSportageSeeder{
		BaseSeeder: BaseSeeder{name: "Kia Sportage Specifications"},
	}
}

func (kss *KiaSportageSeeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Kia Sportage
func (kss *KiaSportageSeeder) Seed(db *gorm.DB) error {
	productSlug := "kia-sportage"
	...
	log.Printf("✅ Kia Sportage specifications seeded successfully")
	return nil
}
