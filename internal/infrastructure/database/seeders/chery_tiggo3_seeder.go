...
// CheryTiggo3Seeder seeds specifications for Chery Tiggo 3
type CheryTiggo3Seeder struct {
	BaseSeeder
}

// NewCheryTiggo3Seeder creates a new Chery Tiggo 3 seeder
func NewCheryTiggo3Seeder() *CheryTiggo3Seeder {
	return &CheryTiggo3Seeder{
		BaseSeeder: BaseSeeder{name: "Chery Tiggo 3 Specifications"},
	}
}

func (cts *CheryTiggo3Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"1598":                                "১৫৯৮ সিসি",
		"4":                                   "৪ (সিলিন্ডার)",
		"126 hp":                              "১২৬ হর্স পাওয়ার",
		"126 hp @ 6150 rpm":                   "৬১৫০ আরপিএম এ ১২৬ হর্স পাওয়ার",
		"160 Nm @ 3900 rpm":                   "৩৯০০ আরপিএম এ ১৬০ এনএম",
		"Petrol":                              "পেট্রোল",
...
// Seed implements the Seeder interface for Chery Tiggo 3
func (cts *CheryTiggo3Seeder) Seed(db *gorm.DB) error {
	productSlug := "chery-tiggo-3"
	...
	log.Printf("✅ Chery Tiggo 3 specifications seeded successfully")
	return nil
}
