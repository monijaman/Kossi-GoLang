...
// SpecificationSeederRefrigeratorMarcelMfeB8bGdelXx seeds specifications/options for product 'mfe-b8b-gdel-xx'
...
func NewSpecificationSeederRefrigeratorMarcelMfeB8bGdelXx() *SpecificationSeederRefrigeratorMarcelMfeB8bGdelXx {
	return &SpecificationSeederRefrigeratorMarcelMfeB8bGdelXx{
		BaseSeeder: BaseSeeder{name: "Specifications for mfe-b8b-gdel-xx"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'mfe-b8b-gdel-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfeB8bGdelXx) Seed(db *gorm.DB) error {
	productSlug := "mfe-b8b-gdel-xx"
