...
// SpecificationSeederRefrigeratorecoomega3glg322rvbbas seeds specifications/options for product 'eco-omega3-gl-g322rvbb-as'
type SpecificationSeederRefrigeratorecoomega3glg322rvbbas struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecoomega3glg322rvbbas creates a new seeder instance
func NewSpecificationSeederRefrigeratorecoomega3glg322rvbbas() *SpecificationSeederRefrigeratorecoomega3glg322rvbbas {
	return &SpecificationSeederRefrigeratorecoomega3glg322rvbbas{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-omega3-gl-g322rvbb-as"},
	}
}

func (s *SpecificationSeederRefrigeratorecoomega3glg322rvbbas) getBanglaTranslations() map[string]string {
	return map[string]string{
		"LG":                       "এলজি",
		"LG OMEGA3 GL-G322RVBB AS": "এলজি ওমেগা৩ জিএল-জি৩২২আরভিবিবি এএস",
		"Top Mount":                "টপ মাউন্ট",
		"281":                      "২৮১",
		"223":                      "২২৩",
		"58":                       "৫৮",
...
// Seed inserts specification records for the product identified by slug 'eco-omega3-gl-g322rvbb-as'
func (s *SpecificationSeederRefrigeratorecoomega3glg322rvbbas) Seed(db *gorm.DB) error {
	productSlug := "eco-omega3-gl-g322rvbb-as"
	...
	specs := map[string]string{
		"Brand":                 "LG",
		"Model Name":            "LG OMEGA3 GL-G322RVBB AS",
		"Door Type":             "Top Mount",
		"Capacity":              "281",
