...
// AsusRogStrixScar18Seeder seeds specifications for Asus ROG Strix Scar 18
type AsusRogStrixScar18Seeder struct {
	BaseSeeder
}

// NewAsusRogStrixScar18Seeder creates a new Asus ROG Strix Scar 18 seeder
func NewAsusRogStrixScar18Seeder() *AsusRogStrixScar18Seeder {
	return &AsusRogStrixScar18Seeder{
		BaseSeeder: BaseSeeder{name: "Asus ROG Strix Scar 18 Specifications"},
	}
}

func (arz *AsusRogStrixScar18Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Asus":                                 "এসুস",
		"ROG Strix Scar 18":                    "আরওজি স্ট্রিক্স স্কার ১৮",
		...
		"394 x 294 x 27 mm":                    "৩৯৪ x ২৯৪ x ২৭ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"24":                                   "২৪",
		"32":                                   "৩২",
...
// Seed implements the Seeder interface for Asus ROG Strix Scar 18
func (arz *AsusRogStrixScar18Seeder) Seed(db *gorm.DB) error {
	productSlug := "asus-rog-strix-scar-18"
	...
	log.Printf("✅ Asus ROG Strix Scar 18 specifications seeded successfully")
	return nil
}
