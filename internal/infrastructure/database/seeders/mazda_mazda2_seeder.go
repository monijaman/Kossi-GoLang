...
// MazdaMazda2Seeder seeds specifications for Mazda Mazda2
type MazdaMazda2Seeder struct {
	BaseSeeder
}

// NewMazdaMazda2Seeder creates a new Mazda Mazda2 seeder
func NewMazdaMazda2Seeder() *MazdaMazda2Seeder {
	return &MazdaMazda2Seeder{
		BaseSeeder: BaseSeeder{name: "Mazda Mazda2 Specifications"},
	}
}

func (mm2s *MazdaMazda2Seeder) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for Mazda Mazda2
func (mm2s *MazdaMazda2Seeder) Seed(db *gorm.DB) error {
	productSlug := "mazda-mazda2"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := mm2s.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Mazda Mazda2 specifications seeded successfully")
	return nil
}
