...
// SpecificationSeederMobileRealme14t5g seeds specifications/options for product 'realme-14t-5g'
type SpecificationSeederMobileRealme14t5g struct {
	BaseSeeder
}

// NewSpecificationSeederMobileRealme14t5g creates a new seeder instance
func NewSpecificationSeederMobileRealme14t5g() *SpecificationSeederMobileRealme14t5g {
	return &SpecificationSeederMobileRealme14t5g{BaseSeeder: BaseSeeder{name: "Specifications for Realme 14T 5G"}}
}

// getBanglaTranslations returns a map of English specification values to their Bangla translations
func (s *SpecificationSeederMobileRealme14t5g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"186 g": "১৮৬ g",
		"2023": "২০২৩",
		"2412 × 1080 px (~400 ppi)": "২৪১২ × ১০৮০ পিক্সেল (~৪০০ পিপিআই)",
		...
		"Octa-core (2×2.6 GHz Cortex-A76 + 6×2.0 GHz Cortex-A55)": "অক্টা-কোর (২×২.৬ গিগাহার্টজ Cবাtex-A৭৬ + ৬×২.০ গিগাহার্টজ Cবাtex-A৫৫)",
		"Wi-Fi 802.11 a/b/g/n/ac": "ওয়াই-ফাই ৮০২.১১ a/b/g/n/ac",
	}
}

// Seed inserts specification records for the product identified by slug 'realme-14t-5g'
func (s *SpecificationSeederMobileRealme14t5g) Seed(db *gorm.DB) error {
	productSlug := "realme-14t-5g"
	...
	// Override model-specific values for Realme 14T 5G
