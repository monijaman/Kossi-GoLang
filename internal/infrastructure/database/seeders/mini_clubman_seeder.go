...
// MINIClubmanSeeder seeds specifications for MINI Clubman
type MINIClubmanSeeder struct {
	BaseSeeder
}

// NewMINIClubmanSeeder creates a new MINI Clubman seeder
func NewMINIClubmanSeeder() *MINIClubmanSeeder {
	return &MINIClubmanSeeder{
		BaseSeeder: BaseSeeder{name: "MINI Clubman Specifications"},
	}
}

func (mcs *MINIClubmanSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"1.5L Turbo":                    "১.৫ লিটার টার্বো",
		"Subcompact Wagon":              "সাবকমপ্যাক্ট ওয়াগন",
		"2019":                          "২০১৯",
		"Wagon":                         "ওয়াগন",
...
func (mcs *MINIClubmanSeeder) Seed(db *gorm.DB) error {
	// First, find or create the product
	var product models.ProductModel
	if err := db.Where("name = ?", "MINI Clubman").First(&product).Error; err != nil {
		if err == gorm.ErrRecordNotFound {
			product = models.ProductModel{
				Name:        "MINI Clubman",
				Brand:       "MINI",
				Category:    "Wagon",
				Subcategory: "Subcompact Wagon",
				Status:      1,
			}
	...
	specifications := map[string]string{
		...
		"dimensions_width":            "1800 mm",
		"dimensions_height":           "1441 mm",
		"dimensions_wheelbase":        "2670 mm",
		"dimensions_front_tread":      "1569 mm",
		"dimensions_rear_tread":       "1572 mm",
		"dimensions_ground_clearance": "141 mm",
		"dimensions_boot_space":       "360 L",
		"dimensions_fuel_tank":        "48 L",
		"dimensions_turning_radius":   "5.7 m",
		"weight_kerb_weight":          "1360 kg",
		"weight_gross_weight":         "1860 kg",
		...
		"brakes_front":                "Disc",
		"brakes_rear":                 "Disc",
		"tyres_size":                  "205/45 R17",
		"tyres_wheel_size":            "17 inches",
		"tyres_spare_size":            "205/45 R17",
		"exterior_colors":             "Midnight Black, Black, Gray, White, Silver, Blue, Red, Green, Orange",
	...
	log.Printf("Seeded specifications for MINI Clubman")
	return nil
}
