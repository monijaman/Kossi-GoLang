...
// DaihatsuMoveSeeder seeds specifications for Daihatsu Move
type DaihatsuMoveSeeder struct {
	BaseSeeder
}

// NewDaihatsuMoveSeeder creates a new Daihatsu Move seeder
func NewDaihatsuMoveSeeder() *DaihatsuMoveSeeder {
	return &DaihatsuMoveSeeder{
		BaseSeeder: BaseSeeder{name: "Daihatsu Move Specifications"},
	}
}

func (dms *DaihatsuMoveSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"658":                        "৬৫৮ সিসি",
		"3":                          "৩ (সিলিন্ডার)",
		"58 hp":                      "৫৮ হর্স পাওয়ার",
		"58 hp @ 7200 rpm":           "৭২০০ আরপিএম এ ৫৮ হর্স পাওয়ার",
		"65 Nm @ 4000 rpm":           "৪০০০ আরপিএম এ ৬৫ এনএম",
		"Petrol":                     "পেট্রোল",
		"Naturally Aspirated":        "ন্যাচারালি অ্যাসপিরেটেড",
		"Multipoint Injection":       "মাল্টিপয়েন্ট ইনজেকশন",
		"13.8 seconds":               "১৩.৮ সেকেন্ড",
...
// Seed implements the Seeder interface for Daihatsu Move
func (dms *DaihatsuMoveSeeder) Seed(db *gorm.DB) error {
	productSlug := "daihatsu-move"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "68 hp/ton",
	...
	log.Printf("✅ Daihatsu Move specifications seeded successfully")
	return nil
}
