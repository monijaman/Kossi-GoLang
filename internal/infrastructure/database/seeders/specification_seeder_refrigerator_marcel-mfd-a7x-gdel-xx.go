...
// SpecificationSeederRefrigeratorMarcelMfdA7xGdelXx seeds specifications/options for product 'marcel-mfd-a7x-gdel-xx'
type SpecificationSeederRefrigeratorMarcelMfdA7xGdelXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfdA7xGdelXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfdA7xGdelXx() *SpecificationSeederRefrigeratorMarcelMfdA7xGdelXx {
	return &SpecificationSeederRefrigeratorMarcelMfdA7xGdelXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfd-a7x-gdel-xx"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfdA7xGdelXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":         "মার্সেল",
				"marcel-mfd-a7x-gdel-xx":         "মার্সেল-mfd-a7x-gdel-xx",
		"MFD-A7X-GDEL-XX":   "MFD-A7X-GDEL-XX",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfd-a7x-gdel-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfdA7xGdelXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfd-a7x-gdel-xx"
