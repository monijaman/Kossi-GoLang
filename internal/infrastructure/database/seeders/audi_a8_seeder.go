...
// AudiA8Seeder seeds specifications for Audi A8
type AudiA8Seeder struct {
	BaseSeeder
}

// NewAudiA8Seeder creates a new Audi A8 seeder
func NewAudiA8Seeder() *AudiA8Seeder {
	return &AudiA8Seeder{
		BaseSeeder: BaseSeeder{name: "Audi A8 Specifications"},
	}
}

func (aas *AudiA8Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"3996":                          "৩৯৯৬ সিসি",
		"8":                             "৮ (সিলিন্ডার)",
		"460 hp":                        "৪৬০ হর্স পাওয়ার",
		"460 hp @ 5250 rpm":             "৫২৫০ আরপিএম এ ৪৬০ হর্স পাওয়ার",
		"660 Nm @ 1500-6000 rpm":        "১৫০০-৬০০০ আরপিএম এ ৬৬০ এনএম",
		"Petrol":                        "পেট্রোল",
		"Turbocharged":                  "টার্বোচার্জড",
		"4.1 seconds":                   "৪.১ সেকেন্ড",
...
// Seed implements the Seeder interface for Audi A8
func (aas *AudiA8Seeder) Seed(db *gorm.DB) error {
	productSlug := "audi-a8"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "227 hp/ton",
	...
	log.Printf("✅ Audi A8 specifications seeded successfully")
	return nil
}
