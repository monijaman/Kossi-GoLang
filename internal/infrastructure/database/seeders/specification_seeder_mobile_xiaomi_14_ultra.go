...
func (s *SpecificationSeederMobileXiaomi14Ultra) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Black, White, Blue, Titanium Gray": "কালো, সাদা, নীল, টাইটানিয়াম ধূসর",
		"February 2024": "ফেব্রুয়ারি ২০২৪",
		"Glass front, eco leather back, titanium frame": "গ্লাস সামনে, eco চামড়া পেছনে, টাইটানিয়াম ফ্রেম",
		"IP68": "IP৬৮",
