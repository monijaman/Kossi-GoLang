...
// SpecificationSeederRefrigeratorecowpifinv258steelonyx seeds specifications/options for product 'eco-wp-if-inv-258-steel-onyx'
type SpecificationSeederRefrigeratorecowpifinv258steelonyx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecowpifinv258steelonyx creates a new seeder instance
func NewSpecificationSeederRefrigeratorecowpifinv258steelonyx() *SpecificationSeederRefrigeratorecowpifinv258steelonyx {
	return &SpecificationSeederRefrigeratorecowpifinv258steelonyx{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-wp-if-inv-258-steel-onyx"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'eco-wp-if-inv-258-steel-onyx'
func (s *SpecificationSeederRefrigeratorecowpifinv258steelonyx) Seed(db *gorm.DB) error {
	productSlug := "eco-wp-if-inv-258-steel-onyx"
