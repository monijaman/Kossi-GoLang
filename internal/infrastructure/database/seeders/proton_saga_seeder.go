...
// ProtonSagaSeeder seeds specifications for Proton Saga
type ProtonSagaSeeder struct {
	BaseSeeder
}

// NewProtonSagaSeeder creates a new Proton Saga seeder
func NewProtonSagaSeeder() *ProtonSagaSeeder {
	return &ProtonSagaSeeder{
		BaseSeeder: BaseSeeder{name: "Proton Saga Specifications"},
	}
}

func (pss *ProtonSagaSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"1332":                            "১৩৩২ সিসি",
		"4":                               "৪ (সিলিন্ডার)",
		"95 hp":                           "৯৫ হর্স পাওয়ার",
		"95 hp @ 5800 rpm":                "৫৮০০ আরপিএম এ ৯৫ হর্স পাওয়ার",
		"120 Nm @ 4000 rpm":               "৪০০০ আরপিএম এ ১২০ এনএম",
		"Petrol":                          "পেট্রোল",
...
// Seed implements the Seeder interface for Proton Saga
func (pss *ProtonSagaSeeder) Seed(db *gorm.DB) error {
	productSlug := "proton-saga"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := pss.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Proton Saga specifications seeded successfully")
	return nil
}
