...
// SpecificationSeederMobileOppoReno13F5g seeds specifications/options for product 'oppo-reno-13-f-5g'
type SpecificationSeederMobileOppoReno13F5g struct {
	BaseSeeder
}

// NewSpecificationSeederMobileOppoReno13F5g creates a new seeder instance
func NewSpecificationSeederMobileOppoReno13F5g() *SpecificationSeederMobileOppoReno13F5g {
	return &SpecificationSeederMobileOppoReno13F5g{BaseSeeder: BaseSeeder{name: "Specifications for Oppo Reno 13 F 5G"}}
}

// getBanglaTranslations returns a map of English specification values to their Bangla translations
func (s *SpecificationSeederMobileOppoReno13F5g) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'oppo-reno-13-f-5g'
func (s *SpecificationSeederMobileOppoReno13F5g) Seed(db *gorm.DB) error {
	productSlug := "oppo-reno-13-f-5g"
	...
	// Override model-specific values for Oppo Reno 13 F 5G
