...
// SpecificationSeederRefrigeratorSingerFTDS230BG seeds specifications/options for product 'singer-ftds230-bg'
type SpecificationSeederRefrigeratorSingerFTDS230BG struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS230BG creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS230BG() *SpecificationSeederRefrigeratorSingerFTDS230BG {
	return &SpecificationSeederRefrigeratorSingerFTDS230BG{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds230-bg"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS230BG) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                       "সিঙ্গার",
		"SRREF-SS300-FTDS230-BG":       "SRREF-SS300-FTDS230-BG",
...
// Seed inserts specification records for the product identified by slug 'singer-ftds230-bg'
func (s *SpecificationSeederRefrigeratorSingerFTDS230BG) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds230-bg"
	...
	specs := map[string]string{
		"Brand":                       "Singer",
		"Model Name":                  "SRREF-SS300-FTDS230-BG",
