...
// VolkswagenGolfSeeder seeds specifications for Volkswagen Golf
type VolkswagenGolfSeeder struct {
	BaseSeeder
}

// NewVolkswagenGolfSeeder creates a new Volkswagen Golf seeder
func NewVolkswagenGolfSeeder() *VolkswagenGolfSeeder {
	return &VolkswagenGolfSeeder{
		BaseSeeder: BaseSeeder{name: "Volkswagen Golf Specifications"},
	}
}

func (vgs *VolkswagenGolfSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"1.4L":                         "১.৪ লিটার",
		"8th":                          "৮ম প্রজন্ম",
		"Compact Hatchback":            "কমপ্যাক্ট হ্যাচব্যাক",
		"2020":                         "২০২০",
		...
		"1395":                         "১৩৯৫ সিসি",
		"4":                            "৪ (সিলিন্ডার)",
		"125 hp":                       "১২৫ হর্স পাওয়ার",
		"125 hp @ 5000 rpm":            "৫০০০ আরপিএম এ ১২৫ হর্স পাওয়ার",
		"200 Nm @ 1400-4000 rpm":       "১৪০০-৪০০০ আরপিএম এ ২০০ এনএম",
		"Petrol":                       "পেট্রোল",
		"Turbocharged":                 "টার্বোচার্জড",
		"9.1 seconds":                  "৯.১ সেকেন্ড",
		"204 km/h":                     "২০৪ কিমি/ঘণ্টা",
...
// Seed implements the Seeder interface for Volkswagen Golf
func (vgs *VolkswagenGolfSeeder) Seed(db *gorm.DB) error {
	productSlug := "volkswagen-golf"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := vgs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Volkswagen Golf specifications seeded successfully")
	return nil
}
