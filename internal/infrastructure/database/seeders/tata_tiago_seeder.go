...
// TataTiagoSeeder seeds specifications for Tata Tiago
type TataTiagoSeeder struct {
	BaseSeeder
}

// NewTataTiagoSeeder creates a new Tata Tiago seeder
func NewTataTiagoSeeder() *TataTiagoSeeder {
	return &TataTiagoSeeder{
		BaseSeeder: BaseSeeder{name: "Tata Tiago Specifications"},
	}
}

func (tts *TataTiagoSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"1.2L":                               "১.২ লিটার",
		"1st":                                "১ম প্রজন্ম",
		"Hatchback (Segment)":                "হ্যাচব্যাক",
		"2016":                               "২০১৬",
...
// Seed implements the Seeder interface for Tata Tiago
func (tts *TataTiagoSeeder) Seed(db *gorm.DB) error {
	productSlug := "tata-tiago"
	...
	log.Printf("✅ Tata Tiago specifications seeded successfully")
	return nil
}
