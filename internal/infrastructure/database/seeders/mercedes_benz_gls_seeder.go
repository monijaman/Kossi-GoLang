...
// MercedesBenzGLSSeeder seeds specifications for Mercedes-Benz GLS
type MercedesBenzGLSSeeder struct {
	BaseSeeder
}

// NewMercedesBenzGLSSeeder creates a new Mercedes-Benz GLS seeder
func NewMercedesBenzGLSSeeder() *MercedesBenzGLSSeeder {
	return &MercedesBenzGLSSeeder{
		BaseSeeder: BaseSeeder{name: "Mercedes-Benz GLS Specifications"},
	}
}

func (mbglss *MercedesBenzGLSSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"GLS 450":                        "জিএলএস ৪৫০",
		"2nd Generation (X167)":          "২য় প্রজন্ম (এক্স১৬৭)",
...
// Seed implements the Seeder interface for Mercedes-Benz GLS
func (mbglss *MercedesBenzGLSSeeder) Seed(db *gorm.DB) error {
	productSlug := "mercedes-benz-gls"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := mbglss.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Mercedes-Benz GLS specifications seeded successfully")
	return nil
}
