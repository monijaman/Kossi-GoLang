...
func (mx5s *MahindraXUV500Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"2023":                           "২০২৩",
		"SUV":                            "এসইউভি",
		"Napoli Black":                   "নাপোলি ব্ল্যাক",
		"Inline":                         "ইনলাইন",
		"2179":                           "২১৭৯ সিসি",
		"4":                              "৪ (সিলিন্ডার)",
		"155 hp":                         "১৫৫ হর্স পাওয়ার",
		"155 hp @ 3750 rpm":              "৩৭৫০ আরপিএম এ ১৫৫ হর্স পাওয়ার",
		"360 Nm @ 1750-2800 rpm":         "১৭৫০-২৮০০ আরপিএম এ ৩৬০ এনএম",
		"Diesel":                         "ডিজেল",
...
func (mx5s *MahindraXUV500Seeder) Seed(db *gorm.DB) error {
	...
	if err := db.Where("name = ?", "Mahindra XUV500").First(&product).Error; err != nil {
