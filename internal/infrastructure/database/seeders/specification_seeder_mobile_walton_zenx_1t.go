...
// SpecificationSeederMobileWaltonZenx1t seeds specifications/options for product 'walton-zenx-1t'
type SpecificationSeederMobileWaltonZenx1t struct {
	BaseSeeder
}

// NewSpecificationSeederMobileWaltonZenx1t creates a new seeder instance
func NewSpecificationSeederMobileWaltonZenx1t() *SpecificationSeederMobileWaltonZenx1t {
	return &SpecificationSeederMobileWaltonZenx1t{BaseSeeder: BaseSeeder{name: "Specifications for Walton ZENX 1T"}}
}

// getBanglaTranslations returns a map of English specification values to their Bangla translations
func (s *SpecificationSeederMobileWaltonZenx1t) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"May 2023": "মে ২০২৩",
		"Qualcomm Snapdragon 695 5G (6 nm)": "কোয়ালকম স্ন্যাপড্রাগন ৬৯৫ ৫G (৬ ন্যানোমিটার)",
		"Silver, Black": "রূপালী, কালো",
		"Snapdragon 695": "স্ন্যাপড্রাগন ৬৯৫",
	}
}

// Seed inserts specification records for the product identified by slug 'walton-zenx-1t'
func (s *SpecificationSeederMobileWaltonZenx1t) Seed(db *gorm.DB) error {
	productSlug := "walton-zenx-1t"
	...
	// Override model-specific values for Walton ZENX 1T
	...
	specs["Announcement Date"] = "May 2023"
