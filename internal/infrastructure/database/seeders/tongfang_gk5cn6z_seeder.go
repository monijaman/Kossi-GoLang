...
// TongfangGk5cn6zSeeder seeds specifications for Tongfang GK5CN6Z
type TongfangGk5cn6zSeeder struct {
	BaseSeeder
}

// NewTongfangGk5cn6zSeeder creates a new Tongfang GK5CN6Z seeder
func NewTongfangGk5cn6zSeeder() *TongfangGk5cn6zSeeder {
	return &TongfangGk5cn6zSeeder{
		BaseSeeder: BaseSeeder{name: "Tongfang GK5CN6Z Specifications"},
	}
}

func (tgs *TongfangGk5cn6zSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Tongfang":                             "টংফ্যাং",
		"GK5CN6Z":                              "জিকে৫সিএন৬জেড",
		...
		"360 x 252 x 25 mm":                    "৩৬০ x ২৫২ x ২৫ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"8":                                    "৮",
		"16":                                   "১৬",
...
// Seed implements the Seeder interface for Tongfang GK5CN6Z
func (tgs *TongfangGk5cn6zSeeder) Seed(db *gorm.DB) error {
	productSlug := "tongfang-gk5cn6z"
	...
	log.Printf("✅ Tongfang GK5CN6Z specifications seeded successfully")
	return nil
}
