...
func (s *SpecificationSeederMobileXiaomi14) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Black, White, Jade Green, Pink": "কালো, সাদা, জেড সবুজ, গোলাপী",
		"Glass front, glass/silicone polymer back, aluminum frame": "গ্লাস সামনে, গ্লাস/সিলিকন পলিমার পেছনে, অ্যালুমিনিয়াম ফ্রেম",
		"IP68": "IP৬৮",
		"LTPO OLED, 120Hz, Dolby Vision, HDR10+, 3000 nits": "এলটিপিও ওএলইডি, ১২০Hz, ডলবি ভিশন, এইচডিআর১০+, ৩০০০ nits",
