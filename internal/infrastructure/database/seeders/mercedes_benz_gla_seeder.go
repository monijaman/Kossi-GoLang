...
// MercedesBenzGLASeeder seeds specifications for Mercedes-Benz GLA
type MercedesBenzGLASeeder struct {
	BaseSeeder
}

// NewMercedesBenzGLASeeder creates a new Mercedes-Benz GLA seeder
func NewMercedesBenzGLASeeder() *MercedesBenzGLASeeder {
	return &MercedesBenzGLASeeder{
		BaseSeeder: BaseSeeder{name: "Mercedes-Benz GLA Specifications"},
	}
}

func (mbglas *MercedesBenzGLASeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"GLA 200":                        "জিএলএ ২০০",
		"2nd Generation (H247)":          "২য় প্রজন্ম (এইচ২৪৭)",
...
// Seed implements the Seeder interface for Mercedes-Benz GLA
func (mbglas *MercedesBenzGLASeeder) Seed(db *gorm.DB) error {
	productSlug := "mercedes-benz-gla"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := mbglas.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Mercedes-Benz GLA specifications seeded successfully")
	return nil
}
