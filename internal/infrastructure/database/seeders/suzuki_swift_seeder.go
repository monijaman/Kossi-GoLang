...
// SuzukiSwiftSeeder seeds specifications for Suzuki Swift
type SuzukiSwiftSeeder struct {
	BaseSeeder
}

// NewSuzukiSwiftSeeder creates a new Suzuki Swift seeder
func NewSuzukiSwiftSeeder() *SuzukiSwiftSeeder {
	return &SuzukiSwiftSeeder{
		BaseSeeder: BaseSeeder{name: "Suzuki Swift Specifications"},
	}
}

func (sss *SuzukiSwiftSeeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Suzuki Swift
func (sss *SuzukiSwiftSeeder) Seed(db *gorm.DB) error {
	productSlug := "suzuki-swift"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := sss.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Suzuki Swift specifications seeded successfully")
	return nil
}
