...
func SetupAllSeeders(db *gorm.DB) *SeederManager {
	...
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDChestFreezerVIS150LMagicLine())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDChestFreezerVIS150LMagicLineBlueEN())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDChestFreezerRE150LMapleLeaf())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONSideBySideDoorRefrigeratorSHR())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVisionRefrigerator267LInverter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONRefrigeratorVis50LtrGray())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONMiniRefrigeratorRE101LiterSS())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONMiniRefrigeratorRE50LSS())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE305LMirrorJabaFlower())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE330LWDBlackBM())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE240LMirrorPurple())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE222LLotusFlMaroon())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE217LBluePeony())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE216LMirrorPurple())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE200LDigitalDark())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE185LPinkFLBM())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE185LPinkJuhuaFlowerBM())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE160LRedFLBM())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE150LDigitalRedFL())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE150LDigitalRedFlowerEN())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorFrenchDoorInverter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorFrenchDoorInverterVis558L())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVisionIceCreamFreezerVIS568L())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNMiniRefrigeratorRE101LSS())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE142LDigitalRainbow())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE142LDigitalRainbowFLTM())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorTopMountRefrigerator())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONRefrigeratorVis50LtrGray())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONSideBySideDoorRefrigeratorSHR())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDChestFreezerRE150LMapleLeaf())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDChestFreezerVIS150LMagicLine())
	...
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNGDRefrigeratorRE330LWDBlackBM())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVSNMiniRefrigeratorRE101LSS())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONBeverageRefrigeratorRE275Litre())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorBottomMountRefrigerator())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorChestFreezeRE150Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorChestFreezerRE150Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorChestFreezerRE250Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorChestFreezerRE250LMaple())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorChestFreezerRE350Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE142LDigital())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE142Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE150LDigital())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE150Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVisionGlassDoorRefrigeratorRE160LBlue())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE160Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE180LDigital())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE180Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE180LPink())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE180LPlatinum())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE185LDigital())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE185Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE196LPink())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE200Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE200LRed())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE208Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE216LBlue())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE216Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE222Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE222LMirror())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE238Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE240Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE252LMirror())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE280Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE285Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE305Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE305LiterGoldenPeonyFlowerTopMount())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE309Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE330Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorRE356Liter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorSideBySide())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorRefrigeratorTopMount())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorSmartDispenserRefrigerator())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorVisionVISIONGlassDoorTopMountRefrigerator())
