...
func SetupAllSeeders(db *gorm.DB) *SeederManager {
	...
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense566LSideBySide())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense577lPureflatSmartCrossDoor())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense580LSideBySide())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense664LCrossDoor())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrb190gb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrb200gb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrb230gb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrb270evb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrb270vb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrb307evb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrb307vb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt165gb3d())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt165gb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt180gb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt180hgb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt200gb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt240gb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt282egb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt282eigb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt282gb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt315egb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt315eigb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorKonkaKrt315gb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorMideaDoubleDoor())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorMideaSingleDoor())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorMideaTopMount())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorToshibaGr46sdz())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorToshibaGrE31())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorToshibaGrE37())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorToshibaGrE514())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorToshibaGrEf37sed())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorToshibaGrHg55Sedz())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorToshibaGrR39sed())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorToshibaGrS20Spb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorToshibaGrS24spb())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorToshibaGrT37sebz())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorToshibaGrWg58Sedz())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense189LChestFreezerBd189oblkv())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense240LChestFreezerBd240obluv())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense259LBottomMount())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense270lBmfGlassDoor())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense270lBmfInverterGlassDoor())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense300LUprightFreezerRd36w42())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense346LTopMountRt4())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorHisense564LSideBySide())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorGreeNonFrostBdrfBdrf616wpg())
