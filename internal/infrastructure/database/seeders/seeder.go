...
func SetupAllSeeders(db *gorm.DB) *SeederManager {
	...
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lGlassDoorMajesticSteel())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lGlassDoorSteelOnyx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lGlassDoorChromiumSteel())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lMajesticSteel())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lFloretRed())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lSilverMetallic())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lBlackMetallic())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lWhiteMetallic())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lBlueMetallic())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lRedMetallic())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lGreenMetallic())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lPurpleMetallic())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lOrangeMetallic())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lYellowMetallic())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolNeofreshInverter278GlassDoorCrystalBlack())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolNeofreshInverter257GlassDoorCrystalBlack())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshmagicProInverter236lGlassDoorFloretPurple())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicProInverter278lGlassDoorFloretRed())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicProInverter236lGlassDoorFloretRed())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshmagicPro278lGlassDoorFlorinaPurple())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolNeofresh258LhChromiumSteel())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolIntellifreshInverter257SteelOnyx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshmagicPro257lGlassDoorFlorinaRed())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicProInverter278lGlassDoorFloretPurple())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshmagicPro257lGlassDoorFlorinaPurple())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshmagicPro278lGlassDoorFlorinaRed())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolNeofreshInverter257GlassDoorGalaxy())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolIntellifreshInverter257ChromiumSteel())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolChestFreezerCf420t())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lGlassDoorFlorinaPurple())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lGlassDoorFlorinaBlue())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolFreshMagicPro236lGlassDoorFlorinaRed())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWhirlpoolIntellifreshInverter278ChromiumSteel())
