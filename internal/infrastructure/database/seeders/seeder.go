...
func SetupAllSeeders(db *gorm.DB) *SeederManager {
	...
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWnm2a7GdelXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWnm2f1GeheXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfa2a3GdelSc())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfa2d4GdelXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfb1n3GdxxXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfb2x1GdelXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfb2e4GdelXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfe3e8GdenXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfd1b6GdehXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfd1d4GdehXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfd1b6GdelXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfd1d4GdelXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfd1f3GdelXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWnr6d6GdfsDd())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWnr6f0ScrcCo())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcg3j0RxlxXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcg3j0GddbXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcg3j0DdgeXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcf2a0GsreXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfb2b6ElxxXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfb2x1GdshXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWnj5h5RxxxXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWnm1n5RxxxRp())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfb1h5GdxxXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfb2e0GdxxXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfe3a2GdelXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfc3d8GdehDd())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcg2e5GdelDdInverter())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcg2e5GdelDd())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcg2e5EhlxXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcg2e5EhlcXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcf2a0GsreXxP())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcf2t5RrlxGx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcf2t5RrlxXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcf2t5GdelXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcf1d5RrxxXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcf1d5GeleDl())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWcf1d5GdelXx())
	...
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWfc3f5GdehXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWnh3h6GdelXx())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWni5f3GdneId())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWni5f3GdelDd())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWni6a9GdneDd())
	manager.AddSeeder(NewSpecificationSeederRefrigeratorWaltonWni6a9GdsdDd())
