...
func (s *SpecificationSeederMobileSamsungGalaxyA265g) getBanglaTranslations() map[string]string {
	return map[string]string{
		"1080 x 2400 pixels (~405 ppi density)": "১০৮০ x ২৪০০ পিক্সেল (~৪০৫ পিপিআই density)",
		"120Hz": "১২০Hz",
		"128 GB": "১২৮ GB",
		"13 MP": "১৩ মেগাপিক্সেল",
		"161.3 x 73.9 x 8.4 mm": "১৬১.৩ x ৭৩.৯ x ৮.৪ মিমি",
		"189 g (6.67 oz)": "১৮৯ গ্রাম (৬.৬৭ oz)",
		...
		"MediaTek MT6833 Dimensity 6020 (7 nm)": "মিডিয়াটেক MT৬৮৩৩ ডাইমেনসিটি ৬০২০ (৭ ন্যানোমিটার)",
