...
// SpecificationSeederRefrigeratorMarcelMfbB2cGdelXx seeds specifications/options for product 'marcel-mfb-b2c-gdel-xx'
type SpecificationSeederRefrigeratorMarcelMfbB2cGdelXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfbB2cGdelXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfbB2cGdelXx() *SpecificationSeederRefrigeratorMarcelMfbB2cGdelXx {
	return &SpecificationSeederRefrigeratorMarcelMfbB2cGdelXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfb-b2c-gdel-xx"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfbB2cGdelXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":                 "মার্সেল",
		"marcel-mfb-b2c-gdel-xx": "মার্সেল-mfb-b2c-gdel-xx",
		"MFB-B2C-GDEL-XX":        "MFB-B2C-GDEL-XX",
...
func (s *SpecificationSeederRefrigeratorMarcelMfbB2cGdelXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfb-b2c-gdel-xx"
    ...
    specs := map[string]string{
		...
		"Compressor Input Power (Watt)": "V 01.01-97.4 V 01.02-97.4",
