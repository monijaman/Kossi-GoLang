...
// SpecificationSeederRefrigeratorecobcd218vcmred5 seeds specifications/options for product 'eco-bcd-218-vcm-red-5'
type SpecificationSeederRefrigeratorecobcd218vcmred5 struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecobcd218vcmred5 creates a new seeder instance
func NewSpecificationSeederRefrigeratorecobcd218vcmred5() *SpecificationSeederRefrigeratorecobcd218vcmred5 {
	return &SpecificationSeederRefrigeratorecobcd218vcmred5{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-bcd-218-vcm-red-5"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'eco-bcd-218-vcm-red-5'
func (s *SpecificationSeederRefrigeratorecobcd218vcmred5) Seed(db *gorm.DB) error {
	productSlug := "eco-bcd-218-vcm-red-5"
