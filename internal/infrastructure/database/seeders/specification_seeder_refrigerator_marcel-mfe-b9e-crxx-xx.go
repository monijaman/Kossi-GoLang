...
// SpecificationSeederRefrigeratorMarcelMfeB9eCrxxXx seeds specifications/options for product 'marcel-mfe-b9e-crxx-xx'
type SpecificationSeederRefrigeratorMarcelMfeB9eCrxxXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfeB9eCrxxXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfeB9eCrxxXx() *SpecificationSeederRefrigeratorMarcelMfeB9eCrxxXx {
	return &SpecificationSeederRefrigeratorMarcelMfeB9eCrxxXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfe-b9e-crxx-xx"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfeB9eCrxxXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":         "মার্সেল",
				"marcel-mfe-b9e-crxx-xx":         "মার্সেল-mfe-b9e-crxx-xx",
		"MFE-B9E-CRXX-XX":   "MFE-B9E-CRXX-XX",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfe-b9e-crxx-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfeB9eCrxxXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfe-b9e-crxx-xx"
