...
func (s *SpecificationSeederRefrigeratorToshibaGrEf37sed) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Silver":                             "সিলভার",
		"35-40 dB":                           "৩৫-৪০ dB",
		"1720 x 600 x 665 mm":                "১৭২০ x ৬০০ x ৬৬৫ মিমি",
		"1720 mm":                            "১৭२०० মিমি",
		"600 mm":                             "৬००  মিমি",
		"665 mm":                             "৬६५ মিমি",
		"72 Kg":                              "७२ কেজি",
		"Yes (LED)":                          "হ্যাঁ (LED)",
		"Energy Efficient":                   "শক্তি দক্ষ",
		"Adjustable Shelves":                 "সামঞ্জস্যযোগ্য তাক",
		"1 Year Warranty on Parts and Labor": "১ বছর যন্ত্রাংশ এবং শ্রম ওয়ারেন্টি",
	}
}
...
func (s *SpecificationSeederRefrigeratorToshibaGrEf37sed) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"Dimensions":                      "1720 x 600 x 665 mm",
		"Height (mm)":                     "1720 mm",
		"Width":                           "600 mm",
		"Depth (mm)":                      "665 mm",
		"Weight":                          "72 Kg",
