...
// MsiStealth14StudioSeeder seeds specifications for MSI Stealth 14 Studio
type MsiStealth14StudioSeeder struct {
	BaseSeeder
}

// NewMsiStealth14StudioSeeder creates a new MSI Stealth 14 Studio seeder
func NewMsiStealth14StudioSeeder() *MsiStealth14StudioSeeder {
	return &MsiStealth14StudioSeeder{
		BaseSeeder: BaseSeeder{name: "MSI Stealth 14 Studio Specifications"},
	}
}

func (msss *MsiStealth14StudioSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"MSI":                           "এমএসআই",
		"Stealth 14 Studio":             "স্টেলথ ১৪ স্টুডিও",
		...
		"319 x 219 x 16 mm":             "৩১৯ x ২১৯ x ১৬ মিমি",
		"TPM 2.0":                       "টিপিএম ২.০",
		"14":                            "১৪",
		"20":                            "২০",
...
// Seed implements the Seeder interface for MSI Stealth 14 Studio
func (msss *MsiStealth14StudioSeeder) Seed(db *gorm.DB) error {
	productSlug := "msi-stealth-14-studio"
	...
	log.Printf("✅ MSI Stealth 14 Studio specifications seeded successfully")
	return nil
}
