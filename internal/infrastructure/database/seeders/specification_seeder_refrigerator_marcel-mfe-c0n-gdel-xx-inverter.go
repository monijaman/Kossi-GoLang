...
// SpecificationSeederRefrigeratorMarcelMfeC0nGdelXxInverter seeds specifications/options for product 'marcel-mfe-c0n-gdel-xx-inverter'
type SpecificationSeederRefrigeratorMarcelMfeC0nGdelXxInverter struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfeC0nGdelXxInverter creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfeC0nGdelXxInverter() *SpecificationSeederRefrigeratorMarcelMfeC0nGdelXxInverter {
	return &SpecificationSeederRefrigeratorMarcelMfeC0nGdelXxInverter{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfe-c0n-gdel-xx-inverter"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'marcel-mfe-c0n-gdel-xx-inverter'
func (s *SpecificationSeederRefrigeratorMarcelMfeC0nGdelXxInverter) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfe-c0n-gdel-xx-inverter"
