...
// SpecificationSeederRefrigeratorMarcelMfcC1gElexXx seeds specifications/options for product 'marcel-mfc-c1g-elex-xx'
type SpecificationSeederRefrigeratorMarcelMfcC1gElexXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfcC1gElexXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfcC1gElexXx() *SpecificationSeederRefrigeratorMarcelMfcC1gElexXx {
	return &SpecificationSeederRefrigeratorMarcelMfcC1gElexXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfc-c1g-elex-xx"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfcC1gElexXx) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'marcel-mfc-c1g-elex-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfcC1gElexXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfc-c1g-elex-xx"
