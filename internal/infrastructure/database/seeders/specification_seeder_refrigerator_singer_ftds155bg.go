...
// SpecificationSeederRefrigeratorSingerFTDS155BG seeds specifications/options for product 'singer-ftds155-bg'
type SpecificationSeederRefrigeratorSingerFTDS155BG struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS155BG creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS155BG() *SpecificationSeederRefrigeratorSingerFTDS155BG {
	return &SpecificationSeederRefrigeratorSingerFTDS155BG{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds155-bg"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS155BG) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                   "সিঙ্গার",
		"FTDS155-BG":               "FTDS155-BG",
		"Top Mounted Refrigerator": "টপ মাউন্টেড রেফ্রিজারেটর",
		"157 Liters":               "157 লিটার",
...
// Seed inserts specification records for the product identified by slug 'singer-ftds155-bg'
func (s *SpecificationSeederRefrigeratorSingerFTDS155BG) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds155-bg"
