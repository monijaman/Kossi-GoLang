...
func (s *SpecificationSeederMobileSamsungGalaxyA23) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"195 g": "১৯৫ g",
		"2408 × 1080 px (~400 ppi)": "২৪০৮ × ১০৮০ পিক্সেল (~৪০০ পিপিআই)",
		...
		"Android 12, One UI 4.1 (upgradable)": "অ্যান্ড্রয়েড ১২, ওয়ান ইউআই ৪.১ (আপগ্রেডযোগ্য)",
		"Black, White, Peach, Blue": "কালো, সাদা, পীচ, নীল",
		...
		"Octa-core (4×2.4 GHz + 4×1.9 GHz)": "অক্টা-কোর (৪×২.৪ গিগাহার্টজ + ৪×১.৯ গিগাহার্টজ)",
