...
// SpecificationSeederRefrigeratorecobd198sggray seeds specifications/options for product 'eco-bd-198sg-gray'
type SpecificationSeederRefrigeratorecobd198sggray struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecobd198sggray creates a new seeder instance
func NewSpecificationSeederRefrigeratorecobd198sggray() *SpecificationSeederRefrigeratorecobd198sggray {
	return &SpecificationSeederRefrigeratorecobd198sggray{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-bd-198sg-gray"},
	}
}

func (s *SpecificationSeederRefrigeratorecobd198sggray) getBanglaTranslations() map[string]string {
	return map[string]string{
		"ECO+":               "ইকো+",
		"ECO+ BD-198SG Gray": "ECO+ BD-198SG Gray",
...
// Seed inserts specification records for the product identified by slug 'eco-bd-198sg-gray'
func (s *SpecificationSeederRefrigeratorecobd198sggray) Seed(db *gorm.DB) error {
	productSlug := "eco-bd-198sg-gray"
