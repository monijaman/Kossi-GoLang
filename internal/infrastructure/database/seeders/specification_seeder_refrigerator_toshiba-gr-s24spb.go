...
// SpecificationSeederRefrigeratorToshibaGrS24spb seeds specifications/options for product 'toshiba-gr-s24spb'
type SpecificationSeederRefrigeratorToshibaGrS24spb struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorToshibaGrS24spb creates a new seeder instance
func NewSpecificationSeederRefrigeratorToshibaGrS24spb() *SpecificationSeederRefrigeratorToshibaGrS24spb {
	return &SpecificationSeederRefrigeratorToshibaGrS24spb{
		BaseSeeder: BaseSeeder{name: "Specifications for toshiba-gr-s24spb"},
	}
}

func (s *SpecificationSeederRefrigeratorToshibaGrS24spb) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"35kg":                "35kg",
		"49L":                 "49L",
		"480 x 595 x 1420 mm": "480 x 595 x 1420 mm",
	}
}

// Seed inserts specification records for the product identified by slug 'toshiba-gr-s24spb'
func (s *SpecificationSeederRefrigeratorToshibaGrS24spb) Seed(db *gorm.DB) error {
	productSlug := "toshiba-gr-s24spb"
	...
	specs := map[string]string{
		...
		"Weight":                          "35kg",
		"Dimensions (mm)":                 "480 x 595 x 1420 mm",
		"Warranty":                        "2 Years",
