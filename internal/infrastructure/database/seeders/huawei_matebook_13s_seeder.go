...
// HuaweiMatebook13sSeeder seeds specifications for Huawei MateBook 13s
type HuaweiMatebook13sSeeder struct {
	BaseSeeder
}

// NewHuaweiMatebook13sSeeder creates a new Huawei MateBook 13s seeder
func NewHuaweiMatebook13sSeeder() *HuaweiMatebook13sSeeder {
	return &HuaweiMatebook13sSeeder{
		BaseSeeder: BaseSeeder{name: "Huawei MateBook 13s Specifications"},
	}
}

func (hms *HuaweiMatebook13sSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Huawei":                          "হুয়াওয়ে",
		"MateBook 13s":                    "মেটবুক ১৩এস",
		...
		"286.5 x 211 x 14.9 mm":           "২৮৬.৫ x ২১১ x ১৪.৯ মিমি",
		"TPM 2.0":                         "টিপিএম ২.০",
		"4":                               "৪",
		"8":                               "৮",
...
// Seed implements the Seeder interface for Huawei MateBook 13s
func (hms *HuaweiMatebook13sSeeder) Seed(db *gorm.DB) error {
	productSlug := "huawei-matebook-13s"
	...
	specs := map[string]string{
		...
		"Sensors":              "No",
		"Dimensions":           "286.5 x 211 x 14.9 mm",
		"Body Type":            "Aluminum",
	...
	log.Printf("✅ Huawei MateBook 13s specifications seeded successfully")
	return nil
}
