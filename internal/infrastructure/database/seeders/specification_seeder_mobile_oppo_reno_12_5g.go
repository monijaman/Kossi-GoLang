...
// SpecificationSeederMobileOppoReno125g seeds specifications/options for product 'oppo-reno-12-5g'
type SpecificationSeederMobileOppoReno125g struct {
	BaseSeeder
}

// NewSpecificationSeederMobileOppoReno125g creates a new seeder instance
func NewSpecificationSeederMobileOppoReno125g() *SpecificationSeederMobileOppoReno125g {
	return &SpecificationSeederMobileOppoReno125g{BaseSeeder: BaseSeeder{name: "Specifications for Oppo Reno 12 5G"}}
}

// getBanglaTranslations returns a map of English specification values to their Bangla translations
func (s *SpecificationSeederMobileOppoReno125g) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'oppo-reno-12-5g'
func (s *SpecificationSeederMobileOppoReno125g) Seed(db *gorm.DB) error {
	productSlug := "oppo-reno-12-5g"
	...
	// Override model-specific values for Oppo Reno 12 5G
