...
// ProtonX50Seeder seeds specifications for Proton X50
type ProtonX50Seeder struct {
	BaseSeeder
}

// NewProtonX50Seeder creates a new Proton X50 seeder
func NewProtonX50Seeder() *ProtonX50Seeder {
	return &ProtonX50Seeder{
		BaseSeeder: BaseSeeder{name: "Proton X50 Specifications"},
	}
}

func (pxs *ProtonX50Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"177 hp @ 5500 rpm":            "৫৫০০ আরপিএম এ ১৭৭ হর্স পাওয়ার",
		"255 Nm @ 1500-4000 rpm":       "১৫০০-৪০০০ আরপিএম এ ২৫৫ এনএম",
		"Petrol":                       "পেট্রোল",
...
// Seed implements the Seeder interface for Proton X50
func (pxs *ProtonX50Seeder) Seed(db *gorm.DB) error {
	productSlug := "proton-x50"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "122 hp/ton",
	...
	log.Printf("✅ Proton X50 specifications seeded successfully")
	return nil
}
