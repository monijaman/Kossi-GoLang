...
func (s *SpecificationSeederMobileSymphonyXplorerV55) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"8 GB": "৮ GB",
		"8 MP": "৮ মেগাপিক্সেল",
		"Android 5.1 (Lollipop)": "অ্যান্ড্রয়েড ৫.১ (Lollipop)",
		"Mali-400MP2": "মালি-৪০০MP২",
		"Mediatek MT6582": "মিডিয়াটেক MT৬৫৮২",
		"Quad-core 1.3GHz": "Quad-কোর ১.৩GHz",
	}
}

// Seed inserts specification records for the product identified by slug 'symphony-xplorer-v55'
func (s *SpecificationSeederMobileSymphonyXplorerV55) Seed(db *gorm.DB) error {
	...
	// Override model-specific values for Symphony Xplorer V55
	specs["Display Size"] = "5.0 inches"
	specs["Processor"] = "Quad-core 1.3GHz"
	specs["Chipset"] = "Mediatek MT6582"
	...
	specs["Weight"] = "140 g"
	specs["Dimensions"] = "145 x 72 x 9 mm"
	specs["Water Resistance"] = "No"
	specs["Network Technology"] = "3G"
	specs["Rear Camera"] = "8 MP"
	specs["Front Camera"] = "2 MP"
	specs["Battery"] = "2,200 mAh"
	specs["Operating System"] = "Android 5.1 (Lollipop)"
	specs["Available Colors"] = "Black"
	specs["Announcement Date"] = "2015"
