...
func (s *SpecificationSeederRefrigeratorMarcelMfeC5hGdxxXx) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"Capillary": "V 0102- CopperV 0301- Copper",
		"Climate Type (SN, N, ST, T)": "N ~ ST",
		"Compressor Input Power (Watt)": "V 0102- 130V 0301- 123",
		"Compressor Type": "V 0102- RSCRV 0301- RSCR",
		...
		"Refrigerant": "V 0102- R600aV 0301- R600a",
		"Reversible Door": "No",
