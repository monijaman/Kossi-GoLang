...
// SuzukiJimnySeeder seeds specifications for Suzuki Jimny
type SuzukiJimnySeeder struct {
	BaseSeeder
}

// NewSuzukiJimnySeeder creates a new Suzuki Jimny seeder
func NewSuzukiJimnySeeder() *SuzukiJimnySeeder {
	return &SuzukiJimnySeeder{
		BaseSeeder: BaseSeeder{name: "Suzuki Jimny Specifications"},
	}
}

func (sjs *SuzukiJimnySeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"2018":                         "২০১৮",
		"SUV":                          "এসইউভি",
		"Granite Grey":                 "গ্র্যানাইট গ্রে",
		"Inline":                       "ইনলাইন",
		"1462":                         "১৪৬২ সিসি",
		"4":                            "৪ (সিলিন্ডার)",
		"102 hp":                       "১০২ হর্স পাওয়ার",
		"102 hp @ 6000 rpm":            "৬০০০ আরপিএম এ ১০২ হর্স পাওয়ার",
		"130 Nm @ 4000 rpm":            "৪০০০ আরপিএম এ ১৩০ এনএম",
		"Petrol":                       "পেট্রোল",
		"Naturally Aspirated":          "ন্যাচারালি অ্যাসপিরেটেড",
		"Multipoint Injection":         "মাল্টিপয়েন্ট ইনজেকশন",
		"14.1 seconds":                 "১৪.১ সেকেন্ড",
		"145 km/h":                     "১৪৫ কিমি/ঘণ্টা",
		"16.9 km/L":                    "১৬.৯ কিমি/লিটার",
		"20.4 km/L":                    "২০.৪ কিমি/লিটার",
		"18.6 km/L":                    "১৮.৬ কিমি/লিটার",
		...
		"15 inch":                      "১৫ ইঞ্চি",
		"3-Link Rigid (Suspension)":    "৩-লিঙ্ক রিজিড (সাসপেনশন)",
...
// Seed implements the Seeder interface for Suzuki Jimny
func (sjs *SuzukiJimnySeeder) Seed(db *gorm.DB) error {
	productSlug := "suzuki-jimny"
	...
	specs := map[string]string{
		...
		"Mileage City (km/L)":            "16.9 km/L",
		"Mileage Highway (km/L)":         "20.4 km/L",
		"Mileage Combined (km/L)":        "18.6 km/L",
		"Front Suspension":               "3-Link Rigid",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := sjs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Suzuki Jimny specifications seeded successfully")
	return nil
}
