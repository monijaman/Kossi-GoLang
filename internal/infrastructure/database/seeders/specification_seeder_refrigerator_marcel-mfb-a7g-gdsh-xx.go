...
// SpecificationSeederRefrigeratorMarcelMfbA7gGdshXx seeds specifications/options for product 'marcel-mfb-a7g-gdsh-xx'
type SpecificationSeederRefrigeratorMarcelMfbA7gGdshXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfbA7gGdshXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfbA7gGdshXx() *SpecificationSeederRefrigeratorMarcelMfbA7gGdshXx {
	return &SpecificationSeederRefrigeratorMarcelMfbA7gGdshXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfb-a7g-gdsh-xx"},
	}
}
...
func (s *SpecificationSeederRefrigeratorMarcelMfbA7gGdshXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Loading Capacity (40HQ/40Ft/20Ft)": "লোডিং ক্যাপাসিটি- 40HQ/40Ft/20Ft 105/105/52",
		"GPPS/3": "জিপিপিএস/৩",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfb-a7g-gdsh-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfbA7gGdshXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfb-a7g-gdsh-xx"
