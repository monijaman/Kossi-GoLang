...
// XiaomiRedmiBook15Seeder seeds specifications for Xiaomi Redmi Book 15
type XiaomiRedmiBook15Seeder struct {
	BaseSeeder
}

// NewXiaomiRedmiBook15Seeder creates a new Xiaomi Redmi Book 15 seeder
func NewXiaomiRedmiBook15Seeder() *XiaomiRedmiBook15Seeder {
	return &XiaomiRedmiBook15Seeder{
		BaseSeeder: BaseSeeder{name: "Xiaomi Redmi Book 15 Specifications"},
	}
}

func (xrbs *XiaomiRedmiBook15Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Xiaomi":                        "শাওমি",
		"Redmi Book 15":                 "রেডমি বুক ১৫",
		...
		"363.8 x 243.5 x 19.9 mm":      "৩৬৩.৮ x ২৪৩.৫ x ১৯.৯ মিমি",
		...
		"2x USB 3.2 Gen 1, 1x USB 2.0": "২x ইউএসবি ৩.২ জেন ১, ১x ইউএসবি ২.০"}
}

// Seed implements the Seeder interface for Xiaomi Redmi Book 15
func (xrbs *XiaomiRedmiBook15Seeder) Seed(db *gorm.DB) error {
	productSlug := "xiaomi-redmi-book-15"
	...
	specs := map[string]string{
		...
		"Touchscreen": "No",
		"HDMI Ports":  "HDMI 1.4",
		"USB Ports":   "2x USB 3.2 Gen 1, 1x USB 2.0",
	}
	...
	log.Printf("✅ Xiaomi Redmi Book 15 specifications seeded successfully")
	return nil
}
