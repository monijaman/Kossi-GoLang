...
func (s *SpecificationSeederMobileRealme15Pro5g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"182 g": "১৮২ g",
		"2023": "২০২৩",
		"2400 × 1080 px (~400 ppi)": "২৪০০ × ১০৮০ পিক্সেল (~৪০০ পিপিআই)",
		...
		"Octa-core (2×2.6 GHz Cortex-A77 + 6×2.0 GHz Cortex-A55)": "অক্টা-কোর (২×২.৬ গিগাহার্টজ Cবাtex-A৭৭ + ৬×২.০ গিগাহার্টজ Cবাtex-A৫৫)",
		"Wi-Fi 802.11 a/b/g/n/ac": "ওয়াই-ফাই ৮০২.১১ a/b/g/n/ac",
	}
}

// Seed inserts specification records for the product identified by slug 'realme-15-pro-5g'
