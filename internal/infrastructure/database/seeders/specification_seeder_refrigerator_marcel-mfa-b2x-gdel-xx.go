...
func (s *SpecificationSeederRefrigeratorMarcelMfaB2xGdelXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"205 Ltr.":               "205 লিটার",
		"220 Ltr.":               "220 লিটার",
		"557 x 635 x 1580 mm": "৫৫৭ x ৬৩৫ x ১৫৮০ মিমি",
...
func (s *SpecificationSeederRefrigeratorMarcelMfaB2xGdelXx) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"Recommended voltage stabilizer capacity": "V05.01: No Need to use voltage stabilizer.If out of voltage range(140V-260V),then suggested voltage             stabilizer capacity is 1000VA.",
		"Refrigerant":                             "V05.01-R600a",
		"Reversible Door":                         "No",
