...
func (s *SpecificationSeederRefrigeratorMarcelMfaB2xGdelXx) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"Recommended voltage stabilizer capacity": "V05.01: No Need to use voltage stabilizer.If out of voltage range(140V-260V),then suggested voltage
             stabilizer capacity is 1000VA.",
