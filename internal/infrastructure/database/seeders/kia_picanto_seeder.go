...
// KiaPicantoSeeder seeds specifications for Kia Picanto
type KiaPicantoSeeder struct {
	BaseSeeder
}

// NewKiaPicantoSeeder creates a new Kia Picanto seeder
func NewKiaPicantoSeeder() *KiaPicantoSeeder {
	return &KiaPicantoSeeder{
		BaseSeeder: BaseSeeder{name: "Kia Picanto Specifications"},
	}
}

func (kps *KiaPicantoSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Clear White":                        "ক্লিয়ার হোয়াইট",
		"Inline":                             "ইনলাইন",
		"998":                                "৯৯৮ সিসি",
		"4":                                  "৪ (সিলিন্ডার)",
		"67 hp":                              "৬৭ হর্স পাওয়ার",
		"67 hp @ 5500 rpm":                   "৫৫০০ আরপিএম এ ৬৭ হর্স পাওয়ার",
		"96 Nm @ 3500 rpm":                   "৩৫০০ আরপিএম এ ৯৬ এনএম",
		"Petrol":                             "পেট্রোল",
		"Naturally Aspirated":                "ন্যাচারালি অ্যাসপিরেটেড",
		"MPi":                                "এমপিআই",
		"14.6 seconds":                       "১৪.৬ সেকেন্ড",
		"161 km/h":                           "১৬১ কিমি/ঘণ্টা",
...
// Seed implements the Seeder interface for Kia Picanto
func (kps *KiaPicantoSeeder) Seed(db *gorm.DB) error {
	productSlug := "kia-picanto"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "80 hp/ton",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := kps.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Kia Picanto specifications seeded successfully")
	return nil
}
