...
// SpecificationSeederRefrigeratorToshibaGr46sdz seeds specifications/options for product 'toshiba-gr-46sdz'
type SpecificationSeederRefrigeratorToshibaGr46sdz struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorToshibaGr46sdz creates a new seeder instance
func NewSpecificationSeederRefrigeratorToshibaGr46sdz() *SpecificationSeederRefrigeratorToshibaGr46sdz {
	return &SpecificationSeederRefrigeratorToshibaGr46sdz{
		BaseSeeder: BaseSeeder{name: "Specifications for toshiba-gr-46sdz"},
	}
}

func (s *SpecificationSeederRefrigeratorToshibaGr46sdz) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'toshiba-gr-46sdz'
func (s *SpecificationSeederRefrigeratorToshibaGr46sdz) Seed(db *gorm.DB) error {
	productSlug := "toshiba-gr-46sdz"
