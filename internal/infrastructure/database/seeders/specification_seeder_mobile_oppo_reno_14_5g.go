...
// SpecificationSeederMobileOppoReno145g seeds specifications/options for product 'oppo-reno-14-5g'
type SpecificationSeederMobileOppoReno145g struct {
	BaseSeeder
}

// NewSpecificationSeederMobileOppoReno145g creates a new seeder instance
func NewSpecificationSeederMobileOppoReno145g() *SpecificationSeederMobileOppoReno145g {
	return &SpecificationSeederMobileOppoReno145g{BaseSeeder: BaseSeeder{name: "Specifications for Oppo Reno 14 5G"}}
}

// getBanglaTranslations returns a map of English specification values to their Bangla translations
func (s *SpecificationSeederMobileOppoReno145g) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'oppo-reno-14-5g'
func (s *SpecificationSeederMobileOppoReno145g) Seed(db *gorm.DB) error {
	productSlug := "oppo-reno-14-5g"
	...
	// Override model-specific values for Oppo Reno 14 5G
