...
// SpecificationSeederRefrigeratorMarcelMfdA6cRxxxXx seeds specifications/options for product 'marcel-mfd-a6c-rxxx-xx'
type SpecificationSeederRefrigeratorMarcelMfdA6cRxxxXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfdA6cRxxxXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfdA6cRxxxXx() *SpecificationSeederRefrigeratorMarcelMfdA6cRxxxXx {
	return &SpecificationSeederRefrigeratorMarcelMfdA6cRxxxXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfd-a6c-rxxx-xx"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfdA6cRxxxXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":         "মার্সেল",
				"marcel-mfd-a6c-rxxx-xx":         "মার্সেল-mfd-a6c-rxxx-xx",
		"MFD-A6C-RXXX-XX":   "MFD-A6C-RXXX-XX",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfd-a6c-rxxx-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfdA6cRxxxXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfd-a6c-rxxx-xx"
