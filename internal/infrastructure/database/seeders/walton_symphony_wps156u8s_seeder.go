...
// WaltonSymphonyWps156u8sSeeder seeds specifications for Walton Symphony WPS156U8S
type WaltonSymphonyWps156u8sSeeder struct {
	BaseSeeder
}

// NewWaltonSymphonyWps156u8sSeeder creates a new Walton Symphony WPS156U8S seeder
func NewWaltonSymphonyWps156u8sSeeder() *WaltonSymphonyWps156u8sSeeder {
	return &WaltonSymphonyWps156u8sSeeder{
		BaseSeeder: BaseSeeder{name: "Walton Symphony WPS156U8S Specifications"},
	}
}

func (wss *WaltonSymphonyWps156u8sSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Walton":                        "ওয়ালটন",
		"Symphony WPS156U8S":            "সিম্ফনি ডব্লিউপিএস১৫৬ইউ৮এস",
		...
		"365 x 240 x 20 mm":                    "৩৬৫ x ২৪০ x ২০ মিমি",
...
// Seed implements the Seeder interface for Walton Symphony WPS156U8S
func (wss *WaltonSymphonyWps156u8sSeeder) Seed(db *gorm.DB) error {
	productSlug := "walton-symphony-wps156u8s"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := wss.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Walton Symphony WPS156U8S specifications seeded successfully")
	return nil
}
