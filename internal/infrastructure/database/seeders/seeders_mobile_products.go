...
func SeedMobileProducts(db *gorm.DB) error {
	...
	products := []models.ProductModel{
		// Apple iPhones
		{Name: "iPhone 17 Pro Max", Description: ptrStr("Latest flagship Apple smartphone with advanced camera system"), Slug: "iphone-17-pro-max", Price: ptrFloat(189999), CategoryID: &catID, BrandID: ptrUint(getBrandID(db, "Apple")), ViewsCount: 0, Status: 1, Priority: 1, CreatedAt: now, UpdatedAt: now},
		{Name: "iPhone 17 Pro", Description: ptrStr("Premium Apple flagship smartphone"), Slug: "iphone-17-pro", Price: ptrFloat(149999), CategoryID: &catID, BrandID: ptrUint(getBrandID(db, "Apple")), ViewsCount: 0, Status: 1, Priority: 2, CreatedAt: now, UpdatedAt: now},
		{Name: "iPhone 17 Plus", Description: ptrStr("Large-screen Apple flagship"), Slug: "iphone-17-plus", Price: ptrFloat(129999), CategoryID: &catID, BrandID: ptrUint(getBrandID(db, "Apple")), ViewsCount: 0, Status: 1, Priority: 3, CreatedAt: now, UpdatedAt: now},
		{Name: "iPhone 17", Description: ptrStr("Standard Apple flagship smartphone"), Slug: "iphone-17", Price: ptrFloat(109999), CategoryID: &catID, BrandID: ptrUint(getBrandID(db, "Apple")), ViewsCount: 0, Status: 1, Priority: 4, CreatedAt: now, UpdatedAt: now},
