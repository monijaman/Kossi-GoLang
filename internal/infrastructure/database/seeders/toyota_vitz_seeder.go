...
// ToyotaVitzSeeder seeds specifications for Toyota Vitz
type ToyotaVitzSeeder struct {
	BaseSeeder
}

// NewToyotaVitzSeeder creates a new Toyota Vitz seeder
...
func (tvs *ToyotaVitzSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"128 Nm @ 3800 rpm":              "৩৮০০ আরপিএম এ ১২৮ এনএম",
		"Petrol":                         "পেট্রল",
		"Multi-Point Fuel Injection":     "মাল্টি-পয়েন্ট ফুয়েল ইনজেকশন",
		"11.5 seconds":                   "১১.৫ সেকেন্ড",
		"170 km/h":                       "১৭০ কিমি/ঘণ্টা",
		"Manual: 19 km/L | CVT: 21 km/L": "ম্যানুয়াল: ১৯ কিমি/লিটার | সিভিটি: ২১ কিমি/লিটার",
...
// Seed inserts specification records for Toyota Vitz
func (tvs *ToyotaVitzSeeder) Seed(db *gorm.DB) error {
	productSlug := "toyota-vitz"
	...
	specs := map[string]string{
		...
		"Body Type":                      "Hatchback",
		"Color":                          "Premium White",
		"Engine Type":                    "1.3L Petrol",
		"Engine Configuration":           "Inline",
		"Displacement":                   "1329",
		"Number of Cylinders":            "4",
		"Horsepower":                     "100 hp",
		"Max Power":                      "100 hp @ 6000 rpm",
		"Max Torque":                     "128 Nm @ 3800 rpm",
		"Valves Per Cylinder":            "4",
		"Fuel Type":                      "Petrol",
		"Fuel System":                    "Multi-Point Fuel Injection",
		"Acceleration 0-100 km/h":        "11.5 seconds",
		"Top Speed":                      "170 km/h",
		"Mileage":                        "Manual: 19 km/L | CVT: 21 km/L",
		...
		"Apple CarPlay":                  "No",
		"Android Auto":                   "No",
		"Sound System Brand":             "Entry-level",
