...
// SpecificationSeederRefrigeratorMideaSingleDoor seeds specifications/options for product 'midea-single-door'
type SpecificationSeederRefrigeratorMideaSingleDoor struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMideaSingleDoor creates a new seeder instance
func NewSpecificationSeederRefrigeratorMideaSingleDoor() *SpecificationSeederRefrigeratorMideaSingleDoor {
	return &SpecificationSeederRefrigeratorMideaSingleDoor{
		BaseSeeder: BaseSeeder{name: "Specifications for midea-single-door"},
	}
}

func (s *SpecificationSeederRefrigeratorMideaSingleDoor) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'midea-single-door'
func (s *SpecificationSeederRefrigeratorMideaSingleDoor) Seed(db *gorm.DB) error {
	productSlug := "midea-single-door"
