...
func (s *SpecificationSeederMobileRealmeGtNeo3) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"188 g": "১৮৮ g",
		"2022": "২০২২",
		"2412 × 1080 px (~394 ppi)": "২৪১২ × ১০৮০ পিক্সেল (~৩৯৪ পিপিআই)",
		...
		"Dimensity 8100-Max (5 nm)": "ডাইমেনসিটি ৮১০০-ম্যাক্স (৫ ন্যানোমিটার)",
		...
		"MediaTek Dimensity 8100-Max": "মিডিয়াটেক ডাইমেনসিটি ৮১০০-ম্যাক্স",
		"Octa-core (4×2.85 GHz Cortex-A78 + 4×2.0 GHz Cortex-A55)": "অক্টা-কোর (৪×২.৮৫ গিগাহার্টজ Cবাtex-A৭৮ + ৪×২.০ গিগাহার্টজ Cবাtex-A৫৫)",
