...
func (s *SpecificationSeederMobileIphone17ProMax) getBanglaTranslations() map[string]string {
	return map[string]string{
		"12 GB": "১২ GB",
		"12 MP, f/2.2": "১২ মেগাপিক্সেল, f/২.২",
		"120Hz ProMotion": "১২০Hz প্রোমোশন",
		"165.3 x 76.3 x 8.5 mm (6.51 x 3.00 x 0.33 in)": "১৬৫.৩ x ৭৬.৩ x ৮.৫ মিমি (৬.৫১ x ৩.০০ x ০.৩৩ in)",
		"235 g (8.28 oz)": "২৩৫ গ্রাম (৮.২৮ oz)",
		"256 GB / 512 GB / 1 TB": "২৫৬ জিবি / ৫১২ জিবি / ১ টিবি",
		"2796 x 1290 pixels (~456 ppi density)": "২৭৯৬ x ১২৯০ পিক্সেল (~৪৫৬ পিপিআই density)",
		"2x + 5x Optical Zoom": "২x + ৫x অপটিক্যাল জুম",
		"4,500 mAh (typical)": "৪,৫০০ এমএএইচ (সাধারণ)",
		"45W wired; 25W MagSafe wireless; 5W reverse wireless": "৪৫W তারযুক্ত; ২৫W MagSafe বেতার; ৫W রিভার্স বেতার",
		"48 MP + 12 MP + 12 MP": "৪৮ মেগাপিক্সেল + ১২ মেগাপিক্সেল + ১২ মেগাপিক্সেল",
		"4K@24/25/30/60fps, 1080p@30/60/120/240fps, ProRes video recording": "৪K@২৪/২৫/৩০/৬০fps, ১০৮০p@৩০/৬০/১২০/২৪০fps, প্রোRes video recবাding",
		...
		"Apple A19 Pro": "অ্যাপল A১৯ প্রো",
		"Black, White, Gold, Rose Gold, Blue, Deep Purple": "কালো, সাদা, সোনালী, রোজ সোনালী, নীল, Deep বেগুনি",
		...
		"IP68 dust tight and water resistant (immersible up to 6m for 30 min)": "IP৬৮ ধুলো প্রতিরোধী এবং জল প্রতিরোধী (immersible পর্যন্ত ৬m জন্য ৩০ min)",
		"Li-Ion (non-removable)": "লি-আয়ন (অপসারণযোগ্য নয়)",
		"Nano-SIM + eSIM": "ন্যানো-সিম + ই-সিম",
		"September 2024": "সেপ্টেম্বর ২০২৪",
		"Super Retina XDR LTPO OLED, 120Hz, HDR10, Dolby Vision": "সুপার রেটিনা এক্সডিআর এলটিপিও ওএলইডি, ১২০Hz, এইচডিআর১০, ডলবি ভিশন",
		"USB Type-C with USB 3.1 speeds": "ইউএসবি টাইপ-সি with USB ৩.১ speeds",
		"Wi-Fi 802.11 a/b/g/n/ac/6e (802.11ax)": "ওয়াই-ফাই ৮০২.১১ a/b/g/n/ac/৬e (৮০২.১১ax)",
		"Yes - 25W MagSafe wireless; 5W reverse wireless": "Yes - ২৫W MagSafe বেতার; ৫W রিভার্স বেতার",
		"iOS 18": "আইওএস ১৮",
	}
}
