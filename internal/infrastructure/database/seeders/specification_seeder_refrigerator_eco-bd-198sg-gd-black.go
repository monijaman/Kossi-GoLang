...
// SpecificationSeederRefrigeratorecobd198sggdblack seeds specifications/options for product 'eco-bd-198sg-gd-black'
type SpecificationSeederRefrigeratorecobd198sggdblack struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecobd198sggdblack creates a new seeder instance
func NewSpecificationSeederRefrigeratorecobd198sggdblack() *SpecificationSeederRefrigeratorecobd198sggdblack {
	return &SpecificationSeederRefrigeratorecobd198sggdblack{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-bd-198sg-gd-black"},
	}
}

func (s *SpecificationSeederRefrigeratorecobd198sggdblack) getBanglaTranslations() map[string]string {
	return map[string]string{
		"ECO+":                   "ইকো+",
		"ECO+ BD-198SG GD Black": "ECO+ BD-198SG GD Black",
...
// Seed inserts specification records for the product identified by slug 'eco-bd-198sg-gd-black'
func (s *SpecificationSeederRefrigeratorecobd198sggdblack) Seed(db *gorm.DB) error {
	productSlug := "eco-bd-198sg-gd-black"
	...
	specs := map[string]string{
		"Brand":                       "ECO+",
		"Model Name":                  "ECO+ BD-198SG GD Black",
