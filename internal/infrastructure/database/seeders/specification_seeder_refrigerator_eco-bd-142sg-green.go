...
// SpecificationSeederRefrigeratorecobd142sggreen seeds specifications/options for product 'eco-bd-142sg-green'
type SpecificationSeederRefrigeratorecobd142sggreen struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecobd142sggreen creates a new seeder instance
func NewSpecificationSeederRefrigeratorecobd142sggreen() *SpecificationSeederRefrigeratorecobd142sggreen {
	return &SpecificationSeederRefrigeratorecobd142sggreen{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-bd-142sg-green"},
	}
}

func (s *SpecificationSeederRefrigeratorecobd142sggreen) getBanglaTranslations() map[string]string {
	return map[string]string{
		"ECO+":                "ইকো+",
		"ECO+ BD-142SG Green": "ECO+ BD-142SG Green",
...
// Seed inserts specification records for the product identified by slug 'eco-bd-142sg-green'
func (s *SpecificationSeederRefrigeratorecobd142sggreen) Seed(db *gorm.DB) error {
	productSlug := "eco-bd-142sg-green"
	...
	specs := map[string]string{
		"Brand":                       "ECO+",
		"Model Name":                  "ECO+ BD-142SG Green",
		"Door Type":                   "Top Opening",
		"Capacity":                    "142",
		"Freezer Capacity":            "136",
		"Gross Volume":                "142",
		"Net Volume":                  "136",
