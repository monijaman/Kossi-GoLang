...
// SpecificationSeederRefrigeratorAuxSingleDoor seeds specifications/options for product 'aux-single-door'
type SpecificationSeederRefrigeratorAuxSingleDoor struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorAuxSingleDoor creates a new seeder instance
func NewSpecificationSeederRefrigeratorAuxSingleDoor() *SpecificationSeederRefrigeratorAuxSingleDoor {
	return &SpecificationSeederRefrigeratorAuxSingleDoor{
		BaseSeeder: BaseSeeder{name: "Specifications for aux-single-door"},
	}
}

func (s *SpecificationSeederRefrigeratorAuxSingleDoor) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'aux-single-door'
func (s *SpecificationSeederRefrigeratorAuxSingleDoor) Seed(db *gorm.DB) error {
	productSlug := "aux-single-door"
