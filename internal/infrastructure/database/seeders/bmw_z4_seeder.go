...
// BmwZ4Seeder seeds specifications for BMW Z4
type BmwZ4Seeder struct {
	BaseSeeder
}

// NewBmwZ4Seeder creates a new BMW Z4 seeder
func NewBmwZ4Seeder() *BmwZ4Seeder {
	return &BmwZ4Seeder{
		BaseSeeder: BaseSeeder{name: "BMW Z4 Specifications"},
	}
}

func (bz4s *BmwZ4Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for BMW Z4
func (bz4s *BmwZ4Seeder) Seed(db *gorm.DB) error {
	productSlug := "bmw-z4"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "183 hp/ton",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := bz4s.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ BMW Z4 specifications seeded successfully")
	return nil
}
