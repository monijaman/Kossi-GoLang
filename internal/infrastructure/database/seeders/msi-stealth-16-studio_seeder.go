...
// MsiStealth16StudioSeeder seeds specifications for MSI Stealth 16 Studio
type MsiStealth16StudioSeeder struct {
	BaseSeeder
}

// NewMsiStealth16StudioSeeder creates a new MSI Stealth 16 Studio seeder
func NewMsiStealth16StudioSeeder() *MsiStealth16StudioSeeder {
	return &MsiStealth16StudioSeeder{
		BaseSeeder: BaseSeeder{name: "MSI Stealth 16 Studio Specifications"},
	}
}

func (msss *MsiStealth16StudioSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"MSI":                           "এমএসআই",
		"Stealth 16 Studio":             "স্টেলথ ১৬ স্টুডিও",
		...
		"359 x 241 x 19 mm":             "৩৫৯ x ২৪১ x ১৯ মিমি",
		"TPM 2.0":                       "টিপিএম ২.০",
		"14":                            "১৪",
		"20":                            "২০",
...
// Seed implements the Seeder interface for MSI Stealth 16 Studio
func (msss *MsiStealth16StudioSeeder) Seed(db *gorm.DB) error {
	productSlug := "msi-stealth-16-studio"
	...
	log.Printf("✅ MSI Stealth 16 Studio specifications seeded successfully")
	return nil
}
