...
func (s *SpecificationSeederRefrigeratorMarcelMfbB2fGdehScInverter) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"GPPS/4": "GPPS/৪",
		"59 ± 2 Kg": "৫৯ ± ২ কেজি",
		"V 1101-Low Voltage(90~300V), Voltage stabilizer is not required.": "V ১১০১-Low Voltage(৯০~৩০০V), Voltage stabilizer is not required.",
		"98/ 72/ 36": "৯৮/ ৭২/ ৩৬",
...
func (s *SpecificationSeederRefrigeratorMarcelMfbB2fGdehScInverter) Seed(db *gorm.DB) error {
    ...
    specs := map[string]string{
		...
		"Compressor Input Power (Watt)": "V 1101-57~125",
		...
		"Recommended voltage stabilizer capacity": "V 1101-Low Voltage(90~300V), Voltage stabilizer is not required.",
