...
// SpecificationSeederRefrigeratorecoglc322rvbbas seeds specifications/options for product 'eco-gl-c322rvbb-as'
type SpecificationSeederRefrigeratorecoglc322rvbbas struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecoglc322rvbbas creates a new seeder instance
func NewSpecificationSeederRefrigeratorecoglc322rvbbas() *SpecificationSeederRefrigeratorecoglc322rvbbas {
	return &SpecificationSeederRefrigeratorecoglc322rvbbas{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-gl-c322rvbb-as"},
	}
}

func (s *SpecificationSeederRefrigeratorecoglc322rvbbas) getBanglaTranslations() map[string]string {
	return map[string]string{
		"LG":                       "এলজি",
		"LG OMEGA3 GL-C322RVBB AS": "এলজি ওমেগা৩ জিএল-সি৩২২আরভিবিবি এএস",
		"Top Mount":                "টপ মাউন্ট",
		"281":                      "২৮১",
		"223":                      "২২৩",
		"58":                       "৫৮",
...
// Seed inserts specification records for the product identified by slug 'eco-gl-c322rvbb-as'
func (s *SpecificationSeederRefrigeratorecoglc322rvbbas) Seed(db *gorm.DB) error {
	productSlug := "eco-gl-c322rvbb-as"
	...
	specs := map[string]string{
		"Brand":                 "LG",
		"Model Name":            "LG OMEGA3 GL-C322RVBB AS",
		"Door Type":             "Top Mount",
		"Capacity":              "281",
