...
func (s *SpecificationSeederMobileInfinixNote50Pro5g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Dimensity 8050": "ডাইমেনসিটি ৮০৫০",
		"Glass front, plastic frame, glass back": "গ্লাস সামনে, প্লাস্টিক ফ্রেম, গ্লাস পেছনে",
		"IP53": "IP৫৩",
		"Magic Black, Variable Gold": "ম্যাজিক কালো, ভেরিয়েবল সোনালী",
		"Mali-G77 MC9": "মালি-G৭৭ MC৯",
		"May 2024": "মে ২০২৪",
		"Mediatek Dimensity 8050 (6 nm)": "মিডিয়াটেক ডাইমেনসিটি ৮০৫০ (৬ ন্যানোমিটার)",
	}
}
