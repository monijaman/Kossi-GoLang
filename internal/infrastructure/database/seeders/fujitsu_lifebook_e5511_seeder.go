...
// FujitsuLifeBookE5511Seeder seeds specifications for Fujitsu LifeBook E5511
type FujitsuLifeBookE5511Seeder struct {
	BaseSeeder
}

// NewFujitsuLifeBookE5511Seeder creates a new Fujitsu LifeBook E5511 seeder
func NewFujitsuLifeBookE5511Seeder() *FujitsuLifeBookE5511Seeder {
	return &FujitsuLifeBookE5511Seeder{
		BaseSeeder: BaseSeeder{name: "Fujitsu LifeBook E5511 Specifications"},
	}
}

func (fles *FujitsuLifeBookE5511Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Fujitsu":                       "ফুজিতসু",
		"LifeBook E5511":                "লাইফবুক ই৫৫১১",
		...
		"362 x 240 x 19.9 mm":                  "৩৬২ x ২৪০ x ১৯.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"4":                                    "৪",
		"8":                                    "৮",
...
// Seed implements the Seeder interface for Fujitsu LifeBook E5511
func (fles *FujitsuLifeBookE5511Seeder) Seed(db *gorm.DB) error {
	productSlug := "fujitsu-lifebook-e5511"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "362 x 240 x 19.9 mm",
		"Body Type":               "Plastic",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := fles.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Fujitsu LifeBook E5511 specifications seeded successfully")
	return nil
}
