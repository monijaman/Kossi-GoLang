...
// SpecificationSeederRefrigeratorToshibaGrE37 seeds specifications/options for product 'toshiba-gr-e37'
type SpecificationSeederRefrigeratorToshibaGrE37 struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorToshibaGrE37 creates a new seeder instance
func NewSpecificationSeederRefrigeratorToshibaGrE37() *SpecificationSeederRefrigeratorToshibaGrE37 {
	return &SpecificationSeederRefrigeratorToshibaGrE37{
		BaseSeeder: BaseSeeder{name: "Specifications for toshiba-gr-e37"},
	}
}

func (s *SpecificationSeederRefrigeratorToshibaGrE37) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"1635 x 598 x 660 mm": "১৬৩৫ x ৫৯৮ x ৬৬০ মিমি",
		"1635 mm":             "১৬৩৫ মিমি",
		"598 mm":              "৫৯৮ মিমি",
		"660 mm":              "৬৬০ মিমি",
	}
...
// Seed inserts specification records for the product identified by slug 'toshiba-gr-e37'
func (s *SpecificationSeederRefrigeratorToshibaGrE37) Seed(db *gorm.DB) error {
	productSlug := "toshiba-gr-e37"
	...
	specs := map[string]string{
		...
		"Dimensions":                      "1635 x 598 x 660 mm",
		"Height (mm)":                     "1635 mm",
		"Width":                           "598 mm",
		"Depth (mm)":                      "660 mm",
		"Warranty":                        "2 Years",
