...
// TongfangGi5cn54Seeder seeds specifications for Tongfang GI5CN54
type TongfangGi5cn54Seeder struct {
	BaseSeeder
}

// NewTongfangGi5cn54Seeder creates a new Tongfang GI5CN54 seeder
func NewTongfangGi5cn54Seeder() *TongfangGi5cn54Seeder {
	return &TongfangGi5cn54Seeder{
		BaseSeeder: BaseSeeder{name: "Tongfang GI5CN54 Specifications"},
	}
}

func (tgs *TongfangGi5cn54Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Tongfang":                             "টংফ্যাং",
		"GI5CN54":                              "জিআই৫সিএন৫৪",
		"Windows 11 Home":                      "উইন্ডোজ ১১ হোম",
		"Intel":                                "ইন্টেল",
		"Core i5-11320H":                       "কোর আই৫-১১৩২০এইচ",
		"11th Gen":                             "১১তম প্রজন্ম",
		"Intel Platform Controller Hub":        "ইন্টেল প্ল্যাটফর্ম কন্ট্রোলার হাব",
		"NVIDIA GeForce GTX 1650":              "এনভিডিয়া গেফোর্স জিটিএক্স ১৬৫০",
		...
		"362 x 237 x 19 mm":                    "৩৬২ x ২৩৭ x ১৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"4":                                    "৪",
		"8":                                    "৮",
...
// Seed implements the Seeder interface for Tongfang GI5CN54
func (tgs *TongfangGi5cn54Seeder) Seed(db *gorm.DB) error {
	productSlug := "tongfang-gi5cn54"
	...
	specs := map[string]string{
		...
		"Processor Model":      "Core i5-11320H",
	...
	log.Printf("✅ Tongfang GI5CN54 specifications seeded successfully")
	return nil
}
