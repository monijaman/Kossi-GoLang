...
func (s *SpecificationSeederMobileVivoV605g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"176 g": "১৭৬ g",
		"2376 × 1080 px": "২৩৭৬ × ১০৮০ পিক্সেল",
		"2x": "২x",
		...
		"Black, Blue": "কালো, নীল",
		"Dimensity 800U (7 nm)": "ডাইমেনসিটি ৮০০U (৭ ন্যানোমিটার)",
		...
		"Mali-G57 MC3": "মালি-G৫৭ MC৩",
		"MediaTek Dimensity 800U": "মিডিয়াটেক ডাইমেনসিটি ৮০০U",
...
func (s *SpecificationSeederMobileVivoV605g) Seed(db *gorm.DB) error {
	...
	// Override model-specific values for Vivo V60 5G
	specs["Display Size"] = "6.56 inches"
	specs["Processor"] = "MediaTek Dimensity 800U"
	specs["Chipset"] = "Dimensity 800U (7 nm)"
	...
	specs["Announcement Date"] = "April 2021"
