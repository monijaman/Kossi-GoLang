...
// AcerSwiftGo14Seeder seeds specifications for Acer Swift Go 14
type AcerSwiftGo14Seeder struct {
	BaseSeeder
}

// NewAcerSwiftGo14Seeder creates a new Acer Swift Go 14 seeder
func NewAcerSwiftGo14Seeder() *AcerSwiftGo14Seeder {
	return &AcerSwiftGo14Seeder{
		BaseSeeder: BaseSeeder{name: "Acer Swift Go 14 Specifications"},
	}
}

func (asgs *AcerSwiftGo14Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Acer":                          "এসার",
		"Swift Go 14":                   "সুইফট গো ১৪",
		...
		"327 x 228 x 17.9 mm":                  "৩২৭ x ২২৮ x ১৭.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"4":                                    "৪",
		"8":                                    "৮",
...
// Seed implements the Seeder interface for Acer Swift Go 14
func (asgs *AcerSwiftGo14Seeder) Seed(db *gorm.DB) error {
	productSlug := "acer-swift-go-14"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "327 x 228 x 17.9 mm",
		"Body Type":               "Plastic",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := asgs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Acer Swift Go 14 specifications seeded successfully")
	return nil
}
