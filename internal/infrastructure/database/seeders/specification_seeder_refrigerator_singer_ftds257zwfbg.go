...
// SpecificationSeederRefrigeratorSingerFTDS257ZWFBG seeds specifications/options for product 'singer-ftds257zwf-bg'
type SpecificationSeederRefrigeratorSingerFTDS257ZWFBG struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS257ZWFBG creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS257ZWFBG() *SpecificationSeederRefrigeratorSingerFTDS257ZWFBG {
	return &SpecificationSeederRefrigeratorSingerFTDS257ZWFBG{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds257zwf-bg"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS257ZWFBG) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                    "সিঙ্গার",
		"FTDS257ZWF-BG":             "FTDS257ZWF-BG",
		"SRREF-SS500-FTDS257ZWF-BG": "SRREF-SS500-FTDS257ZWF-BG",
...
// Seed inserts specification records for the product identified by slug 'singer-ftds257zwf-bg'
func (s *SpecificationSeederRefrigeratorSingerFTDS257ZWFBG) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds257zwf-bg"
	...
	specs := map[string]string{
		"Brand":                       "Singer",
		"Model Name":                  "SRREF-SS500-FTDS257ZWF-BG",
