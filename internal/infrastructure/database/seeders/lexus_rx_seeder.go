...
// LexusRXSeeder seeds specifications for Lexus RX
type LexusRXSeeder struct {
	BaseSeeder
}

// NewLexusRXSeeder creates a new Lexus RX seeder
func NewLexusRXSeeder() *LexusRXSeeder {
	return &LexusRXSeeder{
		BaseSeeder: BaseSeeder{name: "Lexus RX Specifications"},
	}
}

func (lrxs *LexusRXSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"3.5L V6":                       "৩.৫ লিটার ভি৬",
		"Luxury SUV":                    "লাক্সারি এসইউভি",
		"2023":                          "২০২৩",
		"SUV":                           "এসইউভি",
		"Atomic Silver":                 "অ্যাটমিক সিলভার",
		"V":                             "ভি",
		"3456":                          "৩৪৫৬ সিসি",
		"6":                             "৬ (সিলিন্ডার)",
		"275 hp":                        "২৭৫ হর্স পাওয়ার",
		"275 hp @ 6000 rpm":             "৬০০০ আরপিএম এ ২৭৫ হর্স পাওয়ার",
		"317 Nm @ 4800 rpm":             "৪৮০০ আরপিএম এ ৩১৭ এনএম",
		"Petrol":                        "পেট্রোল",
		...
		"Dynamic Torque Control":        "ডায়নামিক টর্ক কন্ট্রোল",
		"4890 mm":                       "৪৮৯০ মিমি",
		"1895 mm":                       "১৮৯৫ মিমি",
		"1690 mm":                       "১৬৯০ মিমি",
		"2790 mm":                       "২৭৯০ মিমি",
		...
		"317 Nm @ 4800 rpm":             "৩১৭ এনএম @ ৪৮০০ আরপিএম",
...
func (lrxs *LexusRXSeeder) Seed(db *gorm.DB) error {
	// First, find or create the product
	var product models.ProductModel
	if err := db.Where("name = ?", "Lexus RX").First(&product).Error; err != nil {
	...
	specifications := map[string]string{
		...
		"engine_max_torque":           "317 Nm @ 4800 rpm",
		...
		"transmission_clutch_type":    "Dynamic Torque Control",
		"performance_top_speed":       "200 km/h",
		"performance_acceleration":    "7.9 seconds",
		...
		"dimensions_length":           "4890 mm",
		"dimensions_width":            "1895 mm",
		"dimensions_height":           "1690 mm",
		"dimensions_wheelbase":        "2790 mm",
		"dimensions_front_tread":      "1645 mm",
		"dimensions_rear_tread":       "1650 mm",
		"dimensions_ground_clearance": "195 mm",
		"dimensions_boot_space":       "453 L",
		"dimensions_fuel_tank":        "72 L",
		"dimensions_turning_radius":   "6.1 m",
		"weight_kerb_weight":          "1940 kg",
		"weight_gross_weight":         "2500 kg",
		...
		"brakes_front":                "Disc",
		"brakes_rear":                 "Disc",
		"tyres_size":                  "235/65 R18",
		"tyres_wheel_size":            "18 inches",
		"tyres_spare_size":            "235/65 R18",
		"exterior_colors":             "Atomic Silver, Black, Gray, White, Silver, Blue, Red, Brown, Beige",
	...
	for key, value := range specifications {
		if specKeyID, exists := specKeyMap[key]; exists {
			...
			translation := models.SpecificationTranslationModel{
				...
				LanguageCode:    "bn",
				Value:           lrxs.getBanglaTranslations()[value],
				Status:          1,
			}
	...
	log.Printf("Seeded specifications for Lexus RX")
	return nil
}
