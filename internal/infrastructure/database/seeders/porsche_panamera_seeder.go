...
// PorschePanameraSeeder seeds specifications for Porsche Panamera
type PorschePanameraSeeder struct {
	BaseSeeder
}

// NewPorschePanameraSeeder creates a new Porsche Panamera seeder
func NewPorschePanameraSeeder() *PorschePanameraSeeder {
	return &PorschePanameraSeeder{
		BaseSeeder: BaseSeeder{name: "Porsche Panamera Specifications"},
	}
}

func (pps *PorschePanameraSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"2.9L Turbo V6":                 "২.৯ লিটার টার্বো ভি৬",
		"Executive Sedan":               "এক্সিকিউটিভ সেডান",
		"2023":                          "২০২৩",
		"Sedan":                         "সেডান",
		"Volcano Grey":                  "ভলকানো গ্রে",
		"V":                             "ভি",
		"2894":                          "২৮৯৪ সিসি",
		"6":                             "৬ (সিলিন্ডার)",
		"330 hp":                        "৩৩০ হর্স পাওয়ার",
		"330 hp @ 5400 rpm":             "৫৪০০ আরপিএম এ ৩৩০ হর্স পাওয়ার",
		"450 Nm @ 1800 rpm":             "১৮০০ আরপিএম এ ৪৫০ এনএম",
		"Petrol":                        "পেট্রোল",
		"Turbocharged":                  "টার্বোচার্জড",
		"5.6 seconds":                   "৫.৬ সেকেন্ড",
		"270 km/h":                      "২৭০ কিমি/ঘণ্টা",
		...
		"2.9L Turbo V6":                 "২.৯লি টার্বো ভি৬",
		"Displacement":                  "ডিসপ্লেসমেন্ট",
		"2894 cc":                       "২৮৯৪ সিসি",
		"Max Power":                     "ম্যাক্স পাওয়ার",
		"330 hp @ 5400 rpm":             "৩৩০ হর্স পাওয়ার @ ৫৪০০ আরপিএম",
		"Max Torque":                    "ম্যাক্স টর্ক",
		"450 Nm @ 1800 rpm":             "৪৫০ এনএম @ ১৮০০ আরপিএম",
		...
		"84.5 x 86.0 mm":                "৮৪.৫ x ৮৬.০ মিমি",
...
func (pps *PorschePanameraSeeder) Seed(db *gorm.DB) error {
	...
	specifications := map[string]string{
		...
		"engine_max_power":            "330 hp @ 5400 rpm",
		"engine_max_torque":           "450 Nm @ 1800 rpm",
		"engine_fuel_supply_system":   "Direct Injection",
		"engine_bore_stroke":          "84.5 x 86.0 mm",
		...
		"performance_top_speed":       "270 km/h",
		"performance_acceleration":    "5.6 seconds",
		...
		"dimensions_length":           "5049 mm",
		"dimensions_width":            "1937 mm",
		"dimensions_height":           "1428 mm",
		"dimensions_wheelbase":        "2950 mm",
		"dimensions_front_tread":      "1668 mm",
		"dimensions_rear_tread":       "1651 mm",
		"dimensions_ground_clearance": "134 mm",
		"dimensions_boot_space":       "495 L",
		"dimensions_fuel_tank":        "75 L",
		"dimensions_turning_radius":   "6.1 m",
		"weight_kerb_weight":          "1995 kg",
		"weight_gross_weight":         "2580 kg",
		...
		"brakes_front":                "Disc",
		"brakes_rear":                 "Disc",
		"tyres_size":                  "275/40 R19",
		"tyres_wheel_size":            "19 inches",
		"tyres_spare_size":            "275/40 R19",
		"exterior_colors":             "Volcano Grey, Black, White, Silver, Blue, Red, Gray, Green, Brown",
		...
		"interior_seats_adjustment":   "14-way Electric",
		"interior_ac":                 "4-Zone Auto AC",
	...
	log.Printf("Seeded specifications for Porsche Panamera")
	return nil
}
