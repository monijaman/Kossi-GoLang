...
// SpecificationSeederRefrigeratorMarcelMfcC6eGdneXxInverter seeds specifications/options for product 'marcel-mfc-c6e-gdne-xx-inverter'
...
func NewSpecificationSeederRefrigeratorMarcelMfcC6eGdneXxInverter() *SpecificationSeederRefrigeratorMarcelMfcC6eGdneXxInverter {
	return &SpecificationSeederRefrigeratorMarcelMfcC6eGdneXxInverter{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfc-c6e-gdne-xx-inverter"},
	}
}
...
func (s *SpecificationSeederRefrigeratorMarcelMfcC6eGdneXxInverter) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":         "মার্সেল",
				"marcel-mfc-c6e-gdne-xx-inverter":         "মার্সেল-mfc-c6e-gdne-xx-inverter",
		"MFC-C6E-GDNE-XX-INVERTER":   "MFC-C6E-GDNE-XX-INVERTER",
		// Add more translations as needed
	}
}

// Seed inserts specification records for the product identified by slug 'marcel-mfc-c6e-gdne-xx-inverter'
func (s *SpecificationSeederRefrigeratorMarcelMfcC6eGdneXxInverter) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfc-c6e-gdne-xx-inverter"
