...
// SpecificationSeederRefrigeratorMarcelMfbB5dGdshXx seeds specifications/options for product 'mfb-b5d-gdsh-xx'
...
func NewSpecificationSeederRefrigeratorMarcelMfbB5dGdshXx() *SpecificationSeederRefrigeratorMarcelMfbB5dGdshXx {
	return &SpecificationSeederRefrigeratorMarcelMfbB5dGdshXx{
		BaseSeeder: BaseSeeder{name: "Specifications for mfb-b5d-gdsh-xx"},
	}
}
