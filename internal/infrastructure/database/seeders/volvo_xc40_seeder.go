...
// VolvoXc40Seeder seeds specifications for Volvo XC40
type VolvoXc40Seeder struct {
	BaseSeeder
}

// NewVolvoXc40Seeder creates a new Volvo XC40 seeder
func NewVolvoXc40Seeder() *VolvoXc40Seeder {
	return &VolvoXc40Seeder{
		BaseSeeder: BaseSeeder{name: "Volvo XC40 Specifications"},
	}
}

func (vxs *VolvoXc40Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"2017":                         "২০১৭",
		"SUV":                          "এসইউভি",
		"Crystal White":                "ক্রিস্টাল হোয়াইট",
		"Inline":                       "ইনলাইন",
		"1969":                         "১৯৬৯ সিসি",
		"4":                            "৪ (সিলিন্ডার)",
		"190 hp":                       "১৯০ হর্স পাওয়ার",
		"190 hp @ 4700 rpm":            "৪৭০০ আরপিএম এ ১৯০ হর্স পাওয়ার",
		"300 Nm @ 1400-4000 rpm":       "১৪০০-৪০০০ আরপিএম এ ৩০০ এনএম",
		"Petrol":                       "পেট্রোল",
...
// Seed implements the Seeder interface for Volvo XC40
func (vxs *VolvoXc40Seeder) Seed(db *gorm.DB) error {
	productSlug := "volvo-xc40"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "113 hp/ton",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := vxs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Volvo XC40 specifications seeded successfully")
	return nil
}
