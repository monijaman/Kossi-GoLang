...
func (s *SpecificationSeederMobileVivoX300Pro) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"5.2": "৫.২",
		"50 MP + 13 MP + 13 MP": "৫০ মেগাপিক্সেল + ১৩ মেগাপিক্সেল + ১৩ মেগাপিক্সেল",
		"6.78 inches": "৬.৭৮ ইঞ্চি",
		"66 W wired": "৬৬ W তারযুক্ত",
		"8 / 12 GB": "৮ / ১২ GB",
		"AMOLED, 120 Hz": "অ্যামোলেড, ১২০ Hz",
		"Adreno 660": "অ্যাড্রেনো ৬৬০",
		...
		"Snapdragon 888+": "স্ন্যাপড্রাগন ৮৮৮+",
		"Snapdragon 888+ (5 nm)": "স্ন্যাপড্রাগন ৮৮৮+ (৫ ন্যানোমিটার)",
...
func (s *SpecificationSeederMobileVivoX300Pro) Seed(db *gorm.DB) error {
	...
	// Override model-specific values for Vivo X300 Pro
	specs["Display Size"] = "6.78 inches"
	specs["Processor"] = "Snapdragon 888+"
	specs["Chipset"] = "Snapdragon 888+ (5 nm)"
	specs["Cpu Type"] = "Octa-core"
	specs["Gpu Type"] = "Adreno 660"
	specs["Ram"] = "8 / 12 GB"
	...
	specs["Rear Camera"] = "50 MP + 13 MP + 13 MP"
