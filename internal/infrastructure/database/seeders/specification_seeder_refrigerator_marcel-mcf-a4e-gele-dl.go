...
func (s *SpecificationSeederRefrigeratorMarcelMcfA4eGeleDl) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		"Brand":               "Marcel",
		"Model Name":          "MCF-A4E-GELE-DL",
		"Basket": "Wire/1",
		"Capillary": "Copper",
		"Climate Type (SN, N, ST, T)": "N ~ T",
		"Compressor Input Power (Watt)": "V 06.03-64V 07.02-104",
		...
		"Recommended voltage stabilizer capacity (600VA)": "V 06.03-N/AV 07.02-(600VA)",
		"Refrigerant": "V 06.03-R600aV 07.02-R600a",
