...
// SpecificationSeederRefrigeratorAuxNoFrost seeds specifications/options for product 'aux-no-frost'
type SpecificationSeederRefrigeratorAuxNoFrost struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorAuxNoFrost creates a new seeder instance
func NewSpecificationSeederRefrigeratorAuxNoFrost() *SpecificationSeederRefrigeratorAuxNoFrost {
	return &SpecificationSeederRefrigeratorAuxNoFrost{
		BaseSeeder: BaseSeeder{name: "Specifications for aux-no-frost"},
	}
}

func (s *SpecificationSeederRefrigeratorAuxNoFrost) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'aux-no-frost'
func (s *SpecificationSeederRefrigeratorAuxNoFrost) Seed(db *gorm.DB) error {
	productSlug := "aux-no-frost"
