...
// VolvoXc60Seeder seeds specifications for Volvo XC60
type VolvoXc60Seeder struct {
	BaseSeeder
}

// NewVolvoXc60Seeder creates a new Volvo XC60 seeder
func NewVolvoXc60Seeder() *VolvoXc60Seeder {
	return &VolvoXc60Seeder{
		BaseSeeder: BaseSeeder{name: "Volvo XC60 Specifications"},
	}
}

func (vxs *VolvoXc60Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"350 Nm @ 1500-4800 rpm":       "১৫০০-৪৮০০ আরপিএম এ ৩৫০ এনএম",
		"Petrol":                       "পেট্রোল",
...
// Seed implements the Seeder interface for Volvo XC60
func (vxs *VolvoXc60Seeder) Seed(db *gorm.DB) error {
	productSlug := "volvo-xc60"
	...
	log.Printf("✅ Volvo XC60 specifications seeded successfully")
	return nil
}
