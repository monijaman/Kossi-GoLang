...
// SpecificationSeederRefrigeratorVitusDoubleDoor seeds specifications/options for product 'vitus-double-door'
type SpecificationSeederRefrigeratorVitusDoubleDoor struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorVitusDoubleDoor creates a new seeder instance
func NewSpecificationSeederRefrigeratorVitusDoubleDoor() *SpecificationSeederRefrigeratorVitusDoubleDoor {
	return &SpecificationSeederRefrigeratorVitusDoubleDoor{
		BaseSeeder: BaseSeeder{name: "Specifications for vitus-double-door"},
	}
}

func (s *SpecificationSeederRefrigeratorVitusDoubleDoor) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'vitus-double-door'
func (s *SpecificationSeederRefrigeratorVitusDoubleDoor) Seed(db *gorm.DB) error {
	productSlug := "vitus-double-door"
