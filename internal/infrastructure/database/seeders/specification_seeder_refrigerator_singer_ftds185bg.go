...
// SpecificationSeederRefrigeratorSingerFTDS185BG seeds specifications/options for product 'singer-ftds185-bg'
type SpecificationSeederRefrigeratorSingerFTDS185BG struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS185BG creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS185BG() *SpecificationSeederRefrigeratorSingerFTDS185BG {
	return &SpecificationSeederRefrigeratorSingerFTDS185BG{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds185-bg"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS185BG) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                   "সিঙ্গার",
		"FTDS185-BG":               "FTDS185-BG",
...
// Seed inserts specification records for the product identified by slug 'singer-ftds185-bg'
func (s *SpecificationSeederRefrigeratorSingerFTDS185BG) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds185-bg"
