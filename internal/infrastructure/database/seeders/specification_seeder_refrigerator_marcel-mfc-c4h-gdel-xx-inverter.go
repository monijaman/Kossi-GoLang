...
// SpecificationSeederRefrigeratorMarcelMfcC4hGdelXxInverter seeds specifications/options for product 'mfc-c4h-gdel-xx-inverter'
...
func NewSpecificationSeederRefrigeratorMarcelMfcC4hGdelXxInverter() *SpecificationSeederRefrigeratorMarcelMfcC4hGdelXxInverter {
	return &SpecificationSeederRefrigeratorMarcelMfcC4hGdelXxInverter{
		BaseSeeder: BaseSeeder{name: "Specifications for mfc-c4h-gdel-xx-inverter"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'mfc-c4h-gdel-xx-inverter'
func (s *SpecificationSeederRefrigeratorMarcelMfcC4hGdelXxInverter) Seed(db *gorm.DB) error {
	productSlug := "mfc-c4h-gdel-xx-inverter"
