...
func (s *SpecificationSeederMobileOppoReno12Pro5g) getBanglaTranslations() map[string]string {
	return map[string]string{
		"108 MP + 8 MP + 2 MP": "১০৮ মেগাপিক্সেল + ৮ মেগাপিক্সেল + ২ মেগাপিক্সেল",
		...
		"Glass front, aluminum frame/back": "গ্লাস সামনে, অ্যালুমিনিয়াম ফ্রেম/পেছনে",
		"HDR10+ display, Dolby Atmos": "এইচডিআর১০+ display, ডলবি অ্যাটমস",
...
// Seed inserts specification records for the product identified by slug 'oppo-reno-12-pro-5g'
func (s *SpecificationSeederMobileOppoReno12Pro5g) Seed(db *gorm.DB) error {
	...
	// Override model-specific values for Oppo Reno 12 Pro 5G
