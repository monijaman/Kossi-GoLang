...
func (s *SpecificationSeederRefrigeratorMarcelMfaB4dGdehXx) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"Recommended voltage stabilizer capacity": "V
  05.01: 1000VAV 06.01: No Need to use voltage stabilizer.V 0701 : No Need to use voltage stabilizerIf out of voltage range(145V-260V), then suggestedvoltage stabilizer
  capacity is 1000VA.",
		"Refrigerant": "V
  0501-R134aV 0601-R600aV 0701-R600a",
		"Reversible Door": "No",
