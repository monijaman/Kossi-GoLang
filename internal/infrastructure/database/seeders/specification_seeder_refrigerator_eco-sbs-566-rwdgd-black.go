...
// SpecificationSeederRefrigeratorecosbs566rwdgdblack seeds specifications/options for product 'eco-sbs-566-rwdgd-black'
type SpecificationSeederRefrigeratorecosbs566rwdgdblack struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecosbs566rwdgdblack creates a new seeder instance
func NewSpecificationSeederRefrigeratorecosbs566rwdgdblack() *SpecificationSeederRefrigeratorecosbs566rwdgdblack {
	return &SpecificationSeederRefrigeratorecosbs566rwdgdblack{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-sbs-566-rwdgd-black"},
	}
}

func (s *SpecificationSeederRefrigeratorecosbs566rwdgdblack) getBanglaTranslations() map[string]string {
	return map[string]string{
		"ECO+":                     "ইকো+",
		"Eco+ SBS-566-RWDGD Black": "ইকো+ এসবিএস-৫৬৬-আরডব্লিউডিজিডি ব্ল্যাক",
...
// Seed inserts specification records for the product identified by slug 'eco-sbs-566-rwdgd-black'
func (s *SpecificationSeederRefrigeratorecosbs566rwdgdblack) Seed(db *gorm.DB) error {
	productSlug := "eco-sbs-566-rwdgd-black"
	...
	specs := map[string]string{
		"Brand":                 "ECO+",
		"Model Name":            "Eco+ SBS-566-RWDGD Black",
