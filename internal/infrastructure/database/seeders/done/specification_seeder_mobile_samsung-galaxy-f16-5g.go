...
func (s *SpecificationSeederMobileSamsungGalaxyF165G) getBanglaTranslations() map[string]string {
	...
	specific := map[string]string{
		...
		"PLS LCD, 90 Hz":                    "পিএলএস এলসিডি, ৯০ হার্জ",
		...
		"Octa-core (2×2.0 GHz + 6×1.8 GHz)": "অক্টা-কোর (২×২.০ GHz + ৬×১.৮ GHz)",
		"Mali-G57 MC2":                      "মালি-জি५৭ ঎মকৃ",
		"4 / 6 GB":                          "৪ / ৬ জিবি",
		"64 / 128 GB + microSD":             "৬৪ / ১২৮ GB + মাইক্রোSD",
		"64 / 128 GB":                       "৬৪ / ১২৮ GB",
		"microSD":                           "মাইক্রোএসডি",
		"50 MP + 2 MP + 2 MP":               "৫০ মেগাপিক্সেল + २ মেগাপিক্সেল + २ মেগাপিক্সেল",
		"50 MP (wide) + 2 MP (macro) + 2 MP (depth)": "৫০ মেগাপিক্সেল (ওয়াইড) + २ মেগাপিক্সেল (ম্যাক্রো) + २ মেগাপিক্সেল (ডেপথ)",
		...
		"Black, Blue, Green":                "ব্ল্যাক, ব্লু, গ্রিন",
		"2024":                              "২০২৪",
		"Available":                         "উপলব্ধ",
		...
		"Accelerometer, Proximity, Compass, Side fingerprint": "অ্যাক্সেলেরোমিটার, প্রক্সিমিটি, কম্পাস, সাইড ফিঙ্গারপ্রিন্ট",
