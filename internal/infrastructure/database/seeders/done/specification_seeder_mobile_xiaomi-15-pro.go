...
func (s *SpecificationSeederMobileXiaomi15Pro) getBanglaTranslations() map[string]string {
	specific := map[string]string{
		...
		"Octa-core":                        "অক্টা-কোর",
		"LTPO AMOLED, 120Hz, Dolby Vision, HDR10+, 3200 nits": "এলটিপিও এএমওএলইডি, ১২০হার্টজ, ডলবি ভিশন, এইচডিআর১০+, ৩২০০ নিটস",
		...
		"Black, White, Green, Silver":     "ব্ল্যাক, হোয়াইট, গ্রিন, সিলভার",
		...
		"Li-Po":                       "লি-পো",
		"90W wired, 80W wireless":     "৯০ডব্লিউ ওয়্যার্ড, ৮০ডব্লিউ ওয়্যারলেস",
		"Yes":                         "হ্যাঁ",
...
func (s *SpecificationSeederMobileXiaomi15Pro) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"battery_type":        "Li-Po",
		"fast_charging":       "90W wired, 80W wireless",
		"charging_speed":      "90W wired, 80W wireless",
