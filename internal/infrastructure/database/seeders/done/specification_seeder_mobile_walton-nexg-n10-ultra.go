...
// SpecificationSeederMobileWaltonNEXGN10ULTRA seeds specifications/options for product 'walton-nexg-n10-ultra'
type SpecificationSeederMobileWaltonNEXGN10ULTRA struct {
	BaseSeeder
}

// NewSpecificationSeederMobileWaltonNEXGN10ULTRA creates a new seeder instance
func NewSpecificationSeederMobileWaltonNEXGN10ULTRA() *SpecificationSeederMobileWaltonNEXGN10ULTRA {
	return &SpecificationSeederMobileWaltonNEXGN10ULTRA{BaseSeeder: BaseSeeder{name: "Specifications for Walton NEXG N10 ULTRA"}}
}

// getBanglaTranslations returns a map of English specification values to their Bangla translations
func (s *SpecificationSeederMobileWaltonNEXGN10ULTRA) getBanglaTranslations() map[string]string {
	specific := map[string]string{
		...
		"NEXG N10 ULTRA (8GB RAM + 128GB)":  "এনইএক্সজি এন১০ আল্ট্রা (৮জিবি র্যাম + ১২৮জিবি)",
		...
		"LTE":                               "এলটিই",
		"4G":                                "4G",
		"September 2023":                    "সেপ্টেম্বর 2023",
		...
		"190 g":                             "190 গ্রাম",
		"5,000 mAh":                         "5000 mAh",
		"Blue, Black":                       "ব্লু, ব্ল্যাক",
		"Available":                         "উপলব্ধ",
		"Unisoc T606 (12 nm)":               "ইউনিসক T606",
		"8 GB":                              "8 জিবি",
		"Glass front":                       "গ্লাস ফ্রন্ট",
		"164 x 75.8 x 8.5 mm":               "164x75.8x8.5 মিমি",
	}
...
// Seed inserts specification records for the product identified by slug 'walton-nexg-n10-ultra'
func (s *SpecificationSeederMobileWaltonNEXGN10ULTRA) Seed(db *gorm.DB) error {
	productSlug := "walton-nexg-n10-ultra"
	...
	specs := map[string]string{
		...
		"model_variants":                "NEXG N10 ULTRA (8GB RAM + 128GB)",
