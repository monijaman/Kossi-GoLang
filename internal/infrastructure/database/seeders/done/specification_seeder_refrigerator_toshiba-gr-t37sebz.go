...
// SpecificationSeederRefrigeratorToshibaGrT37sebz seeds specifications/options for product 'toshiba-gr-t37sebz'
type SpecificationSeederRefrigeratorToshibaGrT37sebz struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorToshibaGrT37sebz creates a new seeder instance
func NewSpecificationSeederRefrigeratorToshibaGrT37sebz() *SpecificationSeederRefrigeratorToshibaGrT37sebz {
	return &SpecificationSeederRefrigeratorToshibaGrT37sebz{
		BaseSeeder: BaseSeeder{name: "Specifications for toshiba-gr-t37sebz"},
	}
}

func (s *SpecificationSeederRefrigeratorToshibaGrT37sebz) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Toshiba":            "তোশিবা",
		"GR-T37SEBZ":         "GR-T37SEBZ",
		"Japan":              "জাপান",
		...
		"150W":                            "150W",
		"52kg":                            "52kg",
		"600 x 680 x 1670 mm":             "600 x 680 x 1670 mm",
		"Top Mount Inverter Refrigerator": "টপ মাউন্ট ইনভার্টার রেফ্রিজারেটর",
	}
}

// Seed inserts specification records for the product identified by slug 'toshiba-gr-t37sebz'
func (s *SpecificationSeederRefrigeratorToshibaGrT37sebz) Seed(db *gorm.DB) error {
	productSlug := "toshiba-gr-t37sebz"
	...
	specs := map[string]string{
		...
		"Weight":                          "52kg",
		"Dimensions (mm)":                 "600 x 680 x 1670 mm",
		"Warranty":                        "2 Years",
