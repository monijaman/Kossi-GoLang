...
func (s *SpecificationSeederMobileWaltonNEXGN71PLUS) getBanglaTranslations() map[string]string {
	specific := map[string]string{
		...
		"NEXG N71 PLUS (8GB RAM + 128GB)":   "এনইএক্সজি এন৭১ প্লাস (৮জিবি র্যাম + ১২৮জিবি)",
...
// Seed inserts specification records for the product identified by slug 'walton-nexg-n71-plus'
func (s *SpecificationSeederMobileWaltonNEXGN71PLUS) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"model_variants":                "NEXG N71 PLUS (8GB RAM + 128GB)",
