...
// MsiRaiderGe68HxSeeder seeds specifications for MSI Raider GE68 HX
type MsiRaiderGe68HxSeeder struct {
	BaseSeeder
}

// NewMsiRaiderGe68HxSeeder creates a new MSI Raider GE68 HX seeder
func NewMsiRaiderGe68HxSeeder() *MsiRaiderGe68HxSeeder {
	return &MsiRaiderGe68HxSeeder{
		BaseSeeder: BaseSeeder{name: "MSI Raider GE68 HX Specifications"},
	}
}

func (mrgs *MsiRaiderGe68HxSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"MSI":                          "এমএসআই",
		"Raider GE68 HX":               "রাইডার জিই৬৮ এইচএক্স",
		...
		"357 x 259 x 23 mm":            "৩৫৭ x ২৫৯ x ২৩ মিমি",
		"TPM 2.0":                      "টিপিএম ২.০",
		"16":                           "১৬",
		"24":                           "২৪",
...
// Seed implements the Seeder interface for MSI Raider GE68 HX
func (mrgs *MsiRaiderGe68HxSeeder) Seed(db *gorm.DB) error {
	productSlug := "msi-raider-ge68-hx"
	...
	log.Printf("✅ MSI Raider GE68 HX specifications seeded successfully")
	return nil
}