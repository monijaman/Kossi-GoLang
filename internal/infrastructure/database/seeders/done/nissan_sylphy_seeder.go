...
// NissanSylphySeeder seeds specifications for Nissan Sylphy
type NissanSylphySeeder struct {
	BaseSeeder
}

// NewNissanSylphySeeder creates a new Nissan Sylphy seeder
func NewNissanSylphySeeder() *NissanSylphySeeder {
	return &NissanSylphySeeder{
		BaseSeeder: BaseSeeder{name: "Nissan Sylphy Specifications"},
	}
}

func (nss *NissanSylphySeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Sylphy 1.6":              "সিলফি ১.৬",
		"3rd Generation (B18)":    "৩য় প্রজন্ম (বি১৮)",
...
// Seed implements the Seeder interface for Nissan Sylphy
func (nss *NissanSylphySeeder) Seed(db *gorm.DB) error {
	productSlug := "nissan-sylphy"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := nss.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Nissan Sylphy specifications seeded successfully")
	return nil
}
