...
// AppleMacbookAirM215Seeder seeds specifications for Apple MacBook Air M2 15-inch
type AppleMacbookAirM215Seeder struct {
	BaseSeeder
}

// NewAppleMacbookAirM215Seeder creates a new Apple MacBook Air M2 15-inch seeder
func NewAppleMacbookAirM215Seeder() *AppleMacbookAirM215Seeder {
	return &AppleMacbookAirM215Seeder{
		BaseSeeder: BaseSeeder{name: "Apple MacBook Air M2 15-inch Specifications"},
	}
}

func (amas *AppleMacbookAirM215Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Apple":                         "অ্যাপল",
		"MacBook Air M2 15-inch":        "ম্যাকবুক এয়ার এম২ ১৫-ইঞ্চি",
...
// Seed implements the Seeder interface for Apple MacBook Air M2 15-inch
func (amas *AppleMacbookAirM215Seeder) Seed(db *gorm.DB) error {
	productSlug := "apple-macbook-air-m2-15-inch"
	...
	specs := map[string]string{
		"Brand":                "Apple",
		"Model Name":           "MacBook Air M2 15-inch",
	...
	log.Printf("✅ Apple MacBook Air M2 15-inch specifications seeded successfully")
	return nil
}
