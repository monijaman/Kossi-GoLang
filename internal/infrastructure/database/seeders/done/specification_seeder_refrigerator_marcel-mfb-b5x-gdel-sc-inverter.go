...
// SpecificationSeederRefrigeratorMarcelMfbB5xGdelScInverter seeds specifications/options for product 'mfb-b5x-gdel-sc-inverter'
...
func NewSpecificationSeederRefrigeratorMarcelMfbB5xGdelScInverter() *SpecificationSeederRefrigeratorMarcelMfbB5xGdelScInverter {
	return &SpecificationSeederRefrigeratorMarcelMfbB5xGdelScInverter{
		BaseSeeder: BaseSeeder{name: "Specifications for mfb-b5x-gdel-sc-inverter"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'mfb-b5x-gdel-sc-inverter'
func (s *SpecificationSeederRefrigeratorMarcelMfbB5xGdelScInverter) Seed(db *gorm.DB) error {
	productSlug := "mfb-b5x-gdel-sc-inverter"
