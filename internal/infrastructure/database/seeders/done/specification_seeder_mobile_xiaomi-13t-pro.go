...
func (s *SpecificationSeederMobileXiaomi13TPro) getBanglaTranslations() map[string]string {
	specific := map[string]string{
		...
		"Glass front (Gorilla Glass 5), glass back or silicone polymer back, plastic frame": "গ্লাস ফ্রন্ট (গরিলা গ্লাস ৫), গ্লাস ব্যাক বা সিলিকন পলিমার ব্যাক, প্লাস্টিক ফ্রেম",
		"200 g":                            "২০০ গ্রাম",
		...
		"Immortalis-G715 MC11":             "ইমর্টালিস-জি৭১৫ এমসি১১",
		"144Hz":                            "১৪৪ হার্টজ",
		"IP68":                             "আইপি৬৮",
		"120W wired":                       "১২০ডব্লিউ ওয়্যার্ড",
		"Android 13, upgradable to Android 14, HyperOS": "অ্যান্ড্রয়েড ১৩, অ্যান্ড্রয়েড ১৪-এ আপগ্রেডেবল, হাইপারওএস",
