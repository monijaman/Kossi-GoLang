...
// DellXPS13Plus9320Seeder seeds specifications for Dell XPS 13 Plus 9320
type DellXPS13Plus9320Seeder struct {
	BaseSeeder
}

// NewDellXPS13Plus9320Seeder creates a new Dell XPS 13 Plus 9320 seeder
func NewDellXPS13Plus9320Seeder() *DellXPS13Plus9320Seeder {
	return &DellXPS13Plus9320Seeder{
		BaseSeeder: BaseSeeder{name: "Dell XPS 13 Plus 9320 Specifications"},
	}
}

func (dxps *DellXPS13Plus9320Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Dell":                          "ডেল",
		"XPS 13 Plus 9320":              "এক্সপিএস ১৩ প্লাস ৯৩২০",
		...
		"295.3 x 199.0 x 15.28 mm":             "২৯৫.৩ x ১৯৯.০ x ১৫.২৮ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"16":                                   "১৬",
		"22":                                   "২২",
...
// Seed implements the Seeder interface for Dell XPS 13 Plus 9320
func (dxps *DellXPS13Plus9320Seeder) Seed(db *gorm.DB) error {
	productSlug := "dell-xps-13-plus-9320"
	...
	specs := map[string]string{
		...
		"Dimensions":              "295.3 x 199.0 x 15.28 mm",
		"Body Type":               "Aluminum",
	...
	log.Printf("✅ Dell XPS 13 Plus 9320 specifications seeded successfully")
	return nil
}
