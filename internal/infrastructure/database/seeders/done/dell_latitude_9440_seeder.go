...
// DellLatitude9440Seeder seeds specifications for Dell Latitude 9440
type DellLatitude9440Seeder struct {
	BaseSeeder
}

// NewDellLatitude9440Seeder creates a new Dell Latitude 9440 seeder
func NewDellLatitude9440Seeder() *DellLatitude9440Seeder {
	return &DellLatitude9440Seeder{
		BaseSeeder: BaseSeeder{name: "Dell Latitude 9440 Specifications"},
	}
}

func (dls *DellLatitude9440Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Dell":                          "ডেল",
		"Latitude 9440":                 "ল্যাটিটিউড ৯৪৪০",
		...
		"1.4 GHz base / 4.8 GHz boost":         "১.৪ গিগাহার্টজ বেস / ৪.৮ গিগাহার্টজ বুস্ট",
		"24 MB cache":                          "২৪ এমবি ক্যাশ",
		"1080p FHD":                            "১০৮০পি এফএইচডি",
		"Stereo Speakers":                      "স্টেরিও স্পিকার",
		"314.0 x 223.0 x 15.5 mm":              "৩১৪.০ x ২২৩.০ x ১৫.৫ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"16":                                   "১৬",
		"22":                                   "২২",
...
// Seed implements the Seeder interface for Dell Latitude 9440
func (dls *DellLatitude9440Seeder) Seed(db *gorm.DB) error {
	productSlug := "dell-latitude-9440"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := dls.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Dell Latitude 9440 specifications seeded successfully")
	return nil
}
