...
// SpecificationSeederRefrigeratorToshibaGrS20Spb seeds specifications/options for product 'toshiba-gr-s20-spb'
type SpecificationSeederRefrigeratorToshibaGrS20Spb struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorToshibaGrS20Spb creates a new seeder instance
func NewSpecificationSeederRefrigeratorToshibaGrS20Spb() *SpecificationSeederRefrigeratorToshibaGrS20Spb {
	return &SpecificationSeederRefrigeratorToshibaGrS20Spb{
		BaseSeeder: BaseSeeder{name: "Specifications for toshiba-gr-s20-spb"},
	}
}

func (s *SpecificationSeederRefrigeratorToshibaGrS20Spb) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Toshiba":            "তোশিবা",
		"GR-S20 SPB":         "GR-S20 SPB",
		"Japan":              "জাপান",
		...
		"37kg":                "37kg",
		"43L":                 "43L",
		"485 x 572 x 1420 mm": "485 x 572 x 1420 mm",
	}
}

// Seed inserts specification records for the product identified by slug 'toshiba-gr-s20-spb'
func (s *SpecificationSeederRefrigeratorToshibaGrS20Spb) Seed(db *gorm.DB) error {
	productSlug := "toshiba-gr-s20-spb"
	...
	specs := map[string]string{
		...
		"Weight":                          "37kg",
		"Dimensions (mm)":                 "485 x 572 x 1420 mm",
		"Warranty":                        "2 Years",
