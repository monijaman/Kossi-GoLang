...
func (s *SpecificationSeederRefrigeratorMarcelMbbB6xTdxxXx) Seed(db *gorm.DB) error {
    ...
    specs := map[string]string{
		...
		"Compressor Input Power (Watt)": "V 0101- 178 V 0201- 178",
		"Compressor Type": "V 0101- CSIR V 0201- CSIR",
		...
		"Lock": "Yes",
		"Refrigerant": "V 0101- R134a V 0201- R134a",
		...
		"CB/Safety Certificate (IEC 60335-1 & 60335-2-89)": "V 0101- Yes V 0201- No",
	}
