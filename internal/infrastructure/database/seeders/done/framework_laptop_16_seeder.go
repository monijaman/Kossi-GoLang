...
// FrameworkLaptop16Seeder seeds specifications for Framework Laptop 16
type FrameworkLaptop16Seeder struct {
	BaseSeeder
}

// NewFrameworkLaptop16Seeder creates a new Framework Laptop 16 seeder
func NewFrameworkLaptop16Seeder() *FrameworkLaptop16Seeder {
	return &FrameworkLaptop16Seeder{
		BaseSeeder: BaseSeeder{name: "Framework Laptop 16 Specifications"},
	}
}

func (fls *FrameworkLaptop16Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Framework":                     "ফ্রেমওয়ার্ক",
		"Framework Laptop 16":           "ফ্রেমওয়ার্ক ল্যাপটপ ১৬",
		...
		"356.6 x 249.4 x 15.95 mm":               "৩৫৬.৬ x ২৪৯.৪ x ১৫.৯৫ মিমি",
		"TPM 2.0":                                "টিপিএম ২.০",
		"14":                                     "১৪",
		"20":                                     "২০",
		"32":                                     "৩২",
...
// Seed implements the Seeder interface for Framework Laptop 16
func (fls *FrameworkLaptop16Seeder) Seed(db *gorm.DB) error {
	productSlug := "framework-laptop-16"
	...
	specs := map[string]string{
		"Brand":                "Framework",
		"Model Name":           "Framework Laptop 16",
		...
		"Dimensions":              "356.6 x 249.4 x 15.95 mm",
		"Body Type":               "Aluminum",
	...
	log.Printf("✅ Framework Laptop 16 specifications seeded successfully")
	return nil
}
