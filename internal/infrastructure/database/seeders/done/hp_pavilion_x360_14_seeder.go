...
// HpPavilionX36014Seeder seeds specifications for HP Pavilion x360 14
type HpPavilionX36014Seeder struct {
	BaseSeeder
}

// NewHpPavilionX36014Seeder creates a new HP Pavilion x360 14 seeder
func NewHpPavilionX36014Seeder() *HpPavilionX36014Seeder {
	return &HpPavilionX36014Seeder{
		BaseSeeder: BaseSeeder{name: "HP Pavilion x360 14 Specifications"},
	}
}

func (hps *HpPavilionX36014Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"Pavilion x360 14":              "প্যাভিলিয়ন এক্স৩৬০ ১৪",
		...
		"313 x 225 x 17.9 mm":            "৩১৩ x ২২৫ x ১৭.৯ মিমি",
		"TPM 2.0":                        "টিপিএম ২.০",
		"10":                             "১০",
		"12":                             "১২",
...
// Seed implements the Seeder interface for HP Pavilion x360 14
func (hps *HpPavilionX36014Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-pavilion-x360-14"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "313 x 225 x 17.9 mm",
		"Body Type":               "Plastic",
	...
	log.Printf("✅ HP Pavilion x360 14 specifications seeded successfully")
	return nil
}
