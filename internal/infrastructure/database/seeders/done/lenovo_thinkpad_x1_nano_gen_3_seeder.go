...
// LenovoThinkpadX1NanoGen3Seeder seeds specifications for Lenovo ThinkPad X1 Nano Gen 3
type LenovoThinkpadX1NanoGen3Seeder struct {
	BaseSeeder
}

// NewLenovoThinkpadX1NanoGen3Seeder creates a new Lenovo ThinkPad X1 Nano Gen 3 seeder
func NewLenovoThinkpadX1NanoGen3Seeder() *LenovoThinkpadX1NanoGen3Seeder {
	return &LenovoThinkpadX1NanoGen3Seeder{
		BaseSeeder: BaseSeeder{name: "Lenovo ThinkPad X1 Nano Gen 3 Specifications"},
	}
}

func (lts *LenovoThinkpadX1NanoGen3Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Lenovo":                        "লেনোভো",
		"ThinkPad X1 Nano Gen 3":        "থিঙ্কপ্যাড এক্স১ ন্যানো জেন ৩",
		...
		"293.3 x 208.1 x 14.95 mm":      "২৯৩.৩ x ২০৮.১ x ১৪.৯৫ মিমি",
		"TPM 2.0":                       "টিপিএম ২.০",
		"12":                            "১২",
		"16":                            "১৬",
...
// Seed implements the Seeder interface for Lenovo ThinkPad X1 Nano Gen 3
func (lts *LenovoThinkpadX1NanoGen3Seeder) Seed(db *gorm.DB) error {
	productSlug := "lenovo-thinkpad-x1-nano-gen-3"
	...
	specs := map[string]string{
		"Brand":                   "Lenovo",
		"Model Name":              "ThinkPad X1 Nano Gen 3",
		...
		"Dimensions":              "293.3 x 208.1 x 14.95 mm",
	...
	log.Printf("✅ Lenovo ThinkPad X1 Nano Gen 3 specifications seeded successfully")
	return nil
}
