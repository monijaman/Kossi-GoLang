...
// HonorMagicbookX16ProSeeder seeds specifications for Honor MagicBook X16 Pro
type HonorMagicbookX16ProSeeder struct {
	BaseSeeder
}

// NewHonorMagicbookX16ProSeeder creates a new Honor MagicBook X16 Pro seeder
func NewHonorMagicbookX16ProSeeder() *HonorMagicbookX16ProSeeder {
	return &HonorMagicbookX16ProSeeder{
		BaseSeeder: BaseSeeder{name: "Honor MagicBook X16 Pro Specifications"},
	}
}

func (hms *HonorMagicbookX16ProSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Honor":                         "অনার",
		"MagicBook X16 Pro":             "ম্যাজিকবুক এক্স১৬ প্রো",
		"Windows 11 Home":               "উইন্ডোজ ১১ হোম",
		"Intel":                         "ইন্টেল",
		"Core i7-13620H":                "কোর আই৭-১৩৬২০এইচ",
		...
		"2.5 GHz base / 4.9 GHz boost":  "২.৫ গিগাহার্টজ বেস / ৪.৯ গিগাহার্টজ বুস্ট",
...
// Seed implements the Seeder interface for Honor MagicBook X16 Pro
func (hms *HonorMagicbookX16ProSeeder) Seed(db *gorm.DB) error {
	productSlug := "honor-magicbook-x16-pro"
	...
	specs := map[string]string{
		"Brand":                   "Honor",
		"Model Name":              "MagicBook X16 Pro",
		"Operating System":        "Windows 11 Home",
		"Processor Brand":         "Intel",
		"Processor Model":         "Core i7-13620H",
		...
		"Processor Speed":         "2.5 GHz base / 4.9 GHz boost",
	...
	log.Printf("✅ Honor MagicBook X16 Pro specifications seeded successfully")
	return nil
}
