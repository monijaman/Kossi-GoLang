...
// BmwX6Seeder seeds specifications for BMW X6
type BmwX6Seeder struct {
	BaseSeeder
}

// NewBmwX6Seeder creates a new BMW X6 seeder
func NewBmwX6Seeder() *BmwX6Seeder {
	return &BmwX6Seeder{
		BaseSeeder: BaseSeeder{name: "BMW X6 Specifications"},
	}
}

func (bx6s *BmwX6Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"375 hp @ 5200-6250 rpm":          "৫২০০-৬২৫০ আরপিএম এ ৩৭৫ হর্স পাওয়ার",
		"520 Nm @ 1850-5000 rpm":          "১৮৫০-৫০০০ আরপিএম এ ৫২০ এনএম",
		"Petrol":                          "পেট্রোল",
		"Turbocharged":                    "টার্বোচার্জড",
		"TwinPower Turbo":                 "টুইনপাওয়ার টার্বো",
		"5.5 seconds":                     "৫.৫ সেকেন্ড",
...
// Seed implements the Seeder interface for BMW X6
func (bx6s *BmwX6Seeder) Seed(db *gorm.DB) error {
	productSlug := "bmw-x6"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "172 hp/ton",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := bx6s.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ BMW X6 specifications seeded successfully")
	return nil
}
