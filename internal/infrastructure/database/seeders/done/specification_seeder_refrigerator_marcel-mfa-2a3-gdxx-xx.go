...
// SpecificationSeederRefrigeratorMarcelMfa2a3GdxxXx seeds specifications/options for product 'marcel-mfa-2a3-gdxx-xx'
type SpecificationSeederRefrigeratorMarcelMfa2a3GdxxXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfa2a3GdxxXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfa2a3GdxxXx() *SpecificationSeederRefrigeratorMarcelMfa2a3GdxxXx {
	return &SpecificationSeederRefrigeratorMarcelMfa2a3GdxxXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfa-2a3-gdxx-xx"},
	}
}
...
func (s *SpecificationSeederRefrigeratorMarcelMfa2a3GdxxXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Walton: 5 Star (BDS 1850:2012)":                                      "Walton: ৫ Star (BDS ১৮৫০:২০১২)",
		"Wire/2":                                                              "Wire/২",
		"580":                                                                 "৫৮০",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfa-2a3-gdxx-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfa2a3GdxxXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfa-2a3-gdxx-xx"
	...
	specs := map[string]string{
		...
		"Energy Star Rating":                  "Walton: 5 Star (BDS 1850:2012)",
