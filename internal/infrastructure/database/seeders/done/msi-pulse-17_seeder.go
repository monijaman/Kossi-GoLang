...
// MsiPulse17Seeder seeds specifications for MSI Pulse 17
type MsiPulse17Seeder struct {
	BaseSeeder
}

// NewMsiPulse17Seeder creates a new MSI Pulse 17 seeder
func NewMsiPulse17Seeder() *MsiPulse17Seeder {
	return &MsiPulse17Seeder{
		BaseSeeder: BaseSeeder{name: "MSI Pulse 17 Specifications"},
	}
}

func (mps *MsiPulse17Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for MSI Pulse 17
func (mps *MsiPulse17Seeder) Seed(db *gorm.DB) error {
	productSlug := "msi-pulse-17"
	...
	log.Printf("✅ MSI Pulse 17 specifications seeded successfully")
	return nil
}
