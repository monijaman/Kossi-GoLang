...
// SpecificationSeederRefrigeratorMarcelMfcC1gGdxxXx seeds specifications/options for product 'marcel-mfc-c1g-gdxx-xx'
type SpecificationSeederRefrigeratorMarcelMfcC1gGdxxXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfcC1gGdxxXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfcC1gGdxxXx() *SpecificationSeederRefrigeratorMarcelMfcC1gGdxxXx {
	return &SpecificationSeederRefrigeratorMarcelMfcC1gGdxxXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfc-c1g-gdxx-xx"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfcC1gGdxxXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":                 "মার্সেল",
		"marcel-mfc-c1g-gdxx-xx": "মার্সেল-mfc-c1g-gdxx-xx",
		"MFC-C1G-GDXX-XX":        "MFC-C1G-GDXX-XX",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfc-c1g-gdxx-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfcC1gGdxxXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfc-c1g-gdxx-xx"
