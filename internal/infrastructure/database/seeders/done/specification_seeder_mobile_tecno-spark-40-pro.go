...
func (s *SpecificationSeederMobileTecnoSPARK40Pro) getBanglaTranslations() map[string]string {
	...
	tecnoTranslations := map[string]string{
		"Mediatek Helio G99 Ultimate":  "মিডিয়াটেক হেলিও জি৯৯ আলটিমেট",
		"Helio G99 Ultimate":           "হেলিও জি৯৯ আলটিমেট",
		"Temporal Orbits, Lunar Frost": "টেম্পোরাল অরবিটস, লুনার ফ্রস্ট",
		"AMOLED, 120Hz, Curved":        "অ্যামোলেড, ১২০ হার্জ, কার্ভড",
		"108 MP + 2 MP + AI":           "১০৮ এমপি + ২ এমপি + এআই",
		...
		"164.7 x 75 x 7.6 mm":          "১৬৪.৭ × ৭৫ × ৭.৬ মিমি",
...
// Seed inserts specification records for the product identified by slug 'tecno-spark-40-pro'
