...
// FrameworkLaptop13Intel13thGenSeeder seeds specifications for Framework Laptop 13 (Intel 13th Gen)
type FrameworkLaptop13Intel13thGenSeeder struct {
	BaseSeeder
}

// NewFrameworkLaptop13Intel13thGenSeeder creates a new Framework Laptop 13 (Intel 13th Gen) seeder
func NewFrameworkLaptop13Intel13thGenSeeder() *FrameworkLaptop13Intel13thGenSeeder {
	return &FrameworkLaptop13Intel13thGenSeeder{
		BaseSeeder: BaseSeeder{name: "Framework Laptop 13 (Intel 13th Gen) Specifications"},
	}
}

func (fls *FrameworkLaptop13Intel13thGenSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Framework":                            "ফ্রেমওয়ার্ক",
		"Framework Laptop 13 (Intel 13th Gen)": "ফ্রেমওয়ার্ক ল্যাপটপ ১৩ (ইন্টেল ১৩তম প্রজন্ম)",
...
// Seed implements the Seeder interface for Framework Laptop 13 (Intel 13th Gen)
func (fls *FrameworkLaptop13Intel13thGenSeeder) Seed(db *gorm.DB) error {
	productSlug := "framework-laptop-13-intel-13th-gen"
	...
	specs := map[string]string{
		"Brand":                "Framework",
		"Model Name":           "Framework Laptop 13 (Intel 13th Gen)",
	...
	log.Printf("✅ Framework Laptop 13 (Intel 13th Gen) specifications seeded successfully")
	return nil
}
