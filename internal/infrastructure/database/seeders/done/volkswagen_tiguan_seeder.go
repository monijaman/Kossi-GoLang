...
// VolkswagenTiguanSeeder seeds specifications for Volkswagen Tiguan
type VolkswagenTiguanSeeder struct {
	BaseSeeder
}

// NewVolkswagenTiguanSeeder creates a new Volkswagen Tiguan seeder
func NewVolkswagenTiguanSeeder() *VolkswagenTiguanSeeder {
	return &VolkswagenTiguanSeeder{
		BaseSeeder: BaseSeeder{name: "Volkswagen Tiguan Specifications"},
	}
}

func (vts *VolkswagenTiguanSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"180 hp @ 3940 rpm":            "৩৯৪০ আরপিএম এ ১৮০ হর্স পাওয়ার",
		"320 Nm @ 1500-3940 rpm":       "১৫০০-৩৯৪০ আরপিএম এ ৩২০ এনএম",
		"Diesel":                       "ডিজেল",
...
// Seed implements the Seeder interface for Volkswagen Tiguan
func (vts *VolkswagenTiguanSeeder) Seed(db *gorm.DB) error {
	productSlug := "volkswagen-tiguan"
	...
	log.Printf("✅ Volkswagen Tiguan specifications seeded successfully")
	return nil
}
