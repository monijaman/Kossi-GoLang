...
// SpecificationSeederRefrigeratorKonkaKrt315egb seeds specifications/options for product 'konka-krt-315egb'
type SpecificationSeederRefrigeratorKonkaKrt315egb struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorKonkaKrt315egb creates a new seeder instance
func NewSpecificationSeederRefrigeratorKonkaKrt315egb() *SpecificationSeederRefrigeratorKonkaKrt315egb {
	return &SpecificationSeederRefrigeratorKonkaKrt315egb{
		BaseSeeder: BaseSeeder{name: "Specifications for konka-krt-315egb"},
	}
}

func (s *SpecificationSeederRefrigeratorKonkaKrt315egb) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Konka":              "কনকা",
		"KRT-315EGB":         "KRT-315EGB",
		"China":              "চীন",
		...
		"315 Ltr.":        "৩১৫ Ltr.",
		"Purple Magnolia": "পার্পল ম্যাগনোলিয়া",
...
// Seed inserts specification records for the product identified by slug 'konka-krt-315egb'
func (s *SpecificationSeederRefrigeratorKonkaKrt315egb) Seed(db *gorm.DB) error {
	productSlug := "konka-krt-315egb"
	...
	specs := map[string]string{
		"Brand":                           "Konka",
		"Model Name":                      "KRT-315EGB-Purple Magnolia, Upper Freezer, Digital Display (315 LTR)",
		"Origin":                          "China",
		"Type":                            "Top Mount",
