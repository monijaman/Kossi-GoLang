...
// GetacV110Seeder seeds specifications for Getac V110
type GetacV110Seeder struct {
	BaseSeeder
}

// NewGetacV110Seeder creates a new Getac V110 seeder
func NewGetacV110Seeder() *GetacV110Seeder {
	return &GetacV110Seeder{
		BaseSeeder: BaseSeeder{name: "Getac V110 Specifications"},
	}
}

func (gvs *GetacV110Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Getac":                         "গেটাক",
		"V110":                          "ভি১১০",
		"Windows 10 Pro":                "উইন্ডোজ ১০ প্রো",
		"Intel":                         "ইন্টেল",
		"Core i3-10110Y":                "কোর আই৩-১০১১০ওয়াই",
		...
		"1.0 GHz base / 3.9 GHz boost":         "১.০ গিগাহার্টজ বেস / ৩.৯ গিগাহার্টজ বুস্ট",
...
// Seed implements the Seeder interface for Getac V110
func (gvs *GetacV110Seeder) Seed(db *gorm.DB) error {
	productSlug := "getac-v110"
	...
	specs := map[string]string{
		...
		"Processor Model":      "Core i3-10110Y",
		...
		"Processor Speed":         "1.0 GHz base / 3.9 GHz boost",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := gvs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Getac V110 specifications seeded successfully")
	return nil
}
