...
func (s *SpecificationSeederMobileSamsungGalaxyS23Ultra) getBanglaTranslations() map[string]string {
	...
	specific := map[string]string{
		...
		"200 MP + 10 MP + 10 MP + 12 MP":               "২০০ এমপি + ১০ এমপি + ১০ এমপি + ১২ এমপি",
		"12 MP":                                        "১২ এমপি",
		"Phantom Black, Green, Cream, Lavender":        "ফ্যান্টম ব্ল্যাক, গ্রিন, ক্রিম, ল্যাভেন্ডার",
		"163.4 x 78.1 x 8.9 mm":                        "১৬৩.৪ × ৭৮.১ × ৮.৯ মিমি",
		"234 g":                                        "২৩৪ গ্রাম",
...
func (s *SpecificationSeederMobileSamsungGalaxyS23Ultra) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"internal_memory_capacity": "256GB 8GB RAM, 256GB 12GB RAM, 512GB 12GB RAM, 1TB 12GB RAM",
		"card_slot_type":           "No",
		"quad_camera_setup":        "200 MP, f/1.7, 24mm (wide), 1/1.35\", 0.6µm, Dual Pixel PDAF, Laser AF, OIS\n10 MP, f/4.9, 230mm (periscope telephoto), 1/3.52\", 1.12µm, Dual Pixel PDAF, OIS, 10x optical zoom\n10 MP, f/2.4, 70mm (telephoto), 1/3.52\", 1.12µm, Dual Pixel PDAF, OIS, 3x optical zoom\n12 MP, f/2.2, 13mm, 120˚ (ultrawide), 1/2.55\", 1.4µm, Dual Pixel PDAF, Super Steady video",
	}
