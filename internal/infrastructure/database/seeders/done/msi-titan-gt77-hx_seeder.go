...
// MsiTitanGt77HxSeeder seeds specifications for MSI Titan GT77 HX
type MsiTitanGt77HxSeeder struct {
	BaseSeeder
}

// NewMsiTitanGt77HxSeeder creates a new MSI Titan GT77 HX seeder
func NewMsiTitanGt77HxSeeder() *MsiTitanGt77HxSeeder {
	return &MsiTitanGt77HxSeeder{
		BaseSeeder: BaseSeeder{name: "MSI Titan GT77 HX Specifications"},
	}
}

func (mtgs *MsiTitanGt77HxSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"MSI":                           "এমএসআই",
		"Titan GT77 HX":                 "টাইটান জিটি৭৭ এইচএক্স",
		...
		"397 x 330 x 23 mm":             "৩৯৭ x ৩৩০ x ২৩ মিমি",
		"TPM 2.0":                       "টিপিএম ২.০",
		"24":                            "২৪",
		"32":                            "৩২",
...
// Seed implements the Seeder interface for MSI Titan GT77 HX
func (mtgs *MsiTitanGt77HxSeeder) Seed(db *gorm.DB) error {
	productSlug := "msi-titan-gt77-hx"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := mtgs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ MSI Titan GT77 HX specifications seeded successfully")
	return nil
}
