...
// LenovoThinkpadE14Gen5Seeder seeds specifications for Lenovo ThinkPad E14 Gen 5
type LenovoThinkpadE14Gen5Seeder struct {
	BaseSeeder
}

// NewLenovoThinkpadE14Gen5Seeder creates a new Lenovo ThinkPad E14 Gen 5 seeder
func NewLenovoThinkpadE14Gen5Seeder() *LenovoThinkpadE14Gen5Seeder {
	return &LenovoThinkpadE14Gen5Seeder{
		BaseSeeder: BaseSeeder{name: "Lenovo ThinkPad E14 Gen 5 Specifications"},
	}
}

func (lts *LenovoThinkpadE14Gen5Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Lenovo":                        "লেনোভো",
		"ThinkPad E14 Gen 5":            "থিঙ্কপ্যাড ই১৪ জেন ৫",
		...
		"324 x 216 x 17.9 mm":                  "৩২৪ x ২১৬ x ১৭.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"10":                                   "১০",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for Lenovo ThinkPad E14 Gen 5
func (lts *LenovoThinkpadE14Gen5Seeder) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "324 x 216 x 17.9 mm",
		"Body Type":               "Plastic",
	...
	log.Printf("✅ Lenovo ThinkPad E14 Gen 5 specifications seeded successfully")
	return nil
}
