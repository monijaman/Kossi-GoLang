...
func (s *SpecificationSeederMobileSamsungGalaxyA15) getBanglaTranslations() map[string]string {
	...
	specific := map[string]string{
		...
		"MediaTek Helio G99 (6nm)":   "মিডিয়াটেক হেলিও G৯৯ (৬ন্যানোমিটার)",
		"Octa-core":                  "অক্টা-কোর",
		...
		"50 MP (wide) + 5 MP (ultrawide) + 2 MP (macro)": "৫০ MP (ওয়াইড) + ৫ MP (আল্ট্রাওয়াইড) + ২ MP (ম্যাক্রো)",
		...
		"200 g":                       "২০০ গ্রাম",
		"160.1 x 76.8 x 8.4 mm":       "১৬০.১ x ৭৬.৮ x ৮.৪ mm",
		...
		"SM-A155F, SM-A155M, SM-A155P":                                   "SM-A155F, SM-A155M, SM-A155P",
...
func (s *SpecificationSeederMobileSamsungGalaxyA15) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"model_variants":    "SM-A155F, SM-A155M, SM-A155P",
