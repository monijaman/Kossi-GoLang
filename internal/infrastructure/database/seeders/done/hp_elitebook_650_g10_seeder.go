...
// HpElitebook650G10Seeder seeds specifications for HP EliteBook 650 G10
type HpElitebook650G10Seeder struct {
	BaseSeeder
}

// NewHpElitebook650G10Seeder creates a new HP EliteBook 650 G10 seeder
func NewHpElitebook650G10Seeder() *HpElitebook650G10Seeder {
	return &HpElitebook650G10Seeder{
		BaseSeeder: BaseSeeder{name: "HP EliteBook 650 G10 Specifications"},
	}
}

func (hebs *HpElitebook650G10Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"EliteBook 650 G10":             "এলিটবুক ৬৫০ জি১০",
		"Windows 11 Pro":                "উইন্ডোজ ১১ প্রো",
		"Intel":                         "ইন্টেল",
		"Core i5-1245U":                 "কোর আই৫-১২৪৫ইউ",
		...
		"51 Wh":                         "৫১ ডব্লিউএইচ",
		"Plastic/Aluminum":              "প্লাস্টিক/অ্যালুমিনিয়াম",
		"Silver":                        "সিলভার",
		"1.8 kg":                        "১.৮ কেজি",
		"2023":                          "২০২৩",
		...
		"1.6 GHz base / 4.4 GHz boost":         "১.৬ গিগাহার্টজ বেস / ৪.৪ গিগাহার্টজ বুস্ট",
		"12 MB cache":                          "১২ এমবি ক্যাশ",
		"720p HD":                              "৭২০পি এইচডি",
		"Stereo Speakers":                      "স্টেরিও স্পিকার",
		"357.9 x 239.2 x 19.9 mm":              "৩৫৭.৯ x ২৩৯.২ x ১৯.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"10":                                   "১০",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for HP EliteBook 650 G10
func (hebs *HpElitebook650G10Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-elitebook-650-g10"
	...
	specs := map[string]string{
		"Brand":                "HP",
		"Model Name":           "EliteBook 650 G10",
		"Operating System":     "Windows 11 Pro",
		"Processor Brand":      "Intel",
		"Processor Model":      "Core i5-1245U",
		...
		"Build Material":       "Plastic/Aluminum",
		"Color":                "Silver",
		...
		"Processor Speed":         "1.6 GHz base / 4.4 GHz boost",
		"Clock Feature":           "12 MB cache",
		"3.5mm Audio Jack":        "Yes",
		"Camera Features":         "720p HD",
		"Audio Quality":           "Stereo Speakers",
		"Sensors":                 "No",
		"Dimensions":              "357.9 x 239.2 x 19.9 mm",
		"Body Type":               "Plastic/Aluminum",
	...
	log.Printf("✅ HP EliteBook 650 G10 specifications seeded successfully")
	return nil
}
