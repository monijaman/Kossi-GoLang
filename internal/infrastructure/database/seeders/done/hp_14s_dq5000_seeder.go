...
// Hp14sDq5000Seeder seeds specifications for HP 14s-dq5000
type Hp14sDq5000Seeder struct {
	BaseSeeder
}

// NewHp14sDq5000Seeder creates a new HP 14s-dq5000 seeder
func NewHp14sDq5000Seeder() *Hp14sDq5000Seeder {
	return &Hp14sDq5000Seeder{
		BaseSeeder: BaseSeeder{name: "HP 14s-dq5000 Specifications"},
	}
}

func (hds *Hp14sDq5000Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"14s-dq5000":                    "১৪এস-ডিকিউ৫০০০",
		"Windows 11 Home":               "উইন্ডোজ ১১ হোম",
		"AMD":                           "এএমডি",
		"Ryzen 3 7320U":                 "রাইজেন ৩ ৭৩২০ইউ",
		"Zen 2":                         "জেন ২",
		...
		"2.4 GHz base / 4.1 GHz boost":         "২.৪ গিগাহার্টজ বেস / ৪.১ গিগাহার্টজ বুস্ট",
		"8 MB cache":                           "৮ এমবি ক্যাশ",
		"720p HD":                              "৭২০পি এইচডি",
		"Stereo Speakers":                      "স্টেরিও স্পিকার",
		"324 x 226 x 17.9 mm":                  "৩২৪ x ২২৬ x ১৭.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"4":                                    "৪",
		"8":                                    "৮",
...
// Seed implements the Seeder interface for HP 14s-dq5000
func (hds *Hp14sDq5000Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-14s-dq5000"
	...
	specs := map[string]string{
		"Brand":                "HP",
		"Model Name":           "14s-dq5000",
		"Operating System":     "Windows 11 Home",
		"Processor Brand":      "AMD",
		"Processor Model":      "Ryzen 3 7320U",
		"Processor Generation": "Zen 2",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := hds.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ HP 14s-dq5000 specifications seeded successfully")
	return nil
}
