...
func (s *SpecificationSeederMobileWaltonORBITY11) getBanglaTranslations() map[string]string {
	specific := map[string]string{
		...
		"ORBIT Y11 (2GB RAM + 32GB)":         "অরবিট ওয়াই১১ (২জিবি র্যাম + ৩২জিবি)",
...
// Seed inserts specification records for the product identified by slug 'walton-orbit-y11'
func (s *SpecificationSeederMobileWaltonORBITY11) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"model_variants":                "ORBIT Y11 (2GB RAM + 32GB)",
