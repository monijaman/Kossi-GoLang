...
// AppleMacbookAirM315Seeder seeds specifications for Apple MacBook Air M3 15-inch
type AppleMacbookAirM315Seeder struct {
	BaseSeeder
}

// NewAppleMacbookAirM315Seeder creates a new Apple MacBook Air M3 15-inch seeder
func NewAppleMacbookAirM315Seeder() *AppleMacbookAirM315Seeder {
	return &AppleMacbookAirM315Seeder{
		BaseSeeder: BaseSeeder{name: "Apple MacBook Air M3 15-inch Specifications"},
	}
}

func (amas *AppleMacbookAirM315Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Apple":                         "অ্যাপল",
		"MacBook Air M3 15-inch":        "ম্যাকবুক এয়ার এম৩ ১৫-ইঞ্চি",
		"macOS Sonoma":                  "ম্যাকওএস সোনোমা",
		"M3":                            "এম৩",
		"Apple M3 GPU":                  "অ্যাপল এম৩ জিপিইউ",
		"2880 x 1864 pixels":            "২৮৮০ x ১৮৬৪ পিক্সেল",
		"15.3 inches":                   "১৫.৩ ইঞ্চি",
		"66.5 Wh":                       "৬৬.৫ ডব্লিউএইচ",
		...
		"13.40 x 9.35 x 0.45 inches":              "১৩.৪০ x ৯.৩৫ x ০.৪৫ ইঞ্চি",
		...
		"Premium":          "প্রিমিয়াম",
		"2x Thunderbolt 4": "২x থান্ডারবোল্ট ৪",
	}
}

// Seed implements the Seeder interface for Apple MacBook Air M3 15-inch
func (amas *AppleMacbookAirM315Seeder) Seed(db *gorm.DB) error {
	productSlug := "apple-macbook-air-m3-15-inch"
	...
	specs := map[string]string{
		"Brand":                "Apple",
		"Model Name":           "MacBook Air M3 15-inch",
		...
		"Screen Resolution":    "2880 x 1864 pixels",
	...
	log.Printf("✅ Apple MacBook Air M3 15-inch specifications seeded successfully")
	return nil
}
