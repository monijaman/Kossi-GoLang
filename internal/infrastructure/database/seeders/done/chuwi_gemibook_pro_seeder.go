...
// ChuwiGemiBookProSeeder seeds specifications for Chuwi GemiBook Pro
type ChuwiGemiBookProSeeder struct {
	BaseSeeder
}

// NewChuwiGemiBookProSeeder creates a new Chuwi GemiBook Pro seeder
func NewChuwiGemiBookProSeeder() *ChuwiGemiBookProSeeder {
	return &ChuwiGemiBookProSeeder{
		BaseSeeder: BaseSeeder{name: "Chuwi GemiBook Pro Specifications"},
	}
}

func (cgs *ChuwiGemiBookProSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Chuwi":                        "চুউই",
		"GemiBook Pro":                 "জেমিবুক প্রো",
...
// Seed implements the Seeder interface for Chuwi GemiBook Pro
func (cgs *ChuwiGemiBookProSeeder) Seed(db *gorm.DB) error {
	productSlug := "chuwi-gemibook-pro"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := cgs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Chuwi GemiBook Pro specifications seeded successfully")
	return nil
}
