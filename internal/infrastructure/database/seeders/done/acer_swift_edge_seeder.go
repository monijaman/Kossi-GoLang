...
// AcerSwiftEdgeSeeder seeds specifications for Acer Swift Edge
type AcerSwiftEdgeSeeder struct {
	BaseSeeder
}

// NewAcerSwiftEdgeSeeder creates a new Acer Swift Edge seeder
func NewAcerSwiftEdgeSeeder() *AcerSwiftEdgeSeeder {
	return &AcerSwiftEdgeSeeder{
		BaseSeeder: BaseSeeder{name: "Acer Swift Edge Specifications"},
	}
}

func (asse *AcerSwiftEdgeSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"16 inches":                     "১৬ ইঞ্চি",
		"72 Wh":                         "৭২ ডব্লিউএইচ",
		"Aluminum-Magnesium":            "অ্যালুমিনিয়াম-ম্যাগনেসিয়াম",
		"Steel Gray":                    "স্টিল গ্রে",
		"1.2 kg":                        "১.২ কেজি",
		"2024":                          "২০২৪",
		...
		"358 x 242 x 12.95 mm":         "৩৫৮ x ২৪২ x ১২.৯৫ মিমি",
		"TPM 2.0":                      "টিপিএম ২.০",
		"14":                           "১৪",
		"20":                           "২০",
		...
		"1x USB 4.0, 2x USB-C 4.0":     "১x ইউএসবি ৪.০, ২x ইউএসবি-সি ৪.০",
		"Thunderbolt 4":                "থান্ডারবোল্ট ৪",
	}
}

// Seed implements the Seeder interface for Acer Swift Edge
func (asse *AcerSwiftEdgeSeeder) Seed(db *gorm.DB) error {
	productSlug := "acer-swift-edge"
	...
	specs := map[string]string{
		...
		"Build Material":       "Aluminum-Magnesium",
		"Color":                "Steel Gray",
		...
		"Sensors":                 "No",
		"Dimensions":              "358 x 242 x 12.95 mm",
		"Body Type":               "Aluminum-Magnesium",
		"Cooling System":          "Dual Fan",
		"Available Colors":        "Steel Gray",
		...
		"Touchscreen": "No",
		"HDMI Ports":  "HDMI 2.1",
		"USB Ports":   "1x USB 4.0, 2x USB-C 4.0",
	}
	...
	for key, value := range specs {
		...
		if banglaValue, exists := asse.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Acer Swift Edge specifications seeded successfully")
	return nil
}
