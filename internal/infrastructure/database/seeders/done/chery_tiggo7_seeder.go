...
// CheryTiggo7Seeder seeds specifications for Chery Tiggo 7
type CheryTiggo7Seeder struct {
	BaseSeeder
}

// NewCheryTiggo7Seeder creates a new Chery Tiggo 7 seeder
func NewCheryTiggo7Seeder() *CheryTiggo7Seeder {
	return &CheryTiggo7Seeder{
		BaseSeeder: BaseSeeder{name: "Chery Tiggo 7 Specifications"},
	}
}

func (cts *CheryTiggo7Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"1498":                         "১৪৯৮ সিসি",
		"4":                            "৪ (সিলিন্ডার)",
		"147 hp":                       "১৪৭ হর্স পাওয়ার",
		"147 hp @ 5500 rpm":            "৫৫০০ আরপিএম এ ১৪৭ হর্স পাওয়ার",
		"210 Nm @ 2000 rpm":            "২০০০ আরপিএম এ ২১০ এনএম",
		"Petrol":                       "পেট্রোল",
...
// Seed implements the Seeder interface for Chery Tiggo 7
func (cts *CheryTiggo7Seeder) Seed(db *gorm.DB) error {
	productSlug := "chery-tiggo-7"
	...
	log.Printf("✅ Chery Tiggo 7 specifications seeded successfully")
	return nil
}
