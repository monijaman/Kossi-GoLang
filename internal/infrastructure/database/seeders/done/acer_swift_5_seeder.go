...
// AcerSwift5Seeder seeds specifications for Acer Swift 5
type AcerSwift5Seeder struct {
	BaseSeeder
}

// NewAcerSwift5Seeder creates a new Acer Swift 5 seeder
func NewAcerSwift5Seeder() *AcerSwift5Seeder {
	return &AcerSwift5Seeder{
		BaseSeeder: BaseSeeder{name: "Acer Swift 5 Specifications"},
	}
}

func (ass *AcerSwift5Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"317 x 218.9 x 15.9 mm":                "৩১৭ x ২১৮.৯ x ১৫.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"12":                                   "১২",
		"16":                                   "১৬",
...
// Seed implements the Seeder interface for Acer Swift 5
func (ass *AcerSwift5Seeder) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "317 x 218.9 x 15.9 mm",
		"Body Type":               "Aluminum",
