...
// AcerPredatorHelios18Seeder seeds specifications for Acer Predator Helios 18
type AcerPredatorHelios18Seeder struct {
	BaseSeeder
}

// NewAcerPredatorHelios18Seeder creates a new Acer Predator Helios 18 seeder
func NewAcerPredatorHelios18Seeder() *AcerPredatorHelios18Seeder {
	return &AcerPredatorHelios18Seeder{
		BaseSeeder: BaseSeeder{name: "Acer Predator Helios 18 Specifications"},
	}
}

func (aphs *AcerPredatorHelios18Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Acer":                          "এসার",
		"Predator Helios 18":            "প্রেডেটর হেলিওস ১৮",
		"Windows 11 Home":               "উইন্ডোজ ১১ হোম",
		"Intel":                         "ইন্টেল",
		"Core i9-13900HX":               "কোর আই৯-১৩৯০০এইচএক্স",
		...
		"2.2 GHz base / 5.4 GHz boost":         "২.২ গিগাহার্টজ বেস / ৫.৪ গিগাহার্টজ বুস্ট",
		"36 MB cache":                          "৩৬ এমবি ক্যাশ",
		"1080p FHD":                            "১০৮০পি এফএইচডি",
		"Acer TrueHarmony":                     "এসার ট্রু হারমোনি",
		"428 x 299 x 32.2 mm":                  "৪২৮ x ২৯৯ x ৩২.২ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"24":                                   "২৪",
		"32":                                   "৩২",
		...
		"Yes (M.2 slots)":                      "হ্যাঁ (এম.২ স্লট)",
		"12 GB GDDR6":                          "১২ জিবি জিডিডিআর৬",
		"English/Bangla":                       "ইংরেজি/বাংলা",
		"HDMI 2.1":                             "এইচডিএমআই ২.১",
		"3x USB 3.2 Gen 2, 1x USB-C 3.2 Gen 2": "৩x ইউএসবি ৩.২ জেন ২, ১x ইউএসবি-সি ৩.২ জেন ২",
		"Thunderbolt 4":                        "থান্ডারবোল্ট ৪",
		"Ethernet (RJ-45)":                     "ইথারনেট (আরজে-৪৫)",
	}
}

// Seed implements the Seeder interface for Acer Predator Helios 18
func (aphs *AcerPredatorHelios18Seeder) Seed(db *gorm.DB) error {
	productSlug := "acer-predator-helios-18"
	...
	specs := map[string]string{
		"Brand":                "Acer",
		"Model Name":           "Predator Helios 18",
		"Operating System":     "Windows 11 Home",
		"Processor Brand":      "Intel",
		"Processor Model":      "Core i9-13900HX",
		...
		"Touchscreen": "No",
		"HDMI Ports":  "HDMI 2.1",
		"USB Ports":   "3x USB 3.2 Gen 2, 1x USB-C 3.2 Gen 2",
	}
	...
	for key, value := range specs {
		...
		if banglaValue, exists := aphs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Acer Predator Helios 18 specifications seeded successfully")
	return nil
}
