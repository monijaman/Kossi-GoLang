...
func (s *SpecificationSeederMobileSamsungGalaxyS22Ultra) getBanglaTranslations() map[string]string {
	...
	specific := map[string]string{
		...
		"Dynamic AMOLED 2X, 120Hz, HDR10+":      "ডায়নামিক অ্যামোলেড ২এক্স, ১২০ হার্জ, এইচডিআর১০+",
		"1440 x 3088 pixels":                    "১৪৪০ × ৩০৮৮ পিক্সেল",
		"6.8 inches":                            "৬.৮ ইঞ্চি",
		"108 MP + 10 MP + 10 MP + 12 MP":        "১০৮ এমপি + ১০ এমপি + ১০ এমপি + ১২ এমপি",
		"40 MP":                                 "৪০ এমপি",
		"Phantom Black, White, Burgundy, Green": "ফ্যান্টম ব্ল্যাক, হোয়াইট, বার্গান্ডি, গ্রিন",
		"163.3 x 77.9 x 8.9 mm":                 "১৬৩.৩ × ৭৭.৯ × ৮.৯ মিলিমিটার",
		"228 g":                                 "২২৮ গ্রাম",
		...
		"128GB 8GB RAM, 256GB 8GB RAM, 512GB 12GB RAM, 1TB 12GB RAM": "১২৮জিবি ৮জিবি র্যাম, ২৫৬জিবি ৮জিবি র্যাম, ৫১২জিবি ১২জিবি র্যাম, ১টিবি ১২জিবি র্যাম",
		"No":        "না",
		"Available": "উপলব্ধ",
		"108 MP, f/1.8, 23mm (wide), 1/1.33\", 0.8µm, PDAF, Laser AF, OIS\n10 MP, f/4.9, 230mm (periscope telephoto), 1/3.52\", 1.12µm, Dual Pixel PDAF, OIS, 10x optical zoom\n10 MP, f/2.4, 70mm (telephoto), 1/3.52\", 1.12µm, Dual Pixel PDAF, OIS, 3x optical zoom\n12 MP, f/2.2, 13mm, 120˚ (ultrawide), 1/2.55\", 1.4µm, Dual Pixel PDAF, Super Steady video": "১০৮ এমপি, এফ/১.৮, ২৩মিমি (ওয়াইড), ১/১.৩৩\", ০.৮মাইক্রোমিটার, পিডিএএফ, লেজার এএফ, ওআইএস\n১০ এমপি, এফ/৪.৯, ২৩০মিমি (পেরিস্কোপ টেলিফোটো), ১/৩.৫২\", ১.১২মাইক্রোমিটার, ডুয়াল পিক্সেল পিডিএএফ, ওআইএস, ১০এক্স অপটিক্যাল জুম\n১০ এমপি, এফ/২.৪, ৭০মিমি (টেলিফোটো), ১/৩.৫২\", ১.১২মাইক্রোমিটার, ডুয়াল পিক্সেল পিডিএএফ, ওআইএস, ৩এক্স অপটিক্যাল জুম\n১২ এমপি, এফ/২.২, ১৩মিমি, ১২০ডিগ্রি (আল্ট্রাওয়াইড), ১/২.৫৫\", ১.৪মাইক্রোমিটার, ডুয়াল পিক্সেল পিডিএএফ, সুপার স্টেডি ভিডিও",
	}
...
func (s *SpecificationSeederMobileSamsungGalaxyS22Ultra) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"internal_memory_capacity": "128GB 8GB RAM, 256GB 8GB RAM, 512GB 12GB RAM, 1TB 12GB RAM",
		"card_slot_type":           "No",
		"quad_camera_setup":        "108 MP, f/1.8, 23mm (wide), 1/1.33\", 0.8µm, PDAF, Laser AF, OIS\n10 MP, f/4.9, 230mm (periscope telephoto), 1/3.52\", 1.12µm, Dual Pixel PDAF, OIS, 10x optical zoom\n10 MP, f/2.4, 70mm (telephoto), 1/3.52\", 1.12µm, Dual Pixel PDAF, OIS, 3x optical zoom\n12 MP, f/2.2, 13mm, 120˚ (ultrawide), 1/2.55\", 1.4µm, Dual Pixel PDAF, Super Steady video",
	}
