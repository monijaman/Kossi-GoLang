...
// AcerPredatorHeliosNeo16Seeder seeds specifications for Acer Predator Helios Neo 16
type AcerPredatorHeliosNeo16Seeder struct {
	BaseSeeder
}

// NewAcerPredatorHeliosNeo16Seeder creates a new Acer Predator Helios Neo 16 seeder
func NewAcerPredatorHeliosNeo16Seeder() *AcerPredatorHeliosNeo16Seeder {
	return &AcerPredatorHeliosNeo16Seeder{
		BaseSeeder: BaseSeeder{name: "Acer Predator Helios Neo 16 Specifications"},
	}
}

func (aphns *AcerPredatorHeliosNeo16Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Acer":                          "এসার",
		"Predator Helios Neo 16":        "প্রেডেটর হেলিওস নিও ১৬",
		"Windows 11 Home":               "উইন্ডোজ ১১ হোম",
		"AMD":                           "এএমডি",
		"Ryzen 7 7735HS":                "রাইজেন ৭ ৭৭৩৫এইচএস",
		"7000 Series":                   "৭০০০ সিরিজ",
		...
		"Entry Gaming":                         "এন্ট্রি গেমিং",
		"Lithium-ion":                          "লিথিয়াম-আয়ন",
		"180W AC Adapter":                      "১৮০ওয়াট এসি অ্যাডাপ্টার",
		"5-7 hours":                            "৫-৭ ঘন্টা",
		...
		"374 x 248 x 23.9 mm":                  "৩৭৪ x ২৪৮ x ২৩.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"8":                                    "৮",
		"16":                                   "১৬",
...
// Seed implements the Seeder interface for Acer Predator Helios Neo 16
func (aphns *AcerPredatorHeliosNeo16Seeder) Seed(db *gorm.DB) error {
	productSlug := "acer-predator-helios-neo-16"
	...
	specs := map[string]string{
		"Brand":                "Acer",
		"Model Name":           "Predator Helios Neo 16",
		...
		"Laptop Type":             "Entry Gaming",
		"Battery Type":            "Lithium-ion",
		"Charging Speed":          "180W AC Adapter",
		...
		"Sensors":                 "No",
		"Dimensions":              "374 x 248 x 23.9 mm",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := aphns.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Acer Predator Helios Neo 16 specifications seeded successfully")
	return nil
}
