...
// OneNetbookOneGx1ProSeeder seeds specifications for One-Netbook OneGx1 Pro
type OneNetbookOneGx1ProSeeder struct {
	BaseSeeder
}

// NewOneNetbookOneGx1ProSeeder creates a new One-Netbook OneGx1 Pro seeder
func NewOneNetbookOneGx1ProSeeder() *OneNetbookOneGx1ProSeeder {
	return &OneNetbookOneGx1ProSeeder{
		BaseSeeder: BaseSeeder{name: "One-Netbook OneGx1 Pro Specifications"},
	}
}

func (oons *OneNetbookOneGx1ProSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"One-Netbook":                            "ওয়ান-নেটবুক",
		"OneGx1 Pro":                             "ওয়ানজিএক্স১ প্রো",
		"Windows 11 Home":                        "উইন্ডোজ ১১ হোম",
		"AMD":                                    "এএমডি",
		"Ryzen 7 6800U":                          "রাইজেন ৭ ৬৮০০ইউ",
		"Zen 3+":                                 "জেন ৩+",
		"AMD Integrated":                         "এএমডি ইন্টিগ্রেটেড",
		"AMD Radeon 680M":                        "এএমডি রেডিয়ন ৬৮০এম",
		...
		"Built-in Speakers":                      "বিল্ট-ইন স্পিকার্স",
		"200 x 128 x 8 mm":                       "২০০ x ১২৮ x ৮ মিমি",
		"TPM 2.0":                                "টিপিএম ২.০",
		"8.4":                                    "৮.৪",
		"8":                                      "৮",
		...
		"1x USB-C 3.2 Gen 1, 1x USB-C 3.2 Gen 2": "১x ইউএসবি-সি ৩.২ জেন ১, ১x ইউএসবি-সি ৩.২ জেন ২",
	}
}

// Seed implements the Seeder interface for One-Netbook OneGx1 Pro
func (oons *OneNetbookOneGx1ProSeeder) Seed(db *gorm.DB) error {
	productSlug := "onenetbook-onegx1-pro"
	...
	specs := map[string]string{
		...
		"Touchscreen":             "Yes",
		"HDMI Ports":              "HDMI 2.0",
		"USB Ports":               "1x USB-C 3.2 Gen 1, 1x USB-C 3.2 Gen 2",
	}
	...
	for key, value := range specs {
		...
		if banglaValue, exists := oons.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ One-Netbook OneGx1 Pro specifications seeded successfully")
	return nil
}
