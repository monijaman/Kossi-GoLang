...
// HpPavilion14Seeder seeds specifications for HP Pavilion 14
type HpPavilion14Seeder struct {
	BaseSeeder
}

// NewHpPavilion14Seeder creates a new HP Pavilion 14 seeder
func NewHpPavilion14Seeder() *HpPavilion14Seeder {
	return &HpPavilion14Seeder{
		BaseSeeder: BaseSeeder{name: "HP Pavilion 14 Specifications"},
	}
}

func (hps *HpPavilion14Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"Pavilion 14":                   "প্যাভিলিয়ন ১৪",
		...
		"313 x 225 x 17.5 mm":            "৩১৩ x ২২৫ x ১৭.৫ মিমি",
		"TPM 2.0":                        "টিপিএম ২.০",
		"10":                             "১০",
		"12":                             "১২",
...
// Seed implements the Seeder interface for HP Pavilion 14
func (hps *HpPavilion14Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-pavilion-14"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "313 x 225 x 17.5 mm",
		"Body Type":               "Plastic",
	...
	log.Printf("✅ HP Pavilion 14 specifications seeded successfully")
	return nil
}
