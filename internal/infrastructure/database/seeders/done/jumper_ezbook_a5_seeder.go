...
// JumperEzbookA5Seeder seeds specifications for Jumper EZbook A5
type JumperEzbookA5Seeder struct {
	BaseSeeder
}

// NewJumperEzbookA5Seeder creates a new Jumper EZbook A5 seeder
func NewJumperEzbookA5Seeder() *JumperEzbookA5Seeder {
	return &JumperEzbookA5Seeder{
		BaseSeeder: BaseSeeder{name: "Jumper EZbook A5 Specifications"},
	}
}

func (jea *JumperEzbookA5Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Jumper EZbook A5
func (jea *JumperEzbookA5Seeder) Seed(db *gorm.DB) error {
	productSlug := "jumper-ezbook-a5"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := jea.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Jumper EZbook A5 specifications seeded successfully")
	return nil
}
