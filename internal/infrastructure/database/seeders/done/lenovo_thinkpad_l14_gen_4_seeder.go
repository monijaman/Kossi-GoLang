...
// LenovoThinkpadL14Gen4Seeder seeds specifications for Lenovo ThinkPad L14 Gen 4
type LenovoThinkpadL14Gen4Seeder struct {
	BaseSeeder
}

// NewLenovoThinkpadL14Gen4Seeder creates a new Lenovo ThinkPad L14 Gen 4 seeder
func NewLenovoThinkpadL14Gen4Seeder() *LenovoThinkpadL14Gen4Seeder {
	return &LenovoThinkpadL14Gen4Seeder{
		BaseSeeder: BaseSeeder{name: "Lenovo ThinkPad L14 Gen 4 Specifications"},
	}
}

func (lts *LenovoThinkpadL14Gen4Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Lenovo":                        "লেনোভো",
		"ThinkPad L14 Gen 4":            "থিঙ্কপ্যাড এল১৪ জেন ৪",
		"Windows 11 Pro":                "উইন্ডোজ ১১ প্রো",
		"Intel":                         "ইন্টেল",
		"Core i5-1335U":                 "কোর আই৫-১৩৩৫ইউ",
		...
		"1.3 GHz base / 4.6 GHz boost":         "১.৩ গিগাহার্টজ বেস / ৪.৬ গিগাহার্টজ বুস্ট",
		"12 MB cache":                          "১২ এমবি ক্যাশ",
		"720p HD":                              "৭২০পি এইচডি",
		"Stereo Speakers":                      "স্টেরিও স্পিকার",
		"319 x 217 x 17.9 mm":                  "৩১৯ x ২১৭ x ১৭.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"10":                                   "১০",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for Lenovo ThinkPad L14 Gen 4
func (lts *LenovoThinkpadL14Gen4Seeder) Seed(db *gorm.DB) error {
	productSlug := "lenovo-thinkpad-l14-gen-4"
	...
	log.Printf("✅ Lenovo ThinkPad L14 Gen 4 specifications seeded successfully")
	return nil
}
