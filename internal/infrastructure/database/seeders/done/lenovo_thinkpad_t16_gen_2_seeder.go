...
// LenovoThinkpadT16Gen2Seeder seeds specifications for Lenovo ThinkPad T16 Gen 2
type LenovoThinkpadT16Gen2Seeder struct {
	BaseSeeder
}

// NewLenovoThinkpadT16Gen2Seeder creates a new Lenovo ThinkPad T16 Gen 2 seeder
func NewLenovoThinkpadT16Gen2Seeder() *LenovoThinkpadT16Gen2Seeder {
	return &LenovoThinkpadT16Gen2Seeder{
		BaseSeeder: BaseSeeder{name: "Lenovo ThinkPad T16 Gen 2 Specifications"},
	}
}

func (lts *LenovoThinkpadT16Gen2Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Lenovo":                        "লেনোভো",
		"ThinkPad T16 Gen 2":            "থিঙ্কপ্যাড টি১৬ জেন ২",
		...
		"365 x 250 x 19.2 mm":                  "৩৬৫ x ২৫০ x ১৯.২ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"12":                                   "১২",
		"16":                                   "১৬",
...
// Seed implements the Seeder interface for Lenovo ThinkPad T16 Gen 2
func (lts *LenovoThinkpadT16Gen2Seeder) Seed(db *gorm.DB) error {
	productSlug := "lenovo-thinkpad-t16-gen-2"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "365 x 250 x 19.2 mm",
		"Body Type":               "Aluminum",
	...
	log.Printf("✅ Lenovo ThinkPad T16 Gen 2 specifications seeded successfully")
	return nil
}
