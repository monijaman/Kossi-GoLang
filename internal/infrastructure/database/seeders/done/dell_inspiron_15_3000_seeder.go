...
// DellInspiron153000Seeder seeds specifications for Dell Inspiron 15 3000
type DellInspiron153000Seeder struct {
	BaseSeeder
}

// NewDellInspiron153000Seeder creates a new Dell Inspiron 15 3000 seeder
func NewDellInspiron153000Seeder() *DellInspiron153000Seeder {
	return &DellInspiron153000Seeder{
		BaseSeeder: BaseSeeder{name: "Dell Inspiron 15 3000 Specifications"},
	}
}

func (dis *DellInspiron153000Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Dell":                          "ডেল",
		"Inspiron 15 3000":              "ইন্সপিরন ১৫ ৩০০০",
...
// Seed implements the Seeder interface for Dell Inspiron 15 3000
func (dis *DellInspiron153000Seeder) Seed(db *gorm.DB) error {
	productSlug := "dell-inspiron-15-3000"
	...
	log.Printf("✅ Dell Inspiron 15 3000 specifications seeded successfully")
	return nil
}
