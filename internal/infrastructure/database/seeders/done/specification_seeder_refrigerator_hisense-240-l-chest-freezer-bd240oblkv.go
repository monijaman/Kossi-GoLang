...
// SpecificationSeederRefrigeratorHisense240LChestFreezerBd240oblkv seeds specifications/options for product 'hisense-240-l-chest-freezer-bd240oblkv'
type SpecificationSeederRefrigeratorHisense240LChestFreezerBd240oblkv struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorHisense240LChestFreezerBd240oblkv creates a new seeder instance
func NewSpecificationSeederRefrigeratorHisense240LChestFreezerBd240oblkv() *SpecificationSeederRefrigeratorHisense240LChestFreezerBd240oblkv {
	return &SpecificationSeederRefrigeratorHisense240LChestFreezerBd240oblkv{
		BaseSeeder: BaseSeeder{name: "Specifications for hisense-240-l-chest-freezer-bd240oblkv"},
	}
}

func (s *SpecificationSeederRefrigeratorHisense240LChestFreezerBd240oblkv) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Hisense":                        "হাইসেন্স",
		"240 L Chest Freezer BD240OBLKV": "240 L Chest Freezer BD240OBLKV",
		"China":                          "চীন",
...
// Seed inserts specification records for the product identified by slug 'hisense-240-l-chest-freezer-bd240oblkv'
func (s *SpecificationSeederRefrigeratorHisense240LChestFreezerBd240oblkv) Seed(db *gorm.DB) error {
	productSlug := "hisense-240-l-chest-freezer-bd240oblkv"
	...
	specs := map[string]string{
		"Brand":                           "Hisense",
		"Model Name":                      "240 L Chest Freezer BD240OBLKV",
		"Origin":                          "China",
		"Type":                            "Chest Freezer",
