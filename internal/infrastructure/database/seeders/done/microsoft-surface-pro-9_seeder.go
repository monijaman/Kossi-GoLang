...
// MicrosoftSurfacePro9Seeder seeds specifications for Microsoft Surface Pro 9
type MicrosoftSurfacePro9Seeder struct {
	BaseSeeder
}

// NewMicrosoftSurfacePro9Seeder creates a new Microsoft Surface Pro 9 seeder
func NewMicrosoftSurfacePro9Seeder() *MicrosoftSurfacePro9Seeder {
	return &MicrosoftSurfacePro9Seeder{
		BaseSeeder: BaseSeeder{name: "Microsoft Surface Pro 9 Specifications"},
	}
}

func (msps *MicrosoftSurfacePro9Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Microsoft":                              "মাইক্রোসফ্ট",
		"Surface Pro 9":                          "সারফেস প্রো ৯",
		...
		"2880 x 1920 pixels":                     "২৮৮০ x ১৯২০ পিক্সেল",
		"13 inches":                              "১৩ ইঞ্চি",
		"47.7 Wh":                                "৪৭.৭ ডব্লিউএইচ",
		...
		"287 x 208 x 9.4 mm":                     "২৮৭ x ২০৮ x ৯.৪ মিমি",
		"TPM 2.0":                                "টিপিএম ২.০",
		"10":                                     "১০",
		"12":                                     "১২",
...
// Seed implements the Seeder interface for Microsoft Surface Pro 9
func (msps *MicrosoftSurfacePro9Seeder) Seed(db *gorm.DB) error {
	productSlug := "microsoft-surface-pro-9"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := msps.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Microsoft Surface Pro 9 specifications seeded successfully")
	return nil
}
