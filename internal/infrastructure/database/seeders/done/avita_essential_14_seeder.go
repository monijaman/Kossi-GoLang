...
// AvitaEssential14Seeder seeds specifications for Avita Essential 14
type AvitaEssential14Seeder struct {
	BaseSeeder
}

// NewAvitaEssential14Seeder creates a new Avita Essential 14 seeder
func NewAvitaEssential14Seeder() *AvitaEssential14Seeder {
	return &AvitaEssential14Seeder{
		BaseSeeder: BaseSeeder{name: "Avita Essential 14 Specifications"},
	}
}

func (aes *AvitaEssential14Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Avita":                        "অ্যাভিটা",
		"Essential 14":                 "এসেনশিয়াল ১৪",
		...
		"330 x 225 x 19 mm":            "৩৩০ x ২২৫ x ১৯ মিমি",
		"2":                            "২",
		...
		"1x USB 2.0":                   "১x ইউএসবি ২.০",
	}
}

// Seed implements the Seeder interface for Avita Essential 14
func (aes *AvitaEssential14Seeder) Seed(db *gorm.DB) error {
	productSlug := "avita-essential-14"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := aes.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Avita Essential 14 specifications seeded successfully")
	return nil
}
