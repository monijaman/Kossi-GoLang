...
// RangeRoverEvoqueSeeder seeds specifications for Range Rover Evoque
type RangeRoverEvoqueSeeder struct {
	BaseSeeder
}

// NewRangeRoverEvoqueSeeder creates a new Range Rover Evoque seeder
func NewRangeRoverEvoqueSeeder() *RangeRoverEvoqueSeeder {
	return &RangeRoverEvoqueSeeder{
		BaseSeeder: BaseSeeder{name: "Range Rover Evoque Specifications"},
	}
}

func (rres *RangeRoverEvoqueSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"2011":                         "২০১১",
		"SUV":                          "এসইউভি",
		"Fuji White":                   "ফুজি হোয়াইট",
		"Inline":                       "ইনলাইন",
		"1999":                         "১৯৯৯ সিসি",
		"4":                            "৪ (সিলিন্ডার)",
		"240 hp":                       "২৪০ হর্স পাওয়ার",
		"240 hp @ 5500 rpm":            "৫৫০০ আরপিএম এ ২৪০ হর্স পাওয়ার",
		"340 Nm @ 1750-4000 rpm":       "১৭৫০-৪০০০ আরপিএম এ ৩৪০ এনএম",
		"Petrol":                       "পেট্রোল",
		"Turbocharged":                 "টার্বোচার্জড",
		"7.6 seconds":                  "৭.৬ সেকেন্ড",
		"217 km/h":                     "২১৭ কিমি/ঘণ্টা",
		"12 km/L":                      "১২ কিমি/লিটার",
		"16 km/L":                      "১৬ কিমি/লিটার",
		"14 km/L":                      "১৪ কিমি/লিটার",
		"Automatic (Transmission)":     "অটোমেটিক (ট্রান্সমিশন)",
		"9-Speed Automatic":            "৯-স্পিড অটোমেটিক",
...
// Seed implements the Seeder interface for Range Rover Evoque
func (rres *RangeRoverEvoqueSeeder) Seed(db *gorm.DB) error {
	productSlug := "range-rover-evoque"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "143 hp/ton",
		...
		"Power Steering":                 "Yes",
		"Touchscreen":                    "Yes",
		"Suspension Type":                "MacPherson Strut / Integral Link",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := rres.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Range Rover Evoque specifications seeded successfully")
	return nil
}
