...
// HonorMagicbook15Seeder seeds specifications for Honor MagicBook 15
type HonorMagicbook15Seeder struct {
	BaseSeeder
}

// NewHonorMagicbook15Seeder creates a new Honor MagicBook 15 seeder
func NewHonorMagicbook15Seeder() *HonorMagicbook15Seeder {
	return &HonorMagicbook15Seeder{
		BaseSeeder: BaseSeeder{name: "Honor MagicBook 15 Specifications"},
	}
}

func (hms *HonorMagicbook15Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Honor":                                "অনার",
		"MagicBook 15":                         "ম্যাজিকবুক ১৫",
		...
		"357.8 x 229.8 x 16.8 mm":              "৩৫৭.৮ x ২২৯.৮ x ১৬.৮ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"6":                                    "৬",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for Honor MagicBook 15
func (hms *HonorMagicbook15Seeder) Seed(db *gorm.DB) error {
	productSlug := "honor-magicbook-15"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "357.8 x 229.8 x 16.8 mm",
		"Body Type":               "Plastic",
	...
	log.Printf("✅ Honor MagicBook 15 specifications seeded successfully")
	return nil
}
