...
// AppleMacbookPro14M3ProSeeder seeds specifications for Apple MacBook Pro 14-inch M3 Pro
type AppleMacbookPro14M3ProSeeder struct {
	BaseSeeder
}

// NewAppleMacbookPro14M3ProSeeder creates a new Apple MacBook Pro 14-inch M3 Pro seeder
func NewAppleMacbookPro14M3ProSeeder() *AppleMacbookPro14M3ProSeeder {
	return &AppleMacbookPro14M3ProSeeder{
		BaseSeeder: BaseSeeder{name: "Apple MacBook Pro 14-inch M3 Pro Specifications"},
	}
}

func (amas *AppleMacbookPro14M3ProSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Apple":                         "অ্যাপল",
		"MacBook Pro 14-inch M3 Pro":    "ম্যাকবুক প্রো ১৪-ইঞ্চি এম৩ প্রো",
		"macOS Sonoma":                  "ম্যাকওএস সোনোমা",
		"M3 Pro":                        "এম৩ প্রো",
		"Apple M3 Pro GPU":              "অ্যাপল এম৩ প্রো জিপিইউ",
		"3024 x 1964 pixels":            "৩০২৪ x ১৯৬৪ পিক্সেল",
		"14.2 inches":                   "১৪.২ ইঞ্চি",
		"70 Wh":                         "৭০ ডব্লিউএইচ",
		...
		"11-core CPU, 14-core GPU":        "১১-কোর সিপিইউ, ১৪-কোর জিপিইউ",
		...
		"12.31 x 8.46 x 0.61 inches":      "১২.৩১ x ৮.৪৬ x ০.৬১ ইঞ্চি",
...
// Seed implements the Seeder interface for Apple MacBook Pro 14-inch M3 Pro
func (amas *AppleMacbookPro14M3ProSeeder) Seed(db *gorm.DB) error {
	productSlug := "apple-macbook-pro-14-inch-m3-pro"
	...
	specs := map[string]string{
		"Brand":                "Apple",
		"Model Name":           "MacBook Pro 14-inch M3 Pro",
		...
		"Screen Resolution":    "3024 x 1964 pixels",
	...
	log.Printf("✅ Apple MacBook Pro 14-inch M3 Pro specifications seeded successfully")
	return nil
}
