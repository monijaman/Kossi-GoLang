...
// MercedesBenzVClassSeeder seeds specifications for Mercedes-Benz V-Class
type MercedesBenzVClassSeeder struct {
	BaseSeeder
}

// NewMercedesBenzVClassSeeder creates a new Mercedes-Benz V-Class seeder
func NewMercedesBenzVClassSeeder() *MercedesBenzVClassSeeder {
	return &MercedesBenzVClassSeeder{
		BaseSeeder: BaseSeeder{name: "Mercedes-Benz V-Class Specifications"},
	}
}

func (mbvcs *MercedesBenzVClassSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"V 250":                   "ভি ২৫০",
		"3rd Generation (W447)":   "৩য় প্রজন্ম (ডব্লিউ৪৪৭)",
		"MPV":                     "এমপিভি",
		"2014":                    "২০১৪",
		"Inline-4":                "ইনলাইন-৪",
		"2143":                    "২১৪৩ সিসি",
...
// Seed implements the Seeder interface for Mercedes-Benz V-Class
func (mbvcs *MercedesBenzVClassSeeder) Seed(db *gorm.DB) error {
	productSlug := "mercedes-benz-v-class"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := mbvcs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Mercedes-Benz V-Class specifications seeded successfully")
	return nil
}
