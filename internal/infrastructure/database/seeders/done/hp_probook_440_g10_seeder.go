...
// HpProbook440G10Seeder seeds specifications for HP ProBook 440 G10
type HpProbook440G10Seeder struct {
	BaseSeeder
}

// NewHpProbook440G10Seeder creates a new HP ProBook 440 G10 seeder
func NewHpProbook440G10Seeder() *HpProbook440G10Seeder {
	return &HpProbook440G10Seeder{
		BaseSeeder: BaseSeeder{name: "HP ProBook 440 G10 Specifications"},
	}
}

func (hps *HpProbook440G10Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"ProBook 440 G10":               "প্রোবুক ৪৪০ জি১০",
		...
		"323 x 214 x 19.9 mm":            "৩২৩ x ২১৪ x ১৯.৯ মিমি",
		"TPM 2.0":                        "টিপিএম ২.০",
		"10":                             "১০",
		"12":                             "১২",
...
// Seed implements the Seeder interface for HP ProBook 440 G10
func (hps *HpProbook440G10Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-probook-440-g10"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "323 x 214 x 19.9 mm",
		"Body Type":               "Plastic",
	...
	log.Printf("✅ HP ProBook 440 G10 specifications seeded successfully")
	return nil
}
