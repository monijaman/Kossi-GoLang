...
// LenovoIdeapadFlex5Seeder seeds specifications for Lenovo IdeaPad Flex 5
type LenovoIdeapadFlex5Seeder struct {
	BaseSeeder
}

// NewLenovoIdeapadFlex5Seeder creates a new Lenovo IdeaPad Flex 5 seeder
func NewLenovoIdeapadFlex5Seeder() *LenovoIdeapadFlex5Seeder {
	return &LenovoIdeapadFlex5Seeder{
		BaseSeeder: BaseSeeder{name: "Lenovo IdeaPad Flex 5 Specifications"},
	}
}

func (lif *LenovoIdeapadFlex5Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Lenovo":                        "লেনোভো",
		"IdeaPad Flex 5":                "আইডিয়াপ্যাড ফ্লেক্স ৫",
		...
		"297 x 210 x 16.9 mm":                  "২৯৭ x ২১০ x ১৬.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"6":                                    "৬",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for Lenovo IdeaPad Flex 5
func (lif *LenovoIdeapadFlex5Seeder) Seed(db *gorm.DB) error {
	productSlug := "lenovo-ideapad-flex-5"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "297 x 210 x 16.9 mm",
		"Body Type":               "Aluminum",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := lif.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Lenovo IdeaPad Flex 5 specifications seeded successfully")
	return nil
}
