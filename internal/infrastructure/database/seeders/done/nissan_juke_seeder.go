...
// NissanJukeSeeder seeds specifications for Nissan Juke
type NissanJukeSeeder struct {
	BaseSeeder
}

// NewNissanJukeSeeder creates a new Nissan Juke seeder
func NewNissanJukeSeeder() *NissanJukeSeeder {
	return &NissanJukeSeeder{
		BaseSeeder: BaseSeeder{name: "Nissan Juke Specifications"},
	}
}

func (njs *NissanJukeSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Juke 1.6":                 "জুক ১.৬",
		"2nd Generation (F16)":     "২য় প্রজন্ম (এফ১৬)",
		"Subcompact Crossover SUV": "সাবকমপ্যাক্ট ক্রসওভার এসইউভি",
		"2019":                     "২০১৯",
		"Inline-4":                 "ইনলাইন-৪",
		"1618":                     "১৬১৮ সিসি",
...
// Seed implements the Seeder interface for Nissan Juke
func (njs *NissanJukeSeeder) Seed(db *gorm.DB) error {
	productSlug := "nissan-juke"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := njs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Nissan Juke specifications seeded successfully")
	return nil
}
