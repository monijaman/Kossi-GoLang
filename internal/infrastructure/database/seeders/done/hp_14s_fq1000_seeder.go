...
// Hp14sFq1000Seeder seeds specifications for HP 14s-fq1000
type Hp14sFq1000Seeder struct {
	BaseSeeder
}

// NewHp14sFq1000Seeder creates a new HP 14s-fq1000 seeder
func NewHp14sFq1000Seeder() *Hp14sFq1000Seeder {
	return &Hp14sFq1000Seeder{
		BaseSeeder: BaseSeeder{name: "HP 14s-fq1000 Specifications"},
	}
}

func (hfs *Hp14sFq1000Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"14s-fq1000":                    "১৪এস-এফকিউ১০০০",
...
// Seed implements the Seeder interface for HP 14s-fq1000
func (hfs *Hp14sFq1000Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-14s-fq1000"
	...
	log.Printf("✅ HP 14s-fq1000 specifications seeded successfully")
	return nil
}
