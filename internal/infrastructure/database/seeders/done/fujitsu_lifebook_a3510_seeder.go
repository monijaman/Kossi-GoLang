...
// FujitsuLifeBookA3510Seeder seeds specifications for Fujitsu LifeBook A3510
type FujitsuLifeBookA3510Seeder struct {
	BaseSeeder
}

// NewFujitsuLifeBookA3510Seeder creates a new Fujitsu LifeBook A3510 seeder
func NewFujitsuLifeBookA3510Seeder() *FujitsuLifeBookA3510Seeder {
	return &FujitsuLifeBookA3510Seeder{
		BaseSeeder: BaseSeeder{name: "Fujitsu LifeBook A3510 Specifications"},
	}
}

func (flas *FujitsuLifeBookA3510Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Fujitsu":                       "ফুজিতসু",
		"LifeBook A3510":                "লাইফবুক এ৩৫১০",
...
// Seed implements the Seeder interface for Fujitsu LifeBook A3510
func (flas *FujitsuLifeBookA3510Seeder) Seed(db *gorm.DB) error {
	productSlug := "fujitsu-lifebook-a3510"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := flas.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Fujitsu LifeBook A3510 specifications seeded successfully")
	return nil
}
