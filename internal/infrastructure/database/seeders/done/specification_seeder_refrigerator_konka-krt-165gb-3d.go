...
// SpecificationSeederRefrigeratorKonkaKrt165gb3d seeds specifications/options for product 'konka-krt-165gb-3d'
type SpecificationSeederRefrigeratorKonkaKrt165gb3d struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorKonkaKrt165gb3d creates a new seeder instance
func NewSpecificationSeederRefrigeratorKonkaKrt165gb3d() *SpecificationSeederRefrigeratorKonkaKrt165gb3d {
	return &SpecificationSeederRefrigeratorKonkaKrt165gb3d{
		BaseSeeder: BaseSeeder{name: "Specifications for konka-krt-165gb-3d"},
	}
}

func (s *SpecificationSeederRefrigeratorKonkaKrt165gb3d) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Konka": "কনকা",
		"KRT-165GB-3D Green Nilumbo Upper Freezer (165 Ltr)": "KRT-165GB-3D Green Nilumbo Upper Freezer (165 Ltr)",
		"China":              "চীন",
		...
		"165 Ltr.":      "১৬৫ Ltr.",
		"Green Nilumbo": "গ্রিন নিলুম্বো",
		"BSTI 5 Star":   "BSTI ৫ স্টার",
		"Large Moist Fresh Zone with humidity control": "বড় আর্দ্র তাজা জোন হিউমিডিটি কন্ট্রোল সহ",
	}
}

// Seed inserts specification records for the product identified by slug 'konka-krt-165gb-3d'
func (s *SpecificationSeederRefrigeratorKonkaKrt165gb3d) Seed(db *gorm.DB) error {
	productSlug := "konka-krt-165gb-3d"
	...
	specs := map[string]string{
		"Brand":                           "Konka",
		"Model Name":                      "KRT-165GB-3D Green Nilumbo Upper Freezer (165 Ltr)",
		"Origin":                          "China",
		"Type":                            "Top Mount",
