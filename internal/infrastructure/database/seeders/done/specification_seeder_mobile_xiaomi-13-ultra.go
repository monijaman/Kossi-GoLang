...
func (s *SpecificationSeederMobileXiaomi13Ultra) getBanglaTranslations() map[string]string {
	specific := map[string]string{
		...
		"Black, Olive Green, White":     "ব্ল্যাক, অলিভ গ্রিন, হোয়াইট",
		...
		"Glass front, eco leather back, aluminum frame": "গ্লাস ফ্রন্ট, ইকো লেদার ব্যাক, অ্যালুমিনিয়াম ফ্রেম",
		"IP68":                   "আইপি৬৮",
		"32 MP":                  "৩২ এমপি",
		"5,000 mAh":              "৫,০০০ এমএএইচ",
		"256 GB / 512 GB / 1 TB": "২৫৬ জিবি / ৫১২ জিবি / ১ টিবি",
		"LTPO AMOLED, 120Hz, Dolby Vision, HDR10+, 2600 nits": "এলটিপিও অ্যামোলেড, ১২০হার্টজ, ডলবি ভিশন, এইচডিআর১০+, ২৬০০ নিটস",
...
func (s *SpecificationSeederMobileXiaomi13Ultra) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"quad_camera_setup":             "50MP (wide, f/1.9) + 50MP (periscope telephoto 5x, f/2.5) + 50MP (telephoto 3.2x, f/2.0) + 50MP (ultrawide, f/2.2)",
