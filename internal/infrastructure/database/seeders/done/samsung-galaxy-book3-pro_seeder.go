...
// SamsungGalaxyBook3ProSeeder seeds specifications for Samsung Galaxy Book3 Pro
type SamsungGalaxyBook3ProSeeder struct {
	BaseSeeder
}

// NewSamsungGalaxyBook3ProSeeder creates a new Samsung Galaxy Book3 Pro seeder
func NewSamsungGalaxyBook3ProSeeder() *SamsungGalaxyBook3ProSeeder {
	return &SamsungGalaxyBook3ProSeeder{
		BaseSeeder: BaseSeeder{name: "Samsung Galaxy Book3 Pro Specifications"},
	}
}

func (sgbps *SamsungGalaxyBook3ProSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Samsung":                              "স্যামসাং",
		"Galaxy Book3 Pro":                     "গ্যালাক্সি বুক৩ প্রো",
		...
		"312 x 223 x 11.5 mm":                  "৩১২ x ২২৩ x ১১.৫ মিমি",
...
// Seed implements the Seeder interface for Samsung Galaxy Book3 Pro
func (sgbps *SamsungGalaxyBook3ProSeeder) Seed(db *gorm.DB) error {
	productSlug := "samsung-galaxy-book3-pro"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "312 x 223 x 11.5 mm",
		"Body Type":               "Premium",
	...
	log.Printf("✅ Samsung Galaxy Book3 Pro specifications seeded successfully")
	return nil
}
