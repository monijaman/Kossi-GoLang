...
func (s *SpecificationSeederMobileSamsungGalaxyS24FE) getBanglaTranslations() map[string]string {
	...
	specific := map[string]string{
		"Exynos 2400e":                       "এক্সিনস ২৪০০ই",
		"Xclipse 940":                        "এক্সক্লিপস ৯৪০",
		"Deca-core":                          "ডেকা-কোর",
		"Exynos 2400e (4 nm)":                "এক্সিনস ২৪০০ই (৪ ন্যানোমিটার)",
		...
		"10 MP":                              "১০ এমপি",
		"Blue, Graphite, Gray, Mint, Yellow": "ব্লু, গ্রাফাইট, গ্রে, মিন্ট, ইয়েলো",
		"162 x 77.3 x 8 mm":                  "১৬২ × ৭৭.৩ × ৮ মিমি",
		"213 g":                              "২১৩ গ্রাম",
		"4,700 mAh":                          "৪,৭০০ মিলিঅ্যাম্পিয়ার আওয়ার",
