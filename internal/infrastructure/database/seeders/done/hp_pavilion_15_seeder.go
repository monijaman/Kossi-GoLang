...
// HpPavilion15Seeder seeds specifications for HP Pavilion 15
type HpPavilion15Seeder struct {
	BaseSeeder
}

// NewHpPavilion15Seeder creates a new HP Pavilion 15 seeder
func NewHpPavilion15Seeder() *HpPavilion15Seeder {
	return &HpPavilion15Seeder{
		BaseSeeder: BaseSeeder{name: "HP Pavilion 15 Specifications"},
	}
}

func (hps *HpPavilion15Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"Pavilion 15":                   "প্যাভিলিয়ন ১৫",
...
// Seed implements the Seeder interface for HP Pavilion 15
func (hps *HpPavilion15Seeder) Seed(db *gorm.DB) error {
	...
	log.Printf("✅ HP Pavilion 15 specifications seeded successfully")
	return nil
}
