...
// SpecificationSeederRefrigeratorMarcelMfcC4hGdehDdInverter seeds specifications/options for product 'mfc-c4h-gdeh-dd-inverter'
...
func NewSpecificationSeederRefrigeratorMarcelMfcC4hGdehDdInverter() *SpecificationSeederRefrigeratorMarcelMfcC4hGdehDdInverter {
	return &SpecificationSeederRefrigeratorMarcelMfcC4hGdehDdInverter{
		BaseSeeder: BaseSeeder{name: "Specifications for mfc-c4h-gdeh-dd-inverter"},
	}
}
...
func (s *SpecificationSeederRefrigeratorMarcelMfcC4hGdehDdInverter) Seed(db *gorm.DB) error {
	productSlug := "mfc-c4h-gdeh-dd-inverter"
	...
	specs := map[string]string{
		...
		"Compressor Input Power (Watt)":         "33.78~126.46",
		...
		"Lock":                                  "Yes",
		"Net Volume":                            "333 Ltr.",
		"Operating voltage":                     "85-285V~ (Wide Voltage Design)",
