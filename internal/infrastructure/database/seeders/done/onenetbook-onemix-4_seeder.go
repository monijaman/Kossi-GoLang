...
// OneNetbookOneMix4Seeder seeds specifications for One-Netbook OneMix 4
type OneNetbookOneMix4Seeder struct {
	BaseSeeder
}

// NewOneNetbookOneMix4Seeder creates a new One-Netbook OneMix 4 seeder
func NewOneNetbookOneMix4Seeder() *OneNetbookOneMix4Seeder {
	return &OneNetbookOneMix4Seeder{
		BaseSeeder: BaseSeeder{name: "One-Netbook OneMix 4 Specifications"},
	}
}

func (oons *OneNetbookOneMix4Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"One-Netbook":                            "ওয়ান-নেটবুক",
		"OneMix 4":                               "ওয়ানমিক্স ৪",
...
// Seed implements the Seeder interface for One-Netbook OneMix 4
func (oons *OneNetbookOneMix4Seeder) Seed(db *gorm.DB) error {
	productSlug := "onenetbook-onemix-4"
	...
	log.Printf("✅ One-Netbook OneMix 4 specifications seeded successfully")
	return nil
}
