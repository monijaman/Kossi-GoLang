...
// SpecificationSeederRefrigeratorMarcelMfcC0gGdxxXx seeds specifications/options for product 'marcel-mfc-c0g-gdxx-xx'
type SpecificationSeederRefrigeratorMarcelMfcC0gGdxxXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfcC0gGdxxXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfcC0gGdxxXx() *SpecificationSeederRefrigeratorMarcelMfcC0gGdxxXx {
	return &SpecificationSeederRefrigeratorMarcelMfcC0gGdxxXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfc-c0g-gdxx-xx"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfcC0gGdxxXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":         "মার্সেল",
				"marcel-mfc-c0g-gdxx-xx":         "মার্সেল-mfc-c0g-gdxx-xx",
		"MFC-C0G-GDXX-XX":   "MFC-C0G-GDXX-XX",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfc-c0g-gdxx-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfcC0gGdxxXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfc-c0g-gdxx-xx"
	...
	specs := map[string]string{
		...
		"Height (mm)": "1600",
		"Interior Lamp": "Yes",
		"Loading Capacity (40HQ/40Ft/20Ft)": "24/ 48/ 69",
		"Lock": "Yes",
		"Net Volume": "301 Ltr",
