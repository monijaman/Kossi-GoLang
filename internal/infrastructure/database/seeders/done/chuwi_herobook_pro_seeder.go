...
// ChuwiHeroBookProSeeder seeds specifications for Chuwi HeroBook Pro
type ChuwiHeroBookProSeeder struct {
	BaseSeeder
}

// NewChuwiHeroBookProSeeder creates a new Chuwi HeroBook Pro seeder
func NewChuwiHeroBookProSeeder() *ChuwiHeroBookProSeeder {
	return &ChuwiHeroBookProSeeder{
		BaseSeeder: BaseSeeder{name: "Chuwi HeroBook Pro Specifications"},
	}
}

func (chs *ChuwiHeroBookProSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Chuwi":                        "চুউই",
		"HeroBook Pro":                 "হিরোবুক প্রো",
		...
		"300 x 200 x 15 mm":            "৩০০ x ২০০ x ১৫ মিমি",
		"TPM 2.0":                      "টিপিএম ২.০",
		"6":                            "৬",
		"12":                           "১২",
...
// Seed implements the Seeder interface for Chuwi HeroBook Pro
func (chs *ChuwiHeroBookProSeeder) Seed(db *gorm.DB) error {
	productSlug := "chuwi-herobook-pro"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := chs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Chuwi HeroBook Pro specifications seeded successfully")
	return nil
}
