...
// Hp15sFq5000Seeder seeds specifications for HP 15s-fq5000
type Hp15sFq5000Seeder struct {
	BaseSeeder
}

// NewHp15sFq5000Seeder creates a new HP 15s-fq5000 seeder
func NewHp15sFq5000Seeder() *Hp15sFq5000Seeder {
	return &Hp15sFq5000Seeder{
		BaseSeeder: BaseSeeder{name: "HP 15s-fq5000 Specifications"},
	}
}

func (hfs *Hp15sFq5000Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"15s-fq5000":                    "১৫এস-এফকিউ৫০০০",
...
// Seed implements the Seeder interface for HP 15s-fq5000
func (hfs *Hp15sFq5000Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-15s-fq5000"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := hfs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ HP 15s-fq5000 specifications seeded successfully")
	return nil
}
