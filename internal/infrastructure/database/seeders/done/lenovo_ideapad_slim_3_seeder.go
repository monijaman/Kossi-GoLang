...
// LenovoIdeapadSlim3Seeder seeds specifications for Lenovo IdeaPad Slim 3
type LenovoIdeapadSlim3Seeder struct {
	BaseSeeder
}

// NewLenovoIdeapadSlim3Seeder creates a new Lenovo IdeaPad Slim 3 seeder
func NewLenovoIdeapadSlim3Seeder() *LenovoIdeapadSlim3Seeder {
	return &LenovoIdeapadSlim3Seeder{
		BaseSeeder: BaseSeeder{name: "Lenovo IdeaPad Slim 3 Specifications"},
	}
}

func (lis *LenovoIdeapadSlim3Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Lenovo":                        "লেনোভো",
		"IdeaPad Slim 3":                "আইডিয়াপ্যাড স্লিম ৩",
		...
		"6-8 hours":                            "৬-৮ ঘন্টা",
		"IPS, 220 nits":                        "আইপিএস, ২২০ নিটস",
		"1.2 GHz base / 4.4 GHz boost":         "১.২ গিগাহার্টজ বেস / ৪.৪ গিগাহার্টজ বুস্ট",
		"8 MB cache":                           "৮ এমবি ক্যাশ",
		"720p HD":                              "৭২০পি এইচডি",
		"Stereo Speakers":                      "স্টেরিও স্পিকার",
		"358 x 235 x 19.9 mm":                  "৩৫৮ x ২৩৫ x ১৯.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"6":                                    "৬",
		"8":                                    "৮",
...
// Seed implements the Seeder interface for Lenovo IdeaPad Slim 3
func (lis *LenovoIdeapadSlim3Seeder) Seed(db *gorm.DB) error {
	productSlug := "lenovo-ideapad-slim-3"
	...
	specs := map[string]string{
		...
		"Display Characteristics": "IPS, 220 nits",
		"Processor Speed":         "1.2 GHz base / 4.4 GHz boost",
		"Clock Feature":           "8 MB cache",
		"3.5mm Audio Jack":        "Yes",
		"Camera Features":         "720p HD",
		"Audio Quality":           "Stereo Speakers",
		"Sensors":                 "No",
		"Dimensions":              "358 x 235 x 19.9 mm",
		"Body Type":               "Plastic",
	...
	log.Printf("✅ Lenovo IdeaPad Slim 3 specifications seeded successfully")
	return nil
}
