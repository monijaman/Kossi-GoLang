...
// HpProbook450G10Seeder seeds specifications for HP ProBook 450 G10
type HpProbook450G10Seeder struct {
	BaseSeeder
}

// NewHpProbook450G10Seeder creates a new HP ProBook 450 G10 seeder
func NewHpProbook450G10Seeder() *HpProbook450G10Seeder {
	return &HpProbook450G10Seeder{
		BaseSeeder: BaseSeeder{name: "HP ProBook 450 G10 Specifications"},
	}
}

func (hps *HpProbook450G10Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"ProBook 450 G10":               "প্রোবুক ৪৫০ জি১০",
...
// Seed implements the Seeder interface for HP ProBook 450 G10
func (hps *HpProbook450G10Seeder) Seed(db *gorm.DB) error {
	...
	log.Printf("✅ HP ProBook 450 G10 specifications seeded successfully")
	return nil
}
