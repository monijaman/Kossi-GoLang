...
// HpElitebook1040G10Seeder seeds specifications for HP EliteBook 1040 G10
type HpElitebook1040G10Seeder struct {
	BaseSeeder
}

// NewHpElitebook1040G10Seeder creates a new HP EliteBook 1040 G10 seeder
func NewHpElitebook1040G10Seeder() *HpElitebook1040G10Seeder {
	return &HpElitebook1040G10Seeder{
		BaseSeeder: BaseSeeder{name: "HP EliteBook 1040 G10 Specifications"},
	}
}

func (hebs *HpElitebook1040G10Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"EliteBook 1040 G10":            "এলিটবুক ১০৪০ জি১০",
		...
		"313 x 227 x 16.9 mm":          "৩১৩ x ২২৭ x ১৬.৯ মিমি",
		"TPM 2.0":                      "টিপিএম ২.০",
		"10":                           "১০",
		"12":                           "১২",
...
// Seed implements the Seeder interface for HP EliteBook 1040 G10
func (hebs *HpElitebook1040G10Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-elitebook-1040-g10"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "313 x 227 x 16.9 mm",
		"Body Type":               "Aluminum",
	...
	log.Printf("✅ HP EliteBook 1040 G10 specifications seeded successfully")
	return nil
}
