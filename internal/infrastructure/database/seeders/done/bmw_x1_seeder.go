...
// BmwX1Seeder seeds specifications for BMW X1
type BmwX1Seeder struct {
	BaseSeeder
}

// NewBmwX1Seeder creates a new BMW X1 seeder
func NewBmwX1Seeder() *BmwX1Seeder {
	return &BmwX1Seeder{
		BaseSeeder: BaseSeeder{name: "BMW X1 Specifications"},
	}
}

func (bx1s *BmwX1Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"1998":                         "১৯৯৮ সিসি",
		"4":                            "৪ (সিলিন্ডার)",
		"192 hp":                       "১৯২ হর্স পাওয়ার",
		"192 hp @ 5000 rpm":            "৫০০০ আরপিএম এ ১৯২ হর্স পাওয়ার",
		"280 Nm @ 1350-4600 rpm":       "১৩৫০-৪৬০০ আরপিএম এ ২৮০ এনএম",
		"Petrol":                       "পেট্রোল",
...
// Seed implements the Seeder interface for BMW X1
func (bx1s *BmwX1Seeder) Seed(db *gorm.DB) error {
	productSlug := "bmw-x1"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "126 hp/ton",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := bx1s.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ BMW X1 specifications seeded successfully")
	return nil
}
