...
// SpecificationSeederRefrigeratorSingerFBDS225ZBG seeds specifications/options for product 'singer-fbds225zbg'
type SpecificationSeederRefrigeratorSingerFBDS225ZBG struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFBDS225ZBG creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFBDS225ZBG() *SpecificationSeederRefrigeratorSingerFBDS225ZBG {
	return &SpecificationSeederRefrigeratorSingerFBDS225ZBG{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-fbds225zbg"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFBDS225ZBG) getBanglaTranslations() map[string]string {
...
func (s *SpecificationSeederRefrigeratorSingerFBDS225ZBG) Seed(db *gorm.DB) error {
