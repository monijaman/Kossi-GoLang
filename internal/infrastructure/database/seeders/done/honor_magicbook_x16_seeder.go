...
// HonorMagicbookX16Seeder seeds specifications for Honor MagicBook X16
type HonorMagicbookX16Seeder struct {
	BaseSeeder
}

// NewHonorMagicbookX16Seeder creates a new Honor MagicBook X16 seeder
func NewHonorMagicbookX16Seeder() *HonorMagicbookX16Seeder {
	return &HonorMagicbookX16Seeder{
		BaseSeeder: BaseSeeder{name: "Honor MagicBook X16 Specifications"},
	}
}

func (hms *HonorMagicbookX16Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Honor":                                "অনার",
		"MagicBook X16":                        "ম্যাজিকবুক এক্স১৬",
...
// Seed implements the Seeder interface for Honor MagicBook X16
func (hms *HonorMagicbookX16Seeder) Seed(db *gorm.DB) error {
	productSlug := "honor-magicbook-x16"
	...
	log.Printf("✅ Honor MagicBook X16 specifications seeded successfully")
	return nil
}
