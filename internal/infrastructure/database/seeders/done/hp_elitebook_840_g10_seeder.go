...
// HpElitebook840G10Seeder seeds specifications for HP EliteBook 840 G10
type HpElitebook840G10Seeder struct {
	BaseSeeder
}

// NewHpElitebook840G10Seeder creates a new HP EliteBook 840 G10 seeder
func NewHpElitebook840G10Seeder() *HpElitebook840G10Seeder {
	return &HpElitebook840G10Seeder{
		BaseSeeder: BaseSeeder{name: "HP EliteBook 840 G10 Specifications"},
	}
}

func (hes *HpElitebook840G10Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"EliteBook 840 G10":             "এলাইটবুক ৮৪০ জি১০",
		...
		"2x USB 3.2 Gen 1, 1x USB-C 3.2": "২x ইউএসবি ৩.২ জেন ১, ১x ইউএসবি-সি ৩.২",
	}
}

// Seed implements the Seeder interface for HP EliteBook 840 G10
func (hes *HpElitebook840G10Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-elitebook-840-g10"
	...
	specs := map[string]string{
		...
		"Touchscreen": "No",
		"HDMI Ports":  "HDMI 2.0",
		"USB Ports":   "2x USB 3.2 Gen 1, 1x USB-C 3.2",
	}
	...
	log.Printf("✅ HP EliteBook 840 G10 specifications seeded successfully")
	return nil
}
