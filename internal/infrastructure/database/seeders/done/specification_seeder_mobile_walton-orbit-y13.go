...
func (s *SpecificationSeederMobileWaltonOrbitY13) getBanglaTranslations() map[string]string {
	specific := map[string]string{
		...
		"ORBIT Y13 (3GB RAM + 32GB)":         "অরবিট ওয়াই১৩ (৩জিবি র্যাম + ৩২জিবি)",
...
// Seed inserts specification records for the product identified by slug 'walton-orbit-y13'
func (s *SpecificationSeederMobileWaltonOrbitY13) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"model_variants":                "ORBIT Y13 (3GB RAM + 32GB)",
