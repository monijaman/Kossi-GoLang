...
// KiaCarnivalSeeder seeds specifications for Kia Carnival
type KiaCarnivalSeeder struct {
	BaseSeeder
}

// NewKiaCarnivalSeeder creates a new Kia Carnival seeder
func NewKiaCarnivalSeeder() *KiaCarnivalSeeder {
	return &KiaCarnivalSeeder{
		BaseSeeder: BaseSeeder{name: "Kia Carnival Specifications"},
	}
}

func (kcs *KiaCarnivalSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"2022":                         "২০২২",
		"MPV":                          "এমপিভি",
		"Aurora Black Pearl":           "অরোরা ব্ল্যাক পার্ল",
		"Inline":                       "ইনলাইন",
		"2151":                         "২১৫১ সিসি",
		"4":                            "৪ (সিলিন্ডার)",
		"202 hp":                       "২০২ হর্স পাওয়ার",
		"202 hp @ 3800 rpm":            "৩৮০০ আরপিএম এ ২০২ হর্স পাওয়ার",
		"441 Nm @ 1750-2750 rpm":       "১৭৫০-২৭৫০ আরপিএম এ ৪৪১ এনএম",
		"Diesel":                       "ডিজেল",
		"Turbocharged":                 "টার্বোচার্জড",
		"CRDi":                         "সিআরডিআই",
		"10.3 seconds":                 "১০.৩ সেকেন্ড",
...
// Seed implements the Seeder interface for Kia Carnival
func (kcs *KiaCarnivalSeeder) Seed(db *gorm.DB) error {
	productSlug := "kia-carnival"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "97 hp/ton",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := kcs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Kia Carnival specifications seeded successfully")
	return nil
}
