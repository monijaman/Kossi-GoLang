...
// MechervoZ3ProSeeder seeds specifications for Mechrevo Z3 Pro
type MechervoZ3ProSeeder struct {
	BaseSeeder
}

// NewMechervoZ3ProSeeder creates a new Mechrevo Z3 Pro seeder
func NewMechervoZ3ProSeeder() *MechervoZ3ProSeeder {
	return &MechervoZ3ProSeeder{
		BaseSeeder: BaseSeeder{name: "Mechrevo Z3 Pro Specifications"},
	}
}

func (mzs *MechervoZ3ProSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Mechrevo":                      "মেচরেভো",
		"Z3 Pro":                        "জেড৩ প্রো",
		"Windows 11 Home":               "উইন্ডোজ ১১ হোম",
		"AMD":                           "এএমডি",
		"Ryzen 7 7840H":                 "রাইজেন ৭ ৭৮৪০এইচ",
		"Zen 4":                         "জেন ৪",
		...
		"3.8 GHz base / 5.1 GHz boost":  "৩.৮ গিগাহার্টজ বেস / ৫.১ গিগাহার্টজ বুস্ট",
		"16 MB cache":                   "১৬ এমবি ক্যাশ",
		"1080p FHD":                     "১০৮০পি এফএইচডি",
		"Stereo Speakers":               "স্টেরিও স্পিকার",
		"360 x 240 x 22 mm":             "৩৬০ x ২৪০ x ২২ মিমি",
		"TPM 2.0":                       "টিপিএম ২.০",
		"8":                             "৮",
		"16":                            "১৬",
...
// Seed implements the Seeder interface for Mechrevo Z3 Pro
func (mzs *MechervoZ3ProSeeder) Seed(db *gorm.DB) error {
	productSlug := "mechrevo-z3-pro"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := mzs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Mechrevo Z3 Pro specifications seeded successfully")
	return nil
}
