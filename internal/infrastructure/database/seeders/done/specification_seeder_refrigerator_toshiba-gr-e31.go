...
// SpecificationSeederRefrigeratorToshibaGrE31 seeds specifications/options for product 'toshiba-gr-e31'
type SpecificationSeederRefrigeratorToshibaGrE31 struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorToshibaGrE31 creates a new seeder instance
func NewSpecificationSeederRefrigeratorToshibaGrE31() *SpecificationSeederRefrigeratorToshibaGrE31 {
	return &SpecificationSeederRefrigeratorToshibaGrE31{
		BaseSeeder: BaseSeeder{name: "Specifications for toshiba-gr-e31"},
	}
}

func (s *SpecificationSeederRefrigeratorToshibaGrE31) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'toshiba-gr-e31'
func (s *SpecificationSeederRefrigeratorToshibaGrE31) Seed(db *gorm.DB) error {
	productSlug := "toshiba-gr-e31"
