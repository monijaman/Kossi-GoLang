...
// GigabyteAorus17XSeeder seeds specifications for Gigabyte Aorus 17X
type GigabyteAorus17XSeeder struct {
	BaseSeeder
}

// NewGigabyteAorus17XSeeder creates a new Gigabyte Aorus 17X seeder
func NewGigabyteAorus17XSeeder() *GigabyteAorus17XSeeder {
	return &GigabyteAorus17XSeeder{
		BaseSeeder: BaseSeeder{name: "Gigabyte Aorus 17X Specifications"},
	}
}

func (gas *GigabyteAorus17XSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Gigabyte":                      "গিগাবাইট",
		"Aorus 17X":                     "অরাস ১৭এক্স",
		...
		"395 x 282 x 27 mm":                    "৩৯৫ x ২৮২ x ২৭ মিমি",
...
// Seed implements the Seeder interface for Gigabyte Aorus 17X
func (gas *GigabyteAorus17XSeeder) Seed(db *gorm.DB) error {
	productSlug := "gigabyte-aorus-17x"
	...
	log.Printf("✅ Gigabyte Aorus 17X specifications seeded successfully")
	return nil
}
