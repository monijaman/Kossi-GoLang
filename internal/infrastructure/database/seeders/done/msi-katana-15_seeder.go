...
// MsiKatana15Seeder seeds specifications for MSI Katana 15
type MsiKatana15Seeder struct {
	BaseSeeder
}

// NewMsiKatana15Seeder creates a new MSI Katana 15 seeder
func NewMsiKatana15Seeder() *MsiKatana15Seeder {
	return &MsiKatana15Seeder{
		BaseSeeder: BaseSeeder{name: "MSI Katana 15 Specifications"},
	}
}

func (mks *MsiKatana15Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for MSI Katana 15
func (mks *MsiKatana15Seeder) Seed(db *gorm.DB) error {
	productSlug := "msi-katana-15"
	...
	log.Printf("✅ MSI Katana 15 specifications seeded successfully")
	return nil
}
