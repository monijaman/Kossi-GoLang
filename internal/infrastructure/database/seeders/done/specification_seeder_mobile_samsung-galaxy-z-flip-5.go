...
func (s *SpecificationSeederMobileSamsungGalaxyZFlip5) getBanglaTranslations() map[string]string {
	...
	specific := map[string]string{
		...
		"120Hz":                                  "১২০হার্টজ",
		"3700 mAh":                               "৩৭০০ মিলিঅ্যাম্পিয়ার আওয়ার",
		...
		"187 g":                                  "১৮৭ গ্রাম",
		"Unfolded: 165.1 x 71.9 x 6.9 mm / Folded: 85.1 x 71.9 x 15.1 mm": "আনফোল্ডেড: ১৬৫.১ × ৭১.৯ × ৬.৯ মিমি / ফোল্ডেড: ৮৫.১ × ৭১.৯ × ১৫.১ মিমি",
		"Mint, Graphite, Cream, Lavender, Gray, Blue, Green, Yellow":      "মিন্ট, গ্রাফাইট, ক্রিম, ল্যাভেন্ডার, গ্রে, ব্লু, গ্রিন, ইয়েলো",
		"Foldable Dynamic AMOLED 2X, 120Hz, HDR10+":                       "ফোল্ডেবল ডায়নামিক অ্যামোলেড ২এক্স, ১২০হার্টজ, এইচডিআর১০+",
		"Available": "উপলব্ধ",
		"Octa-core": "অক্টা-কোর",
		"Plastic front (open), glass back (Gorilla Glass Victus 2), aluminum frame": "প্লাস্টিক ফ্রন্ট (ওপেন), গ্লাস ব্যাক (গরিলা গ্লাস ভিক্টাস ২), অ্যালুমিনিয়াম ফ্রেম",
		"256 GB / 512 GB": "২৫৬ জিবি / ৫১২ জিবি",
		"3,700 mAh":       "৩,৭০০ মিলিঅ্যাম্পিয়ার আওয়ার",
