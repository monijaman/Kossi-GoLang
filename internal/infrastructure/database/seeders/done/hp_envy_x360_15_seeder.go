...
// HpEnvyX36015Seeder seeds specifications for HP Envy x360 15
type HpEnvyX36015Seeder struct {
	BaseSeeder
}

// NewHpEnvyX36015Seeder creates a new HP Envy x360 15 seeder
func NewHpEnvyX36015Seeder() *HpEnvyX36015Seeder {
	return &HpEnvyX36015Seeder{
		BaseSeeder: BaseSeeder{name: "HP Envy x360 15 Specifications"},
	}
}

func (hes *HpEnvyX36015Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"Envy x360 15":                  "এনভি এক্স৩৬০ ১৫",
		...
		"Nightfall Black":               "নাইটফল ব্ল্যাক",
		"1.8 kg":                        "১.৮ কেজি",
		"2024":                          "২০২৪",
		...
		"357.9 x 229.2 x 17.9 mm":              "৩৫৭.৯ x ২২৯.২ x ১৭.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"10":                                   "১০",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for HP Envy x360 15
func (hes *HpEnvyX36015Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-envy-x360-15"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "357.9 x 229.2 x 17.9 mm",
		"Body Type":               "Aluminum",
		"Cooling System":          "Single Fan",
		"Available Colors":        "Nightfall Black",
	...
	log.Printf("✅ HP Envy x360 15 specifications seeded successfully")
	return nil
}
