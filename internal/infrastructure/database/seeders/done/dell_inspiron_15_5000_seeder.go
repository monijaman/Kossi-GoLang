...
// DellInspiron155000Seeder seeds specifications for Dell Inspiron 15 5000
type DellInspiron155000Seeder struct {
	BaseSeeder
}

// NewDellInspiron155000Seeder creates a new Dell Inspiron 15 5000 seeder
func NewDellInspiron155000Seeder() *DellInspiron155000Seeder {
	return &DellInspiron155000Seeder{
		BaseSeeder: BaseSeeder{name: "Dell Inspiron 15 5000 Specifications"},
	}
}

func (dis *DellInspiron155000Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Dell":                          "ডেল",
		"Inspiron 15 5000":              "ইন্সপিরন ১৫ ৫০০০",
		...
		"358.5 x 235.6 x 18.9 mm":              "৩৫৮.৫ x ২৩৫.৬ x ১৮.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"10":                                   "১০",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for Dell Inspiron 15 5000
func (dis *DellInspiron155000Seeder) Seed(db *gorm.DB) error {
	productSlug := "dell-inspiron-15-5000"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := dis.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Dell Inspiron 15 5000 specifications seeded successfully")
	return nil
}
