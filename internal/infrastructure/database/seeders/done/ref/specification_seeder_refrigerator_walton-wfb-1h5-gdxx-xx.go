...
// SpecificationSeederRefrigeratorWaltonWfb1h5GdxxXx seeds specifications/options for product 'walton-wfb-1h5-gdxx-xx'
type SpecificationSeederRefrigeratorWaltonWfb1h5GdxxXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorWaltonWfb1h5GdxxXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorWaltonWfb1h5GdxxXx() *SpecificationSeederRefrigeratorWaltonWfb1h5GdxxXx {
	return &SpecificationSeederRefrigeratorWaltonWfb1h5GdxxXx{
		BaseSeeder: BaseSeeder{name: "Specifications for walton-wfb-1h5-gdxx-xx"},
	}
}

func (s *SpecificationSeederRefrigeratorWaltonWfb1h5GdxxXx) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'walton-wfb-1h5-gdxx-xx'
func (s *SpecificationSeederRefrigeratorWaltonWfb1h5GdxxXx) Seed(db *gorm.DB) error {
	productSlug := "walton-wfb-1h5-gdxx-xx"
	...
	specs := map[string]string{
		"Brand":                       "Walton",
		"Model Name":                  "WFB-1H5-GDXX-XX",
		"Door Type":                   "Single Door",
		"Capacity":                    "207 Liters",
		"Refrigerator Capacity":       "193 Liters",
