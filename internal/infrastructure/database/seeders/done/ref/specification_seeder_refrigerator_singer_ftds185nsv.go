...
// SpecificationSeederRefrigeratorSingerFTDS185NSV seeds specifications/options for product 'singer-ftds185nsv'
type SpecificationSeederRefrigeratorSingerFTDS185NSV struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS185NSV creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS185NSV() *SpecificationSeederRefrigeratorSingerFTDS185NSV {
	return &SpecificationSeederRefrigeratorSingerFTDS185NSV{
		BaseSeeder{name: "Specifications for singer-ftds185nsv"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS185NSV) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                   "সিঙ্গার",
		"FTDS185NSV":               "FTDS185NSV",
...
// Seed inserts specification records for the product identified by slug 'singer-ftds185nsv'
func (s *SpecificationSeederRefrigeratorSingerFTDS185NSV) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds185nsv"
