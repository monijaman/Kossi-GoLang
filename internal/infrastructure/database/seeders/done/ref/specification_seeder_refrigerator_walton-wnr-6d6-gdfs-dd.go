...
func (s *SpecificationSeederRefrigeratorWaltonWnr6d6GdfsDd) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"646 Ltr":                       "৬৪৬ লিটার",
		"598 Ltr":                       "৫৯৮ লিটার",
		"372 Liters":                    "৩৭২ লিটার",
		"226 Liters":                    "২২৬ লিটার",
		"916 x 738 x 1832 mm":           "৯১৬ x ৭৩৮ x ১৮৩২ মিমি",
		"126 ± 2 Kg":                    "১২৬ ± ২ কেজি",
...
func (s *SpecificationSeederRefrigeratorWaltonWnr6d6GdfsDd) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		...
		"Capacity":                    "598 Liters",
		"Refrigerator Capacity":       "372 Liters",
		"Freezer Capacity":            "226 Liters",
		"Energy Efficiency Rating":    "5 Star",
		"Energy Star Rating":          "5",
		"Annual Energy Consumption":   "N/A",
		"Dimensions":                  "916 x 738 x 1832 mm",
		"Weight":                      "126 ± 2 Kg",
		"Color":                       "Silver",
