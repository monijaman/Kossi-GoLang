...
// SpecificationSeederRefrigeratorSingerFTDS230RG seeds specifications/options for product 'singer-ftds230-rg'
type SpecificationSeederRefrigeratorSingerFTDS230RG struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS230RG creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS230RG() *SpecificationSeederRefrigeratorSingerFTDS230RG {
	return &SpecificationSeederRefrigeratorSingerFTDS230RG{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds230-rg"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS230RG) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                   "সিঙ্গার",
		"SRREF-SS300-FTDS230-RG":   "SRREF-SS300-FTDS230-RG",
...
// Seed inserts specification records for the product identified by slug 'singer-ftds230-rg'
func (s *SpecificationSeederRefrigeratorSingerFTDS230RG) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds230-rg"
	...
	specs := map[string]string{
		"Brand":                       "Singer",
		"Model Name":                  "SRREF-SS300-FTDS230-RG",
