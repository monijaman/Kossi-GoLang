...
// HpChromebook11Seeder seeds specifications for HP Chromebook 11
type HpChromebook11Seeder struct {
	BaseSeeder
}

// NewHpChromebook11Seeder creates a new HP Chromebook 11 seeder
func NewHpChromebook11Seeder() *HpChromebook11Seeder {
	return &HpChromebook11Seeder{
		BaseSeeder: BaseSeeder{name: "HP Chromebook 11 Specifications"},
	}
}

func (hcs *HpChromebook11Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"Chromebook 11":                 "ক্রোমবুক ১১",
		"Chrome OS":                     "ক্রোম ওএস",
		"Intel":                         "ইন্টেল",
		...
		"295 x 200 x 18.2 mm":                  "২৯৫ x ২০০ x ১৮.২ মিমি",
		"TPM 1.2":                              "টিপিএম ১.২",
		"2":                                    "২",
		"LPDDR4":                               "এলপিডিডিআর৪",
		"eMMC":                                 "ইএমএমসি",
...
// Seed implements the Seeder interface for HP Chromebook 11
func (hcs *HpChromebook11Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-chromebook-11"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "295 x 200 x 18.2 mm",
		"Body Type":               "Plastic",
	...
	log.Printf("✅ HP Chromebook 11 specifications seeded successfully")
	return nil
}
