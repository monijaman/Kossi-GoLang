...
// SpecificationSeederRefrigeratorMarcelMfbB2cGdelXxInverter seeds specifications/options for product 'marcel-mfb-b2c-gdel-xx-inverter'
type SpecificationSeederRefrigeratorMarcelMfbB2cGdelXxInverter struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfbB2cGdelXxInverter creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfbB2cGdelXxInverter() *SpecificationSeederRefrigeratorMarcelMfbB2cGdelXxInverter {
	return &SpecificationSeederRefrigeratorMarcelMfbB2cGdelXxInverter{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfb-b2c-gdel-xx-inverter"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfbB2cGdelXxInverter) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":                          "মার্সেল",
		"marcel-mfb-b2c-gdel-xx-inverter": "মার্সেল-mfb-b2c-gdel-xx-inverter",
		"MFB-B2C-GDEL-XX-INVERTER":        "MFB-B2C-GDEL-XX-INVERTER",
...
func (s *SpecificationSeederRefrigeratorMarcelMfbB2cGdelXxInverter) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfb-b2c-gdel-xx-inverter"
