...
// LenovoLegionPro7iSeeder seeds specifications for Lenovo Legion Pro 7i
type LenovoLegionPro7iSeeder struct {
	BaseSeeder
}

// NewLenovoLegionPro7iSeeder creates a new Lenovo Legion Pro 7i seeder
func NewLenovoLegionPro7iSeeder() *LenovoLegionPro7iSeeder {
	return &LenovoLegionPro7iSeeder{
		BaseSeeder: BaseSeeder{name: "Lenovo Legion Pro 7i Specifications"},
	}
}

func (llp *LenovoLegionPro7iSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Lenovo":                        "লেনোভো",
		"Legion Pro 7i":                 "লেজিওন প্রো ৭আই",
...
// Seed implements the Seeder interface for Lenovo Legion Pro 7i
func (llp *LenovoLegionPro7iSeeder) Seed(db *gorm.DB) error {
	productSlug := "lenovo-legion-pro-7i"
	...
	log.Printf("✅ Lenovo Legion Pro 7i specifications seeded successfully")
	return nil
}
