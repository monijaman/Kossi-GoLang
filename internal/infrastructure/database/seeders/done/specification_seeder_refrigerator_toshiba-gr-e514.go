...
// SpecificationSeederRefrigeratorToshibaGrE514 seeds specifications/options for product 'toshiba-gr-e514'
type SpecificationSeederRefrigeratorToshibaGrE514 struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorToshibaGrE514 creates a new seeder instance
func NewSpecificationSeederRefrigeratorToshibaGrE514() *SpecificationSeederRefrigeratorToshibaGrE514 {
	return &SpecificationSeederRefrigeratorToshibaGrE514{
		BaseSeeder: BaseSeeder{name: "Specifications for toshiba-gr-e514"},
	}
}

func (s *SpecificationSeederRefrigeratorToshibaGrE514) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"50L":                   "৫০L",
		"Black":                 "কালো",
		"Direct Cooling":        "ডিরেক্ট কুলিং",
		"3 Star":                "৩ স্টার",
		"80W":                   "80W",
		"18kg":                  "18kg",
		"474 x 475 x 510 mm":    "474 x 475 x 510 mm",
		"Mini Bar Refrigerator": "মিনি বার রেফ্রিজারেটর",
		"GR-E514 (I)":           "GR-E514 (I)",
	}
}

// Seed inserts specification records for the product identified by slug 'toshiba-gr-e514'
func (s *SpecificationSeederRefrigeratorToshibaGrE514) Seed(db *gorm.DB) error {
	productSlug := "toshiba-gr-e514"
	...
	specs := map[string]string{
		"Brand":                           "Toshiba",
		"Model Name":                      "GR-E514 (I)",
		"Origin":                          "Japan",
		"Type":                            "Mini Bar Refrigerator",
		"Color":                           "Black",
		...
		"Shelf (Material/No.)":            "Tempered Glass/1",
		"Number of Shelves":               "1",
		"Door Basket":                     "Yes",
		...
		"Power Consumption (Watts)":       "80W",
		"Weight":                          "18kg",
		"Dimensions (mm)":                 "474 x 475 x 510 mm",
		"Warranty":                        "2 Years",
