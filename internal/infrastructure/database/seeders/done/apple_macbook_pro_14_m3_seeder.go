...
// AppleMacbookPro14M3Seeder seeds specifications for Apple MacBook Pro 14-inch M3
type AppleMacbookPro14M3Seeder struct {
	BaseSeeder
}

// NewAppleMacbookPro14M3Seeder creates a new Apple MacBook Pro 14-inch M3 seeder
func NewAppleMacbookPro14M3Seeder() *AppleMacbookPro14M3Seeder {
	return &AppleMacbookPro14M3Seeder{
		BaseSeeder: BaseSeeder{name: "Apple MacBook Pro 14-inch M3 Specifications"},
	}
}

func (amas *AppleMacbookPro14M3Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Apple":                         "অ্যাপল",
		"MacBook Pro 14-inch M3":        "ম্যাকবুক প্রো ১৪-ইঞ্চি এম৩",
...
// Seed implements the Seeder interface for Apple MacBook Pro 14-inch M3
func (amas *AppleMacbookPro14M3Seeder) Seed(db *gorm.DB) error {
	productSlug := "apple-macbook-pro-14-inch-m3"
	...
	specs := map[string]string{
		"Brand":                "Apple",
		"Model Name":           "MacBook Pro 14-inch M3",
	...
	log.Printf("✅ Apple MacBook Pro 14-inch M3 specifications seeded successfully")
	return nil
}
