...
// HpEnvy17Seeder seeds specifications for HP Envy 17
type HpEnvy17Seeder struct {
	BaseSeeder
}

// NewHpEnvy17Seeder creates a new HP Envy 17 seeder
func NewHpEnvy17Seeder() *HpEnvy17Seeder {
	return &HpEnvy17Seeder{
		BaseSeeder: BaseSeeder{name: "HP Envy 17 Specifications"},
	}
}

func (hes *HpEnvy17Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"397 x 262 x 19.9 mm":            "৩৯৭ x ২৬২ x ১৯.৯ মিমি",
		"TPM 2.0":                        "টিপিএম ২.০",
		"10":                             "১০",
		"12":                             "১২",
...
// Seed implements the Seeder interface for HP Envy 17
func (hes *HpEnvy17Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-envy-17"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "397 x 262 x 19.9 mm",
		"Body Type":               "Aluminum",
	...
	log.Printf("✅ HP Envy 17 specifications seeded successfully")
	return nil
}
