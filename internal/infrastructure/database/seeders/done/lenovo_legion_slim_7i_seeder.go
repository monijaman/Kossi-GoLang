...
// LenovoLegionSlim7iSeeder seeds specifications for Lenovo Legion Slim 7i
type LenovoLegionSlim7iSeeder struct {
	BaseSeeder
}

// NewLenovoLegionSlim7iSeeder creates a new Lenovo Legion Slim 7i seeder
func NewLenovoLegionSlim7iSeeder() *LenovoLegionSlim7iSeeder {
	return &LenovoLegionSlim7iSeeder{
		BaseSeeder: BaseSeeder{name: "Lenovo Legion Slim 7i Specifications"},
	}
}

func (lls *LenovoLegionSlim7iSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Lenovo":                        "লেনোভো",
		"Legion Slim 7i":                "লেজিওন স্লিম ৭আই",
		...
		"356 x 264 x 16 mm":                    "৩৫৬ x ২৬৪ x ১৬ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"14":                                   "১৪",
		"20":                                   "২০",
...
// Seed implements the Seeder interface for Lenovo Legion Slim 7i
func (lls *LenovoLegionSlim7iSeeder) Seed(db *gorm.DB) error {
	productSlug := "lenovo-legion-slim-7i"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := lls.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Lenovo Legion Slim 7i specifications seeded successfully")
	return nil
}
