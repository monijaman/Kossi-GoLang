...
// HpOmen17Seeder seeds specifications for HP Omen 17
type HpOmen17Seeder struct {
	BaseSeeder
}

// NewHpOmen17Seeder creates a new HP Omen 17 seeder
func NewHpOmen17Seeder() *HpOmen17Seeder {
	return &HpOmen17Seeder{
		BaseSeeder: BaseSeeder{name: "HP Omen 17 Specifications"},
	}
}

func (hos *HpOmen17Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"397 x 262 x 27.2 mm":            "৩৯৭ x ২৬২ x ২৭.২ মিমি",
		"TPM 2.0":                        "টিপিএম ২.০",
		"16":                             "১৬",
		"24":                             "২৪",
		...
		"3x USB 3.2 Gen 1, 1x USB-C 3.2": "৩x ইউএসবি ৩.২ জেন ১, ১x ইউএসবি-সি ৩.২",
	}
}

// Seed implements the Seeder interface for HP Omen 17
func (hos *HpOmen17Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-omen-17"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "397 x 262 x 27.2 mm",
		"Body Type":               "Plastic",
		...
		"Touchscreen": "No",
		"HDMI Ports":  "HDMI 2.1",
		"USB Ports":   "3x USB 3.2 Gen 1, 1x USB-C 3.2",
	}
	...
	log.Printf("✅ HP Omen 17 specifications seeded successfully")
	return nil
}
