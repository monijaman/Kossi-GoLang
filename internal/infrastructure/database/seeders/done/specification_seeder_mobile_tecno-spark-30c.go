...
func (s *SpecificationSeederMobileTecnoSPARK30C) getBanglaTranslations() map[string]string {
	...
	tecnoTranslations := map[string]string{
		...
		"165 x 76 x 8 mm":                      "১৬৫ × ৭৬ × ৮ মিমি",
		"IP54":                                 "আইপি৫৪",
		"Helio G81":                            "হেলিও জি৮১",
		"IPS LCD, 120Hz":                       "আইপিএস এলসিডি, ১২০ হার্জ",
		"Orbit Black, Orbit White, Magic Skin": "অরবিট ব্ল্যাক, অরবিট হোয়াইট, ম্যাজিক স্কিন",
		"September 2024":                       "সেপ্টেম্বর ২০২৪",
		"Mediatek Helio G81":                   "মিডিয়াটেক হেলিও জি৮১",
