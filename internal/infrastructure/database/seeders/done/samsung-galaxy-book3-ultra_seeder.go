...
// SamsungGalaxyBook3UltraSeeder seeds specifications for Samsung Galaxy Book3 Ultra
type SamsungGalaxyBook3UltraSeeder struct {
	BaseSeeder
}

// NewSamsungGalaxyBook3UltraSeeder creates a new Samsung Galaxy Book3 Ultra seeder
func NewSamsungGalaxyBook3UltraSeeder() *SamsungGalaxyBook3UltraSeeder {
	return &SamsungGalaxyBook3UltraSeeder{
		BaseSeeder: BaseSeeder{name: "Samsung Galaxy Book3 Ultra Specifications"},
	}
}

func (sgbus *SamsungGalaxyBook3UltraSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Samsung":                              "স্যামসাং",
		"Galaxy Book3 Ultra":                   "গ্যালাক্সি বুক৩ আল্ট্রা",
...
// Seed implements the Seeder interface for Samsung Galaxy Book3 Ultra
func (sgbus *SamsungGalaxyBook3UltraSeeder) Seed(db *gorm.DB) error {
	productSlug := "samsung-galaxy-book3-ultra"
	...
	log.Printf("✅ Samsung Galaxy Book3 Ultra specifications seeded successfully")
	return nil
}
