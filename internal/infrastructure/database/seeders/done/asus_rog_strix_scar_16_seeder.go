...
// AsusRogStrixScar16Seeder seeds specifications for Asus ROG Strix Scar 16
type AsusRogStrixScar16Seeder struct {
	BaseSeeder
}

// NewAsusRogStrixScar16Seeder creates a new Asus ROG Strix Scar 16 seeder
func NewAsusRogStrixScar16Seeder() *AsusRogStrixScar16Seeder {
	return &AsusRogStrixScar16Seeder{
		BaseSeeder: BaseSeeder{name: "Asus ROG Strix Scar 16 Specifications"},
	}
}

func (arz *AsusRogStrixScar16Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Asus":                                 "এসুস",
		"ROG Strix Scar 16":                    "আরওজি স্ট্রিক্স স্কার ১৬",
		...
		"354 x 264 x 27 mm":                    "৩৫৪ x ২৬৪ x ২৭ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"24":                                   "২৪",
		"32":                                   "৩২",
...
// Seed implements the Seeder interface for Asus ROG Strix Scar 16
func (arz *AsusRogStrixScar16Seeder) Seed(db *gorm.DB) error {
	productSlug := "asus-rog-strix-scar-16"
	...
	log.Printf("✅ Asus ROG Strix Scar 16 specifications seeded successfully")
	return nil
}
