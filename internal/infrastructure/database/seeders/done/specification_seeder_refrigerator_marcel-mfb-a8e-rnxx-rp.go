...
// SpecificationSeederRefrigeratorMarcelMfbA8eRnxxRp seeds specifications/options for product 'marcel-mfb-a8e-rnxx-rp'
type SpecificationSeederRefrigeratorMarcelMfbA8eRnxxRp struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfbA8eRnxxRp creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfbA8eRnxxRp() *SpecificationSeederRefrigeratorMarcelMfbA8eRnxxRp {
	return &SpecificationSeederRefrigeratorMarcelMfbA8eRnxxRp{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfb-a8e-rnxx-rp"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfbA8eRnxxRp) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":                 "মার্সেল",
		"marcel-mfb-a8e-rnxx-rp": "মার্সেল-mfb-a8e-rnxx-rp",
		"MFB-A8E-RNXX-RP":        "MFB-A8E-RNXX-RP",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfb-a8e-rnxx-rp'
func (s *SpecificationSeederRefrigeratorMarcelMfbA8eRnxxRp) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfb-a8e-rnxx-rp"
