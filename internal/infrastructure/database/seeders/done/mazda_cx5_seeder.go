...
// MazdaCx5Seeder seeds specifications for Mazda CX-5
type MazdaCx5Seeder struct {
	BaseSeeder
}

// NewMazdaCx5Seeder creates a new Mazda CX-5 seeder
func NewMazdaCx5Seeder() *MazdaCx5Seeder {
	return &MazdaCx5Seeder{
		BaseSeeder: BaseSeeder{name: "Mazda CX-5 Specifications"},
	}
}

func (mc5s *MazdaCx5Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"DOHC":                         "ডিওএইচসি",
		"Open":                         "ওপেন",
		"108 hp/ton":                   "১০৮ হর্স পাওয়ার/টন",
		"3 Years":                      "৩ বছর",
		"5 Years":                      "৫ বছর",
		"8 Years":                      "৮ বছর",
...
// Seed inserts specification records for Mazda CX-5
func (mc5s *MazdaCx5Seeder) Seed(db *gorm.DB) error {
	productSlug := "mazda-cx-5"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := mc5s.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Mazda CX-5 specifications seeded successfully")
	return nil
}
