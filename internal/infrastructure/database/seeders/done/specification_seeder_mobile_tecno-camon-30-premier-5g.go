...
func (s *SpecificationSeederMobileTecnoCAMON30Premier5G) getBanglaTranslations() map[string]string {
	...
	// Add Tecno CAMON 30 Premier 5G specific translations
	tecnoTranslations := map[string]string{
		...
		"IP54":                                 "IP৫৪",
		"5G":                                   "৫জি",
		"Alps Snowy Silver, Hawaii Lava Black": "আল্পস স্নো সিলভার, হাওয়াই লাভা ব্ল্যাক",
		"6.77 inches":                          "৬.৭৭ ইঞ্চি",
		"Mediatek Dimensity 8200 Ultimate (4 nm)": "মিডিয়াটেক ডাইমেনসিটি ৮২০০ আলটিমেট (৪ nm)",
		"120Hz":                              "১২০ হার্জ",
		...
		"LTPO AMOLED, 120Hz":                 "LTPO অ্যামোলেড, ১২০ হার্জ",
		"1264 x 2780 pixels":                 "১২৬৪ x ২৭৮০ পিক্সেল",
		"162.7 x 76.2 x 7.9 mm":              "১৬২.৭ x ৭৬.২ x ৭.৯ মিলিমিটার",
		"Available":                          "উপলব্ধ",
		...
		"Fingerprint (under display, optical), accelerometer, gyro, compass, proximity": "ফিঙ্গারপ্রিন্ট (ডিসপ্লের নিচে, অপটিক্যাল), অ্যাক্সেলেরোমিটার, জাইরো, কম্পাস, প্রক্সিমিটি",
		"GPS, GNSS":                 "GPS, GNSS",
