...
func (s *SpecificationSeederRefrigeratorMarcelMfbB2fGdehXx) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		// Keys MUST match existingkeyMapping in this file
		...
		"Door Bins":                "GPPS/4",
		"Crisper Drawers":          "Yes",
		"Dimensions":               "580 x 645 x 1765 mm",
		"Special Features":         `Compressor Input Power (Watt): V 06.01-124; V 07.01-109; V 07.02-109; V 07.03-109; V 08.01-127. Recommended voltage stabilizer capacity: V 06.01 - Low Voltage(130~260V) (Wide Range 130Vac–260Vac) — stabilizer usually not required; V 07.01/V 07.02/V 07.03 - Low Voltage(140~260V) (Wide Range 140Vac–260Vac) — stabilizer usually not required; V 08.01 - Low Voltage(150~260V) (Wide Range 150Vac–260Vac) — stabilizer usually not required; In case voltages exceed these ranges, 1000VA recommended; Refrigerator Compartment: Shelf (Wire/2); Door Basket: GPPS/4; Interior Lamp: Yes; Vegetable Crisper: Yes; Vegetable Crisper Cover: Yes; Egg Tray: Yes; Freezer Compartment: Shelf (Wire/3); Drawer: HIPS/5; Loading Capacity: 98/ 72/ 36`,
	}
