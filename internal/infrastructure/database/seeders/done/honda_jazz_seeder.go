...
// HondaJazzSeeder seeds specifications for Honda Jazz
type HondaJazzSeeder struct {
	BaseSeeder
}

// NewHondaJazzSeeder creates a new Honda Jazz seeder
func NewHondaJazzSeeder() *HondaJazzSeeder {
	return &HondaJazzSeeder{
		BaseSeeder: BaseSeeder{name: "Honda Jazz Specifications"},
	}
}

func (hjs *HondaJazzSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"122 hp @ 6600 rpm":            "৬৬০০ আরপিএম এ ১২২ হর্স পাওয়ার",
		...
		"SOHC":                         "এসওএইচসি",
		"Open":                         "ওপেন",
		"117 hp/ton":                   "১১৭ হর্স পাওয়ার/টন",
		"3 Years":                      "৩ বছর",
		"5 Years":                      "৫ বছর",
...
// Seed inserts specification records for Honda Jazz
func (hjs *HondaJazzSeeder) Seed(db *gorm.DB) error {
	productSlug := "honda-jazz"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "117 hp/ton",
		"Vehicle Warranty (Years)":       "3 Years",
		"Engine Warranty (Years)":        "5 Years",
	}

	banglaTranslations := hjs.getBanglaTranslations()
