...
// SpecificationSeederRefrigeratorMarcelMfbB5dGdxxXx seeds specifications/options for product 'marcel-mfb-b5d-gdxx-xx'
type SpecificationSeederRefrigeratorMarcelMfbB5dGdxxXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfbB5dGdxxXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfbB5dGdxxXx() *SpecificationSeederRefrigeratorMarcelMfbB5dGdxxXx {
	return &SpecificationSeederRefrigeratorMarcelMfbB5dGdxxXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfb-b5d-gdxx-xx"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfbB5dGdxxXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":                 "মার্সেল",
		"marcel-mfb-b5d-gdxx-xx": "মার্সেল-mfb-b5d-gdxx-xx",
		"MFB-B5D-GDXX-XX":        "এমএফবি-বি৫ডি-জিডিএক্সএক্স-এক্সএক্স",
		"1800 mm":                "১৮০০ মিমি",
		"1845 mm":                "১৮৪৫ মিমি",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfb-b5d-gdxx-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfbB5dGdxxXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfb-b5d-gdxx-xx"
