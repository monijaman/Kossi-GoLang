...
// GetacX500Seeder seeds specifications for Getac X500
type GetacX500Seeder struct {
	BaseSeeder
}

// NewGetacX500Seeder creates a new Getac X500 seeder
func NewGetacX500Seeder() *GetacX500Seeder {
	return &GetacX500Seeder{
		BaseSeeder: BaseSeeder{name: "Getac X500 Specifications"},
	}
}

func (gxs *GetacX500Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"380 x 260 x 35 mm":                    "৩৮০ x ২৬০ x ৩৫ মিমি",
...
// Seed implements the Seeder interface for Getac X500
func (gxs *GetacX500Seeder) Seed(db *gorm.DB) error {
	productSlug := "getac-x500"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := gxs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Getac X500 specifications seeded successfully")
	return nil
}
