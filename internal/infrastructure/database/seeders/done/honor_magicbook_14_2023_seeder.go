...
// HonorMagicbook14_2023Seeder seeds specifications for Honor MagicBook 14 2023
type HonorMagicbook14_2023Seeder struct {
	BaseSeeder
}

// NewHonorMagicbook14_2023Seeder creates a new Honor MagicBook 14 2023 seeder
func NewHonorMagicbook14_2023Seeder() *HonorMagicbook14_2023Seeder {
	return &HonorMagicbook14_2023Seeder{
		BaseSeeder: BaseSeeder{name: "Honor MagicBook 14 2023 Specifications"},
	}
}

func (hms *HonorMagicbook14_2023Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Honor":                                "অনার",
		"MagicBook 14 2023":                    "ম্যাজিকবুক ১৪ ২০২৩",
...
// Seed implements the Seeder interface for Honor MagicBook 14 2023
func (hms *HonorMagicbook14_2023Seeder) Seed(db *gorm.DB) error {
	productSlug := "honor-magicbook-14-2023"
	...
	log.Printf("✅ Honor MagicBook 14 2023 specifications seeded successfully")
	return nil
}
