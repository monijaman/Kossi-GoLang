...
// InfinityS14Seeder seeds specifications for Infinity S14
type InfinityS14Seeder struct {
	BaseSeeder
}

// NewInfinityS14Seeder creates a new Infinity S14 seeder
func NewInfinityS14Seeder() *InfinityS14Seeder {
	return &InfinityS14Seeder{
		BaseSeeder: BaseSeeder{name: "Infinity S14 Specifications"},
	}
}

func (is *InfinityS14Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Infinity S14
func (is *InfinityS14Seeder) Seed(db *gorm.DB) error {
	productSlug := "infinity-s14"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := is.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Infinity S14 specifications seeded successfully")
	return nil
}
