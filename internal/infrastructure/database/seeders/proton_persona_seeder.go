...
// ProtonPersonaSeeder seeds specifications for Proton Persona
type ProtonPersonaSeeder struct {
	BaseSeeder
}

// NewProtonPersonaSeeder creates a new Proton Persona seeder
func NewProtonPersonaSeeder() *ProtonPersonaSeeder {
	return &ProtonPersonaSeeder{
		BaseSeeder: BaseSeeder{name: "Proton Persona Specifications"},
	}
}

func (pps *ProtonPersonaSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"148 Nm @ 4000 rpm":               "৪০০০ আরপিএম এ ১৪৮ এনএম",
		"Petrol":                          "পেট্রোল",
...
// Seed implements the Seeder interface for Proton Persona
func (pps *ProtonPersonaSeeder) Seed(db *gorm.DB) error {
	productSlug := "proton-persona"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := pps.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Proton Persona specifications seeded successfully")
	return nil
}
