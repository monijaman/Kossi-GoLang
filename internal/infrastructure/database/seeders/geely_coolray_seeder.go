...
// GeelyCoolraySeeder seeds specifications for Geely Coolray
type GeelyCoolraySeeder struct {
	BaseSeeder
}

// NewGeelyCoolraySeeder creates a new Geely Coolray seeder
func NewGeelyCoolraySeeder() *GeelyCoolraySeeder {
	return &GeelyCoolraySeeder{
		BaseSeeder: BaseSeeder{name: "Geely Coolray Specifications"},
	}
}

func (gcs *GeelyCoolraySeeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Geely Coolray
func (gcs *GeelyCoolraySeeder) Seed(db *gorm.DB) error {
	productSlug := "geely-coolray"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := gcs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Geely Coolray specifications seeded successfully")
	return nil
}
