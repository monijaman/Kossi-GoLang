...
// XiaomiRedmiBook16Seeder seeds specifications for Xiaomi Redmi Book 16
type XiaomiRedmiBook16Seeder struct {
	BaseSeeder
}

// NewXiaomiRedmiBook16Seeder creates a new Xiaomi Redmi Book 16 seeder
func NewXiaomiRedmiBook16Seeder() *XiaomiRedmiBook16Seeder {
	return &XiaomiRedmiBook16Seeder{
		BaseSeeder: BaseSeeder{name: "Xiaomi Redmi Book 16 Specifications"},
	}
}

func (xrbs *XiaomiRedmiBook16Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Xiaomi":                        "শাওমি",
		"Redmi Book 16":                 "রেডমি বুক ১৬",
		...
		"356.3 x 248.7 x 16.9 mm":              "৩৫৬.৩ x ২৪৮.৭ x ১৬.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"6":                                    "৬",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for Xiaomi Redmi Book 16
func (xrbs *XiaomiRedmiBook16Seeder) Seed(db *gorm.DB) error {
	productSlug := "xiaomi-redmi-book-16"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "356.3 x 248.7 x 16.9 mm",
		"Body Type":               "Plastic",
	...
	log.Printf("✅ Xiaomi Redmi Book 16 specifications seeded successfully")
	return nil
}
