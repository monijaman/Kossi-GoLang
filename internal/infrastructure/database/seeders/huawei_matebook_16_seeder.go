...
// HuaweiMatebook16Seeder seeds specifications for Huawei MateBook 16
type HuaweiMatebook16Seeder struct {
	BaseSeeder
}

// NewHuaweiMatebook16Seeder creates a new Huawei MateBook 16 seeder
func NewHuaweiMatebook16Seeder() *HuaweiMatebook16Seeder {
	return &HuaweiMatebook16Seeder{
		BaseSeeder: BaseSeeder{name: "Huawei MateBook 16 Specifications"},
	}
}

func (hms *HuaweiMatebook16Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Huawei":                        "হুয়াওয়ে",
		"MateBook 16":                   "মেটবুক ১৬",
		...
		"356.9 x 249.1 x 15.9 mm":       "৩৫৬.৯ x ২৪৯.১ x ১৫.৯ মিমি",
		"TPM 2.0":                       "টিপিএম ২.০",
		"12":                            "১২",
		"16":                            "১৬",
...
// Seed implements the Seeder interface for Huawei MateBook 16
func (hms *HuaweiMatebook16Seeder) Seed(db *gorm.DB) error {
	productSlug := "huawei-matebook-16"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "356.9 x 249.1 x 15.9 mm",
		"Body Type":               "Aluminum",
	...
	log.Printf("✅ Huawei MateBook 16 specifications seeded successfully")
	return nil
}
