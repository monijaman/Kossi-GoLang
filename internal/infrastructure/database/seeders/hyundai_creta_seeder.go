...
// HyundaiCretaSeeder seeds specifications for Hyundai Creta
type HyundaiCretaSeeder struct {
	BaseSeeder
}

// NewHyundaiCretaSeeder creates a new Hyundai Creta seeder
func NewHyundaiCretaSeeder() *HyundaiCretaSeeder {
	return &HyundaiCretaSeeder{
		BaseSeeder: BaseSeeder{name: "Hyundai Creta Specifications"},
	}
}

func (hcs *HyundaiCretaSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"1635 mm":                         "১৬৩৫ মিমি",
		"2610 mm":                         "২৬১০ মিমি",
		"1635 mm (Ground Clearance)":      "১৬৩৫ মিমি (গ্রাউন্ড ক্লিয়ারেন্স)",
		"1205 kg":                         "১২০৫ কেজি",
		"45 L":                            "৪৫ লিটার",
		"205/65 R16":                      "২০৫/৬৫ আর১৬",
...
// Seed implements the Seeder interface for Hyundai Creta
func (hcs *HyundaiCretaSeeder) Seed(db *gorm.DB) error {
	productSlug := "hyundai-creta"
	...
	log.Printf("✅ Hyundai Creta specifications seeded successfully")
	return nil
}
