...
// TataSafariSeeder seeds specifications for Tata Safari
type TataSafariSeeder struct {
	BaseSeeder
}

// NewTataSafariSeeder creates a new Tata Safari seeder
func NewTataSafariSeeder() *TataSafariSeeder {
	return &TataSafariSeeder{
		BaseSeeder: BaseSeeder{name: "Tata Safari Specifications"},
	}
}

func (tss *TataSafariSeeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Tata Safari
func (tss *TataSafariSeeder) Seed(db *gorm.DB) error {
	productSlug := "tata-safari"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := tss.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Tata Safari specifications seeded successfully")
	return nil
}
