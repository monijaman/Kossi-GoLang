...
// ToshibaSatelliteProSeeder seeds specifications for Toshiba Satellite Pro
type ToshibaSatelliteProSeeder struct {
	BaseSeeder
}

// NewToshibaSatelliteProSeeder creates a new Toshiba Satellite Pro seeder
func NewToshibaSatelliteProSeeder() *ToshibaSatelliteProSeeder {
	return &ToshibaSatelliteProSeeder{
		BaseSeeder: BaseSeeder{name: "Toshiba Satellite Pro Specifications"},
	}
}

func (tsps *ToshibaSatelliteProSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Toshiba":                       "টোশিবা",
		"Satellite Pro":                 "স্যাটেলাইট প্রো",
		"Windows 11 Pro":                "উইন্ডোজ ১১ প্রো",
		"Intel":                         "ইন্টেল",
		"Core i5-1240P":                 "কোর আই৫-১২৪০পি",
		...
		"1.7 GHz base / 4.4 GHz boost":         "১.৭ গিগাহার্টজ বেস / ৪.৪ গিগাহার্টজ বুস্ট",
		"12 MB cache":                          "১২ এমবি ক্যাশ",
		"720p HD":                              "৭২০পি এইচডি",
		"Stereo Speakers":                      "স্টেরিও স্পিকার",
		"359.4 x 241.3 x 19.9 mm":              "৩৫৯.৪ x ২৪১.৩ x ১৯.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"12":                                   "১২",
		"16":                                   "১৬",
...
// Seed implements the Seeder interface for Toshiba Satellite Pro
func (tsps *ToshibaSatelliteProSeeder) Seed(db *gorm.DB) error {
	productSlug := "toshiba-satellite-pro"
	...
	specs := map[string]string{
		"Brand":                "Toshiba",
		"Model Name":           "Satellite Pro",
		"Operating System":     "Windows 11 Pro",
		"Processor Brand":      "Intel",
		"Processor Model":      "Core i5-1240P",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := tsps.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Toshiba Satellite Pro specifications seeded successfully")
	return nil
}
