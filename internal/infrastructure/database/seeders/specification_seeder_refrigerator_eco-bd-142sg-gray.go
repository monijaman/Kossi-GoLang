...
// SpecificationSeederRefrigeratorecobd142sggray seeds specifications/options for product 'eco-bd-142sg-gray'
type SpecificationSeederRefrigeratorecobd142sggray struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecobd142sggray creates a new seeder instance
func NewSpecificationSeederRefrigeratorecobd142sggray() *SpecificationSeederRefrigeratorecobd142sggray {
	return &SpecificationSeederRefrigeratorecobd142sggray{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-bd-142sg-gray"},
	}
}

func (s *SpecificationSeederRefrigeratorecobd142sggray) getBanglaTranslations() map[string]string {
	return map[string]string{
		"ECO+":               "ইকো+",
		"ECO+ BD-142SG Gray": "ECO+ BD-142SG Gray",
...
// Seed inserts specification records for the product identified by slug 'eco-bd-142sg-gray'
func (s *SpecificationSeederRefrigeratorecobd142sggray) Seed(db *gorm.DB) error {
	productSlug := "eco-bd-142sg-gray"
