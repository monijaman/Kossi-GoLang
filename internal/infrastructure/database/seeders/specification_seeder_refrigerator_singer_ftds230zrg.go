...
// SpecificationSeederRefrigeratorSingerFTDS230ZRG seeds specifications/options for product 'singer-ftds230z-rg'
type SpecificationSeederRefrigeratorSingerFTDS230ZRG struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS230ZRG creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS230ZRG() *SpecificationSeederRefrigeratorSingerFTDS230ZRG {
	return &SpecificationSeederRefrigeratorSingerFTDS230ZRG{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds230z-rg"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS230ZRG) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                       "সিঙ্গার",
		"SRREF-SS500-FTDS230Z-RG":      "SRREF-SS500-FTDS230Z-RG",
...
// Seed inserts specification records for the product identified by slug 'singer-ftds230z-rg'
func (s *SpecificationSeederRefrigeratorSingerFTDS230ZRG) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds230z-rg"
	...
	specs := map[string]string{
		"Brand":                       "Singer",
		"Model Name":                  "SRREF-SS500-FTDS230Z-RG",
