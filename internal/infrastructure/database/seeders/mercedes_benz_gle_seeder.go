...
// MercedesBenzGLESeeder seeds specifications for Mercedes-Benz GLE
type MercedesBenzGLESeeder struct {
	BaseSeeder
}

// NewMercedesBenzGLESeeder creates a new Mercedes-Benz GLE seeder
func NewMercedesBenzGLESeeder() *MercedesBenzGLESeeder {
	return &MercedesBenzGLESeeder{
		BaseSeeder: BaseSeeder{name: "Mercedes-Benz GLE Specifications"},
	}
}

func (mbgles *MercedesBenzGLESeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"GLE 450":                        "জিএলই ৪৫০",
		"2nd Generation (W167)":          "২য় প্রজন্ম (ডব্লিউ১৬৭)",
		...
		"Open":                           "ওপেন",
		"105 hp/ton":                     "১০৫ হর্স পাওয়ার/টন",
		"8 km/L":                         "৮ কিমি/লিটার",
...
// Seed implements the Seeder interface for Mercedes-Benz GLE
func (mbgles *MercedesBenzGLESeeder) Seed(db *gorm.DB) error {
	productSlug := "mercedes-benz-gle"
	...
	specs := map[string]string{
		...
		"Model Name":                  "GLE",
		"Variant":                        "GLE 450",
		"Generation":                     "2nd Generation (W167)",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := mbgles.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Mercedes-Benz GLE specifications seeded successfully")
	return nil
}
