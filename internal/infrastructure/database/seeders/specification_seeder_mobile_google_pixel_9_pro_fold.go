...
func (s *SpecificationSeederMobileGooglePixel9ProFold) getBanglaTranslations() map[string]string {
	return map[string]string{
		"1-120Hz": "১-১২০Hz",
		"10 MP (Cover) + 10 MP (Inner)": "১০ মেগাপিক্সেল (Cover) + ১০ মেগাপিক্সেল (Inner)",
		"16 GB": "১৬ GB",
		"2076 x 2152 pixels": "২০৭৬ x ২১৫২ পিক্সেল",
		"256 GB / 512 GB": "২৫৬ জিবি / ৫১২ GB",
		"257 g": "২৫৭ g",
		"4,650 mAh": "৪,৬৫০ এমএএইচ",
		"48 MP + 10.5 MP + 10.8 MP": "৪৮ মেগাপিক্সেল + ১০.৫ মেগাপিক্সেল + ১০.৮ মেগাপিক্সেল",
		"5G": "৫G",
		...
		"Foldable LTPO OLED, 120Hz, HDR10+, 2700 nits": "Foldable এলটিপিও ওএলইডি, ১২০Hz, এইচডিআর১০+, ২৭০০ nits",
