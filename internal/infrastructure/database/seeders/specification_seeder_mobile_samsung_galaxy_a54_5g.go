...
func (s *SpecificationSeederMobileSamsungGalaxyA545g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"IP67 (up to 1 m for 30 min)": "IP৬৭ (পর্যন্ত ১ m জন্য ৩০ min)",
		"Li-Ion (non-removable)": "লি-আয়ন (অপসারণযোগ্য নয়)",
		"Lime, Graphite, Violet, White": "Lime, গ্রাফাইট, ভায়োলেট, সাদা",
		"Mali-G68 (MP5)": "মালি-G৬৮ (MP৫)",
		"March 2023": "মার্চ ২০২৩",
		"Nano-SIM or Hybrid Dual SIM (market dependent)": "ন্যানো-সিম বা Hybrid ডুয়াল সিম (বাজার নির্ভরশীল)",
		...
		"Yes (region dependent)": "হ্যাঁ (অঞ্চল নির্ভরশীল)",
	}
}
