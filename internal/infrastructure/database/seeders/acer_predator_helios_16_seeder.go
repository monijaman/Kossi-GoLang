...
// AcerPredatorHelios16Seeder seeds specifications for Acer Predator Helios 16
type AcerPredatorHelios16Seeder struct {
	BaseSeeder
}

// NewAcerPredatorHelios16Seeder creates a new Acer Predator Helios 16 seeder
func NewAcerPredatorHelios16Seeder() *AcerPredatorHelios16Seeder {
	return &AcerPredatorHelios16Seeder{
		BaseSeeder: BaseSeeder{name: "Acer Predator Helios 16 Specifications"},
	}
}

func (aphs *AcerPredatorHelios16Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Acer":                          "এসার",
		"Predator Helios 16":            "প্রেডেটর হেলিওস ১৬",
		...
		"280W AC Adapter":                      "২৮০ওয়াট এসি অ্যাডাপ্টার",
		"5-7 hours":                            "৫-৭ ঘন্টা",
		...
		"395 x 262 x 27.2 mm":                  "৩৯৫ x ২৬২ x ২৭.২ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"16":                                   "১৬",
		"24":                                   "২৪",
...
// Seed implements the Seeder interface for Acer Predator Helios 16
func (aphs *AcerPredatorHelios16Seeder) Seed(db *gorm.DB) error {
	productSlug := "acer-predator-helios-16"
	...
	specs := map[string]string{
		...
		"Charging Speed":          "280W AC Adapter",
		...
		"Sensors":                 "No",
		"Dimensions":              "395 x 262 x 27.2 mm",
	...
	log.Printf("✅ Acer Predator Helios 16 specifications seeded successfully")
	return nil
}
