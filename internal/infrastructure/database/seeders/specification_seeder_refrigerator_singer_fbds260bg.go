...
// SpecificationSeederRefrigeratorSingerFBDS260BG seeds specifications/options for product 'singer-fbds260-bg'
type SpecificationSeederRefrigeratorSingerFBDS260BG struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFBDS260BG creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFBDS260BG() *SpecificationSeederRefrigeratorSingerFBDS260BG {
	return &SpecificationSeederRefrigeratorSingerFBDS260BG{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-fbds260-bg"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFBDS260BG) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'singer-fbds260-bg'
func (s *SpecificationSeederRefrigeratorSingerFBDS260BG) Seed(db *gorm.DB) error {
	productSlug := "singer-fbds260-bg"
	...
	specs := map[string]string{
		...
		"Net Volume":                  "260 Ltr.",
		"Special Features":            "260 Ltr Capacity, 50:50 Space Compartment, 5 Star Energy Rating by BSTI, Low power consumption, Real Tempered Glass Finish, Tempered Glass Shelves, Built-in Stabilizer, Odour Filter, Bottle Holder, Bottom Mounted Refrigerator, Big Freezer, Flash Ergonomic Handle, Ice Scraper, Anti Bacterial Gasket, LED Light, Food Grade Plastic Shelf & Crisper, Modular Bottle Holder, Hidden Condenser",
	}
