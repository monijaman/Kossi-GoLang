...
// SpecificationSeederRefrigeratorecoomega3glg322rlbbpz seeds specifications/options for product 'eco-omega3-gl-g322rlbb-pz'
type SpecificationSeederRefrigeratorecoomega3glg322rlbbpz struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecoomega3glg322rlbbpz creates a new seeder instance
func NewSpecificationSeederRefrigeratorecoomega3glg322rlbbpz() *SpecificationSeederRefrigeratorecoomega3glg322rlbbpz {
	return &SpecificationSeederRefrigeratorecoomega3glg322rlbbpz{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-omega3-gl-g322rlbb-pz"},
	}
}

func (s *SpecificationSeederRefrigeratorecoomega3glg322rlbbpz) getBanglaTranslations() map[string]string {
	return map[string]string{
		"LG":                       "এলজি",
		"LG OMEGA3 GL-G322RLBB PZ": "এলজি ওমেগা৩ জিএল-জি৩২২আরএলবিবি পিজেড",
		"Top Mount":                "টপ মাউন্ট",
		"281":                      "২৮১",
		"223":                      "২২৩",
		"58":                       "৫৮",
...
// Seed inserts specification records for the product identified by slug 'eco-omega3-gl-g322rlbb-pz'
func (s *SpecificationSeederRefrigeratorecoomega3glg322rlbbpz) Seed(db *gorm.DB) error {
	productSlug := "eco-omega3-gl-g322rlbb-pz"
	...
	specs := map[string]string{
		"Brand":                 "LG",
		"Model Name":            "LG OMEGA3 GL-G322RLBB PZ",
		"Door Type":             "Top Mount",
		"Capacity":              "281",
