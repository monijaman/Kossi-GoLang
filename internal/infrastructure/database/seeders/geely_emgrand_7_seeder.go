...
// GeelyEmgrand7Seeder seeds specifications for Geely Emgrand 7
type GeelyEmgrand7Seeder struct {
	BaseSeeder
}

// NewGeelyEmgrand7Seeder creates a new Geely Emgrand 7 seeder
func NewGeelyEmgrand7Seeder() *GeelyEmgrand7Seeder {
	return &GeelyEmgrand7Seeder{
		BaseSeeder: BaseSeeder{name: "Geely Emgrand 7 Specifications"},
	}
}

func (ge7s *GeelyEmgrand7Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Geely Emgrand 7
func (ge7s *GeelyEmgrand7Seeder) Seed(db *gorm.DB) error {
	productSlug := "geely-emgrand-7"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := ge7s.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Geely Emgrand 7 specifications seeded successfully")
	return nil
}
