...
func (s *SpecificationSeederMobileTecnoSpark40c) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Gravity Black, Mystery White": "গ্র্যাভিটি কালো, মিস্ট্রি সাদা",
...
func (s *SpecificationSeederMobileTecnoSpark40c) Seed(db *gorm.DB) error {
	...
	// Override model-specific values for Tecno SPARK 40C
	...
	specs["Weight"] = "185 g"
	specs["Dimensions"] = "163.7 x 75.6 x 8.6 mm"
	...
	specs["Available Colors"] = "Gravity Black, Mystery White"
