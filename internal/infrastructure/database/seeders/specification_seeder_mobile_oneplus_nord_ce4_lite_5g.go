...
func (s *SpecificationSeederMobileOneplusNordCe4Lite5g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"8 GB": "৮ GB",
		"AMOLED, 120Hz, 2100 nits": "অ্যামোলেড, ১২০Hz, ২১০০ nits",
		"Adreno 619": "অ্যাড্রেনো ৬১৯",
		"Android 14, OxygenOS 14": "অ্যান্ড্রয়েড ১৪, OxygenOS ১৪",
		"Glass front, plastic frame, plastic back": "গ্লাস সামনে, প্লাস্টিক ফ্রেম, প্লাস্টিক পেছনে",
		"IP54": "IP৫৪",
		"June 2024": "জুন ২০২৪",
		"Qualcomm SM6375 Snapdragon 695 5G (6 nm)": "কোয়ালকম SM৬৩৭৫ স্ন্যাপড্রাগন ৬৯৫ ৫G (৬ ন্যানোমিটার)",
		"Snapdragon 695 5G": "স্ন্যাপড্রাগন ৬৯৫ ৫G",
		"Super Silver, Mega Blue, Ultra Orange": "Super রূপালী, মিga নীল, আল্ট্রা Orange",
	}
}
