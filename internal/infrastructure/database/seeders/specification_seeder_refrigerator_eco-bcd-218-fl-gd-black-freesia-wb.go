...
// SpecificationSeederRefrigeratorecobcd218flgdblackfreesiawb seeds specifications/options for product 'eco-bcd-218-fl-gd-black-freesia-wb'
type SpecificationSeederRefrigeratorecobcd218flgdblackfreesiawb struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecobcd218flgdblackfreesiawb creates a new seeder instance
func NewSpecificationSeederRefrigeratorecobcd218flgdblackfreesiawb() *SpecificationSeederRefrigeratorecobcd218flgdblackfreesiawb {
	return &SpecificationSeederRefrigeratorecobcd218flgdblackfreesiawb{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-bcd-218-fl-gd-black-freesia-wb"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'eco-bcd-218-fl-gd-black-freesia-wb'
func (s *SpecificationSeederRefrigeratorecobcd218flgdblackfreesiawb) Seed(db *gorm.DB) error {
	productSlug := "eco-bcd-218-fl-gd-black-freesia-wb"
