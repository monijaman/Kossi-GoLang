...
func (s *SpecificationSeederMobileOneplus12r) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"IP64": "IP৬৪",
		"Iron Gray, Cool Blue, Electric Violet": "Iron ধূসর, Cool নীল, Electric ভায়োলেট",
		"January 2024": "জানুয়ারি ২০২৪",
		"LTPO4 AMOLED, 120Hz, HDR10+, 4500 nits": "এলটিপিও৪ অ্যামোলেড, ১২০Hz, এইচডিআর১০+, ৪৫০০ nits",
