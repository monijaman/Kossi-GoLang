...
// LenovoIdeapadGaming3Seeder seeds specifications for Lenovo IdeaPad Gaming 3
type LenovoIdeapadGaming3Seeder struct {
	BaseSeeder
}

// NewLenovoIdeapadGaming3Seeder creates a new Lenovo IdeaPad Gaming 3 seeder
func NewLenovoIdeapadGaming3Seeder() *LenovoIdeapadGaming3Seeder {
	return &LenovoIdeapadGaming3Seeder{
		BaseSeeder: BaseSeeder{name: "Lenovo IdeaPad Gaming 3 Specifications"},
	}
}

func (lig *LenovoIdeapadGaming3Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Lenovo":                        "লেনোভো",
		"IdeaPad Gaming 3":              "আইডিয়াপ্যাড গেমিং ৩",
		...
		"359 x 249 x 24.2 mm":                  "৩৫৯ x ২৪৯ x ২৪.২ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"8":                                    "৮",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for Lenovo IdeaPad Gaming 3
func (lig *LenovoIdeapadGaming3Seeder) Seed(db *gorm.DB) error {
	productSlug := "lenovo-ideapad-gaming-3"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "359 x 249 x 24.2 mm",
		"Body Type":               "Plastic",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := lig.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Lenovo IdeaPad Gaming 3 specifications seeded successfully")
	return nil
}
