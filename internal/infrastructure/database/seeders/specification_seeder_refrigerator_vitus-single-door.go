...
// SpecificationSeederRefrigeratorVitusSingleDoor seeds specifications/options for product 'vitus-single-door'
type SpecificationSeederRefrigeratorVitusSingleDoor struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorVitusSingleDoor creates a new seeder instance
func NewSpecificationSeederRefrigeratorVitusSingleDoor() *SpecificationSeederRefrigeratorVitusSingleDoor {
	return &SpecificationSeederRefrigeratorVitusSingleDoor{
		BaseSeeder: BaseSeeder{name: "Specifications for vitus-single-door"},
	}
}

func (s *SpecificationSeederRefrigeratorVitusSingleDoor) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'vitus-single-door'
func (s *SpecificationSeederRefrigeratorVitusSingleDoor) Seed(db *gorm.DB) error {
	productSlug := "vitus-single-door"
