...
// SpecificationSeederRefrigeratorMarcelMfcC4hGdneXx seeds specifications/options for product 'marcel-mfc-c4h-gdne-xx'
...
func NewSpecificationSeederRefrigeratorMarcelMfcC4hGdneXx() *SpecificationSeederRefrigeratorMarcelMfcC4hGdneXx {
	return &SpecificationSeederRefrigeratorMarcelMfcC4hGdneXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfc-c4h-gdne-xx"},
	}
}
...
func (s *SpecificationSeederRefrigeratorMarcelMfcC4hGdneXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":                 "মার্সেল",
		"marcel-mfc-c4h-gdne-xx": "মার্সেল-mfc-c4h-gdne-xx",
		"MFC-C4H-GDNE-XX":        "MFC-C4H-GDNE-XX",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfc-c4h-gdne-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfcC4hGdneXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfc-c4h-gdne-xx"
