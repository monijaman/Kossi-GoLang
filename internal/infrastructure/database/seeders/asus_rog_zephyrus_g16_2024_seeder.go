...
// AsusRogZephyrusG16Seeder seeds specifications for Asus ROG Zephyrus G16 2024
type AsusRogZephyrusG16Seeder struct {
	BaseSeeder
}

// NewAsusRogZephyrusG16Seeder creates a new Asus ROG Zephyrus G16 2024 seeder
func NewAsusRogZephyrusG16Seeder() *AsusRogZephyrusG16Seeder {
	return &AsusRogZephyrusG16Seeder{
		BaseSeeder: BaseSeeder{name: "Asus ROG Zephyrus G16 2024 Specifications"},
	}
}

func (arz *AsusRogZephyrusG16Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Asus":                                 "এসুস",
		"ROG Zephyrus G16 2024":                "আরওজি জেফাইরাস জি১৬ ২০২৪",
		"Windows 11 Home":                      "উইন্ডোজ ১১ হোম",
		"AMD":                                  "এএমডি",
		"Ryzen 9 7845HX":                       "রাইজেন ৯ ৭৮৪৫এইচএক্স",
		"7th Gen":                              "৭ম প্রজন্ম",
		...
		"2.1 GHz base / 5.2 GHz boost":         "২.১ গিগাহার্টজ বেস / ৫.২ গিগাহার্টজ বুস্ট",
...
// Seed implements the Seeder interface for Asus ROG Zephyrus G16 2024
func (arz *AsusRogZephyrusG16Seeder) Seed(db *gorm.DB) error {
	productSlug := "asus-rog-zephyrus-g16-2024"
	...
	specs := map[string]string{
		"Brand":                   "Asus",
		"Model Name":              "ROG Zephyrus G16 2024",
		"Operating System":        "Windows 11 Home",
		"Processor Brand":         "AMD",
		"Processor Model":         "Ryzen 9 7845HX",
		...
		"Processor Speed":         "2.1 GHz base / 5.2 GHz boost",
	...
	log.Printf("✅ Asus ROG Zephyrus G16 2024 specifications seeded successfully")
	return nil
}
