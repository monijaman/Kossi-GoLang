...
// SpecificationSeederRefrigeratorSingerFTDS155 seeds specifications/options for product 'singer-ftds155'
type SpecificationSeederRefrigeratorSingerFTDS155 struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS155 creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS155() *SpecificationSeederRefrigeratorSingerFTDS155 {
	return &SpecificationSeederRefrigeratorSingerFTDS155{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds155"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS155) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'singer-ftds155'
func (s *SpecificationSeederRefrigeratorSingerFTDS155) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds155"
