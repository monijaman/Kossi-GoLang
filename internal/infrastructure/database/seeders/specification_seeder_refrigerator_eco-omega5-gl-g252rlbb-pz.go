...
// SpecificationSeederRefrigeratorecoomega5glg252rlbbpz seeds specifications/options for product 'eco-omega5-gl-g252rlbb-pz'
type SpecificationSeederRefrigeratorecoomega5glg252rlbbpz struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecoomega5glg252rlbbpz creates a new seeder instance
func NewSpecificationSeederRefrigeratorecoomega5glg252rlbbpz() *SpecificationSeederRefrigeratorecoomega5glg252rlbbpz {
	return &SpecificationSeederRefrigeratorecoomega5glg252rlbbpz{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-omega5-gl-g252rlbb-pz"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'eco-omega5-gl-g252rlbb-pz'
func (s *SpecificationSeederRefrigeratorecoomega5glg252rlbbpz) Seed(db *gorm.DB) error {
	productSlug := "eco-omega5-gl-g252rlbb-pz"
