...
func (s *SpecificationSeederMobileSamsungGalaxyF365g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Glass front, plastic frame, eco-leather back": "গ্লাস সামনে, প্লাস্টিক ফ্রেম, eco-চামড়া পেছনে",
		"Li-Ion (non-removable)": "লি-আয়ন (অপসারণযোগ্য নয়)",
		"Luxe Violet, Coral Red, Onyx Black": "Luxe ভায়োলেট, কোরাল লাল, অনিক্স কালো",
		"Mali-G68 MP5": "মালি-G৬৮ মেগাপিক্সেল৫",
		"Nano-SIM + Nano-SIM": "ন্যানো-সিম + ন্যানো-সিম",
		"Octa-core (4×2.4 GHz + 4×2.0 GHz)": "অক্টা-কোর (৪×২.৪ গিগাহার্টজ + ৪×২.০ গিগাহার্টজ)",
