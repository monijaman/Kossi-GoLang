...
// SpecificationSeederRefrigeratorMarcelMfdA6cGdelXx seeds specifications/options for product 'marcel-mfd-a6c-gdel-xx'
type SpecificationSeederRefrigeratorMarcelMfdA6cGdelXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfdA6cGdelXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfdA6cGdelXx() *SpecificationSeederRefrigeratorMarcelMfdA6cGdelXx {
	return &SpecificationSeederRefrigeratorMarcelMfdA6cGdelXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfd-a6c-gdel-xx"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfdA6cGdelXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":         "মার্সেল",
				"marcel-mfd-a6c-gdel-xx":         "মার্সেল-mfd-a6c-gdel-xx",
		"MFD-A6C-GDEL-XX":   "MFD-A6C-GDEL-XX",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfd-a6c-gdel-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfdA6cGdelXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfd-a6c-gdel-xx"
