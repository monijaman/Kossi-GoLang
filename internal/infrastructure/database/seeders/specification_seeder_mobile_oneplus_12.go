...
func (s *SpecificationSeederMobileOneplus12) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"120Hz": "১২০Hz",
		"1440 x 3168 pixels": "১৪৪০ x ৩১৬৮ পিক্সেল",
		...
		"50 MP + 64 MP + 48 MP": "৫০ মেগাপিক্সেল + ৬৪ মেগাপিক্সেল + ৪৮ মেগাপিক্সেল",
		"5G": "৫G",
		...
		"IP65": "IP৬৫",
		"LTPO AMOLED, 120Hz, Dolby Vision, HDR10+, 4500 nits": "এলটিপিও অ্যামোলেড, ১২০Hz, ডলবি ভিশন, এইচডিআর১০+, ৪৫০০ nits",
