...
// SpecificationSeederRefrigeratorSingerFTDS200VBG seeds specifications/options for product 'singer-ftds200v-bg'
type SpecificationSeederRefrigeratorSingerFTDS200VBG struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS200VBG creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS200VBG() *SpecificationSeederRefrigeratorSingerFTDS200VBG {
	return &SpecificationSeederRefrigeratorSingerFTDS200VBG{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds200v-bg"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS200VBG) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                       "সিঙ্গার",
		"FTDS200V-BG":                  "FTDS200V-BG",
...
// Seed inserts specification records for the product identified by slug 'singer-ftds200v-bg'
func (s *SpecificationSeederRefrigeratorSingerFTDS200VBG) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds200v-bg"
