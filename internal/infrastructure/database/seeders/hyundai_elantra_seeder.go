...
// HyundaiElantraSeeder seeds specifications for Hyundai Elantra
type HyundaiElantraSeeder struct {
	BaseSeeder
}

// NewHyundaiElantraSeeder creates a new Hyundai Elantra seeder
func NewHyundaiElantraSeeder() *HyundaiElantraSeeder {
	return &HyundaiElantraSeeder{
		BaseSeeder: BaseSeeder{name: "Hyundai Elantra Specifications"},
	}
}

func (hes *HyundaiElantraSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"128 hp @ 6300 rpm":               "৬৩০০ আরপিএম এ ১২৮ হর্স পাওয়ার",
		"155 Nm @ 4200 rpm":               "৪২০০ আরপিএম এ ১৫৫ এনএম",
		"Petrol":                          "পেট্রোল",
...
// Seed implements the Seeder interface for Hyundai Elantra
func (hes *HyundaiElantraSeeder) Seed(db *gorm.DB) error {
	productSlug := "hyundai-elantra"
	...
	log.Printf("✅ Hyundai Elantra specifications seeded successfully")
	return nil
}
