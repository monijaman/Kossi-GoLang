...
// SpecificationSeederRefrigeratorecobd198sggdgreen seeds specifications/options for product 'eco-bd-198sg-gd-green'
type SpecificationSeederRefrigeratorecobd198sggdgreen struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecobd198sggdgreen creates a new seeder instance
func NewSpecificationSeederRefrigeratorecobd198sggdgreen() *SpecificationSeederRefrigeratorecobd198sggdgreen {
	return &SpecificationSeederRefrigeratorecobd198sggdgreen{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-bd-198sg-gd-green"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'eco-bd-198sg-gd-green'
func (s *SpecificationSeederRefrigeratorecobd198sggdgreen) Seed(db *gorm.DB) error {
	productSlug := "eco-bd-198sg-gd-green"
