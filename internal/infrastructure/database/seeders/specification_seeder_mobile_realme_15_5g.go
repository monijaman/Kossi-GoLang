...
// SpecificationSeederMobileRealme155g seeds specifications/options for product 'realme-15-5g'
type SpecificationSeederMobileRealme155g struct {
	BaseSeeder
}

// NewSpecificationSeederMobileRealme155g creates a new seeder instance
func NewSpecificationSeederMobileRealme155g() *SpecificationSeederMobileRealme155g {
	return &SpecificationSeederMobileRealme155g{BaseSeeder: BaseSeeder{name: "Specifications for Realme 15 5G"}}
}

// getBanglaTranslations returns a map of English specification values to their Bangla translations
func (s *SpecificationSeederMobileRealme155g) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'realme-15-5g'
func (s *SpecificationSeederMobileRealme155g) Seed(db *gorm.DB) error {
	productSlug := "realme-15-5g"
	...
	// Override model-specific values for Realme 15 5G
