...
// RazerBlade15Seeder seeds specifications for Razer Blade 15
type RazerBlade15Seeder struct {
	BaseSeeder
}

// NewRazerBlade15Seeder creates a new Razer Blade 15 seeder
func NewRazerBlade15Seeder() *RazerBlade15Seeder {
	return &RazerBlade15Seeder{
		BaseSeeder: BaseSeeder{name: "Razer Blade 15 Specifications"},
	}
}

func (rbs *RazerBlade15Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"355 x 235 x 19.9 mm":                    "৩৫৫ x ২৩৫ x ১৯.৯ মিমি",
...
// Seed implements the Seeder interface for Razer Blade 15
func (rbs *RazerBlade15Seeder) Seed(db *gorm.DB) error {
	productSlug := "razer-blade-15"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "355 x 235 x 19.9 mm",
		"Body Type":               "Gaming",
	...
	log.Printf("✅ Razer Blade 15 specifications seeded successfully")
	return nil
}
