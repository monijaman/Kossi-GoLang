...
// SsangyongRextonSeeder seeds specifications for SsangYong Rexton
type SsangyongRextonSeeder struct {
	BaseSeeder
}

// NewSsangyongRextonSeeder creates a new SsangYong Rexton seeder
func NewSsangyongRextonSeeder() *SsangyongRextonSeeder {
	return &SsangyongRextonSeeder{
		BaseSeeder: BaseSeeder{name: "SsangYong Rexton Specifications"},
	}
}

func (srs *SsangyongRextonSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"2017":                         "২০১৭",
		"SUV":                          "এসইউভি",
		"Grand White":                  "গ্র্যান্ড হোয়াইট",
		"Inline":                       "ইনলাইন",
		"2157":                         "২১৫৭ সিসি",
		"4":                            "৪ (সিলিন্ডার)",
		"181 hp":                       "১৮১ হর্স পাওয়ার",
		"181 hp @ 4000 rpm":            "৪০০০ আরপিএম এ ১৮১ হর্স পাওয়ার",
		"420 Nm @ 1600-2600 rpm":       "১৬০০-২৬০০ আরপিএম এ ৪২০ এনএম",
		"Diesel":                       "ডিজেল",
		"Turbocharged":                 "টার্বোচার্জড",
		"10.8 seconds":                 "১০.৮ সেকেন্ড",
		"185 km/h":                     "১৮৫ কিমি/ঘণ্টা",
		...
		"Alloy":                        "অ্যালয়",
		"HID (Headlamps)":              "এইচআইডি (হেডল্যাম্পস)",
...
// Seed implements the Seeder interface for SsangYong Rexton
func (srs *SsangyongRextonSeeder) Seed(db *gorm.DB) error {
	productSlug := "ssangyong-rexton"
	...
	specs := map[string]string{
		...
		"Power Steering":                 "Yes",
		"Touchscreen":                    "Yes",
		"Suspension Type":                "Double Wishbone / 5-Link",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := srs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ SsangYong Rexton specifications seeded successfully")
	return nil
}
