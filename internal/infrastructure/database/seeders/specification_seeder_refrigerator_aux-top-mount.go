...
// SpecificationSeederRefrigeratorAuxTopMount seeds specifications/options for product 'aux-top-mount'
type SpecificationSeederRefrigeratorAuxTopMount struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorAuxTopMount creates a new seeder instance
func NewSpecificationSeederRefrigeratorAuxTopMount() *SpecificationSeederRefrigeratorAuxTopMount {
	return &SpecificationSeederRefrigeratorAuxTopMount{
		BaseSeeder: BaseSeeder{name: "Specifications for aux-top-mount"},
	}
}

func (s *SpecificationSeederRefrigeratorAuxTopMount) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'aux-top-mount'
func (s *SpecificationSeederRefrigeratorAuxTopMount) Seed(db *gorm.DB) error {
	productSlug := "aux-top-mount"
