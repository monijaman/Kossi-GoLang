...
// SpecificationSeederRefrigeratorMideaInverter seeds specifications/options for product 'midea-inverter'
type SpecificationSeederRefrigeratorMideaInverter struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMideaInverter creates a new seeder instance
func NewSpecificationSeederRefrigeratorMideaInverter() *SpecificationSeederRefrigeratorMideaInverter {
	return &SpecificationSeederRefrigeratorMideaInverter{
		BaseSeeder: BaseSeeder{name: "Specifications for midea-inverter"},
	}
}

func (s *SpecificationSeederRefrigeratorMideaInverter) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'midea-inverter'
func (s *SpecificationSeederRefrigeratorMideaInverter) Seed(db *gorm.DB) error {
	productSlug := "midea-inverter"
