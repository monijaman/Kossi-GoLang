...
// SpecificationSeederRefrigeratorMarcelMfbA8eGdelXx seeds specifications/options for product 'marcel-mfb-a8e-gdel-xx'
type SpecificationSeederRefrigeratorMarcelMfbA8eGdelXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfbA8eGdelXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfbA8eGdelXx() *SpecificationSeederRefrigeratorMarcelMfbA8eGdelXx {
	return &SpecificationSeederRefrigeratorMarcelMfbA8eGdelXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfb-a8e-gdel-xx"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfbA8eGdelXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":                 "মার্সেল",
		"marcel-mfb-a8e-gdel-xx": "মার্সেল-mfb-a8e-gdel-xx",
		"MFB-A8E-GDEL-XX":        "MFB-A8E-GDEL-XX",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfb-a8e-gdel-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfbA8eGdelXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfb-a8e-gdel-xx"
