...
// SpecificationSeederRefrigeratorMarcelMfeB8bGdelXxInverter seeds specifications/options for product 'marcel-mfe-b8b-gdel-xx-inverter'
...
func NewSpecificationSeederRefrigeratorMarcelMfeB8bGdelXxInverter() *SpecificationSeederRefrigeratorMarcelMfeB8bGdelXxInverter {
	return &SpecificationSeederRefrigeratorMarcelMfeB8bGdelXxInverter{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfe-b8b-gdel-xx-inverter"},
	}
}
...
func (s *SpecificationSeederRefrigeratorMarcelMfeB8bGdelXxInverter) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":         "মার্সেল",
				"marcel-mfe-b8b-gdel-xx-inverter":         "মার্সেল-mfe-b8b-gdel-xx-inverter",
		"MFE-B8B-GDEL-XX-INVERTER":   "MFE-B8B-GDEL-XX-INVERTER",
		// Add more translations as needed
	}
}

// Seed inserts specification records for the product identified by slug 'marcel-mfe-b8b-gdel-xx-inverter'
func (s *SpecificationSeederRefrigeratorMarcelMfeB8bGdelXxInverter) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfe-b8b-gdel-xx-inverter"
	...
	specs := map[string]string{
		"Brand":                       "Marcel",
		"Model Name":                  "MFE-B8B-GDEL-XX-INVERTER",
