...
// DaihatsuSirionSeeder seeds specifications for Daihatsu Sirion
type DaihatsuSirionSeeder struct {
	BaseSeeder
}

// NewDaihatsuSirionSeeder creates a new Daihatsu Sirion seeder
func NewDaihatsuSirionSeeder() *DaihatsuSirionSeeder {
	return &DaihatsuSirionSeeder{
		BaseSeeder: BaseSeeder{name: "Daihatsu Sirion Specifications"},
	}
}

func (dss *DaihatsuSirionSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"998":                        "৯৯৮ সিসি",
		"3":                          "৩ (সিলিন্ডার)",
		"70 hp":                      "৭০ হর্স পাওয়ার",
		"70 hp @ 6000 rpm":           "৬০০০ আরপিএম এ ৭০ হর্স পাওয়ার",
		"94 Nm @ 3600 rpm":           "৩৬০০ আরপিএম এ ৯৪ এনএম",
		"Petrol":                     "পেট্রোল",
...
// Seed implements the Seeder interface for Daihatsu Sirion
func (dss *DaihatsuSirionSeeder) Seed(db *gorm.DB) error {
	productSlug := "daihatsu-sirion"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "76 hp/ton",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := dss.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Daihatsu Sirion specifications seeded successfully")
	return nil
}
