...
// HonorMagicbookX14Seeder seeds specifications for Honor MagicBook X14
type HonorMagicbookX14Seeder struct {
	BaseSeeder
}

// NewHonorMagicbookX14Seeder creates a new Honor MagicBook X14 seeder
func NewHonorMagicbookX14Seeder() *HonorMagicbookX14Seeder {
	return &HonorMagicbookX14Seeder{
		BaseSeeder: BaseSeeder{name: "Honor MagicBook X14 Specifications"},
	}
}

func (hms *HonorMagicbookX14Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Honor":                                "অনার",
		"MagicBook X14":                        "ম্যাজিকবুক এক্স১৪",
		...
		"Ice Crystal Silver":                   "আইস ক্রিস্টাল সিলভার",
		"1.38 kg":                              "১.৩৮ কেজি",
		"2023":                                 "২০২৩",
...
// Seed implements the Seeder interface for Honor MagicBook X14
func (hms *HonorMagicbookX14Seeder) Seed(db *gorm.DB) error {
	productSlug := "honor-magicbook-x14"
	...
	specs := map[string]string{
		...
		"Available Colors":        "Ice Crystal Silver",
	...
	log.Printf("✅ Honor MagicBook X14 specifications seeded successfully")
	return nil
}
