...
// SpecificationSeederMobileRealme15t5g seeds specifications/options for product 'realme-15t-5g'
type SpecificationSeederMobileRealme15t5g struct {
	BaseSeeder
}

// NewSpecificationSeederMobileRealme15t5g creates a new seeder instance
func NewSpecificationSeederMobileRealme15t5g() *SpecificationSeederMobileRealme15t5g {
	return &SpecificationSeederMobileRealme15t5g{BaseSeeder: BaseSeeder{name: "Specifications for Realme 15T 5G"}}
}

// getBanglaTranslations returns a map of English specification values to their Bangla translations
func (s *SpecificationSeederMobileRealme15t5g) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'realme-15t-5g'
func (s *SpecificationSeederMobileRealme15t5g) Seed(db *gorm.DB) error {
	productSlug := "realme-15t-5g"
	...
	// Override model-specific values for Realme 15T 5G
