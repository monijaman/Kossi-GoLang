...
// SpecificationSeederRefrigeratorKonkaKrt282egb seeds specifications/options for product 'konka-krt-282egb'
type SpecificationSeederRefrigeratorKonkaKrt282egb struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorKonkaKrt282egb creates a new seeder instance
func NewSpecificationSeederRefrigeratorKonkaKrt282egb() *SpecificationSeederRefrigeratorKonkaKrt282egb {
	return &SpecificationSeederRefrigeratorKonkaKrt282egb{
		BaseSeeder: BaseSeeder{name: "Specifications for konka-krt-282egb"},
	}
}

func (s *SpecificationSeederRefrigeratorKonkaKrt282egb) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Konka":              "কনকা",
		"KRT-282EGB":         "KRT-282EGB",
		"China":              "চীন",
...
func (s *SpecificationSeederRefrigeratorKonkaKrt282egb) Seed(db *gorm.DB) error {
	...
	specs := map[string]string{
		"Brand":                           "Konka",
		"Model Name":                      "KRT-282EGB-Light Silver with Spot, Upper Freezer, Electronics Control with Digital Display (282 LTR)",
		"Origin":                          "China",
		"Type":                            "Top Mount",
		...
		"Voltage":                         "125V~265V",
		"Frequency (Hz)":                  "50",
		"Color":                           "Light Silver with Spot",
		"Energy Efficiency Rating":        "BSTI 5 Star",
		"Special Features":                "Electronic Control with Digital Display, Digital Door Alarm, Supreme Freezing Capacity, BSTI 5 Star Energy Rating, Stylist Interior Decoration with LED Lighting, Wide Voltage range (125V~265V), Real Tempered Glass Door. Shiny, Colorful & Scratch Resistance, European Standard Anti-Fungal Door gasket, Large Moist Fresh Zone (Vegetable Box) with humidity adjust Control, Active Carbon Deodorizer Ensure odorless, fresh and pure air in the Refrigerator, Optimal humidity for lasting freshness, Garden Fresh Technology, Anti-microbial Technology (Nano- Sliver Technology), Interior parts are 100% Food Grade, Healthy, Fresh and Protect Vitamin, R600a Refrigerant Gas, 100% CFC and HCFC Free, Eco Friendly refrigerant, No destructive effect to the ozone sphere, The operating pressure of R600a is not high, so the noisy is very low, DEC System and Faster Cooling",
	}
