...
// PorscheCayenneSeeder seeds specifications for Porsche Cayenne
type PorscheCayenneSeeder struct {
	BaseSeeder
}

// NewPorscheCayenneSeeder creates a new Porsche Cayenne seeder
func NewPorscheCayenneSeeder() *PorscheCayenneSeeder {
	return &PorscheCayenneSeeder{
		BaseSeeder: BaseSeeder{name: "Porsche Cayenne Specifications"},
	}
}

func (pcs *PorscheCayenneSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"3.0L Turbo V6":                 "৩.০ লিটার টার্বো ভি৬",
		"Mid-size Luxury SUV":           "মিড-সাইজ লাক্সারি এসইউভি",
		"2023":                          "২০২৩",
		"SUV":                           "এসইউভি",
		"Carrara White":                 "কারারা হোয়াইট",
		"V":                             "ভি",
		"2995":                          "২৯৯৫ সিসি",
		"6":                             "৬ (সিলিন্ডার)",
		"340 hp":                        "৩৪০ হর্স পাওয়ার",
		"340 hp @ 5300 rpm":             "৫৩০০ আরপিএম এ ৩৪০ হর্স পাওয়ার",
		"450 Nm @ 1340 rpm":             "১৩৪০ আরপিএম এ ৪৫০ এনএম",
		"Petrol":                        "পেট্রোল",
		"Turbocharged":                  "টার্বোচার্জড",
		"6.2 seconds":                   "৬.২ সেকেন্ড",
		"245 km/h":                      "২৪৫ কিমি/ঘণ্টা",
		...
		"8-Speed Tiptronic S":           "৮-স্পিড টিপট্রনিক এস",
		"4926 mm":                       "৪৯২৬ মিমি",
		"1983 mm":                       "১৯৮৩ মিমি",
		"1696 mm":                       "১৬৯৬ মিমি",
		"2895 mm":                       "২৮৯৫ মিমি",
		...
		"3.0L Turbo V6":                 "৩.০লি টার্বো ভি৬",
		"Displacement":                  "ডিসপ্লেসমেন্ট",
		"2995 cc":                       "২৯৯৫ সিসি",
		"Max Power":                     "ম্যাক্স পাওয়ার",
		"340 hp @ 5300 rpm":             "৩৪০ হর্স পাওয়ার @ ৫৩০০ আরপিএম",
		"Max Torque":                    "ম্যাক্স টর্ক",
		"450 Nm @ 1340 rpm":             "৪৫০ এনএম @ ১৩৪০ আরপিএম",
...
func (pcs *PorscheCayenneSeeder) Seed(db *gorm.DB) error {
	...
	specifications := map[string]string{
		...
		"engine_max_power":            "340 hp @ 5300 rpm",
		"engine_max_torque":           "450 Nm @ 1340 rpm",
		"engine_fuel_supply_system":   "Direct Injection",
		"engine_bore_stroke":          "84.5 x 89.0 mm",
		"engine_compression_ratio":    "11.2:1",
		"engine_turbo_charger":        "Yes",
		"engine_super_charger":        "No",
		"transmission_type":           "Automatic",
		"transmission_gearbox":        "8-Speed",
		"transmission_drive_type":     "AWD",
		"transmission_clutch_type":    "8-Speed Tiptronic S",
		"performance_top_speed":       "245 km/h",
		"performance_acceleration":    "6.2 seconds",
		...
		"dimensions_length":           "4926 mm",
		"dimensions_width":            "1983 mm",
		"dimensions_height":           "1696 mm",
		"dimensions_wheelbase":        "2895 mm",
		"dimensions_front_tread":      "1691 mm",
		"dimensions_rear_tread":       "1678 mm",
		"dimensions_ground_clearance": "190 mm",
		"dimensions_boot_space":       "745 L",
		"dimensions_fuel_tank":        "75 L",
		"dimensions_turning_radius":   "6.0 m",
		"weight_kerb_weight":          "1980 kg",
		"weight_gross_weight":         "2710 kg",
		...
		"brakes_front":                "Disc",
		"brakes_rear":                 "Disc",
		"tyres_size":                  "275/45 R20",
		"tyres_wheel_size":            "20 inches",
		"tyres_spare_size":            "275/45 R20",
		"exterior_colors":             "Carrara White, Black, White, Silver, Blue, Red, Gray, Green, Orange",
	...
	log.Printf("Seeded specifications for Porsche Cayenne")
	return nil
}
