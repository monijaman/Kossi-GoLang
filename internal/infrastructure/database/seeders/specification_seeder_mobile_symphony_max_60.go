...
func (s *SpecificationSeederMobileSymphonyMax60) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"64 GB (expandable up to 256GB)": "৬৪ জিবি (expএবংable পর্যন্ত ২৫৬GB)",
		...
		"Side fingerprint, accelerometer, proximity": "সাইড ফিঙ্গারপ্রিন্ট, অ্যাক্সিলেরোমিটার, প্রক্সিমিটি",
		"Space Black, Frost Blue, Classic Navy Blue, Titanium Gray, Divine Gold": "স্পেস কালো, ফ্রস্ট নীল, ক্লাসিক নেভি নীল, টাইটানিয়াম ধূসর, ডিভাইন সোনালী",
		"Unisoc SC9863A1": "ইউনিসক SC৯৮৬৩A১",
		"Unisoc SC9863A1 (28 nm)": "ইউনিসক SC৯৮৬৩A১ (২৮ ন্যানোমিটার)",
		"Wi-Fi, Bluetooth 5.0, OTG": "ওয়াই-ফাই, নীলথেকেoth ৫.০, OTG",
	}
}
