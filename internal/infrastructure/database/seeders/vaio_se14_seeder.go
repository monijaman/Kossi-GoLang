...
// VaioSe14Seeder seeds specifications for VAIO SE14
type VaioSe14Seeder struct {
	BaseSeeder
}

// NewVaioSe14Seeder creates a new VAIO SE14 seeder
func NewVaioSe14Seeder() *VaioSe14Seeder {
	return &VaioSe14Seeder{
		BaseSeeder: BaseSeeder{name: "VAIO SE14 Specifications"},
	}
}

func (vss *VaioSe14Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"326 x 226 x 16.9 mm":                  "৩২৬ x ২২৬ x ১৬.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"4":                                    "৪",
		"8":                                    "৮",
...
// Seed implements the Seeder interface for VAIO SE14
func (vss *VaioSe14Seeder) Seed(db *gorm.DB) error {
	productSlug := "vaio-se14"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "326 x 226 x 16.9 mm",
		"Body Type":               "Plastic",
	...
	log.Printf("✅ VAIO SE14 specifications seeded successfully")
	return nil
}
