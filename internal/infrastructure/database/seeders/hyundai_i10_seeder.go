...
// HyundaiI10Seeder seeds specifications for Hyundai i10
type HyundaiI10Seeder struct {
	BaseSeeder
}

// NewHyundaiI10Seeder creates a new Hyundai i10 seeder
func NewHyundaiI10Seeder() *HyundaiI10Seeder {
	return &HyundaiI10Seeder{
		BaseSeeder: BaseSeeder{name: "Hyundai i10 Specifications"},
	}
}

func (his *HyundaiI10Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"69 hp @ 6200 rpm":                "৬২০০ আরপিএম এ ৬৯ হর্স পাওয়ার",
...
// Seed implements the Seeder interface for Hyundai i10
func (his *HyundaiI10Seeder) Seed(db *gorm.DB) error {
	productSlug := "hyundai-i10"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "81 hp/ton",
	...
	log.Printf("✅ Hyundai i10 specifications seeded successfully")
	return nil
}
