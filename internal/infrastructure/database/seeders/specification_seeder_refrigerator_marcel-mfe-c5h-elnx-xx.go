...
// SpecificationSeederRefrigeratorMarcelMfeC5hElnxXx seeds specifications/options for product 'marcel-mfe-c5h-elnx-xx'
...
func NewSpecificationSeederRefrigeratorMarcelMfeC5hElnxXx() *SpecificationSeederRefrigeratorMarcelMfeC5hElnxXx {
	return &SpecificationSeederRefrigeratorMarcelMfeC5hElnxXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfe-c5h-elnx-xx"},
	}
}
...
func (s *SpecificationSeederRefrigeratorMarcelMfeC5hElnxXx) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":         "মার্সেল",
		"marcel-mfe-c5h-elnx-xx":         "মার্সেল-এমএফই-সি৫এইচ-ইএলএনএক্স-এক্সএক্স",
		// Add more translations as needed
	}
}

// Seed inserts specification records for the product identified by slug 'marcel-mfe-c5h-elnx-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfeC5hElnxXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfe-c5h-elnx-xx"
