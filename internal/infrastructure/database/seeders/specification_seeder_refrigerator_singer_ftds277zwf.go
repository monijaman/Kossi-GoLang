...
// SpecificationSeederRefrigeratorSingerFTDS277ZWF seeds specifications/options for product 'singer-ftds277zwf'
type SpecificationSeederRefrigeratorSingerFTDS277ZWF struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS277ZWF creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS277ZWF() *SpecificationSeederRefrigeratorSingerFTDS277ZWF {
	return &SpecificationSeederRefrigeratorSingerFTDS277ZWF{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds277zwf"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS277ZWF) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                    "সিঙ্গার",
		"FTDS277ZWF-RG":             "FTDS277ZWF-RG",
		...
		"1799 x 595 x 605 mm":       "1799 x 595 x 605৪৪ মিমি",
		"221 kg":                    "221 kg",
		"Silver":                    "সিলভার",
		"Inverter":                  "ইনভার্টার",
...
// Seed inserts specification records for the product identified by slug 'singer-ftds277zwf'
func (s *SpecificationSeederRefrigeratorSingerFTDS277ZWF) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds277zwf"
