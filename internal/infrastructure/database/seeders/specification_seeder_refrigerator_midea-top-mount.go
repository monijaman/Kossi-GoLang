...
// SpecificationSeederRefrigeratorMideaTopMount seeds specifications/options for product 'midea-top-mount'
type SpecificationSeederRefrigeratorMideaTopMount struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMideaTopMount creates a new seeder instance
func NewSpecificationSeederRefrigeratorMideaTopMount() *SpecificationSeederRefrigeratorMideaTopMount {
	return &SpecificationSeederRefrigeratorMideaTopMount{
		BaseSeeder: BaseSeeder{name: "Specifications for midea-top-mount"},
	}
}

func (s *SpecificationSeederRefrigeratorMideaTopMount) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'midea-top-mount'
func (s *SpecificationSeederRefrigeratorMideaTopMount) Seed(db *gorm.DB) error {
	productSlug := "midea-top-mount"
