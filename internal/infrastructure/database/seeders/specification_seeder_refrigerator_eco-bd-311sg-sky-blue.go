...
// SpecificationSeederRefrigeratorecobd311sgskyblue seeds specifications/options for product 'eco-bd-311sg-sky-blue'
type SpecificationSeederRefrigeratorecobd311sgskyblue struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecobd311sgskyblue creates a new seeder instance
func NewSpecificationSeederRefrigeratorecobd311sgskyblue() *SpecificationSeederRefrigeratorecobd311sgskyblue {
	return &SpecificationSeederRefrigeratorecobd311sgskyblue{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-bd-311sg-sky-blue"},
	}
}

func (s *SpecificationSeederRefrigeratorecobd311sgskyblue) getBanglaTranslations() map[string]string {
	return map[string]string{
		"ECO+":                   "ইকো+",
		"ECO+ BD-311SG Sky Blue": "ECO+ BD-311SG Sky Blue",
...
// Seed inserts specification records for the product identified by slug 'eco-bd-311sg-sky-blue'
func (s *SpecificationSeederRefrigeratorecobd311sgskyblue) Seed(db *gorm.DB) error {
	productSlug := "eco-bd-311sg-sky-blue"
	...
	specs := map[string]string{
		"Brand":                       "ECO+",
		"Model Name":                  "ECO+ BD-311SG Sky Blue",
