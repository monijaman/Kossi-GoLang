...
// ChevroletCruzeSeeder seeds specifications for Chevrolet Cruze
type ChevroletCruzeSeeder struct {
	BaseSeeder
}

// NewChevroletCruzeSeeder creates a new Chevrolet Cruze seeder
func NewChevroletCruzeSeeder() *ChevroletCruzeSeeder {
	return &ChevroletCruzeSeeder{
		BaseSeeder: BaseSeeder{name: "Chevrolet Cruze Specifications"},
	}
}

func (ccs *ChevroletCruzeSeeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Chevrolet Cruze
func (ccs *ChevroletCruzeSeeder) Seed(db *gorm.DB) error {
	productSlug := "chevrolet-cruze"
	...
	log.Printf("✅ Chevrolet Cruze specifications seeded successfully")
	return nil
}
