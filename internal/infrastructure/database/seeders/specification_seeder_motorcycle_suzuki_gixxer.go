...
// SpecificationSeederMotorcycleSuzukiGixxer seeds specifications/options for product 'suzuki-gixxer'
type SpecificationSeederMotorcycleSuzukiGixxer struct {
	BaseSeeder
}

// NewSpecificationSeederMotorcycleSuzukiGixxer creates a new seeder instance
func NewSpecificationSeederMotorcycleSuzukiGixxer() *SpecificationSeederMotorcycleSuzukiGixxer {
	return &SpecificationSeederMotorcycleSuzukiGixxer{BaseSeeder: BaseSeeder{name: "Specifications for Suzuki Gixxer"}}
}

// Seed inserts specification records for the product identified by slug 'suzuki-gixxer'
func (s *SpecificationSeederMotorcycleSuzukiGixxer) Seed(db *gorm.DB) error {
	productSlug := "suzuki-gixxer"
	...
	// Override model-specific values for Suzuki Gixxer
	...
	specs["Mileage"] = "40-50 km/l (approx)"
