...
// TeclastF15PlusSeeder seeds specifications for Teclast F15 Plus
type TeclastF15PlusSeeder struct {
	BaseSeeder
}

// NewTeclastF15PlusSeeder creates a new Teclast F15 Plus seeder
func NewTeclastF15PlusSeeder() *TeclastF15PlusSeeder {
	return &TeclastF15PlusSeeder{
		BaseSeeder: BaseSeeder{name: "Teclast F15 Plus Specifications"},
	}
}

func (tfps *TeclastF15PlusSeeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Teclast F15 Plus
func (tfps *TeclastF15PlusSeeder) Seed(db *gorm.DB) error {
	productSlug := "teclast-f15-plus"
	...
	log.Printf("✅ Teclast F15 Plus specifications seeded successfully")
	return nil
}
