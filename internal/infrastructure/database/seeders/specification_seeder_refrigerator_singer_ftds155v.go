...
// SpecificationSeederRefrigeratorSingerFTDS155V seeds specifications/options for product 'singer-ftds155v'
type SpecificationSeederRefrigeratorSingerFTDS155V struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS155V creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS155V() *SpecificationSeederRefrigeratorSingerFTDS155V {
	return &SpecificationSeederRefrigeratorSingerFTDS155V{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds155v"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS155V) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'singer-ftds155v'
func (s *SpecificationSeederRefrigeratorSingerFTDS155V) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds155v"
