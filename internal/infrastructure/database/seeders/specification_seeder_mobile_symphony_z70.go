...
func (s *SpecificationSeederMobileSymphonyZ70) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"52 MP + 2 MP + 2 MP": "৫২ মেগাপিক্সেল + ২ মেগাপিক্সেল + ২ মেগাপিক্সেল",
		"6.56 inches": "৬.৫৬ ইঞ্চি",
		"64 GB": "৬৪ GB",
		"650 MHz GPU": "৬৫০ মেগাহার্টজ GPU",
		"720 × 1612 px": "৭২০ × ১৬১২ পিক্সেল",
		"8 MP": "৮ মেগাপিক্সেল",
		"Android 13": "অ্যান্ড্রয়েড ১৩",
		"November 2024": "নভেম্বর ২০২৪",
		"Octa-core 1.6 GHz": "অক্টা-কোর ১.৬ গিগাহার্টজ",
		"Reflective Green, Electric Blue, Honey Dew Green, Fusion Gold": "রিফ্লেক্টিভ সবুজ, Electric নীল, Honey Dew সবুজ, Fusion সোনালী",
		"Side fingerprint, accelerometer, proximity, compass": "সাইড ফিঙ্গারপ্রিন্ট, অ্যাক্সিলেরোমিটার, প্রক্সিমিটি, কম্পাস",
		"Unisoc T606": "ইউনিসক T৬০৬",
		"Unisoc T606 (12 nm)": "ইউনিসক T৬০৬ (১২ ন্যানোমিটার)",
		"Wi-Fi, Bluetooth 5.0, USB-C, OTG": "ওয়াই-ফাই, নীলথেকেoth ৫.০, ইউএসবি-সি, OTG",
	}
}
