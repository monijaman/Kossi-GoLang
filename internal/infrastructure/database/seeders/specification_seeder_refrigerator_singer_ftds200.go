...
// SpecificationSeederRefrigeratorSingerFTDS200 seeds specifications/options for product 'singer-ftds200'
type SpecificationSeederRefrigeratorSingerFTDS200 struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS200 creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS200() *SpecificationSeederRefrigeratorSingerFTDS200 {
	return &SpecificationSeederRefrigeratorSingerFTDS200{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds200"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS200) getBanglaTranslations() map[string]string {
...
// Seed inserts specification records for the product identified by slug 'singer-ftds200'
func (s *SpecificationSeederRefrigeratorSingerFTDS200) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds200"
