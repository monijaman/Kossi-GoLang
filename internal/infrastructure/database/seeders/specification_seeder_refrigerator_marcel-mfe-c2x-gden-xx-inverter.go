...
// SpecificationSeederRefrigeratorMarcelMfeC2xGdenXxInverter seeds specifications/options for product 'marcel-mfe-c2x-gden-xx-inverter'
type SpecificationSeederRefrigeratorMarcelMfeC2xGdenXxInverter struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfeC2xGdenXxInverter creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfeC2xGdenXxInverter() *SpecificationSeederRefrigeratorMarcelMfeC2xGdenXxInverter {
	return &SpecificationSeederRefrigeratorMarcelMfeC2xGdenXxInverter{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfe-c2x-gden-xx-inverter"},
	}
}

func (s *SpecificationSeederRefrigeratorMarcelMfeC2xGdenXxInverter) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Marcel":                            "মার্সেল",
		"marcel-mfe-c2x-gden-xx-inverter":   "মার্সেল-mfe-c2x-gden-xx-inverter",
		"MFE-C2X-GDEN-XX-INVERTER":          "MFE-C2X-GDEN-XX-INVERTER",
...
// Seed inserts specification records for the product identified by slug 'marcel-mfe-c2x-gden-xx-inverter'
func (s *SpecificationSeederRefrigeratorMarcelMfeC2xGdenXxInverter) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfe-c2x-gden-xx-inverter"
	...
	specs := map[string]string{
		"Brand":               "Marcel",
		"Model Name":          "MFE-C2X-GDEN-XX-INVERTER",
		"Can Storage Dispenser": "No",
		"Capillary": "Copper",
		"Climatic Type (SN, N, ST, T)": "N ~ ST",
		"Compressor Input Power (Watt)": "V 0301 - 38~109",
		...
		"Recommended voltage stabilizer capacity": "No need to use voltage stabilizer",
