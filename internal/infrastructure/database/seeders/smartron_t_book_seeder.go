...
// SmartronTBookSeeder seeds specifications for Smartron t.book
type SmartronTBookSeeder struct {
	BaseSeeder
}

// NewSmartronTBookSeeder creates a new Smartron t.book seeder
func NewSmartronTBookSeeder() *SmartronTBookSeeder {
	return &SmartronTBookSeeder{
		BaseSeeder: BaseSeeder{name: "Smartron t.book Specifications"},
	}
}

func (stbs *SmartronTBookSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"325 x 220 x 17.9 mm":                  "৩২৫ x ২২০ x ১৭.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"10":                                   "১০",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for Smartron t.book
func (stbs *SmartronTBookSeeder) Seed(db *gorm.DB) error {
	productSlug := "smartron-t.book"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "325 x 220 x 17.9 mm",
		"Body Type":               "Plastic",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := stbs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Smartron t.book specifications seeded successfully")
	return nil
}
