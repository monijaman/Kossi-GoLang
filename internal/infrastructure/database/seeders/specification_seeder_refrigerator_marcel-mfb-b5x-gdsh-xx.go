...
// SpecificationSeederRefrigeratorMarcelMfbB5xGdshXx seeds specifications/options for product 'mfb-b5x-gdsh-xx'
...
func NewSpecificationSeederRefrigeratorMarcelMfbB5xGdshXx() *SpecificationSeederRefrigeratorMarcelMfbB5xGdshXx {
	return &SpecificationSeederRefrigeratorMarcelMfbB5xGdshXx{
		BaseSeeder: BaseSeeder{name: "Specifications for mfb-b5x-gdsh-xx"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'mfb-b5x-gdsh-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfbB5xGdshXx) Seed(db *gorm.DB) error {
	productSlug := "mfb-b5x-gdsh-xx"
