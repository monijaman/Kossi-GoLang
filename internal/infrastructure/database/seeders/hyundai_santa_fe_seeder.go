...
// HyundaiSantaFeSeeder seeds specifications for Hyundai Santa Fe
type HyundaiSantaFeSeeder struct {
	BaseSeeder
}

// NewHyundaiSantaFeSeeder creates a new Hyundai Santa Fe seeder
func NewHyundaiSantaFeSeeder() *HyundaiSantaFeSeeder {
	return &HyundaiSantaFeSeeder{
		BaseSeeder: BaseSeeder{name: "Hyundai Santa Fe Specifications"},
	}
}

func (hss *HyundaiSantaFeSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"440 Nm @ 1750-2750 rpm":       "১৭৫০-২৭৫০ আরপিএম এ ৪৪০ এনএম",
		"Diesel":                       "ডিজেল",
...
// Seed implements the Seeder interface for Hyundai Santa Fe
func (hss *HyundaiSantaFeSeeder) Seed(db *gorm.DB) error {
	productSlug := "hyundai-santa-fe"
	...
	log.Printf("✅ Hyundai Santa Fe specifications seeded successfully")
	return nil
}
