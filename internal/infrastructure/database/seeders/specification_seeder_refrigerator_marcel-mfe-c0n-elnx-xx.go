...
// SpecificationSeederRefrigeratorMarcelMfeC0nElnxXx seeds specifications/options for product 'marcel-mfe-c0n-elnx-xx'
type SpecificationSeederRefrigeratorMarcelMfeC0nElnxXx struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorMarcelMfeC0nElnxXx creates a new seeder instance
func NewSpecificationSeederRefrigeratorMarcelMfeC0nElnxXx() *SpecificationSeederRefrigeratorMarcelMfeC0nElnxXx {
	return &SpecificationSeederRefrigeratorMarcelMfeC0nElnxXx{
		BaseSeeder: BaseSeeder{name: "Specifications for marcel-mfe-c0n-elnx-xx"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'marcel-mfe-c0n-elnx-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfeC0nElnxXx) Seed(db *gorm.DB) error {
	productSlug := "marcel-mfe-c0n-elnx-xx"
	...
	specs := map[string]string{
		...
		"Capillary": "Copper",
		"Climate Class": "N ~ ST",
		"Compressor Input Power (Watt)": "V 0101- 118V 0201- 109",
		"Compressor Type": "V 0101- RSCRV 0201- RSCR",
		"Condenser": "V 0101- CopperV 0201- Copper",
		...
		"Recommended voltage stabilizer capacity": "Wide Voltage Range (140Vac - 260Vac). Voltage stabilizer is not required.In case of voltages beyond this range, 2100VA is recommended",
		"Reversible Door": "No",
		...
		"Weight/Kg - Net/Packing:": "59 /64.5± 2 Kg",
		"Width/mm": "594",
	}
