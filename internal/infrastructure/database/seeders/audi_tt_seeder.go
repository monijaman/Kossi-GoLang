...
// AudiTTSeeder seeds specifications for Audi TT
type AudiTTSeeder struct {
	BaseSeeder
}

// NewAudiTTSeeder creates a new Audi TT seeder
func NewAudiTTSeeder() *AudiTTSeeder {
	return &AudiTTSeeder{
		BaseSeeder: BaseSeeder{name: "Audi TT Specifications"},
	}
}

func (ats *AudiTTSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"1984":                         "১৯৮৪ সিসি",
		"4":                            "৪ (সিলিন্ডার)",
		"230 hp":                       "২৩০ হর্স পাওয়ার",
		"230 hp @ 4500 rpm":            "৪৫০০ আরপিএম এ ২৩০ হর্স পাওয়ার",
		"370 Nm @ 1600-4300 rpm":       "১৬০০-৪৩০০ আরপিএম এ ৩৭০ এনএম",
		"Petrol":                       "পেট্রোল",
		"Turbocharged":                 "টার্বোচার্জড",
		"6.0 seconds":                  "৬.০ সেকেন্ড",
		...
		"Audi (Sound System)":          "অডি (সাউন্ড সিস্টেম)",
...
// Seed implements the Seeder interface for Audi TT
func (ats *AudiTTSeeder) Seed(db *gorm.DB) error {
	productSlug := "audi-tt"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "163 hp/ton",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := ats.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Audi TT specifications seeded successfully")
	return nil
}
