...
func (s *SpecificationSeederMobileSymphonyS72) getBanglaTranslations() map[string]string {
	return map[string]string{
		"0.08 MP": "০.০৮ মেগাপিক্সেল",
		"1000 contacts": "১০০০ contacts",
		"128 × 160 px": "১২৮ × ১৬০ পিক্সেল",
		"1500 mAh": "১৫০০ এমএএইচ",
		"2.4 inches": "২.৪ ইঞ্চি",
		"2G GSM": "২G জিএসএম",
		"Bluetooth, microUSB, 3.5mm jack": "নীলথেকেoth, microUSB, ৩.৫mm jack",
		"December 2024": "ডিসেম্বর ২০২৪",
		"Li-Ion (removable)": "লি-আয়ন (removable)",
		"Straw Green, Dew Green, Ocean Blue, Ink Black, Caramel Gold": "Straw সবুজ, Dew সবুজ, ওশান নীল, Ink কালো, Caramel সোনালী",
		"microSD up to 16 GB": "মাইক্রোএসডি পর্যন্ত ১৬ GB",
	}
}
