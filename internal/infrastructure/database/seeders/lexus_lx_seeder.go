...
// LexusLXSeeder seeds specifications for Lexus LX
type LexusLXSeeder struct {
	BaseSeeder
}

// NewLexusLXSeeder creates a new Lexus LX seeder
func NewLexusLXSeeder() *LexusLXSeeder {
	return &LexusLXSeeder{
		BaseSeeder: BaseSeeder{name: "Lexus LX Specifications"},
	}
}

func (llxs *LexusLXSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"3.4L V6 Turbo":                 "৩.৪ লিটার ভি৬ টার্বো",
		"Full-size Luxury SUV":          "ফুল-সাইজ লাক্সারি এসইউভি",
		"2023":                          "২০২৩",
		"SUV":                           "এসইউভি",
		"Starlight Black":               "স্টারলাইট ব্ল্যাক",
		"V":                             "ভি",
		"3345":                          "৩৩৪৫ সিসি",
		"6":                             "৬ (সিলিন্ডার)",
		"415 hp":                        "৪১৫ হর্স পাওয়ার",
		"415 hp @ 5200 rpm":             "৫২০০ আরপিএম এ ৪১৫ হর্স পাওয়ার",
		"650 Nm @ 2000 rpm":             "২০০০ আরপিএম এ ৬৫০ এনএম",
		"Petrol":                        "পেট্রোল",
		...
		"10-Speed Automatic":            "১০-স্পিড অটোমেটিক",
		"All-Wheel Drive":               "অল-হুইল ড্রাইভ",
		"Multi-Terrain Select":          "মাল্টি-টেরেইন সিলেক্ট",
		"5080 mm":                       "৫০৮০ মিমি",
		"1980 mm":                       "১৯৮০ মিমি",
		"1895 mm":                       "১৮৯৫ মিমি",
		"2850 mm":                       "২৮৫০ মিমি",
		...
		"40:20:40 Split":                "৪০:২০:৪০ স্প্লিট",
		...
		"3.4L V6 Turbo":                 "৩.৪লি ভি৬ টার্বো",
		"Displacement":                  "ডিসপ্লেসমেন্ট",
		"3345 cc":                       "৩৩৪৫ সিসি",
		"Max Power":                     "ম্যাক্স পাওয়ার",
		"415 hp @ 5200 rpm":             "৪১৫ হর্স পাওয়ার @ ৫২০০ আরপিএম",
		"Max Torque":                    "ম্যাক্স টর্ক",
		"650 Nm @ 2000 rpm":             "৬৫০ এনএম @ ২০০০ আরপিএম",
		...
		"86.0 x 96.0 mm":                "৮৬.০ x ৯৬.০ মিমি",
...
func (llxs *LexusLXSeeder) Seed(db *gorm.DB) error {
	// First, find or create the product
	var product models.ProductModel
	if err := db.Where("name = ?", "Lexus LX").First(&product).Error; err != nil {
		if err == gorm.ErrRecordNotFound {
			product = models.ProductModel{
				Name:        "Lexus LX",
				Brand:       "Lexus",
				Category:    "SUV",
				Subcategory: "Full-size Luxury SUV",
				Status:      1,
			}
	...
	specifications := map[string]string{
		...
		"engine_max_power":            "415 hp @ 5200 rpm",
		"engine_max_torque":           "650 Nm @ 2000 rpm",
		"engine_fuel_supply_system":   "Direct Injection",
		"engine_bore_stroke":          "86.0 x 96.0 mm",
		"engine_compression_ratio":    "10.4:1",
		"engine_turbo_charger":        "Yes",
		"engine_super_charger":        "No",
		"transmission_type":           "Automatic",
		"transmission_gearbox":        "10-Speed",
		"transmission_drive_type":     "AWD",
		"transmission_clutch_type":    "Multi-Terrain Select",
		"performance_top_speed":       "220 km/h",
		"performance_acceleration":    "6.4 seconds",
		"performance_mileage_arai":    "8 km/L",
		"performance_mileage_city":    "6 km/L",
		"performance_mileage_highway": "10 km/L",
		"performance_emission_norm":   "BS VI",
		"dimensions_length":           "5080 mm",
		"dimensions_width":            "1980 mm",
		"dimensions_height":           "1895 mm",
		"dimensions_wheelbase":        "2850 mm",
		"dimensions_front_tread":      "1680 mm",
		"dimensions_rear_tread":       "1685 mm",
		"dimensions_ground_clearance": "205 mm",
		"dimensions_boot_space":       "258 L",
		"dimensions_fuel_tank":        "80 L",
		"dimensions_turning_radius":   "6.2 m",
		"weight_kerb_weight":          "2585 kg",
		"weight_gross_weight":         "3265 kg",
		...
		"brakes_front":                "Disc",
		"brakes_rear":                 "Disc",
		"tyres_size":                  "275/50 R20",
		"tyres_wheel_size":            "20 inches",
		"tyres_spare_size":            "275/50 R20",
		"exterior_colors":             "Starlight Black, Black, Gray, White, Silver, Blue, Red, Brown, Green",
	...
	for key, value := range specifications {
		if specKeyID, exists := specKeyMap[key]; exists {
			...
			translation := models.SpecificationTranslationModel{
				...
				LanguageCode:    "bn",
				Value:           llxs.getBanglaTranslations()[value],
				Status:          1,
			}
	...
	log.Printf("Seeded specifications for Lexus LX")
	return nil
}
