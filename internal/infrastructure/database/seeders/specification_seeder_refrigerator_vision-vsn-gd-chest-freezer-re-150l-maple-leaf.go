...
// SpecificationSeederRefrigeratorVisionVSNGDChestFreezerRE150LMapleLeaf seeds specifications/options for product 'vision-vsn-gd-chest-freezer-re-150l-maple-leaf'
type SpecificationSeederRefrigeratorVisionVSNGDChestFreezerRE150LMapleLeaf struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorVisionVSNGDChestFreezerRE150LMapleLeaf creates a new seeder instance
func NewSpecificationSeederRefrigeratorVisionVSNGDChestFreezerRE150LMapleLeaf() *SpecificationSeederRefrigeratorVisionVSNGDChestFreezerRE150LMapleLeaf {
	return &SpecificationSeederRefrigeratorVisionVSNGDChestFreezerRE150LMapleLeaf{
		BaseSeeder: BaseSeeder{name: "Specifications for vision-vsn-gd-chest-freezer-re-150l-maple-leaf"},
	}
}

func (s *SpecificationSeederRefrigeratorVisionVSNGDChestFreezerRE150LMapleLeaf) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Vision": "ভিশন",
		"VSN GD Chest Freezer RE-150L Maple Leaf Red Wave": "ভিএসএন জিডি চেস্ট ফ্রিজার আরই-১৫০এল ম্যাপল লিফ রেড ওয়েভ",
		"Chest":               "চেস্ট",
		...
		"37 kg":               "৩৭ কেজি",
		"Maple Leaf Red Wave": "ম্যাপল লিফ রেড ওয়েভ",
...
// Seed inserts specification records for the product identified by slug 'vision-vsn-gd-chest-freezer-re-150l-maple-leaf'
func (s *SpecificationSeederRefrigeratorVisionVSNGDChestFreezerRE150LMapleLeaf) Seed(db *gorm.DB) error {
	productSlug := "vision-vsn-gd-chest-freezer-re-150l-maple-leaf"
	...
	specs := map[string]string{
		"Brand":                       "Vision",
		"Model Name":                  "VSN GD Chest Freezer RE-150L Maple Leaf Red Wave",
		"Door Type":                   "Chest",
		"Capacity":                    "150 Liters",
