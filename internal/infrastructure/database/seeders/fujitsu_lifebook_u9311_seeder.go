...
// FujitsuLifeBookU9311Seeder seeds specifications for Fujitsu LifeBook U9311
type FujitsuLifeBookU9311Seeder struct {
	BaseSeeder
}

// NewFujitsuLifeBookU9311Seeder creates a new Fujitsu LifeBook U9311 seeder
func NewFujitsuLifeBookU9311Seeder() *FujitsuLifeBookU9311Seeder {
	return &FujitsuLifeBookU9311Seeder{
		BaseSeeder: BaseSeeder{name: "Fujitsu LifeBook U9311 Specifications"},
	}
}

func (flus *FujitsuLifeBookU9311Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Fujitsu":                       "ফুজিতসু",
		"LifeBook U9311":                "লাইফবুক ইউ৯৩১১",
		...
		"307 x 211 x 15.5 mm":                  "৩০৭ x ২১১ x ১৫.৫ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"4":                                    "৪",
		"8":                                    "৮",
...
// Seed implements the Seeder interface for Fujitsu LifeBook U9311
func (flus *FujitsuLifeBookU9311Seeder) Seed(db *gorm.DB) error {
	productSlug := "fujitsu-lifebook-u9311"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "307 x 211 x 15.5 mm",
		"Body Type":               "Aluminum",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := flus.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Fujitsu LifeBook U9311 specifications seeded successfully")
	return nil
}
