...
// AppleMacbookAirM313Seeder seeds specifications for Apple MacBook Air M3 13-inch
type AppleMacbookAirM313Seeder struct {
	BaseSeeder
}

// NewAppleMacbookAirM313Seeder creates a new Apple MacBook Air M3 13-inch seeder
func NewAppleMacbookAirM313Seeder() *AppleMacbookAirM313Seeder {
	return &AppleMacbookAirM313Seeder{
		BaseSeeder: BaseSeeder{name: "Apple MacBook Air M3 13-inch Specifications"},
	}
}

func (amas *AppleMacbookAirM313Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Apple":                         "অ্যাপল",
		"MacBook Air M3 13-inch":        "ম্যাকবুক এয়ার এম৩ ১৩-ইঞ্চি",
...
// Seed implements the Seeder interface for Apple MacBook Air M3 13-inch
func (amas *AppleMacbookAirM313Seeder) Seed(db *gorm.DB) error {
	productSlug := "apple-macbook-air-m3-13-inch"
	...
	specs := map[string]string{
		"Brand":                "Apple",
		"Model Name":           "MacBook Air M3 13-inch",
	...
	log.Printf("✅ Apple MacBook Air M3 13-inch specifications seeded successfully")
	return nil
}
