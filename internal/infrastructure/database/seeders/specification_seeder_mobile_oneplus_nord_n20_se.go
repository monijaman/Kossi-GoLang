...
func (s *SpecificationSeederMobileOneplusNordN20Se) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"8 MP": "৮ মেগাপিক্সেল",
		"Android 12, OxygenOS 12.1": "অ্যান্ড্রয়েড ১২, OxygenOS ১২.১",
		"August 2022": "আগস্ট ২০২২",
		"Blue Oasis, Celestial Black": "নীল ওয়েসিস, Celestial কালো",
		"Glass front, plastic frame, plastic back": "গ্লাস সামনে, প্লাস্টিক ফ্রেম, প্লাস্টিক পেছনে",
		"Helio G35": "হেলিও G৩৫",
		"IPS LCD, 600 nits": "আইপিএস এলসিডি, ৬০০ nits",
		"Mediatek MT6765G Helio G35 (12 nm)": "মিডিয়াটেক MT৬৭৬৫G হেলিও G৩৫ (১২ ন্যানোমিটার)",
