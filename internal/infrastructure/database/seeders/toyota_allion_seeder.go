...
// ToyotaAllionSeeder seeds specifications for Toyota Allion
type ToyotaAllionSeeder struct {
	BaseSeeder
}

// NewToyotaAllionSeeder creates a new Toyota Allion seeder
...
func (tas *ToyotaAllionSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"CVT: 19 km/L":                          "সিভিটি: ১৯ কিমি/লিটার",
...
// Seed inserts specification records for Toyota Allion
func (tas *ToyotaAllionSeeder) Seed(db *gorm.DB) error {
	productSlug := "toyota-allion"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "88 hp/ton",
