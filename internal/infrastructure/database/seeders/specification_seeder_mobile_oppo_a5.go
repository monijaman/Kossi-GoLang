...
func (s *SpecificationSeederMobileOppoA5) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"12 MP + 2 MP + 2 MP + 2 MP": "১২ মেগাপিক্সেল + ২ মেগাপিক্সেল + ২ মেগাপিক্সেল + ২ মেগাপিক্সেল",
		...
		"Android 10, ColorOS 7": "অ্যান্ড্রয়েড ১০, কালারওএস ৭",
		...
		"Snapdragon 665": "স্ন্যাপড্রাগন ৬৬৫",
		"Snapdragon 665 (11 nm)": "স্ন্যাপড্রাগন ৬৬৫ (১১ ন্যানোমিটার)",
