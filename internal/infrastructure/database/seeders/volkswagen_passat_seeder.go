...
// VolkswagenPassatSeeder seeds specifications for Volkswagen Passat
type VolkswagenPassatSeeder struct {
	BaseSeeder
}

// NewVolkswagenPassatSeeder creates a new Volkswagen Passat seeder
func NewVolkswagenPassatSeeder() *VolkswagenPassatSeeder {
	return &VolkswagenPassatSeeder{
		BaseSeeder: BaseSeeder{name: "Volkswagen Passat Specifications"},
	}
}

func (vps *VolkswagenPassatSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"320 Nm @ 1500-4180 rpm":       "১৫০০-৪১৮০ আরপিএম এ ৩২০ এনএম",
		"Diesel":                       "ডিজেল",
		"Turbocharged":                 "টার্বোচার্জড",
		"8.0 seconds":                  "৮.০ সেকেন্ড",
		"222 km/h":                     "২২২ কিমি/ঘণ্টা",
...
// Seed implements the Seeder interface for Volkswagen Passat
func (vps *VolkswagenPassatSeeder) Seed(db *gorm.DB) error {
	productSlug := "volkswagen-passat"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "124 hp/ton",
	...
	log.Printf("✅ Volkswagen Passat specifications seeded successfully")
	return nil
}
