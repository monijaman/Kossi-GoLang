...
func (s *SpecificationSeederRefrigeratorMarcelMcgB7tCgxxXx) Seed(db *gorm.DB) error {
    ...
    specs := map[string]string{
		...
		"Compressor Input Power (Watt)": "V.0101-153 V.0201-153",
		"Compressor Type": "V.0101-RSCR V.0201-RSCR",
		"Wide Voltage Range": "V.0101-150V ~ 260V V.0201-150V ~ 260V",
		...
		"Temperature Control (Electronic/ Mechanical)": "V0101 & V0201- Mechanical",
