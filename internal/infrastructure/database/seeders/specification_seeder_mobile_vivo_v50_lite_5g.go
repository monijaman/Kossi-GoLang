...
func (s *SpecificationSeederMobileVivoV50Lite5g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Black, Blue": "কালো, নীল",
		"Dimensity 720 (7 nm)": "ডাইমেনসিটি ৭২০ (৭ ন্যানোমিটার)",
		...
		"IPS LCD, 60 Hz": "আইপিএস এলসিডি, ৬০ Hz",
		"January 2021": "জানুয়ারি ২০২১",
		"Li-Ion (non-removable)": "লি-আয়ন (অপসারণযোগ্য নয়)",
		"Mali-G57 MC3": "মালি-G৫৭ MC৩",
		"MediaTek Dimensity 720": "মিডিয়াটেক ডাইমেনসিটি ৭২০",
...
func (s *SpecificationSeederMobileVivoV50Lite5g) Seed(db *gorm.DB) error {
	...
	// Override model-specific values for Vivo V50 Lite 5G
