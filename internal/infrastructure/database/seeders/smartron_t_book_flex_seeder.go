...
// SmartronTBookFlexSeeder seeds specifications for Smartron t.book flex
type SmartronTBookFlexSeeder struct {
	BaseSeeder
}

// NewSmartronTBookFlexSeeder creates a new Smartron t.book flex seeder
func NewSmartronTBookFlexSeeder() *SmartronTBookFlexSeeder {
	return &SmartronTBookFlexSeeder{
		BaseSeeder: BaseSeeder{name: "Smartron t.book flex Specifications"},
	}
}

func (stbfs *SmartronTBookFlexSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Smartron":                      "স্মার্ট্রন",
		"t.book flex":                   "টি.বুক ফ্লেক্স",
		...
		"295 x 207 x 15.9 mm":                  "২৯৫ x ২০৭ x ১৫.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"5":                                    "৫",
		"6":                                    "৬",
...
// Seed implements the Seeder interface for Smartron t.book flex
func (stbfs *SmartronTBookFlexSeeder) Seed(db *gorm.DB) error {
	productSlug := "smartron-t.book-flex"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "295 x 207 x 15.9 mm",
		"Body Type":               "Plastic",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := stbfs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Smartron t.book flex specifications seeded successfully")
	return nil
}
