...
// SpecificationSeederRefrigeratorHisense277lTmfInverterGlassDoor seeds specifications/options for product 'hisense-277l-tmf-inverter-glass-door'
type SpecificationSeederRefrigeratorHisense277lTmfInverterGlassDoor struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorHisense277lTmfInverterGlassDoor creates a new seeder instance
func NewSpecificationSeederRefrigeratorHisense277lTmfInverterGlassDoor() *SpecificationSeederRefrigeratorHisense277lTmfInverterGlassDoor {
	return &SpecificationSeederRefrigeratorHisense277lTmfInverterGlassDoor{
		BaseSeeder: BaseSeeder{name: "Specifications for hisense-277l-tmf-inverter-glass-door"},
	}
}

func (s *SpecificationSeederRefrigeratorHisense277lTmfInverterGlassDoor) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Hisense":                      "হাইসেন্স",
		"277L TMF Inverter Glass Door": "277L TMF Inverter Glass Door",
		"China":                        "চীন",
...
// Seed inserts specification records for the product identified by slug 'hisense-277l-tmf-inverter-glass-door'
func (s *SpecificationSeederRefrigeratorHisense277lTmfInverterGlassDoor) Seed(db *gorm.DB) error {
	productSlug := "hisense-277l-tmf-inverter-glass-door"
	...
	specs := map[string]string{
		"Brand":                           "Hisense",
		"Model Name":                      "277L TMF Inverter Glass Door",
		"Origin":                          "China",
