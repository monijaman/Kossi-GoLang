...
func (s *SpecificationSeederMobileSamsungGalaxyM365g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"6 / 8 GB": "৬ / ৮ GB",
		"6 years of Android / Security updates": "৬ years of অ্যান্ড্রয়েড / Security updates",
		...
		"Glass front (Gorilla Glass Victus+), plastic frame, glass back": "গ্লাস সামনে (গরিলা গ্লাস Victus+), প্লাস্টিক ফ্রেম, গ্লাস পেছনে",
		"July 2025": "জুলাই ২০২৫",
		"Li-Po (non-removable)": "লি-পো (অপসারণযোগ্য নয়)",
		"Mali-G68 MP5": "মালি-G৬৮ মেগাপিক্সেল৫",
		"Nano-SIM + Nano-SIM": "ন্যানো-সিম + ন্যানো-সিম",
		"Octa-core (4×2.4 GHz Cortex-A78 + 4×2.0 GHz Cortex-A55)": "অক্টা-কোর (৪×২.৪ গিগাহার্টজ Cবাtex-A৭৮ + ৪×২.০ গিগাহার্টজ Cবাtex-A৫৫)",
		...
		"Thunder Grey, DayBreak Blue, Moonlight Blue": "থান্ডার ধূসর, ডেব্রেক নীল, মুনলাইট নীল",
