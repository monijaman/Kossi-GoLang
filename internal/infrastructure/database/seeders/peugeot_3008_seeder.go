...
// Peugeot3008Seeder seeds specifications for Peugeot 3008
type Peugeot3008Seeder struct {
	BaseSeeder
}

// NewPeugeot3008Seeder creates a new Peugeot 3008 seeder
func NewPeugeot3008Seeder() *Peugeot3008Seeder {
	return &Peugeot3008Seeder{
		BaseSeeder: BaseSeeder{name: "Peugeot 3008 Specifications"},
	}
}

func (p3s *Peugeot3008Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"1.6L Turbo Hybrid":             "১.৬লি টার্বো হাইব্রিড",
		"Displacement":                  "ডিসপ্লেসমেন্ট",
		"1598 cc":                       "১৫৯৮ সিসি",
		"Max Power":                     "ম্যাক্স পাওয়ার",
		"180 hp @ 5500 rpm":             "১৮০ হর্স পাওয়ার @ ৫৫০০ আরপিএম",
		"Max Torque":                    "ম্যাক্স টর্ক",
		"300 Nm @ 3000 rpm":             "৩০০ এনএম @ ৩০০০ আরপিএম",
...
func (p3s *Peugeot3008Seeder) Seed(db *gorm.DB) error {
	// First, find or create the product
	var product models.ProductModel
	if err := db.Where("name = ?", "Peugeot 3008").First(&product).Error; err != nil {
	...
	specifications := map[string]string{
		...
		"performance_acceleration":    "8.1 seconds",
		"performance_mileage_arai":    "20 km/L",
		"performance_mileage_city":    "16 km/L",
		"performance_mileage_highway": "24 km/L",
		"performance_emission_norm":   "BS VI",
		"dimensions_length":           "4447 mm",
		"dimensions_width":            "1841 mm",
		"dimensions_height":           "1620 mm",
		"dimensions_wheelbase":        "2675 mm",
		"dimensions_front_tread":      "1608 mm",
		"dimensions_rear_tread":       "1617 mm",
		"dimensions_ground_clearance": "219 mm",
		"dimensions_boot_space":       "520 L",
		"dimensions_fuel_tank":        "53 L",
		"dimensions_turning_radius":   "5.4 m",
		"weight_kerb_weight":          "1420 kg",
		"weight_gross_weight":         "1990 kg",
	...
	log.Printf("Seeded specifications for Peugeot 3008")
	return nil
}
