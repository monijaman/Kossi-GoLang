...
// SpecificationSeederRefrigeratorMarcelMfeB8bGdenXx seeds specifications/options for product 'mfe-b8b-gden-xx'
...
func NewSpecificationSeederRefrigeratorMarcelMfeB8bGdenXx() *SpecificationSeederRefrigeratorMarcelMfeB8bGdenXx {
	return &SpecificationSeederRefrigeratorMarcelMfeB8bGdenXx{
		BaseSeeder: BaseSeeder{name: "Specifications for mfe-b8b-gden-xx"},
	}
}
...
// Seed inserts specification records for the product identified by slug 'mfe-b8b-gden-xx'
func (s *SpecificationSeederRefrigeratorMarcelMfeB8bGdenXx) Seed(db *gorm.DB) error {
	productSlug := "mfe-b8b-gden-xx"
