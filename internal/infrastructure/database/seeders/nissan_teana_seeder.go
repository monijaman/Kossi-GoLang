...
// NissanTeanaSeeder seeds specifications for Nissan Teana
type NissanTeanaSeeder struct {
	BaseSeeder
}

// NewNissanTeanaSeeder creates a new Nissan Teana seeder
func NewNissanTeanaSeeder() *NissanTeanaSeeder {
	return &NissanTeanaSeeder{
		BaseSeeder: BaseSeeder{name: "Nissan Teana Specifications"},
	}
}

func (nts *NissanTeanaSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Teana 2.5":               "টিয়ানা ২.৫",
		"4th Generation (J34)":    "৪র্থ প্রজন্ম (জে৩৪)",
...
// Seed implements the Seeder interface for Nissan Teana
func (nts *NissanTeanaSeeder) Seed(db *gorm.DB) error {
	productSlug := "nissan-teana"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := nts.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Nissan Teana specifications seeded successfully")
	return nil
}
