...
func (s *SpecificationSeederMobileSamsungGalaxyS25) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"45W সুপার Fast Charging 2.0 (50% in 30 min); 15W Fast Wireless Charging 2.0; 4.5W reverse wireless": "৪৫W সুপার ফাস্ট চার্জিং ২.০ (৫০% in ৩০ মিনিট); ১৫W Fast বেতার Charging ২.০; ৪.৫W reverse বেতার",
		...
		"Navy, Silver Shadow, Icy Blue, মিন্ট, Coral Red": "Navy, রূপালী Shadow, Icy নীল, মিন্ট, Coral লাল",
		...
		"Triple Camera: 50MP Wide + 10MP Telephoto (3x) + 12MP আল্ট্রাwide": "Triple Camera: ৫০MP Wide + ১০MP Telephoto (৩x) + ১২MP আল্ট্রাwide",
		"UFS 4.0": "UFS ৪.০",
