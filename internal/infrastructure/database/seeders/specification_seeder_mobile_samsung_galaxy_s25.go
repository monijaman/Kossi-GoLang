...
func (s *SpecificationSeederMobileSamsungGalaxyS25) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"12 GB": "১২ GB",
		"12 MP, f/2.2, 26mm (wide), Dual Pixel PDAF": "১২ মেগাপিক্সেল, f/২.২, ২৬mm (ওয়াইড), ডুয়াল Pixel PDAF",
		"120Hz (Adaptive)": "১২০Hz (Adaptive)",
		"1440 x 3120 pixels (~516 ppi density)": "১৪৪০ x ৩১২০ পিক্সেল (~৫১৬ পিপিআই density)",
		...
		"3.4 GHz": "৩.৪ গিগাহার্টজ",
		"32-bit/384kHz audio, Tuned by AKG, Dolby Atmos": "৩২-bit/৩৮৪kHz audio, Tuned by AKG, ডলবি অ্যাটমস",
		"3x optical zoom, up to 30x Space Zoom": "৩x অপটিক্যাল জুম, পর্যন্ত ৩০x স্পেস Zoom",
		"4,900 mAh": "৪,৯০০ এমএএইচ",
		"45W Super Fast Charging 2.0 (50% in 30 min); 15W Fast Wireless Charging 2.0; 4.5W reverse wireless": "৪৫W Super ফাস্ট চার্জিং ২.০ (৫০% in ৩০ মিনিট); ১৫W Fast বেতার Charging ২.০; ৪.৫W রিভার্স বেতার",
		"45W wired, PD3.0; 15W wireless (Qi/PMA); 4.5W reverse wireless": "৪৫W তারযুক্ত, PD৩.০; ১৫W বেতার (Qi/PMA); ৪.৫W রিভার্স বেতার",
		...
		"8K@30fps, 4K@30/60fps, 1080p@60/240fps, 720p@960fps, HDR10+": "৮K@৩০fps, ৪K@৩০/৬০fps, ১০৮০p@৬০/২৪০fps, ৭২০p@৯৬০fps, এইচডিআর১০+",
		"Adreno 830": "অ্যাড্রেনো ৮৩০",
		"Android 15, One UI 7": "অ্যান্ড্রয়েড ১৫, ওয়ান ইউআই ৭",
		"Armor aluminum frame, Gorilla Glass Victus 3 front/back": "Armবা অ্যালুমিনিয়াম ফ্রেম, গরিলা গ্লাস Victus ৩ সামনে/পেছনে",
		"Available. Released February 07, 2025": "উপলব্ধ. প্রকাশিত ফেব্রুয়ারি ০৭, ২০২৫",
		"Corning Gorilla Glass Victus 3": "কর্নিং গরিলা গ্লাস ভিক্টাস ৩",
		"Dynamic AMOLED 2X, 120Hz, HDR10+, 2600 nits (peak)": "Dynamic অ্যামোলেড ২X, ১২০Hz, এইচডিআর১০+, ২৬০০ nits (পিক)",
		"Fingerprint (under display, ultrasonic), accelerometer, gyro, proximity, compass, barometer": "ফিঙ্গারপ্রিন্ট (ডিসপ্লের নিচে, আল্ট্রাসনিক), অ্যাক্সিলেরোমিটার, জাইরো, প্রক্সিমিটি, কম্পাস, ব্যারোমিটার",
		"GPS (L1+L5), GLONASS, BDS, GALILEO (E1+E5a), QZSS (L1+L5)": "জিপিএস (L১+L৫), GLONASS, BDS, GALILEO (E১+E৫a), QZSS (L১+L৫)",
		...
		"IP68 dust/water resistant (up to 1.5m for 30 min)": "IP৬৮ dust/জল প্রতিরোধী (পর্যন্ত ১.৫m জন্য ৩০ min)",
		"January 22, 2025": "জানুয়ারি ২২, ২০২৫",
		"LTE Band 1/2/3/4/5/7/8/12/13/17/18/19/20/25/26/28/32/38/39/40/41/66": "এলটিই Bএবং ১/২/৩/৪/৫/৭/৮/১২/১৩/১৭/১৮/১৯/২০/২৫/২৬/২৮/৩২/৩৮/৩৯/৪০/৪১/৬৬",
		"Li-Ion (non-removable)": "লি-আয়ন (অপসারণযোগ্য নয়)",
		"Navy, Silver Shadow, Icy Blue, Mint, Coral Red": "নেভি, রূপালী শ্যাডো, আইসি নীল, মিন্ট, কোরাল লাল",
		"Octa-core (2x3.4 GHz Cortex-X5 & 6x3.0 GHz Cortex-A730)": "অক্টা-কোর (২x৩.৪ গিগাহার্টজ Cবাtex-X৫ & ৬x৩.০ গিগাহার্টজ Cবাtex-A৭৩০)",
		"Qualcomm SM8750 Snapdragon 8 Gen 4 (3 nm)": "কোয়ালকম SM৮৭৫০ স্ন্যাপড্রাগন ৮ জেন ৪ (৩ ন্যানোমিটার)",
		...
		"Triple Camera: 50MP Wide + 10MP Telephoto (3x) + 12MP Ultrawide": "Triple Camera: ৫০MP Wide + ১০MP Telephoথেকে (৩x) + ১২MP আল্ট্রাওয়াইড",
		"UFS 4.0": "UFS ৪.০",
		"USB Type-C 3.2, DisplayPort, OTG": "ইউএসবি টাইপ-সি ৩.২, DisplayPবাt, OTG",
		"Wi-Fi 802.11 a/b/g/n/ac/6e/7, tri-band, Wi-Fi Direct": "ওয়াই-ফাই ৮০২.১১ a/b/g/n/ac/৬e/৭, tri-bএবং, ওয়াই-ফাই Direct",
		"Yes - 15W wireless (Qi/PMA), 4.5W reverse wireless": "হ্যাঁ - ১৫W বেতার (Qi/PMA), ৪.৫W রিভার্স বেতার",
	}
}
