...
func (s *SpecificationSeederMobileIphone17Pro) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"199 g (7.02 oz)": "১৯৯ গ্রাম (৭.০২ oz)",
		"2556 x 1179 pixels (~460 ppi density)": "২৫৫৬ x ১১৭৯ পিক্সেল (~৪৬০ পিপিআই density)",
		...
		"Black, White, Gold, Rose Gold, Blue": "কালো, সাদা, সোনালী, রোজ সোনালী, নীল",
