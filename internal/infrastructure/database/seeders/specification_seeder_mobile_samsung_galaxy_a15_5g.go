...
func (s *SpecificationSeederMobileSamsungGalaxyA155g) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Brave Black, Optimistic Blue, Magical Blue, Personality Yellow": "Brave কালো, Optimistic নীল, ম্যাজিকal নীল, Personality হলুদ",
		...
		"Super AMOLED, 90Hz, 800 nits": "Super অ্যামোলেড, ৯০Hz, ৮০০ nits",
	}
}
...
func (s *SpecificationSeederMobileSamsungGalaxyA155g) Seed(db *gorm.DB) error {
	...
	// Override model-specific values for Samsung Galaxy A15 5G
