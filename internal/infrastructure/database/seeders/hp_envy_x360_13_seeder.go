...
// HpEnvyX36013Seeder seeds specifications for HP Envy x360 13
type HpEnvyX36013Seeder struct {
	BaseSeeder
}

// NewHpEnvyX36013Seeder creates a new HP Envy x360 13 seeder
func NewHpEnvyX36013Seeder() *HpEnvyX36013Seeder {
	return &HpEnvyX36013Seeder{
		BaseSeeder: BaseSeeder{name: "HP Envy x360 13 Specifications"},
	}
}

func (hes *HpEnvyX36013Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"HP":                            "এইচপি",
		"Envy x360 13":                  "এনভি এক্স৩৬০ ১৩",
		...
		"297.2 x 209.8 x 15.9 mm":              "২৯৭.২ x ২০৯.৮ x ১৫.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"10":                                   "১০",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for HP Envy x360 13
func (hes *HpEnvyX36013Seeder) Seed(db *gorm.DB) error {
	productSlug := "hp-envy-x360-13"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "297.2 x 209.8 x 15.9 mm",
		"Body Type":               "Aluminum",
	...
	log.Printf("✅ HP Envy x360 13 specifications seeded successfully")
	return nil
}
