...
// FordFiestaSeeder seeds specifications for Ford Fiesta
type FordFiestaSeeder struct {
	BaseSeeder
}

// NewFordFiestaSeeder creates a new Ford Fiesta seeder
func NewFordFiestaSeeder() *FordFiestaSeeder {
	return &FordFiestaSeeder{
		BaseSeeder: BaseSeeder{name: "Ford Fiesta Specifications"},
	}
}

func (ffs *FordFiestaSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"1.6L":                               "১.৬ লিটার",
		"6th":                                "৬ষ্ঠ প্রজন্ম",
		"Subcompact Car":                     "সাবকমপ্যাক্ট কার",
		"2019":                               "২০১৯",
		"Hatchback":                          "হ্যাচব্যাক",
		"Oxford White":                       "অক্সফোর্ড হোয়াইট",
		"In-line":                            "ইন-লাইন",
		"1596":                               "১৫৯৬ সিসি",
		"4":                                  "৪ (সিলিন্ডার)",
		"120 hp":                             "১২০ হর্স পাওয়ার",
		"120 hp @ 6350 rpm":                  "৬৩৫০ আরপিএম এ ১২০ হর্স পাওয়ার",
		"152 Nm @ 5000 rpm":                  "৫০০০ আরপিএম এ ১৫২ এনএম",
		"Petrol":                             "পেট্রোল",
		...
		"Ford (Sound System)":                "ফোর্ড (সাউন্ড সিস্টেম)",
...
// Seed implements the Seeder interface for Ford Fiesta
func (ffs *FordFiestaSeeder) Seed(db *gorm.DB) error {
	productSlug := "ford-fiesta"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := ffs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Ford Fiesta specifications seeded successfully")
	return nil
}
