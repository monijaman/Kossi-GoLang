...
// ProtonX70Seeder seeds specifications for Proton X70
type ProtonX70Seeder struct {
	BaseSeeder
}

// NewProtonX70Seeder creates a new Proton X70 seeder
func NewProtonX70Seeder() *ProtonX70Seeder {
	return &ProtonX70Seeder{
		BaseSeeder: BaseSeeder{name: "Proton X70 Specifications"},
	}
}

func (pxs *ProtonX70Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"2018":                         "২০১৮",
		"SUV":                          "এসইউভি",
		"Armour Grey":                  "আর্মার গ্রে",
		"Inline":                       "ইনলাইন",
		"1477":                         "১৪৭৭ সিসি",
		"4":                            "৪ (সিলিন্ডার)",
		"181 hp":                       "১৮১ হর্স পাওয়ার",
		"181 hp @ 5500 rpm":            "৫৫০০ আরপিএম এ ১৮১ হর্স পাওয়ার",
		"300 Nm @ 1500-4000 rpm":       "১৫০০-৪০০০ আরপিএম এ ৩০০ এনএম",
		"Petrol":                       "পেট্রোল",
...
// Seed implements the Seeder interface for Proton X70
func (pxs *ProtonX70Seeder) Seed(db *gorm.DB) error {
	productSlug := "proton-x70"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := pxs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Proton X70 specifications seeded successfully")
	return nil
}
