...
// SpecificationSeederRefrigeratorecobcd170flgdblackfreesia seeds specifications/options for product 'eco-bcd-170-fl-gd-black-freesia'
type SpecificationSeederRefrigeratorecobcd170flgdblackfreesia struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorecobcd170flgdblackfreesia creates a new seeder instance
func NewSpecificationSeederRefrigeratorecobcd170flgdblackfreesia() *SpecificationSeederRefrigeratorecobcd170flgdblackfreesia {
	return &SpecificationSeederRefrigeratorecobcd170flgdblackfreesia{
		BaseSeeder: BaseSeeder{name: "Specifications for eco-bcd-170-fl-gd-black-freesia"},
	}
}

func (s *SpecificationSeederRefrigeratorecobcd170flgdblackfreesia) getBanglaTranslations() map[string]string {
	return map[string]string{
		"ECO+":                        "ইকো+",
		"BCD-170 FL GD Black Freesia": "BCD-170 FL GD Black Freesia",
...
// Seed inserts specification records for the product identified by slug 'eco-bcd-170-fl-gd-black-freesia'
func (s *SpecificationSeederRefrigeratorecobcd170flgdblackfreesia) Seed(db *gorm.DB) error {
	productSlug := "eco-bcd-170-fl-gd-black-freesia"
	...
	specs := map[string]string{
		"Brand":                       "ECO+",
		"Model Name":                  "BCD-170 FL GD Black Freesia",
