...
// SpecificationSeederRefrigeratorSingerFTDS155RG seeds specifications/options for product 'singer-ftds155-rg'
type SpecificationSeederRefrigeratorSingerFTDS155RG struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS155RG creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS155RG() *SpecificationSeederRefrigeratorSingerFTDS155RG {
	return &SpecificationSeederRefrigeratorSingerFTDS155RG{
		BaseSeeder: BaseSeeder{name: "Specifications for singer-ftds155-rg"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS155RG) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                   "সিঙ্গার",
		"FTDS155-RG":               "FTDS155-RG",
...
// Seed inserts specification records for the product identified by slug 'singer-ftds155-rg'
func (s *SpecificationSeederRefrigeratorSingerFTDS155RG) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds155-rg"
