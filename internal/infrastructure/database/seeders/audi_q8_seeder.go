...
// AudiQ8Seeder seeds specifications for Audi Q8
type AudiQ8Seeder struct {
	BaseSeeder
}

// NewAudiQ8Seeder creates a new Audi Q8 seeder
func NewAudiQ8Seeder() *AudiQ8Seeder {
	return &AudiQ8Seeder{
		BaseSeeder: BaseSeeder{name: "Audi Q8 Specifications"},
	}
}

func (aqs *AudiQ8Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Audi Q8
func (aqs *AudiQ8Seeder) Seed(db *gorm.DB) error {
	productSlug := "audi-q8"
	...
	log.Printf("✅ Audi Q8 specifications seeded successfully")
	return nil
}
