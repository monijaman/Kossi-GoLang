...
// RangeRoverVelarSeeder seeds specifications for Range Rover Velar
type RangeRoverVelarSeeder struct {
	BaseSeeder
}

// NewRangeRoverVelarSeeder creates a new Range Rover Velar seeder
func NewRangeRoverVelarSeeder() *RangeRoverVelarSeeder {
	return &RangeRoverVelarSeeder{
		BaseSeeder: BaseSeeder{name: "Range Rover Velar Specifications"},
	}
}

func (rrvs *RangeRoverVelarSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"2017":                         "২০১৭",
		"SUV":                          "এসইউভি",
		"Santorini Black":              "স্যান্টোরিনি ব্ল্যাক",
		"Inline":                       "ইনলাইন",
		"1997":                         "১৯৯৭ সিসি",
		"4":                            "৪ (সিলিন্ডার)",
		"250 hp":                       "২৫০ হর্স পাওয়ার",
		"250 hp @ 5500 rpm":            "৫৫০০ আরপিএম এ ২৫০ হর্স পাওয়ার",
		"365 Nm @ 1500-4500 rpm":       "১৫০০-৪৫০০ আরপিএম এ ৩৬৫ এনএম",
		"Petrol":                       "পেট্রোল",
...
// Seed implements the Seeder interface for Range Rover Velar
func (rrvs *RangeRoverVelarSeeder) Seed(db *gorm.DB) error {
	productSlug := "range-rover-velar"
	...
	specs := map[string]string{
		...
		"Power to Weight (HP/ton)":       "137 hp/ton",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := rrvs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Range Rover Velar specifications seeded successfully")
	return nil
}
