...
func (s *SpecificationSeederMobileSamsungGalaxyA24) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"Eye Care Certification (low blue light)": "Eye Care Certification (low নীল লাইট)",
		"GSM / HSPA / LTE (no 5G)": "জিএসএম / এইচএসপিএ / এলটিই (no ৫G)",
		"Glass front, plastic frame / back": "গ্লাস সামনে, প্লাস্টিক ফ্রেম / পেছনে",
		"Helio G99 (6 nm)": "হেলিও G৯৯ (৬ ন্যানোমিটার)",
