...
// ChanganCs35Seeder seeds specifications for Changan CS35
type ChanganCs35Seeder struct {
	BaseSeeder
}

// NewChanganCs35Seeder creates a new Changan CS35 seeder
func NewChanganCs35Seeder() *ChanganCs35Seeder {
	return &ChanganCs35Seeder{
		BaseSeeder: BaseSeeder{name: "Changan CS35 Specifications"},
	}
}

func (ccs *ChanganCs35Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"121 hp @ 6000 rpm":                   "৬০০০ আরপিএম এ ১২১ হর্স পাওয়ার",
...
// Seed implements the Seeder interface for Changan CS35
func (ccs *ChanganCs35Seeder) Seed(db *gorm.DB) error {
	productSlug := "changan-cs35"
	...
	log.Printf("✅ Changan CS35 specifications seeded successfully")
	return nil
}
