...
// SpecificationSeederRefrigeratorSingerFTDS155NSV seeds specifications/options for product 'singer-ftds155nsv'
type SpecificationSeederRefrigeratorSingerFTDS155NSV struct {
	BaseSeeder
}

// NewSpecificationSeederRefrigeratorSingerFTDS155NSV creates a new seeder instance
func NewSpecificationSeederRefrigeratorSingerFTDS155NSV() *SpecificationSeederRefrigeratorSingerFTDS155NSV {
	return &SpecificationSeederRefrigeratorSingerFTDS155NSV{
		BaseSeeder{name: "Specifications for singer-ftds155nsv"},
	}
}

func (s *SpecificationSeederRefrigeratorSingerFTDS155NSV) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Singer":                   "সিঙ্গার",
		"FTDS155NSV":               "FTDS155NSV",
...
// Seed inserts specification records for the product identified by slug 'singer-ftds155nsv'
func (s *SpecificationSeederRefrigeratorSingerFTDS155NSV) Seed(db *gorm.DB) error {
	productSlug := "singer-ftds155nsv"
