...
// XiaomiRedmiBookPro14Seeder seeds specifications for Xiaomi Redmi Book Pro 14
type XiaomiRedmiBookPro14Seeder struct {
	BaseSeeder
}

// NewXiaomiRedmiBookPro14Seeder creates a new Xiaomi Redmi Book Pro 14 seeder
func NewXiaomiRedmiBookPro14Seeder() *XiaomiRedmiBookPro14Seeder {
	return &XiaomiRedmiBookPro14Seeder{
		BaseSeeder: BaseSeeder{name: "Xiaomi Redmi Book Pro 14 Specifications"},
	}
}

func (xrbpx14s *XiaomiRedmiBookPro14Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Xiaomi":                        "শাওমি",
		"Redmi Book Pro 14":             "রেডমি বুক প্রো ১৪",
		...
		"322.5 x 207.1 x 14.9 mm":              "৩২২.৫ x ২০৭.১ x ১৪.৯ মিমি",
		"TPM 2.0":                              "টিপিএম ২.০",
		"8":                                    "৮",
		"12":                                   "১২",
...
// Seed implements the Seeder interface for Xiaomi Redmi Book Pro 14
func (xrbpx14s *XiaomiRedmiBookPro14Seeder) Seed(db *gorm.DB) error {
	productSlug := "xiaomi-redmi-book-pro-14"
	...
	specs := map[string]string{
		...
		"Sensors":                 "No",
		"Dimensions":              "322.5 x 207.1 x 14.9 mm",
		"Body Type":               "Plastic",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := xrbpx14s.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Xiaomi Redmi Book Pro 14 specifications seeded successfully")
	return nil
}
