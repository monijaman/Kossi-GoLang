...
// SuzukiWagonRSeeder seeds specifications for Suzuki Wagon R
type SuzukiWagonRSeeder struct {
	BaseSeeder
}

// NewSuzukiWagonRSeeder creates a new Suzuki Wagon R seeder
func NewSuzukiWagonRSeeder() *SuzukiWagonRSeeder {
	return &SuzukiWagonRSeeder{
		BaseSeeder: BaseSeeder{name: "Suzuki Wagon R Specifications"},
	}
}

func (swrs *SuzukiWagonRSeeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Suzuki Wagon R
func (swrs *SuzukiWagonRSeeder) Seed(db *gorm.DB) error {
	productSlug := "suzuki-wagon-r"
	...
	for key, value := range specs {
		...
		if banglaValue, exists := swrs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ Suzuki Wagon R specifications seeded successfully")
	return nil
}
