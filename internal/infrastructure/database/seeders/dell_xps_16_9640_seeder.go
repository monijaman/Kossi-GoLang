...
// DellXPS169640Seeder seeds specifications for Dell XPS 16 9640
type DellXPS169640Seeder struct {
	BaseSeeder
}

// NewDellXPS169640Seeder creates a new Dell XPS 16 9640 seeder
func NewDellXPS169640Seeder() *DellXPS169640Seeder {
	return &DellXPS169640Seeder{
		BaseSeeder: BaseSeeder{name: "Dell XPS 16 9640 Specifications"},
	}
}

func (dxps *DellXPS169640Seeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"Dell":                          "ডেল",
		"XPS 16 9640":                   "এক্সপিএস ১৬ ৯৬৪০",
		"Windows 11 Pro":                "উইন্ডোজ ১১ প্রো",
		"Intel":                         "ইন্টেল",
		"Core Ultra 9 185H":             "কোর আল্ট্রা ৯ ১৮৫এইচ",
		"14th Gen":                      "১৪তম প্রজন্ম",
		"Intel Platform Controller Hub": "ইন্টেল প্ল্যাটফর্ম কন্ট্রোলার হাব",
		"NVIDIA GeForce RTX 4070":       "এনভিডিয়া জিফোর্স আরটিএক্স ৪০৭০",
		"3840 x 2160 pixels":            "৩৮৪০ x ২১৬০ পিক্সেল",
		"16 inches":                     "১৬ ইঞ্চি",
		"90 Wh":                         "৯০ ডব্লিউএইচ",
...
// Seed implements the Seeder interface for Dell XPS 16 9640
func (dxps *DellXPS169640Seeder) Seed(db *gorm.DB) error {
	productSlug := "dell-xps-16-9640"
	...
	specs := map[string]string{
		"Brand":                "Dell",
		"Model Name":           "XPS 16 9640",
		"Operating System":     "Windows 11 Pro",
		"Processor Brand":      "Intel",
		"Processor Model":      "Core Ultra 9 185H",
		...
		"Laptop Type":             "Premium Workstation",
	...
	log.Printf("✅ Dell XPS 16 9640 specifications seeded successfully")
	return nil
}
