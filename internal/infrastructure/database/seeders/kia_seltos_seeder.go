...
// KiaSeltosSeeder seeds specifications for Kia Seltos
type KiaSeltosSeeder struct {
	BaseSeeder
}

// NewKiaSeltosSeeder creates a new Kia Seltos seeder
func NewKiaSeltosSeeder() *KiaSeltosSeeder {
	return &KiaSeltosSeeder{
		BaseSeeder: BaseSeeder{name: "Kia Seltos Specifications"},
	}
}

func (kss *KiaSeltosSeeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for Kia Seltos
func (kss *KiaSeltosSeeder) Seed(db *gorm.DB) error {
	productSlug := "kia-seltos"
	...
	log.Printf("✅ Kia Seltos specifications seeded successfully")
	return nil
}
