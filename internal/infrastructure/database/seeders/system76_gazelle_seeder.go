...
// System76GazelleSeeder seeds specifications for System76 Gazelle
type System76GazelleSeeder struct {
	BaseSeeder
}

// NewSystem76GazelleSeeder creates a new System76 Gazelle seeder
func NewSystem76GazelleSeeder() *System76GazelleSeeder {
	return &System76GazelleSeeder{
		BaseSeeder: BaseSeeder{name: "System76 Gazelle Specifications"},
	}
}

func (sgs *System76GazelleSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		"System76":                             "সিস্টেম৭৬",
		"Gazelle":                              "গ্যাজেল",
		"Pop!_OS 24.04 LTS":                    "পপ!_ওএস ২৪.০৪ এলটিএস",
		"Intel":                                "ইন্টেল",
		"Core 7 250H":                          "কোর ৭ ২৫০এইচ",
		"14th Gen":                             "১৪তম প্রজন্ম",
		"NVIDIA RTX 5050":                      "এনভিডিয়া আরটিএক্স ৫০৫০",
		...
		"1.6 GHz base / 5.4 GHz boost":         "১.৬ গিগাহার্টজ বেস / ৫.৪ গিগাহার্টজ বুস্ট",
...
// Seed implements the Seeder interface for System76 Gazelle
func (sgs *System76GazelleSeeder) Seed(db *gorm.DB) error {
	productSlug := "system76-gazelle"
	...
	specs := map[string]string{
		...
		"Processor Model":         "Core 7 250H",
		"Processor Generation":    "14th Gen",
		"Graphics Card":           "NVIDIA RTX 5050",
		...
		"Processor Speed":         "1.6 GHz base / 5.4 GHz boost",
	...
	for key, value := range specs {
		...
		if banglaValue, exists := sgs.getBanglaTranslations()[value]; exists {
	...
	log.Printf("✅ System76 Gazelle specifications seeded successfully")
	return nil
}
