...
// MsiPulse15Seeder seeds specifications for MSI Pulse 15
type MsiPulse15Seeder struct {
	BaseSeeder
}

// NewMsiPulse15Seeder creates a new MSI Pulse 15 seeder
func NewMsiPulse15Seeder() *MsiPulse15Seeder {
	return &MsiPulse15Seeder{
		BaseSeeder: BaseSeeder{name: "MSI Pulse 15 Specifications"},
	}
}

func (mps *MsiPulse15Seeder) getBanglaTranslations() map[string]string {
...
// Seed implements the Seeder interface for MSI Pulse 15
func (mps *MsiPulse15Seeder) Seed(db *gorm.DB) error {
	productSlug := "msi-pulse-15"
	...
	log.Printf("✅ MSI Pulse 15 specifications seeded successfully")
	return nil
}
