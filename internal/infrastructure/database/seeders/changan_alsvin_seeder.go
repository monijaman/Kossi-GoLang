...
// ChanganAlsvinSeeder seeds specifications for Changan Alsvin
type ChanganAlsvinSeeder struct {
	BaseSeeder
}

// NewChanganAlsvinSeeder creates a new Changan Alsvin seeder
func NewChanganAlsvinSeeder() *ChanganAlsvinSeeder {
	return &ChanganAlsvinSeeder{
		BaseSeeder: BaseSeeder{name: "Changan Alsvin Specifications"},
	}
}

func (cas *ChanganAlsvinSeeder) getBanglaTranslations() map[string]string {
	return map[string]string{
		...
		"1370":                               "১৩৭০ সিসি",
		"4":                                  "৪ (সিলিন্ডার)",
		"99 hp":                              "৯৯ হর্স পাওয়ার",
		"99 hp @ 6000 rpm":                   "৬০০০ আরপিএম এ ৯৯ হর্স পাওয়ার",
		"135 Nm @ 4500 rpm":                  "৪৫০০ আরপিএম এ ১৩৫ এনএম",
		"Petrol":                             "পেট্রোল",
...
// Seed implements the Seeder interface for Changan Alsvin
func (cas *ChanganAlsvinSeeder) Seed(db *gorm.DB) error {
	productSlug := "changan-alsvin"
	...
	log.Printf("✅ Changan Alsvin specifications seeded successfully")
	return nil
}
