...
func (b *BrandGORMModel) FromEntity(entity *entities.Brand) {
	b.ID = entity.ID; b.Name = entity.Name; b.Slug = entity.Slug
	b.CreatedAt = entity.CreatedAt; b.UpdatedAt = entity.UpdatedAt; b.DeletedAt = entity.DeletedAt
}
...
func (b *BrandEntModel) FromEntity(entity *entities.Brand) {
	b.ID = int(entity.ID); b.Name = entity.Name; b.Slug = entity.Slug
	b.CreatedAt = entity.CreatedAt; b.UpdatedAt = entity.UpdatedAt; b.DeletedAt = entity.DeletedAt
}
