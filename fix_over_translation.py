...
"""
Fix over-translation issues - restore English in code/imports
"""
...
FIX_TRANSLATIONS = [
    # Fix import statements and code keywords that got wrongly translated
    ('dataবেস', 'database'),
    ('বেসSeeder', 'BaseSeeder'),
    ('বেস A', 'base A'),
]

def fix_over_translation(file_path):
    """Fix over-translated terms in a single file"""
...
def main():
    ...
    print("=" * 80)
    print("FIXING OVER-TRANSLATION ISSUES")
    print("=" * 80)
    ...
    for file_path in seeder_files:
        fix_count = fix_over_translation(file_path)
